...
{
    [XmlRoot(RuleXmlTag.Rule8)]
    public partial class Rule8 : IRule, IRuleChecker
    {
        ...
        [XmlElement(RuleXmlTag.ClinicalStatus)]
        public string ClinicalStatus { get; set; }

        [XmlElement(RuleXmlTag.Icd10)]
        public string Icd10 { get; set; }

        [XmlElement(RuleXmlTag.PetIndicationCode)]
        public string PetIndicationCode { get; set; }

        [XmlElement(RuleXmlTag.SupplementalConditions)]
        public string SupplementalConditions { get; set; }
        ...
        {
            // PET için tanı ve endikasyon veya rapor koşulu
        }
