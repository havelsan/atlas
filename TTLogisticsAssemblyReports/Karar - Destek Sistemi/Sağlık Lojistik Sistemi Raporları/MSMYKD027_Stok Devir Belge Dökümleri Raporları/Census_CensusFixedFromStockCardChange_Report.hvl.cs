...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (TMİB Sayım Düzeltme - Değiş Döküm Çizelgesi)
    /// </summary>
    public partial class Census_CensusFixedFromStockCardChange : TTReport
    {
        ...
        {
            public Census_CensusFixedFromStockCardChange MyParentReport
            {
                get { return (Census_CensusFixedFromStockCardChange)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME.Value = @"TMİB SAYIM DÜZELTME - DEĞİŞ DÖKÜM ÇİZELGESİ";

                    AdditionNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 166, 2, 191, 7, false);
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 166, 7, 191, 12, false);
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 1, 1, 191, 6, false);
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField12221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 0, 181, 10, false);
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 181, 0, 191, 10, false);
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SIGNS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 29, 191, 47, false);
                    SIGNS.Name = "SIGNS";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_CensusFixedFromStockCardChange)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet TMİB Sayım Düzeltme - Değiş'in 4'üncü nüshaları "
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 0, 181, 5, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    EXTRA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 181, 0, 191, 5, false);
                    EXTRA.Name = "EXTRA";
...
#region MAIN BODY_Script
        ...
        public Census_CensusFixedFromStockCardChange()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_CENSUSFIXEDFROMSTOCKCARDCHANGE";
            Caption = "Stok Devir Belge Dökümleri (TMİB Sayım Düzeltme - Değiş Döküm Çizelgesi)";
