...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (Dağıtım/İade Belgesi (Dağıtım) Döküm Çizelgesi)
    /// </summary>
    public partial class Census_DistributionDocument : TTReport
    {
        ...
        {
            public Census_DistributionDocument MyParentReport
            {
                get { return (Census_DistributionDocument)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 9, 192, 27, false);
                    ...
                    REPORTNAME.Value = @"DAĞITIM/İADE BELGESİ (DAĞITIM) DÖKÜM ÇİZELGESİ";
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SIGNS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 29, 192, 54, false);
                    SIGNS.Name = "SIGNS";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_DistributionDocument)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet Dağıtım/İade Belgesinin (Dağıtım) 4'üncü nüshaları "
...
#region PARTB_Methods
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<DistributionDocument.CensusReportNQL_DistributionDocument_Class>("CensusReportNQL_DistributionDocument", DistributionDocument.CensusReportNQL_DistributionDocument((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TERMID)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DistributionDocument.CensusReportNQL_DistributionDocument_Class dataset_CensusReportNQL_DistributionDocument = ParentGroup.rsGroup.GetCurrentRecord<DistributionDocument.CensusReportNQL_DistributionDocument_Class>(0);
                    ObjectID.CalcValue = (dataset_CensusReportNQL_DistributionDocument != null ? Globals.ToStringCore(dataset_CensusReportNQL_DistributionDocument.ObjectID) : "");
...
#region MAIN BODY_Script
        ...
        public Census_DistributionDocument()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_DISTRIBUTIONDOCUMENT";
            Caption = "Stok Devir Belge Dökümleri (Dağıtım/İade Belgesi (Dağıtım) Döküm Çizelgesi)";
