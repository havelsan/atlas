...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (TMİB Malzeme Giriş Onay Döküm Çizelgesi EK-129A)
    /// </summary>
    public partial class Census_ChattelDocInWithAccountancyNoGAB : TTReport
    {
        ...
        {
            public Census_ChattelDocInWithAccountancyNoGAB MyParentReport
            {
                get { return (Census_ChattelDocInWithAccountancyNoGAB)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME.Value = @"TMİB MALZEME GİRİŞ ONAY DÖKÜM ÇİZELGESİ";
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 182, 0, 193, 10, false);
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SIGNS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 29, 193, 60, false);
                    SIGNS.Name = "SIGNS";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_ChattelDocInWithAccountancyNoGAB)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet TMİB Malzeme Giriş Onay'ın 3'üncü nüshaları "
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    EXTRA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 182, 0, 193, 5, false);
                    EXTRA.Name = "EXTRA";
...
#region MAIN BODY_Script
        ...
        public Census_ChattelDocInWithAccountancyNoGAB()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_CHATTELDOCINWITHACCOUNTANCYNOGAB";
            Caption = "Stok Devir Belge Dökümleri (TMİB Malzeme Giriş Onay Döküm Çizelgesi EK-129A)";
