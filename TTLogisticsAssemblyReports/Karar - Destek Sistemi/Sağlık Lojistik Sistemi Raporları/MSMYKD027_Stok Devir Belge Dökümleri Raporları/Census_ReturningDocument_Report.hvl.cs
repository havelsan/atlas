...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (Dağıtım/İade Belgesi (İade) Döküm Çizelgesi)
    /// </summary>
    public partial class Census_ReturningDocument : TTReport
    {
        ...
        {
            public Census_ReturningDocument MyParentReport
            {
                get { return (Census_ReturningDocument)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME.Value = @"DAĞITIM/İADE BELGESİ (İADE) DÖKÜM ÇİZELGESİ";
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 167, 6, 192, 11, false);
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField12221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 164, 0, 181, 10, false);
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 181, 0, 192, 10, false);
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SIGNS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 29, 192, 56, false);
                    SIGNS.Name = "SIGNS";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_ReturningDocument)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet Dağıtım/İade Belgesinin (İade) 4'üncü nüshaları "
...
#region PARTB_Methods
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<ReturningDocument.CensusReportNQL_ReturningDocument_Class>("CensusReportNQL_ReturningDocument", ReturningDocument.CensusReportNQL_ReturningDocument((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TERMID)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 164, 0, 181, 5, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    EXTRA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 181, 0, 192, 5, false);
                    EXTRA.Name = "EXTRA";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ReturningDocument.CensusReportNQL_ReturningDocument_Class dataset_CensusReportNQL_ReturningDocument = ParentGroup.rsGroup.GetCurrentRecord<ReturningDocument.CensusReportNQL_ReturningDocument_Class>(0);
                    ObjectID.CalcValue = (dataset_CensusReportNQL_ReturningDocument != null ? Globals.ToStringCore(dataset_CensusReportNQL_ReturningDocument.ObjectID) : "");
...
#region MAIN BODY_Script
        ...
        public Census_ReturningDocument()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_RETURNINGDOCUMENT";
            Caption = "Stok Devir Belge Dökümleri (Dağıtım/İade Belgesi (İade) Döküm Çizelgesi)";
