...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (Tüm Girdi Gönderme Belgeleri Döküm Çizelgesi EK-129A)
    /// </summary>
    public partial class Census_ChattelDocInWithAccountancy : TTReport
    {
        ...
        {
            public Census_ChattelDocInWithAccountancy MyParentReport
            {
                get { return (Census_ChattelDocInWithAccountancy)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 12, 193, 30, false);
                    ...
                    REPORTNAME.Value = @"TÜM GİRDİ GÖNDERME BELGELERİ DÖKÜM ÇİZELGESİ";

                    AdditionNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 168, 1, 193, 6, false);
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 168, 6, 193, 11, false);
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 1, 193, 6, false);
                    ...
                    PAGENUMBER.Value = @"129A-{@pagenumber@}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    PAGENUMBER.CalcValue = @"129A-" + ParentReport.CurrentPageNumber.ToString();
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField12221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 0, 183, 10, false);
                    ...
                    NewField13221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 165, 10, false);
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 183, 0, 193, 10, false);
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    TOTAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 7, 193, 12, false);
                    TOTAL.Name = "TOTAL";
                    ...
                    TEFTIS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), -1, 13, 193, 25, false);
                    TEFTIS.Name = "TEFTIS";
                    ...
                    COUNTTEXT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 1, 193, 6, false);
                    ...
                    SAYMAN = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 39, 27, 73, 58, false);
                    SAYMAN.Name = "SAYMAN";
                    ...
                    HESAPSORUMLUSU = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 112, 27, 147, 58, false);
                    ...
                    BIRLIKXXXXXXI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 75, 27, 109, 58, false);
                    ...
                    NewField112111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 39, 59, 73, 69, false);
                    ...
                    NewField1111211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 112, 59, 147, 68, false);
                    ...
                    NewField1311112111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 75, 59, 109, 69, false);
                    NewField1311112111.Name = "NewField1311112111";
                    NewField1311112111.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    ...
                    NewField1311112111.Value = @"Birlik XXXXXXı";

                    TEXT1654321 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 3, 27, 37, 64, false);
                    TEXT1654321.Name = "TEXT1654321";
                    TEXT1654321.MultiLine = EvetHayirEnum.ehEvet;
                    TEXT1654321.WordBreak = EvetHayirEnum.ehEvet;
                    TEXT1654321.TextFont.Size = 11;
                    TEXT1654321.TextFont.Bold = true;
...
";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { TOTAL,TEFTIS,SUBGROUPCOUNT,PAGECOUNT,AMOUNTTEXT,ACCOUNTANCYNAME,COUNTTEXT,SUBGROUPCOUNTTEXT,SAYMAN,HESAPSORUMLUSU,BIRLIKXXXXXXI,NewField112111,NewField1111211,NewField1311112111,TEXT1654321};
                }
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_ChattelDocInWithAccountancy)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet Tüm Girdi Gönderme Belgelerinin 3'üncü nüshaları "
            ...
            COUNTTEXT.CalcValue = "///////////YALNIZ " + SUBGROUPCOUNT.FormattedValue + " (" + SUBGROUPCOUNTTEXT.FormattedValue.ToUpper() + ") ADET BELGE///////////";
              ...
              CheckStockCensusAction checkStockCensusAction = new CheckStockCensusAction(ctx);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 0, 183, 5, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    MATERIALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 165, 5, false);
                    ...
                    EXTRA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 183, 0, 193, 5, false);
                    EXTRA.Name = "EXTRA";
...
#region MAIN BODY_Script
        ...
        public Census_ChattelDocInWithAccountancy()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_CHATTELDOCINWITHACCOUNTANCY";
            Caption = "Stok Devir Belge Dökümleri (Tüm Girdi Gönderme Belgeleri Döküm Çizelgesi EK-129A)";
