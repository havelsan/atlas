...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (Tüm Tüketim, Üretim ve Elde Edilenler Belgeleri Döküm Çizelgesi EK-129F)
    /// </summary>
    public partial class Census_ProductionConsumptionDocument : TTReport
    {
        ...
        {
            public Census_ProductionConsumptionDocument MyParentReport
            {
                get { return (Census_ProductionConsumptionDocument)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 8, 192, 26, false);
                    ...
                    REPORTNAME.Value = @"TÜM TÜKETİM, ÜRETİM VE ELDE EDİLENLER BELGELERİ DÖKÜM ÇİZELGESİ";
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 167, 3, 192, 8, false);
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_ProductionConsumptionDocument)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet Tüketim, Üretim ve Elde Edilenler Belgelerinin 4'üncü nüshaları "
...
#region MAIN BODY_Script
        ...
        public Census_ProductionConsumptionDocument()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_PRODUCTIONCONSUMPTIONDOCUMENT";
            Caption = "Stok Devir Belge Dökümleri (Tüm Tüketim, Üretim ve Elde Edilenler Belgeleri Döküm Çizelgesi EK-129F)";
