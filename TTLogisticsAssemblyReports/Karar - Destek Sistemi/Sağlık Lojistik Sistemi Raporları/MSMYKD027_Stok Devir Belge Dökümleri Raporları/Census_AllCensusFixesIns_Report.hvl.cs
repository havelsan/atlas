...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (Tüm Sayım Düzeltme Belgeleri Dökümleri(Giriş))
    /// </summary>
    public partial class Census_AllCensusFixesIns : TTReport
    {
        ...
        {
            public Census_AllCensusFixesIns MyParentReport
            {
                get { return (Census_AllCensusFixesIns)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 12, 189, 30, false);
                    ...
                    REPORTNAME.Value = @"TÜM SAYIM DÜZELTME BELGELERİ DÖKÜM ÇİZELGESİ (GİRİŞLER)";

                    AdditionNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 164, 2, 189, 7, false);
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 164, 7, 189, 12, false);
...
#region PARTA HEADER_Script
                    //            ((Census_AllCensusFixes)ParentReport).RuntimeParameters.OBJDEFIDS.Add("87b43545-54b2-468c-909d-913cb518aa53");
//            ((Census_AllCensusFixes)ParentReport).RuntimeParameters.OBJDEFIDS.Add("7536de26-3fb2-4747-abf0-d0e53d2b8ff2");
//            ((Census_AllCensusFixes)ParentReport).RuntimeParameters.OBJDEFIDS.Add("6fa99efd-e615-41a6-ae85-3eaa77d730d6");
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 1, 1, 188, 6, false);
                    ...
                    PAGENUMBER.Value = @"129E-{@pagenumber@}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    PAGENUMBER.CalcValue = @"129E-" + ParentReport.CurrentPageNumber.ToString();
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField12221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 161, 0, 177, 10, false);
                    ...
                    NewField13221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 161, 10, false);
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 177, 0, 189, 10, false);
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    TOTAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 306, 25, 327, 30, false);
                    TOTAL.Name = "TOTAL";
                    ...
                    TEFTIS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 3, 189, 15, false);
                    TEFTIS.Name = "TEFTIS";
                    ...
                    COUNTTEXT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 306, 20, 335, 25, false);
                    ...
                    SIGNS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 17, 189, 33, false);
                    SIGNS.Name = "SIGNS";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_AllCensusFixesIns)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet Tüm Sayım Düzeltme Belgelerinin 4'üncü nüshaları "
...
#region PARTB_Methods
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<DocumentRecordLog.CensusReportNQL_DocumentRecLogAllCensusFixesInOut_Class>("CensusReportNQL_DocumentRecLogAllCensusFixesInOut", DocumentRecordLog.CensusReportNQL_DocumentRecLogAllCensusFixesInOut((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TERMID),(int)TTObjectDefManager.Instance.DataTypes["Integer"].ConvertValue(@"0")));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 161, 0, 177, 5, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    MATERIALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 161, 5, false);
                    ...
                    EXTRA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 177, 0, 189, 5, false);
                    EXTRA.Name = "EXTRA";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DocumentRecordLog.CensusReportNQL_DocumentRecLogAllCensusFixesInOut_Class dataset_CensusReportNQL_DocumentRecLogAllCensusFixesInOut = ParentGroup.rsGroup.GetCurrentRecord<DocumentRecordLog.CensusReportNQL_DocumentRecLogAllCensusFixesInOut_Class>(0);
                    ObjectID.CalcValue = (dataset_CensusReportNQL_DocumentRecLogAllCensusFixesInOut != null ? Globals.ToStringCore(dataset_CensusReportNQL_DocumentRecLogAllCensusFixesInOut.ObjectID) : "");
...
#region MAIN BODY_Script
            ...
            if(dr.DocumentTransactionType == DocumentTransactionTypeEnum.In)
            {
        ...
        public Census_AllCensusFixesIns()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_ALLCENSUSFIXESINS";
            Caption = "Stok Devir Belge Dökümleri (Tüm Sayım Düzeltme Belgeleri Dökümleri(Giriş))";
