...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (Tüm Piyasa Alım Belgeleri Döküm Çizelgesi EK-129C)
    /// </summary>
    public partial class Census_ChattelDocInWithPurchase : TTReport
    {
        ...
        {
            public Census_ChattelDocInWithPurchase MyParentReport
            {
                get { return (Census_ChattelDocInWithPurchase)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 12, 191, 30, false);
                    ...
                    REPORTNAME.Value = @"TÜM PİYASA ALIM BELGELERİ DÖKÜM ÇİZELGESİ";

                    AdditionNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 166, 1, 191, 6, false);
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 166, 6, 191, 11, false);
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 1, 191, 6, false);
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField12221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 160, 0, 178, 10, false);
                    ...
                    NewField13221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 160, 10, false);
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 178, 0, 191, 10, false);
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    TOTAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 7, 191, 12, false);
                    TOTAL.Name = "TOTAL";
                    ...
                    TEFTIS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), -1, 13, 191, 25, false);
                    TEFTIS.Name = "TEFTIS";
                    ...
                    COUNTTEXT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 1, 191, 6, false);
                    ...
                    SIGNS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 29, 191, 56, false);
                    SIGNS.Name = "SIGNS";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_ChattelDocInWithPurchase)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet TMİB Payasa Alımının 3 ve 4'üncü nüshaları "
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 160, 0, 178, 5, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    MATERIALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 160, 5, false);
                    ...
                    EXTRA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 178, 0, 191, 5, false);
                    EXTRA.Name = "EXTRA";
...
#region MAIN BODY_Script
            ...
            if(cd.StockActionInDetails.Count > 0)
            {
                ...
                BindingList<StockAction.CensusReportNQL_StockActionInDetailsReportQuery_Class> list = StockAction.CensusReportNQL_StockActionInDetailsReportQuery(ctx, cd.ObjectID.ToString());
        ...
        public Census_ChattelDocInWithPurchase()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_CHATTELDOCINWITHPURCHASE";
            Caption = "Stok Devir Belge Dökümleri (Tüm Piyasa Alım Belgeleri Döküm Çizelgesi EK-129C)";
