...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (Tüm Sayım Düzeltme Belgeleri Döküm EK-129E)
    /// </summary>
    public partial class Census_AllCensusFixes : TTReport
    {
        ...
        {
            public Census_AllCensusFixes MyParentReport
            {
                get { return (Census_AllCensusFixes)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME.Value = @"TÜM SAYIM DÜZELTME BELGELERİ DÖKÜM ÇİZELGESİ";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_AllCensusFixes)ParentReport).RuntimeParameters.TERMID.ToString();
...
#region PARTB_Methods
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<DocumentRecordLog.CensusReportNQL_DocumentRecLogAllCensusFixes_Class>("CensusReportNQL_DocumentRecLogByObjectDefName", DocumentRecordLog.CensusReportNQL_DocumentRecLogAllCensusFixes((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TERMID)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DocumentRecordLog.CensusReportNQL_DocumentRecLogAllCensusFixes_Class dataset_CensusReportNQL_DocumentRecLogByObjectDefName = ParentGroup.rsGroup.GetCurrentRecord<DocumentRecordLog.CensusReportNQL_DocumentRecLogAllCensusFixes_Class>(0);
                    ObjectID.CalcValue = (dataset_CensusReportNQL_DocumentRecLogByObjectDefName != null ? Globals.ToStringCore(dataset_CensusReportNQL_DocumentRecLogByObjectDefName.ObjectID) : "");
...
#region MAIN BODY_Script
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_ALLCENSUSFIXES";
            Caption = "Stok Devir Belge Dökümleri (Tüm Sayım Düzeltme Belgeleri Döküm EK-129E)";
