...
{
    /// <summary>
    /// Depo Toplam Giriş Miktarları  Raporu
    /// </summary>
    public partial class StockInSumAmount : TTReport
    {
#region Methods
   public double totalAllPrice =0.0;
        ...
        {
            public StockInSumAmount MyParentReport
            {
                get { return (StockInSumAmount)ParentReport; }
            }
...
#region PARTA FOOTER_Script
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    StockTransaction.StockInSumAmountRQ_Class dataset_StockInSumAmountRQ = ParentGroup.rsGroup.GetCurrentRecord<StockTransaction.StockInSumAmountRQ_Class>(0);
                    MATERIALNSN.CalcValue = (dataset_StockInSumAmountRQ != null ? Globals.ToStringCore(dataset_StockInSumAmountRQ.Materialnsn) : "");
                    MATERIALBARCODE.CalcValue = (dataset_StockInSumAmountRQ != null ? Globals.ToStringCore(dataset_StockInSumAmountRQ.Materialbarcode) : "");
                    MATERIALNAME.CalcValue = (dataset_StockInSumAmountRQ != null ? Globals.ToStringCore(dataset_StockInSumAmountRQ.Materialname) : "");
                    UNITPRICE.CalcValue = (dataset_StockInSumAmountRQ != null ? Globals.ToStringCore(dataset_StockInSumAmountRQ.UnitPrice) : "");
                    AMOUNT.CalcValue = (dataset_StockInSumAmountRQ != null ? Globals.ToStringCore(dataset_StockInSumAmountRQ.Amount) : "");
...
#region MAIN BODY_Script
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "STOCKINSUMAMOUNT";
            Caption = "Depo Toplam Giriş Miktarları  Raporu";
        ...
        {
#region STOCKINSUMAMOUNT_PreScript
...
#endregion STOCKINSUMAMOUNT_PreScript
        }
    }
}