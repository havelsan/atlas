...
{
    public partial class ConsignedCensusFixedReport : TTReport
    {
        ...
        {
            public ConsignedCensusFixedReport MyParentReport
            {
                get { return (ConsignedCensusFixedReport)ParentReport; }
            }
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 16, 205, 25, false);
                    ...
                    NewField15111231 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 25, 75, 34, false);
                    ...
                    TASINIRMALSAYMANLIGI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 75, 25, 205, 34, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { NewField111,NewField15111231,TASINIRMALSAYMANLIGI};
                }
...
#region PARTB HEADER_Script
                    if (MyParentReport.RuntimeParameters.TTOBJECTID.HasValue)
                    {
                        ...
                        if (stockAction.DestinationStore is MainStoreDefinition)
                            TASINIRMALSAYMANLIGI.CalcValue = ((MainStoreDefinition)stockAction.DestinationStore).Accountancy.AccountancyNO + " " + ((MainStoreDefinition)stockAction.DestinationStore).Accountancy.Name;
                    }
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DESCRIPTIONFIELD = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 0, 205, 19, false);
                    ...
                    NewField1333 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 156, 19, 205, 47, false);
                    ...
                    NewField1332 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 109, 19, 156, 47, false);
                    ...
                    NewField133 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 19, 62, 47, false);
                    ...
                    MALSORUMLUSU = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 27, 60, 45, false);
                    ...
                    MALSORUMLUSUTARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 20, 60, 26, false);
                    ...
                    ONAYLAYAN = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 157, 28, 203, 45, false);
                    ...
                    ONAYLAYANTARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 158, 20, 203, 26, false);
                    ...
                    MALSAYMANI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 110, 28, 154, 45, false);
                    ...
                    MALSAYMANITARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 110, 20, 154, 26, false);
                    ...
                    NewField1331 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 62, 19, 109, 47, false);
                    ...
                    HESAPSORUMLUSU = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 64, 27, 107, 45, false);
                    ...
                    HESAPSORUMLUSUTARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 64, 20, 107, 26, false);
                    ...
                    DESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 38, 1, 203, 18, false);
        ...
        public partial class PARTAGroup : TTReportGroup
        {
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField11111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 0, 22, 18, false);
...
S. Nu.";
                    ...
                    NewField111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 22, 0, 43, 18, false);
                    ...
                    NewField1111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 43, 0, 100, 18, false);
                    ...
                    NewField1211111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 100, 0, 111, 18, false);
...
Birimi";
                    ...
                    NewField13111131 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 111, 0, 123, 18, false);
...
Miktar";
                    ...
                    NewField113111131 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 123, 0, 135, 18, false);
...
Miktar";
                    ...
                    NewField113111132 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 135, 0, 147, 18, false);
...
Miktar";
                    ...
                    NewField113111133 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 147, 0, 159, 18, false);
...
Miktar";
                    ...
                    NewField113111134 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 159, 0, 175, 18, false);
...
Fiyatı";
                    ...
                    NewField113111135 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 175, 0, 190, 18, false);
...
Tutarı";
                    ...
                    NewField113111136 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 190, 0, 205, 18, false);
...
Tutarı";
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 15, 0, 15, 21, false);
                    NewLine11.Name = "NewLine11";
                    NewLine11.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine11.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 22, 6, 22, 27, false);
                    NewLine111.Name = "NewLine111";
                    NewLine111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine1111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 100, 6, 100, 27, false);
                    NewLine1111.Name = "NewLine1111";
                    NewLine1111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine1111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine11111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 123, 6, 123, 27, false);
                    NewLine11111.Name = "NewLine11111";
                    NewLine11111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine11111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine12111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 135, 6, 135, 27, false);
                    ...
                    NewLine13111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 147, 6, 147, 27, false);
                    ...
                    NewLine14111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 159, 6, 159, 27, false);
                    ...
                    NewLine15111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 111, 6, 111, 27, false);
                    ...
                    NewLine16111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 175, 6, 175, 27, false);
                    ...
                    NewLine17111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 190, 6, 190, 27, false);
                    ...
                    NewLine18111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 205, 0, 205, 21, false);
                    ...
                    ITEMCOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 16, 1, 204, 6, false);
                    ...
                    NewLine1112 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 43, 6, 43, 27, false);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<ConsignedCensusFixed.ConsignedCensusFixedReportForReportQuery_Class>("ConsignedCensusFixedReportForReportQuery", ConsignedCensusFixed.ConsignedCensusFixedReportForReportQuery((Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    CENSUSAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 123, 0, 135, 5, false);
                    ...
                    CENSUSAMOUNT.TextFont.CharSet = 1;
                    CENSUSAMOUNT.Value = @"{#CENSUSAMOUNT#}";

                    CARDAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 111, 0, 123, 5, false);
                    ...
                    CARDAMOUNT.TextFont.CharSet = 1;
                    CARDAMOUNT.Value = @"{#CARDAMOUNT#}";

                    DISTRIBUTIONTYPE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 100, 0, 111, 5, false);
                    ...
                    DISTRIBUTIONTYPE.TextFont.CharSet = 1;
                    DISTRIBUTIONTYPE.Value = @"{#DISTRIBUTIONTYPE#}";

                    ORDERSEQUENCENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 0, 22, 5, false);
                    ...
                    ORDERSEQUENCENUMBER.TextFont.CharSet = 1;
                    ORDERSEQUENCENUMBER.Value = @"{@counter@}";

                    NATOSTOCKNOANDNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 22, 0, 43, 5, false);
                    ...
                    NATOSTOCKNOANDNAME.TextFont.CharSet = 1;
                    NATOSTOCKNOANDNAME.Value = @"{%NATOSTOCKNO%}";

                    STOCKACTIONDETAILOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 220, 1, 271, 6, false);
                    ...
                    NATOSTOCKNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 220, 7, 271, 12, false);
                    ...
                    FAZLAMIKTAR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 135, 0, 147, 5, false);
                    ...
                    FAZLAMIKTAR.TextFont.CharSet = 1;
                    FAZLAMIKTAR.Value = @"";

                    EKSIKMIKTAR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 147, 0, 159, 5, false);
                    ...
                    EKSIKMIKTAR.TextFont.CharSet = 1;
                    EKSIKMIKTAR.Value = @"";

                    BIRININTUTARI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 159, 0, 175, 5, false);
                    ...
                    BIRININTUTARI.TextFont.CharSet = 1;
                    BIRININTUTARI.Value = @"";

                    FAZLANINTUTARI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 175, 0, 190, 5, false);
                    ...
                    FAZLANINTUTARI.TextFont.CharSet = 1;
                    FAZLANINTUTARI.Value = @"";

                    EKSIGININTUTARI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 190, 0, 205, 5, false);
                    ...
                    EKSIGININTUTARI.TextFont.CharSet = 1;
                    ...
                    MATERIALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 43, 0, 100, 5, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ConsignedCensusFixed.ConsignedCensusFixedReportForReportQuery_Class dataset_ConsignedCensusFixedReportForReportQuery = ParentGroup.rsGroup.GetCurrentRecord<ConsignedCensusFixed.ConsignedCensusFixedReportForReportQuery_Class>(0);
                    CENSUSAMOUNT.CalcValue = (dataset_ConsignedCensusFixedReportForReportQuery != null ? Globals.ToStringCore(dataset_ConsignedCensusFixedReportForReportQuery.CensusAmount) : "");
                    CARDAMOUNT.CalcValue = (dataset_ConsignedCensusFixedReportForReportQuery != null ? Globals.ToStringCore(dataset_ConsignedCensusFixedReportForReportQuery.CardAmount) : "");
                    DISTRIBUTIONTYPE.CalcValue = (dataset_ConsignedCensusFixedReportForReportQuery != null ? Globals.ToStringCore(dataset_ConsignedCensusFixedReportForReportQuery.DistributionType) : "");
                    ORDERSEQUENCENUMBER.CalcValue = ParentGroup.Counter.ToString();
                    NATOSTOCKNO.CalcValue = (dataset_ConsignedCensusFixedReportForReportQuery != null ? Globals.ToStringCore(dataset_ConsignedCensusFixedReportForReportQuery.NATOStockNO) : "");
                    NATOSTOCKNOANDNAME.CalcValue = MyParentReport.MAIN.NATOSTOCKNO.CalcValue;
                    STOCKACTIONDETAILOBJECTID.CalcValue = (dataset_ConsignedCensusFixedReportForReportQuery != null ? Globals.ToStringCore(dataset_ConsignedCensusFixedReportForReportQuery.Stockactiondetailobjectid) : "");
                    NAME.CalcValue = (dataset_ConsignedCensusFixedReportForReportQuery != null ? Globals.ToStringCore(dataset_ConsignedCensusFixedReportForReportQuery.Name) : "");
                    AMOUNT.CalcValue = (dataset_ConsignedCensusFixedReportForReportQuery != null ? Globals.ToStringCore(dataset_ConsignedCensusFixedReportForReportQuery.Amount) : "");
                    UNITPRICE.CalcValue = (dataset_ConsignedCensusFixedReportForReportQuery != null ? Globals.ToStringCore(dataset_ConsignedCensusFixedReportForReportQuery.Unitprice) : "");
                    ...
                    ISLEMTIPI.CalcValue = (dataset_ConsignedCensusFixedReportForReportQuery != null ? Globals.ToStringCore(dataset_ConsignedCensusFixedReportForReportQuery.Islemtipi) : "");
...
#region MAIN BODY_Script
                    ...
                    if (ISLEMTIPI.CalcValue.Equals("EKSILTILEN"))
                    {
                        ...
                        {
                            ConsignedCensusFixedMaterialOut consignedCensusFixedMaterialOut = MyParentReport.ReportObjectContext.GetObject(new Guid(STOCKACTIONDETAILOBJECTID.CalcValue), typeof(ConsignedCensusFixedMaterialOut)) as ConsignedCensusFixedMaterialOut;
                            if (consignedCensusFixedMaterialOut != null)
                            {
                                BIRININTUTARI.CalcValue = (consignedCensusFixedMaterialOut.TotalPrice.Value / consignedCensusFixedMaterialOut.Amount.Value).ToString();
                                EKSIGININTUTARI.CalcValue = consignedCensusFixedMaterialOut.TotalPrice.ToString();
                            }
                        }
        ...
        public ConsignedCensusFixedReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CONSIGNEDCENSUSFIXEDREPORT";
