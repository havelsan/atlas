...
namespace TTStorageManager.Security
{
    ...
    public partial class LBPurchaseProjectPermission : TTSecurityAuthority
    {
        public LBPurchaseProjectPermission(TTPermissionDef permissionDef) : base(permissionDef)
        {
        }
