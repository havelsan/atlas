...
namespace TTStorageManager.Security
{
    ...
    public partial class AnnualRequirementPermission : TTSecurityAuthority
    {
        public AnnualRequirementPermission(TTPermissionDef permissionDef) : base(permissionDef)
        {
        }
