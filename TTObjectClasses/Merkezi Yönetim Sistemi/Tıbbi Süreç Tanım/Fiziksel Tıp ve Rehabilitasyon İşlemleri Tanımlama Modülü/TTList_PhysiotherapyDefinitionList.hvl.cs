...
{
    public partial class TTList_PhysiotherapyDefinitionList : TTList
    {
        public TTList_PhysiotherapyDefinitionList(TTListDef listDef, string listFilterExpression) : base(listDef, listFilterExpression)
        {
        }

        public TTList_PhysiotherapyDefinitionList(TTObjectContext objectContext, TTListDef listDef, string listFilterExpression) : base(objectContext, listDef, listFilterExpression)
        {
        }

        BindingList<PhysiotherapyDefinition.GetPhysiotherapyDefinition_Class> _listOfDefinition;
    
        public override int RunListNql(string injectionNQL)
        {
            _listOfDefinition = PhysiotherapyDefinition.GetPhysiotherapyDefinition(injectionNQL);
            return _listOfDefinition.Count;
        }

        public override Guid FillRow(int rowIndex, object[] values)
        {
            PhysiotherapyDefinition.GetPhysiotherapyDefinition_Class definition = _listOfDefinition[rowIndex];
