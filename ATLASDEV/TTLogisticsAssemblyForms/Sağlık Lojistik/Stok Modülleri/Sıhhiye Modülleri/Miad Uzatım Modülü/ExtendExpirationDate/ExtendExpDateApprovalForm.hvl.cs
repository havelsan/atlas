...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public ExtendExpDateApprovalForm() : base("EXTENDEXPIRATIONDATE", "ExtendExpDateApprovalForm")
        {
        }

        protected ExtendExpDateApprovalForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}