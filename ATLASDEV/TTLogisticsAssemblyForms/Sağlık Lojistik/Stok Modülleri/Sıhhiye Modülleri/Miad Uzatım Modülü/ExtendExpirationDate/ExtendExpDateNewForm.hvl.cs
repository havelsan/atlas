...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public ExtendExpDateNewForm() : base("EXTENDEXPIRATIONDATE", "ExtendExpDateNewForm")
        {
        }

        protected ExtendExpDateNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}