...
namespace TTFormClasses
{
    public partial class ChattelDocumentInputWithAccountancyNewForm : BaseChattelDocumentInputWithAccountancyForm
    {
        ...
        public ChattelDocumentInputWithAccountancyNewForm() : base("CHATTELDOCUMENTINPUTWITHACCOUNTANCY", "ChattelDocumentInputWithAccountancyNewForm")
        {
        }

        protected ChattelDocumentInputWithAccountancyNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}