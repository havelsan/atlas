...
namespace TTFormClasses
{
    ...
    /// </summary>
    public partial class DeleteRecordDocumentDestroyableForm : BaseDeleteRecordDocumentDestroyableForm
    {

        protected override void PreScript()
        {
            #region DeleteRecordDocumentDestroyableForm_PreScript
            base.PreScript();
            if (this._DeleteRecordDocumentDestroyable.CurrentStateDefID == DeleteRecordDocumentDestroyable.States.New)
                SelectStoreUsage(SelectStoreUsageEnum.UseMainStoreResources, SelectStoreUsageEnum.Nothing);
            #endregion DeleteRecordDocumentDestroyableForm_PreScript

        }



        #region DeleteRecordDocumentDestroyableForm_ClientSideMethods
        protected override void BarcodeRead(string value)
        {
            base.BarcodeRead(value);
            Material material = null;
            IBindingList materials = _DeleteRecordDocumentDestroyable.ObjectContext.QueryObjects("MATERIAL", "BARCODE='" + value + "'");
            ...
            if (material != null)
            {
                ...
                DeleteRecordDocumentDestroyableMaterialOut returningDocument = _DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials.AddNew();
                ...
                IBindingList stockLevels = _DeleteRecordDocumentWaste.ObjectContext.QueryObjects("STOCKLEVELTYPE", "", "STOCKLEVELTYPESTATUS");
        ...
        #endregion DeleteRecordDocumentDestroyableForm_ClientSideMethods
    }
}