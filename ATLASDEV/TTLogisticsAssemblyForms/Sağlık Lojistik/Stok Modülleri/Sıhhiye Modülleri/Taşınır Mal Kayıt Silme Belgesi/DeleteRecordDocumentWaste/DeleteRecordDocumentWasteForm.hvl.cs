...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public DeleteRecordDocumentWasteForm() : base("DELETERECORDDOCUMENTWASTE", "DeleteRecordDocumentWasteForm")
        {
        }

        protected DeleteRecordDocumentWasteForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}