...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public GeneralProductionActionNewForm() : base("GENERALPRODUCTIONACTION", "GeneralProductionActionNewForm")
        {
        }

        protected GeneralProductionActionNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}