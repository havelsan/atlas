...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public PresDistributionDocumentClinicAprovvalForm() : base("PRESDISTRIBUTIONDOCUMENT", "PresDistributionDocumentClinicAprovvalForm")
        {
        }

        protected PresDistributionDocumentClinicAprovvalForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}