...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public PresDistributionDocumentRequestForm() : base("PRESDISTRIBUTIONDOCUMENT", "PresDistributionDocumentRequestForm")
        {
        }

        protected PresDistributionDocumentRequestForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}