...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public PresChaDocInputWithAccountancyNewForm() : base("PRESCHADOCINPUTWITHACCOUNTANCY", "PresChaDocInputWithAccountancyNewForm")
        {
        }

        protected PresChaDocInputWithAccountancyNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}