...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public PresChaDocOutputWithAccountancyStockCardRegistryForm() : base("PRESCHADOCOUTPUTWITHACCOUNTANCY", "PresChaDocOutputWithAccountancyStockCardRegistryForm")
        {
        }

        protected PresChaDocOutputWithAccountancyStockCardRegistryForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}