...
namespace TTObjectClasses
{
    public partial class SapsScore : BaseMultipleDataEntry
    {
        ...
        public override string GetSummary()
        {
            ...
            if (SapsIIPoint != null)
            {
                tempString += " SAP II: " + SapsIIPoint + ",";
            }

            if (SapsIIPointDetail != null)
            {
                tempString += " SAP II(genişletilmiş): " + SapsIIPointDetail + ",";
            }

            if (WaitingMortalite != null)
            {
                tempString += " Beklenen Motalite: " + WaitingMortalite + "%";
            }
