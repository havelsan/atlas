...
namespace TTObjectClasses
{
    ...
    {
        public HemodialysisRequest(TTObjectContext objectContext, EpisodeAction _episodeAction) : this(objectContext)
        {
            ...
            CurrentStateDefID = HemodialysisRequest.States.Request;
        ...
        public override void Cancel()
        {
            ...
            foreach (HemodialysisOrder dialysisOrder in HemodialysisOrders)
            {
        ...
        public RaporIslemleri.raporGirisDVO GetTakipNoileRaporBilgisiKaydet(DialysisRequest dailReq)
        {
            ...
            //            foreach (HemodialysisOrder item in _HemodialysisOrders)
            //            {
