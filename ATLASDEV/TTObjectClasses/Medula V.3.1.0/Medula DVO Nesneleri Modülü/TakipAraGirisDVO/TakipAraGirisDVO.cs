...
#region Methods
        protected override void OnConstruct()
        {
            ...
            {
                if(baslangicTarihiDateTime == null)
                    baslangicTarihiDateTime = TTObjectDefManager.ServerTime;
                if(bitisTarihiDateTime == null)
                  bitisTarihiDateTime= TTObjectDefManager.ServerTime;
            }
        }
