...
namespace TTStorageManager.Security
{
    ...
    {
        public CMRActionPermissionDefinition(TTPermissionDef permissionDef) : base(permissionDef)
        {
        }
        ...
        public bool? MasterDivision
        {
            get
            {
                object paramVal;
                if (CurrentPermission.ParameterValues.TryGetValue("MasterDivision", out paramVal))
                    return (bool?)paramVal;
                return null;
            }
        }
        ...
        public bool? MasterWorkShop
        {
            get
            {
                object paramVal;
                if (CurrentPermission.ParameterValues.TryGetValue("MasterWorkShop", out paramVal))
                    return (bool?)paramVal;
                return null;
            }
        }

        public bool? UserResource
        {
            get
            {
                object paramVal;
                if (CurrentPermission.ParameterValues.TryGetValue("UserResource", out paramVal))
                    return (bool?)paramVal;
                return null;
            }
        }
