...
#region PostTransition_Maintenance2Completed
        ...
        {
            if (transDef.ObjectDef.CodeName != typeof(MaterialMaintenance).Name)
                return;

            var fromState = transDef.FromStateDefID;
            var toState = transDef.ToStateDefID;

            if (fromState == MaterialMaintenance.States.Maintenance && toState == MaterialMaintenance.States.Completed)
