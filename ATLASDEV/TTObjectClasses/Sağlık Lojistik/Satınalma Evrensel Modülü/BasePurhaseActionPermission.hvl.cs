...
namespace TTStorageManager.Security
{
    ...
    {
        public BasePurhaseActionPermission(TTPermissionDef permissionDef) : base(permissionDef)
        {
        }
        ...
        public bool? OwnerResource
        {
            get
            {
                object paramVal;
                if (CurrentPermission.ParameterValues.TryGetValue("OwnerResource", out paramVal))
                    return (bool?)paramVal;
                return null;
            }
        }
