...
#region Methods
        ...
        public List<AutoDocumentRecordLogAttribute.DocumentRecordLogContent> DocumentRecordLogContents
        {
            get
            {
                ...
                foreach (CensusFixedMaterialIn detail in CensusFixedInMaterials)
                {
                ...
                foreach (CensusFixedMaterialOut  detail in CensusFixedOutMaterials)
                {
                    foreach (StockTransaction outTrx in detail.StockTransactions)
                    {
