...
{
    /// <summary>
    /// Serum İhtiyaç Bildirim Formu Hazırlama Tablosu
    /// </summary>
    public partial class SerumIBFReport : TTReport
    {
        ...
        {
            public SerumIBFReport MyParentReport
            {
                get { return (SerumIBFReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME.Value = @".... YILI SERUM İHTİYAÇ BİLDİRİM FORMU
HAZIRLAMA TABLOSU";
...
NUMARASI";
                    ...
                    NewField1212 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 46, 41, 104, 49, false);
                    ...
                    NewField1213 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 104, 41, 121, 49, false);
...
MAL SORUMLULARI";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { MILITARYUNIT,NewField1,TOTALMATERIAL,NewField11,REPORTNAME,NewField112,NewField1211,NewField1212,NewField1213,YEAR0,NewField122131,YEAR1,NewField122133,NewField1231221,NewField11221321,NewField1331221,NewField11221331,NewField1214,NewField14121,NewField14122};
                }
...
#region PARTA HEADER_Script
            ...
            if(purchaseAction is IBFDemand)
            {
                ...
                REPORTNAME.CalcValue = ibfDemand.IBFYear.ToString() + " YILI SERUM İHTİYAÇ BİLDİRİM FORMU\nHAZIRLAMA TABLOSU";
            ...
            else if(purchaseAction is AnnualRequirement)
            {
                ...
                REPORTNAME.CalcValue = ibf.IBFYear.ToString() + " YILI SERUM İHTİYAÇ BİLDİRİM FORMU\nHAZIRLAMA TABLOSU";
            ...
            else if(purchaseAction is LBPurchaseProject)
            {
                ...
                REPORTNAME.CalcValue = lbPurchase.IBFYear.ToString() + " YILI SERUM İHTİYAÇ BİLDİRİM FORMU\nHAZIRLAMA TABLOSU";
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    MATERIAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 47, 0, 103, 8, false);
                    ...
                    DISTRIBUTIONTYPE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 104, 0, 121, 8, false);
                    ...
                    NewLine13 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 104, 0, 104, 8, false);
                    NewLine13.Name = "NewLine13";
                    NewLine13.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine13.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine14 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 121, 0, 121, 8, false);
                    ...
                    NewLine15 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 0, 289, 0, false);
                    NewLine15.Name = "NewLine15";
                    NewLine15.DrawStyle = DrawStyleConstants.vbSolid;

                    DETAILOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 301, 1, 326, 6, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { REQUESTAMOUNTBOX,DESCRIPTION,LASTIBFREQUESTAMOUNT,CONSUMPTIONAMOUNT,STOCK,COUNT,NSN,MATERIAL,DISTRIBUTIONTYPE,REQUESTAMOUNT,DETAILOBJECTID};
                }
...
#region MAIN BODY_Script
                    if(DETAILOBJECTID.CalcValue != "")
            {
                ...
                {
                    IBFDemand ibfDemand = (IBFDemand)purchaseAction;
                    IBFDet_SerumIn serum = (IBFDet_SerumIn)MyParentReport.ReportObjectContext.GetObject(new Guid(DETAILOBJECTID.CalcValue), typeof(IBFDet_SerumIn));
                    if(ibfDemand.CurrentStateDefID == IBFDemand.States.New || ibfDemand.CurrentStateDefID == IBFDemand.States.ClinicApproval)
                    {
                        if(serum.ClinicApprovedAmount == null)
                            REQUESTAMOUNT.CalcValue = serum.RequestAmount.ToString();
                        else
                            REQUESTAMOUNT.CalcValue = serum.ClinicApprovedAmount.ToString();
                    }
                        ...
                        REQUESTAMOUNT.CalcValue = serum.Amount.ToString();
                    
                    REQUESTAMOUNTBOX.CalcValue = serum.RequestAmountBox.ToString();
                    
                }
                else if(purchaseAction is AnnualRequirement)
                {
                    AnnualRequirement ibf = (AnnualRequirement)purchaseAction;
                    ARD_SerumIn serum = (ARD_SerumIn)MyParentReport.ReportObjectContext.GetObject(new Guid(DETAILOBJECTID.CalcValue), typeof(ARD_SerumIn));
                    ...
                    {                        
                        if(serum.ACC_ApproveAmount == null)
                            REQUESTAMOUNT.CalcValue = serum.RequestAmount.ToString();
                        else
                            REQUESTAMOUNT.CalcValue = serum.ACC_ApproveAmount.ToString();
                    }
                        ...
                        REQUESTAMOUNT.CalcValue = serum.LD_ApproveAmount.ToString();
                    
                    else
                        REQUESTAMOUNT.CalcValue = serum.LB_ApproveAmount.ToString();
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "SERUMIBFREPORT";
            Caption = "Serum İhtiyaç Bildirim Formu Hazırlama Tablosu";
