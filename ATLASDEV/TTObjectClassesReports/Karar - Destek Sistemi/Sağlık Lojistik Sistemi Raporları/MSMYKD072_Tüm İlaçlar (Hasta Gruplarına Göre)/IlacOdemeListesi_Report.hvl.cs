...
namespace TTReportClasses
{
    ...
    public partial class IlacOdemeListesi : TTReport
    {
        ...
        {
            public IlacOdemeListesi MyParentReport
            {
                get { return (IlacOdemeListesi)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    HEADER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 0, 161, 20, false);
                    HEADER.Name = "HEADER";
                    ...
                    HEADER.Value = @"XXXXXX BAŞECZACILIK KLİNİK EC. {@STARTDATE@} - {@ENDDATE@}
TARİHLERİ ARASI ALINAN İLAÇ ÖDEME LİSTESİ";
                ...
                {
                    HEADER.CalcValue = @"XXXXXX BAŞECZACILIK KLİNİK EC. " + MyParentReport.RuntimeParameters.STARTDATE.ToString() + @" - " + MyParentReport.RuntimeParameters.ENDDATE.ToString() + @"
TARİHLERİ ARASI ALINAN İLAÇ ÖDEME LİSTESİ";
                    ...
                    return new TTReportObject[] { HEADER,NewField1,NewField11,NewField12,NewField121,StartDate,EndDate};
                }
            }
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PageNumber = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 136, 1, 161, 6, false);
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 3, 127, 13, false);
                    NewField1.Name = "NewField1";
                    ...
                    NewField2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 127, 3, 161, 13, false);
                    NewField2.Name = "NewField2";
                    NewField2.DrawStyle = DrawStyleConstants.vbSolid;
                    NewField2.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField2.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    NewField2.Value = @"Miktar";

                    NewField3 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 3, 11, 13, false);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DrugName = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, -1, 127, 4, false);
                    ...
                    Amount = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 127, -1, 161, 4, false);
                    Amount.Name = "Amount";
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, -1, 11, 4, false);
                    NewField1.Name = "NewField1";
                    NewField1.DrawStyle = DrawStyleConstants.vbSolid;
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DrugOrder.IlacOdemeQuery_Class dataset_IlacOdemeQuery = ParentGroup.rsGroup.GetCurrentRecord<DrugOrder.IlacOdemeQuery_Class>(0);
                    DrugName.CalcValue = (dataset_IlacOdemeQuery != null ? Globals.ToStringCore(dataset_IlacOdemeQuery.Name) : "");
                    Amount.CalcValue = (dataset_IlacOdemeQuery != null ? Globals.ToStringCore(dataset_IlacOdemeQuery.Amount) : "");
                    NewField1.CalcValue = ParentGroup.Counter.ToString();
                    return new TTReportObject[] { DrugName,Amount,NewField1};
                }
            }
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "ILACODEMELISTESI";
            Caption = "İlaç Ödeme Listesi";
