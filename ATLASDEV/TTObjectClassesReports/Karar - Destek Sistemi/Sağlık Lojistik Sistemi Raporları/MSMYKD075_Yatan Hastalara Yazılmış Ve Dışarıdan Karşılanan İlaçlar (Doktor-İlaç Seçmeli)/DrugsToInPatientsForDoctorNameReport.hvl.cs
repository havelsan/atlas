...
{
    /// <summary>
    /// Yatan Hastalara Yazılmış ve Dışarıdan Karşılanan İlaçlar Raporu (Doktor Seçmeli)
    /// </summary>
    public partial class DrugsToInPatientsForDoctorNameReport : TTReport
    {
        ...
        {
            public DrugsToInPatientsForDoctorNameReport MyParentReport
            {
                get { return (DrugsToInPatientsForDoctorNameReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName.Value = @"YATAN HASTALARA YAZILMIŞ VE DIŞARIDAN KARŞILANAN İLAÇLAR RAPORU (DOKTOR SEÇMELİ)";
        ...
        public partial class PARTCGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<InpatientDrugOrder.GetDrugsToInPatientsForDoctorNameReportQuery_Class>("GetDrugsToInPatientsForDoctorNameReportQuery", InpatientDrugOrder.GetDrugsToInPatientsForDoctorNameReportQuery((DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.STARTDATE),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.ENDDATE),(string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.DOCTORID)));
            ...
            public partial class PARTCGroupHeader : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    InpatientDrugOrder.GetDrugsToInPatientsForDoctorNameReportQuery_Class dataset_GetDrugsToInPatientsForDoctorNameReportQuery = ParentGroup.rsGroup.GetCurrentRecord<InpatientDrugOrder.GetDrugsToInPatientsForDoctorNameReportQuery_Class>(0);
                    PatientNO.CalcValue = (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.ID) : "");
                    NewField1.CalcValue = NewField1.Value;
                    NewField11.CalcValue = NewField11.Value;
                    NewField12.CalcValue = NewField12.Value;
                    ...
                    PatientName.CalcValue = (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.Patientname) : "") + @" " + (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.Patientsurname) : "");
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                InpatientDrugOrder.GetDrugsToInPatientsForDoctorNameReportQuery_Class dataSet_GetDrugsToInPatientsForDoctorNameReportQuery = ParentGroup.rsGroup.GetCurrentRecord<InpatientDrugOrder.GetDrugsToInPatientsForDoctorNameReportQuery_Class>(0);    
                return new object[] {(dataSet_GetDrugsToInPatientsForDoctorNameReportQuery==null ? null : dataSet_GetDrugsToInPatientsForDoctorNameReportQuery.ID)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    InpatientDrugOrder.GetDrugsToInPatientsForDoctorNameReportQuery_Class dataset_GetDrugsToInPatientsForDoctorNameReportQuery = MyParentReport.PARTC.rsGroup.GetCurrentRecord<InpatientDrugOrder.GetDrugsToInPatientsForDoctorNameReportQuery_Class>(0);
                    Code.CalcValue = (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.Material) : "");
                    Code.PostFieldValueCalculation();
                    DrugName.CalcValue = (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.Material) : "");
                    DrugName.PostFieldValueCalculation();
                    Dose.CalcValue = (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.DoseAmount) : "");
                    NewFrequency.CalcValue = NewFrequency.Value;
                    Day.CalcValue = (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.Day) : "");
                    Amount.CalcValue = (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.Amount) : "");
                    UnitPrice.CalcValue = (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.Price) : "");
                    TotalPrice.CalcValue = (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.Totalprice) : "");
                    Frequency.CalcValue = (dataset_GetDrugsToInPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDoctorNameReportQuery.Frequency) : "");
...
#region MAIN BODY_Script
        ...
        public DrugsToInPatientsForDoctorNameReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DRUGSTOINPATIENTSFORDOCTORNAMEREPORT";
            Caption = "Yatan Hastalara Yazılmış ve Dışarıdan Karşılanan İlaçlar Raporu (Doktor Seçmeli)";
