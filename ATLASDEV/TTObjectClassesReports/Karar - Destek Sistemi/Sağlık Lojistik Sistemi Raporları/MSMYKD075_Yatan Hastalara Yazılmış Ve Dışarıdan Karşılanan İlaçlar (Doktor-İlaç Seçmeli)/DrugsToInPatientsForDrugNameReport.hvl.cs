...
{
    /// <summary>
    /// Yatan Hastalara Yazılmış ve Dışarıdan Karşılanan İlaçlar Raporu (İlaç Seçmeli)
    /// </summary>
    public partial class DrugsToInPatientsForDrugNameReport : TTReport
    {
        ...
        {
            public DrugsToInPatientsForDrugNameReport MyParentReport
            {
                get { return (DrugsToInPatientsForDrugNameReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName.Value = @"YATAN HASTALARA YAZILMIŞ VE DIŞARIDAN KARŞILANAN İLAÇLAR RAPORU (İLAÇ SEÇMELİ)";
        ...
        public partial class PARTCGroup : TTReportGroup
        {
            ...
            public partial class PARTCGroupHeader : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    InpatientDrugOrder.GetDrugsToInPatientsForDrugNameReportQuery_Class dataset_GetDrugsToInPatientsForDrugNameReportQuery = ParentGroup.rsGroup.GetCurrentRecord<InpatientDrugOrder.GetDrugsToInPatientsForDrugNameReportQuery_Class>(0);
                    Doctor.CalcValue = (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.Name) : "") + @" - " + (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.Work) : "");
                    NewField1.CalcValue = NewField1.Value;
                    NewField11.CalcValue = NewField11.Value;
                    NewField12.CalcValue = NewField12.Value;
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                InpatientDrugOrder.GetDrugsToInPatientsForDrugNameReportQuery_Class dataSet_GetDrugsToInPatientsForDrugNameReportQuery = ParentGroup.rsGroup.GetCurrentRecord<InpatientDrugOrder.GetDrugsToInPatientsForDrugNameReportQuery_Class>(0);    
                return new object[] {(dataSet_GetDrugsToInPatientsForDrugNameReportQuery==null ? null : dataSet_GetDrugsToInPatientsForDrugNameReportQuery.Material)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    InpatientDrugOrder.GetDrugsToInPatientsForDrugNameReportQuery_Class dataset_GetDrugsToInPatientsForDrugNameReportQuery = MyParentReport.PARTC.rsGroup.GetCurrentRecord<InpatientDrugOrder.GetDrugsToInPatientsForDrugNameReportQuery_Class>(0);
                    PatientNO.CalcValue = (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.ID) : "");
                    PatientName.CalcValue = (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.Patientname) : "") + @" " + (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.Patientsurname) : "");
                    Dose.CalcValue = (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.DoseAmount) : "");
                    NewFrequency.CalcValue = NewFrequency.Value;
                    Day.CalcValue = (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.Day) : "");
                    Amount.CalcValue = (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.Amount) : "");
                    UnitPrice.CalcValue = (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.Price) : "");
                    TotalPrice.CalcValue = (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.Totalprice) : "");
                    Frequency.CalcValue = (dataset_GetDrugsToInPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToInPatientsForDrugNameReportQuery.Frequency) : "");
...
#region MAIN BODY_Script
        ...
        public DrugsToInPatientsForDrugNameReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DRUGSTOINPATIENTSFORDRUGNAMEREPORT";
            Caption = "Yatan Hastalara Yazılmış ve Dışarıdan Karşılanan İlaçlar Raporu (İlaç Seçmeli)";
