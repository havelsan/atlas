...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class CMRRegistrationHospitalReportCalibration : TTReport
    {
        ...
        {
            public CMRRegistrationHospitalReportCalibration MyParentReport
            {
                get { return (CMRRegistrationHospitalReportCalibration)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 217, 15, 235, 42, false);
...
TARİHİ";
                    ...
                    REPORTHEADER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 7, 175, 15, false);
                    ...
                    NewField14 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 15, 9, 42, false);
...
SIRA NU.";
                    ...
                    NewField1141 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 264, 23, 279, 42, false);
...
ÜKS";
                    ...
                    NewField1142 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 249, 23, 264, 42, false);
...
PB";
                    ...
                    NewField12411 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 235, 15, 279, 23, false);
                    ...
                    NewField111421 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 235, 23, 250, 42, false);
...
O";
                    ...
                    NewField111422 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 66, 22, 116, 42, false);
...
KLİNİĞİ";
                    ...
                    NewField15 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 8, 22, 24, 42, false);
...
NU.";
                    ...
                    NewField16 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 133, 15, 155, 42, false);
...
EDEN";
                    ...
                    NewField161 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 24, 22, 66, 42, false);
                    ...
                    NewField1161 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 155, 15, 177, 42, false);
...
ALAN";
                    ...
                    NewField11611 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 175, 15, 203, 42, false);
...
KISIM";
                    ...
                    NewField111611 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 203, 15, 221, 42, false);
...
TARİHİ";
                    ...
                    NewField111423 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 235, 7, 279, 15, false);
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 8, 15, 116, 22, false);
                    ...
                    NewField2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 116, 15, 133, 42, false);
...
FORMMU NU.";
                    ...
                    NewField162 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 203, 8, 208, 13, false);
                    ...
                    NewField171 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 209, 8, 234, 14, false);
                    ...
                    NewLine1 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 176, 15, 238, 15, false);
                    NewLine1.Name = "NewLine1";
                    NewLine1.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 173, 7, 235, 7, false);
                    NewLine11.Name = "NewLine11";
                    NewLine11.DrawStyle = DrawStyleConstants.vbSolid;

                    NewField11511 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 176, 8, 202, 14, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { NewField11,REPORTHEADER,NewField14,NewField1141,NewField1142,NewField12411,NewField111421,NewField111422,NewField15,NewField16,NewField161,NewField1161,NewField11611,NewField111611,NewField111423,NewField1,NewField2,NewField3,NewField4,NewField162,NewField171,NewField11511};
                }
...
#region PARTA HEADER_Script
                    ...
                    if (Sites.SiteXXXXXX06XXXXXX == siteIDGuid || Sites.SiteXXXXXX04 == siteIDGuid)
                        REPORTHEADER.CalcValue = "XXXXXX BİYOMEDİKAL MÜHENDİSLİK LABORATUVAR MERKEZİ TIBBİ CİHAZ KALİBRASYON KAYIT DEFTERİ";
                    else
                        REPORTHEADER.CalcValue = "TIBBİ CİHAZ KALİBRASYON KAYIT DEFTERİ";
...
";
                    ...
                    DELIVERERUSER.Value = @"{#RESPONSIBLEUSER#}";
                    ...
                    DELIVEREDPERSON.Value = @"{#DEVICEUSER#}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    CMRActionRequest.CMRActionHospitalReportQueryByCalibration_Class dataset_CMRActionHospitalReportQueryByCalibration2 = ParentGroup.rsGroup.GetCurrentRecord<CMRActionRequest.CMRActionHospitalReportQueryByCalibration_Class>(0);
                    COUNT.CalcValue = ParentGroup.Counter.ToString();
                    STOCKNO.CalcValue = (dataset_CMRActionHospitalReportQueryByCalibration2 != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByCalibration2.Stockno) : "") + @"
";
                    MATERIALNAME.CalcValue = (dataset_CMRActionHospitalReportQueryByCalibration2 != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByCalibration2.Materialname) : "");
                    CLINIC.CalcValue = (dataset_CMRActionHospitalReportQueryByCalibration2 != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByCalibration2.Sendersection) : "");
                    REQUESTNO.CalcValue = (dataset_CMRActionHospitalReportQueryByCalibration2 != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByCalibration2.RequestNo) : "");
                    DELIVERERUSER.CalcValue = (dataset_CMRActionHospitalReportQueryByCalibration2 != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByCalibration2.Responsibleuser) : "");
                    WORKSHOP.CalcValue = (dataset_CMRActionHospitalReportQueryByCalibration2 != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByCalibration2.Workshopname) : "");
                    STARTDATE.CalcValue = (dataset_CMRActionHospitalReportQueryByCalibration2 != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByCalibration2.RequestDate) : "");
                    ENDDATE.CalcValue = @"";
                    O.CalcValue = @"";
                    PB.CalcValue = @"";
                    UKS.CalcValue = @"";
                    OBJECTID.CalcValue = (dataset_CMRActionHospitalReportQueryByCalibration2 != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByCalibration2.ObjectID) : "");
                    DELIVEREDPERSON.CalcValue = (dataset_CMRActionHospitalReportQueryByCalibration2 != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByCalibration2.Deviceuser) : "");
                    REQUESTDATE.CalcValue = (dataset_CMRActionHospitalReportQueryByCalibration2 != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByCalibration2.RequestDate) : "");
...
#region MAIN BODY_Script
        ...
        public CMRRegistrationHospitalReportCalibration()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CMRREGISTRATIONHOSPITALREPORTCALIBRATION";
            Caption = "Kalibrasyon Kayıt Defteri Raporu(XXXXXX)";
