...
{
    /// <summary>
    /// Barkodu Olmayan İlçalar Raporu
    /// </summary>
    public partial class DrugNonDependBarcodeReport : TTReport
    {
        ...
        {
            public DrugNonDependBarcodeReport MyParentReport
            {
                get { return (DrugNonDependBarcodeReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName.Value = @"BARKODU OLMAYAN İLAÇLAR RAPORU";
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 14, 1, 139, 6, false);
                    ...
                    NewField12 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 140, 1, 170, 6, false);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<DrugDefinition.GetDrugNonDependBarcodeReportQuery_Class>("GetDrugNonDependBarcodeReportQuery", DrugDefinition.GetDrugNonDependBarcodeReportQuery());
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DrugName = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 14, 1, 139, 6, false);
                    ...
                    Code = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 140, 1, 170, 6, false);
                    Code.Name = "Code";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DrugDefinition.GetDrugNonDependBarcodeReportQuery_Class dataset_GetDrugNonDependBarcodeReportQuery = ParentGroup.rsGroup.GetCurrentRecord<DrugDefinition.GetDrugNonDependBarcodeReportQuery_Class>(0);
                    OrderNO.CalcValue = ParentGroup.Counter.ToString();
                    DrugName.CalcValue = (dataset_GetDrugNonDependBarcodeReportQuery != null ? Globals.ToStringCore(dataset_GetDrugNonDependBarcodeReportQuery.Name) : "");
                    Code.CalcValue = (dataset_GetDrugNonDependBarcodeReportQuery != null ? Globals.ToStringCore(dataset_GetDrugNonDependBarcodeReportQuery.Code) : "");
                    return new TTReportObject[] { OrderNO,DrugName,Code};
                }
            }
        ...
        public DrugNonDependBarcodeReport()
        {
        ...
        {
            Name = "DRUGNONDEPENDBARCODEREPORT";
            Caption = "Barkodu Olmayan İlçalar Raporu";
