...
{
    /// <summary>
    /// Karar Defteri Raporu
    /// </summary>
    public partial class PurchaseDecisionReport : TTReport
    {
        public class ReportRuntimeParameters 
        {
            ...
            public long? REQUESTNO = (long?)TTObjectDefManager.Instance.DataTypes["RequestNo_Seq"].ConvertValue("0");
        ...
        {
            public PurchaseDecisionReport MyParentReport
            {
                get { return (PurchaseDecisionReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME.Value = @"KARAR DEFTERİ RAPORU";
                    ...
                    NewField11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 25, 25, 50, 35, false);
                    ...
                    NewField11.Value = @"İstek Nu.";

                    NewField12 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 50, 25, 98, 35, false);
                    ...
                    NewField12.Value = @"İstek Yapan Bölüm";

                    NewField13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 98, 25, 123, 35, false);
                    ...
                    NewField14 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 123, 25, 148, 35, false);
                    ...
                    NewField14.Value = @"Onay Nu.";

                    NewField15 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 148, 25, 169, 35, false);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<Demand.GetPurchaseDecisionReportQuery_Class>("GetPurchaseDecisionReportQuery", Demand.GetPurchaseDecisionReportQuery((Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.PROJECTNO),(long)TTObjectDefManager.Instance.DataTypes["RequestNo_Seq"].ConvertValue(MyParentReport.RuntimeParameters.REQUESTNO),(Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.MASTERID),(Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.MATERIALID)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DEMANDNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 25, 0, 50, 9, false);
                    ...
                    MASTERRESOURCE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 50, 0, 98, 9, false);
                    ...
                    STATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 98, 0, 123, 9, false);
                    STATE.Name = "STATE";
                    ...
                    CONFIRMNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 123, 0, 148, 9, false);
                    ...
                    CONFIRMDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 148, 0, 169, 9, false);
                    ...
                    CONFIRMDATE.MultiLine = EvetHayirEnum.ehEvet;
                    CONFIRMDATE.WordBreak = EvetHayirEnum.ehEvet;
                    CONFIRMDATE.TextFont.Name = "Arial";
                    CONFIRMDATE.TextFont.CharSet = 162;
                    CONFIRMDATE.Value = @"{#CONFIRMDATE#}";

                    MATERIALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 169, 0, 225, 9, false);
                    ...
                    SUPPLIEDAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 241, 0, 257, 9, false);
                    ...
                    REQUESTEDAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 225, 0, 241, 9, false);
                    ...
                    OBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 310, 3, 335, 12, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    Demand.GetPurchaseDecisionReportQuery_Class dataset_GetPurchaseDecisionReportQuery = ParentGroup.rsGroup.GetCurrentRecord<Demand.GetPurchaseDecisionReportQuery_Class>(0);
                    PROJECTNO.CalcValue = (dataset_GetPurchaseDecisionReportQuery != null ? Globals.ToStringCore(dataset_GetPurchaseDecisionReportQuery.PurchaseProjectNO) : "");
                    DEMANDNO.CalcValue = (dataset_GetPurchaseDecisionReportQuery != null ? Globals.ToStringCore(dataset_GetPurchaseDecisionReportQuery.RequestNo) : "");
                    MASTERRESOURCE.CalcValue = (dataset_GetPurchaseDecisionReportQuery != null ? Globals.ToStringCore(dataset_GetPurchaseDecisionReportQuery.Masterresource) : "");
                    STATE.CalcValue = @"";
                    CONFIRMNO.CalcValue = (dataset_GetPurchaseDecisionReportQuery != null ? Globals.ToStringCore(dataset_GetPurchaseDecisionReportQuery.ConfirmNO) : "");
                    CONFIRMDATE.CalcValue = (dataset_GetPurchaseDecisionReportQuery != null ? Globals.ToStringCore(dataset_GetPurchaseDecisionReportQuery.ConfirmDate) : "");
                    MATERIALNAME.CalcValue = (dataset_GetPurchaseDecisionReportQuery != null ? Globals.ToStringCore(dataset_GetPurchaseDecisionReportQuery.ItemName) : "");
                    SUPPLIEDAMOUNT.CalcValue = (dataset_GetPurchaseDecisionReportQuery != null ? Globals.ToStringCore(dataset_GetPurchaseDecisionReportQuery.Amount) : "");
                    REQUESTEDAMOUNT.CalcValue = (dataset_GetPurchaseDecisionReportQuery != null ? Globals.ToStringCore(dataset_GetPurchaseDecisionReportQuery.RequestAmount) : "");
                    OBJECTID.CalcValue = (dataset_GetPurchaseDecisionReportQuery != null ? Globals.ToStringCore(dataset_GetPurchaseDecisionReportQuery.ObjectID) : "");
                    return new TTReportObject[] { PROJECTNO,DEMANDNO,MASTERRESOURCE,STATE,CONFIRMNO,CONFIRMDATE,MATERIALNAME,SUPPLIEDAMOUNT,REQUESTEDAMOUNT,OBJECTID};
                }
...
#region MAIN BODY_Script
            ...
            Demand demand = (Demand)ctx.GetObject(new Guid(OBJECTID.CalcValue), typeof(Demand));
            STATE.CalcValue = demand.CurrentStateDef.DisplayText.ToString();
        ...
        public PurchaseDecisionReport()
        {
            ...
            reportParameter = Parameters.Add("REQUESTNO", "0", "İstek Numarasını Giriniz", @"", true, true, false, new Guid("22f4f714-4a34-47e4-a2a3-64eb29ec2d08"));
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            if (parameters.ContainsKey("REQUESTNO"))
                _runtimeParameters.REQUESTNO = (long?)TTObjectDefManager.Instance.DataTypes["RequestNo_Seq"].ConvertValue(parameters["REQUESTNO"]);
            ...
            Name = "PURCHASEDECISIONREPORT";
            Caption = "Karar Defteri Raporu";
