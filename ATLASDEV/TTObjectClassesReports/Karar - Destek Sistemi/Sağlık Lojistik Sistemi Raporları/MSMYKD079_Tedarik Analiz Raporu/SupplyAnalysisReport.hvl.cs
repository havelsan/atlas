...
{
    /// <summary>
    /// Tedarik Analiz Raporu
    /// </summary>
    public partial class SupplyAnalysisReport : TTReport
    {
        public class ReportRuntimeParameters 
        {
            ...
            public PurchaseTypeEnum_Material_Procedure? PURCHASETYPE = (PurchaseTypeEnum_Material_Procedure?)(int?)TTObjectDefManager.Instance.DataTypes["PurchaseTypeEnum_Material_Procedure"].ConvertValue("");
        ...
        {
            public SupplyAnalysisReport MyParentReport
            {
                get { return (SupplyAnalysisReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME.Value = @"TEDARİK ANALİZ RAPORU";
                    ...
                    NewField13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 55, 35, 60, false);
                    ...
                    NewField131 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 55, 56, 60, false);
                    ...
                    NewField132 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 55, 106, 60, false);
                    ...
                    NewField133 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 107, 55, 151, 60, false);
                    ...
                    NewField134 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 152, 55, 198, 60, false);
                    ...
                    NewLine1 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 15, 60, 35, 60, false);
                    NewLine1.Name = "NewLine1";
                    NewLine1.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine2 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 60, 56, 60, false);
                    NewLine2.Name = "NewLine2";
                    NewLine2.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine3 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 57, 60, 106, 60, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { LOGO,REPORTNAME,NewField1,NewField11,NewField12,NewField121,NewField13,NewField131,NewField132,NewField133,NewField134,NewField135,NewField136,NewField137,NewField138,STARTDATE,ENDDATE};
                }
            }
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<PurchaseProject.GetSupplyAnalysisReportQuery_Class>("GetSupplyAnalysisReportQuery", PurchaseProject.GetSupplyAnalysisReportQuery((DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.STARTDATE),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.ENDDATE),(Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.MASTERID),(Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.MATERIALID),(Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.SUPPLIERID),((PurchaseTypeEnum_Material_Procedure)TTObjectDefManager.Instance.DataTypes["PurchaseTypeEnum_Material_Procedure"].EnumValueDefs[MyParentReport.RuntimeParameters.PURCHASETYPE.ToString()].EnumValue),((PurchaseMainTypeEnum)TTObjectDefManager.Instance.DataTypes["PurchaseMainTypeEnum"].EnumValueDefs[MyParentReport.RuntimeParameters.PURCHASEMAINTYPE.ToString()].EnumValue)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    CONFIRMNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 1, 35, 10, false);
                    ...
                    CONFIRMNO.MultiLine = EvetHayirEnum.ehEvet;
                    CONFIRMNO.WordBreak = EvetHayirEnum.ehEvet;
                    CONFIRMNO.TextFont.Name = "Arial";
                    CONFIRMNO.TextFont.CharSet = 162;
                    CONFIRMNO.Value = @"{#CONFIRMNO#}";

                    PROJECTNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 1, 56, 10, false);
                    ...
                    SUPPLIER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 1, 106, 10, false);
                    ...
                    MATERIALSERVICENAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 107, 1, 151, 10, false);
                    ...
                    UNIT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 152, 1, 198, 10, false);
                    UNIT.Name = "UNIT";
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 199, 1, 219, 10, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    DISTRIBUTIONTYPE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 220, 1, 240, 10, false);
                    ...
                    UNITPRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 241, 1, 261, 10, false);
                    ...
                    TOTAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 262, 1, 282, 10, false);
                    TOTAL.Name = "TOTAL";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    PurchaseProject.GetSupplyAnalysisReportQuery_Class dataset_GetSupplyAnalysisReportQuery = ParentGroup.rsGroup.GetCurrentRecord<PurchaseProject.GetSupplyAnalysisReportQuery_Class>(0);
                    CONFIRMNO.CalcValue = (dataset_GetSupplyAnalysisReportQuery != null ? Globals.ToStringCore(dataset_GetSupplyAnalysisReportQuery.ConfirmNO) : "");
                    PROJECTNO.CalcValue = (dataset_GetSupplyAnalysisReportQuery != null ? Globals.ToStringCore(dataset_GetSupplyAnalysisReportQuery.PurchaseProjectNO) : "");
                    SUPPLIER.CalcValue = (dataset_GetSupplyAnalysisReportQuery != null ? Globals.ToStringCore(dataset_GetSupplyAnalysisReportQuery.Supplier) : "");
                    MATERIALSERVICENAME.CalcValue = (dataset_GetSupplyAnalysisReportQuery != null ? Globals.ToStringCore(dataset_GetSupplyAnalysisReportQuery.ItemName) : "");
                    UNIT.CalcValue = (dataset_GetSupplyAnalysisReportQuery != null ? Globals.ToStringCore(dataset_GetSupplyAnalysisReportQuery.Masterresource) : "");
                    AMOUNT.CalcValue = (dataset_GetSupplyAnalysisReportQuery != null ? Globals.ToStringCore(dataset_GetSupplyAnalysisReportQuery.Amount) : "");
                    DISTRIBUTIONTYPE.CalcValue = (dataset_GetSupplyAnalysisReportQuery != null ? Globals.ToStringCore(dataset_GetSupplyAnalysisReportQuery.Typename) : "");
                    UNITPRICE.CalcValue = (dataset_GetSupplyAnalysisReportQuery != null ? Globals.ToStringCore(dataset_GetSupplyAnalysisReportQuery.ProposalPrice) : "");
                    TOTAL.CalcValue = (dataset_GetSupplyAnalysisReportQuery != null ? Globals.ToStringCore(dataset_GetSupplyAnalysisReportQuery.Total) : "");
                    return new TTReportObject[] { CONFIRMNO,PROJECTNO,SUPPLIER,MATERIALSERVICENAME,UNIT,AMOUNT,DISTRIBUTIONTYPE,UNITPRICE,TOTAL};
                }
            }
        ...
        public SupplyAnalysisReport()
        {
            ...
            reportParameter = Parameters.Add("PURCHASETYPE", "", "Alım Tipini Seçiniz", @"", true, true, false, new Guid("48b0bc42-6145-4f3d-bd7d-cbf5e75d9f6f"));
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            if (parameters.ContainsKey("PURCHASETYPE"))
                _runtimeParameters.PURCHASETYPE = (PurchaseTypeEnum_Material_Procedure?)(int?)TTObjectDefManager.Instance.DataTypes["PurchaseTypeEnum_Material_Procedure"].ConvertValue(parameters["PURCHASETYPE"]);
            ...
            Name = "SUPPLYANALYSISREPORT";
            Caption = "Tedarik Analiz Raporu";
