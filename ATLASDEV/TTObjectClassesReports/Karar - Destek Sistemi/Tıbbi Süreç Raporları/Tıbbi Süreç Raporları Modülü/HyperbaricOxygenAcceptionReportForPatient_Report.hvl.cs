...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class HyperbaricOxygenAcceptionReportForPatient : TTReport
    {
        ...
        {
            public HyperbaricOxygenAcceptionReportForPatient MyParentReport
            {
                get { return (HyperbaricOxygenAcceptionReportForPatient)ParentReport; }
            }
            ...
            public partial class MASTERGroupHeader : TTReportSection
            {
                ...
                public MASTERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    XXXXXXBASLIK = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 50, 10, 173, 33, false);
                    ...
                    DTARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 61, 255, 66, false);
                    DTARIH.Name = "DTARIH";
                    ...
                    DYER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 66, 255, 71, false);
                    DYER.Name = "DYER";
                    ...
                    SubTypeExplanat = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 50, 42, 173, 47, false);
                    ...
                    HYPERBARIKOXYGENTREATMENTREQUESTOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 56, 255, 61, false);
                    ...
                    AYAKTANYATAN = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 50, 47, 173, 51, false);
                    ...
                    EPISODEID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 42, 266, 47, false);
                    ...
                    REPORTHEADER1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 50, 34, 173, 42, false);
                    ...
                    REPORTHEADER1.Value = @"HİPERBARİK OKSİJEN TEDAVİSİ İSTEK RAPORU (HASTA)";
                    ...
                    EPISODEOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 47, 266, 52, false);
                    ...
                    AYAKYATANCODED = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 52, 255, 56, false);
...
#region MASTER HEADER_Script
            ...
            string objectID = ((HyperbaricOxygenAcceptionReportForPatient)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
...
";
        ...
        public partial class ORDERSGroup : TTReportGroup
        {
            ...
            public partial class ORDERSGroupHeader : TTReportSection
            {
                ...
                public ORDERSGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1111141111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 37, 1, 92, 6, false);
                    ...
                    NewField0 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 104, 1, 130, 6, false);
                    NewField0.Name = "NewField0";
                    NewField0.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField0.TextFont.Name = "Arial Narrow";
                    NewField0.TextFont.Size = 9;
                    NewField0.TextFont.Bold = true;
                    NewField0.Value = @" Tedavi Derinliği (m)";

                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 92, 1, 104, 6, false);
                    NewField1.Name = "NewField1";
                    NewField1.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField1.TextFont.Name = "Arial Narrow";
                    NewField1.TextFont.Size = 9;
                    ...
                    NewField11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 130, 1, 169, 6, false);
                    NewField11.Name = "NewField11";
                    NewField11.TextFont.Name = "Arial Narrow";
                    NewField11.TextFont.Size = 9;
                    NewField11.TextFont.Bold = true;
                    ...
                    NewField15.Value = @"İşlemi Yapacak Operatör";
        ...
        public partial class ORDERDETAILSGroup : TTReportGroup
        {
            ...
            {
                TTBaseReportNqlData[] list = new TTBaseReportNqlData[1];
                list[0] = new TTReportNqlData<HyperbarikOxygenTreatmentOrderDetail.GetHyperbaricOrderDetailsForPatient_Class>("GetHyperbaricOrderDetailsForPatient", HyperbarikOxygenTreatmentOrderDetail.GetHyperbaricOrderDetailsForPatient((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.MASTER.HYPERBARIKOXYGENTREATMENTREQUESTOBJECTID.CalcValue)));
                return new TTReportNqlDataSet(ParentGroup, list);
            }
            ...
            public partial class ORDERDETAILSGroupBody : TTReportSection
            {
                ...
                public ORDERDETAILSGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PROCEDUREOBJECTCODENAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 37, 2, 92, 7, false);
                    ...
                    TREATMENTDEPTH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 104, 2, 130, 7, false);
                    ...
                    DURATION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 92, 2, 104, 7, false);
                    ...
                    TREATMENTDIAGNOSISUNITNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 130, 2, 169, 7, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    HyperbarikOxygenTreatmentOrderDetail.GetHyperbaricOrderDetailsForPatient_Class dataset_GetHyperbaricOrderDetailsForPatient = ParentGroup.rsGroup.GetCurrentRecord<HyperbarikOxygenTreatmentOrderDetail.GetHyperbaricOrderDetailsForPatient_Class>(0);
                    WORKLISTDATE.CalcValue = (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.PricingDate) : "");
                    PROCEDUREBYUSER.CalcValue = (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.Procedurebyuser) : "");
                    ORDEROBJECTPROCEDUREDOCTOR.CalcValue = (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.Orderobjectproceduredoctor) : "");
                    ORDERDETAILPROCEDUREBYUSER.CalcValue = (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.Procedurebyuser) : "");
                    ORDEROBJECTOBJECTID.CalcValue = (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.Orderobjectobjectid) : "");
                    PROCEDUREOBJECTCODENAME.CalcValue = @" " + (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.Procedureobjectcode) : "") + @" " + (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.Procedureobjectname) : "");
                    TREATMENTDEPTH.CalcValue = (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.TreatmentDepth) : "");
                    DURATION.CalcValue = (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.Orderobjectduration) : "");
                    TREATMENTDIAGNOSISUNITNAME.CalcValue = @" " + (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.Treatmentdiagnosisunitname) : "") + @" / " + (dataset_GetHyperbaricOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetHyperbaricOrderDetailsForPatient.Treatmentequipmentname) : "");
                    return new TTReportObject[] { WORKLISTDATE,PROCEDUREBYUSER,ORDEROBJECTPROCEDUREDOCTOR,ORDERDETAILPROCEDUREBYUSER,ORDEROBJECTOBJECTID,PROCEDUREOBJECTCODENAME,TREATMENTDEPTH,DURATION,TREATMENTDIAGNOSISUNITNAME};
                }
...
#region ORDERDETAILS BODY_Script
        ...
        public HyperbaricOxygenAcceptionReportForPatient()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "HYPERBARICOXYGENACCEPTIONREPORTFORPATIENT";
            Caption = "Hiperbarik Oksijen Tedavisi İstek Raporu (Hasta)";
