...
{
    /// <summary>
    /// Diyaliz Detay Raporu
    /// </summary>
    public partial class DialysisDetailReport : TTReport
    {
        ...
        {
            public DialysisDetailReport MyParentReport
            {
                get { return (DialysisDetailReport)ParentReport; }
            }
            ...
            public partial class MASTERGroupHeader : TTReportSection
            {
                ...
                public MASTERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DTARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 63, 255, 68, false);
                    DTARIH.Name = "DTARIH";
                    ...
                    DYER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 68, 255, 73, false);
                    DYER.Name = "DYER";
...
";
                    ...
                    DIALYSISREQUESTOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 58, 255, 63, false);
                    ...
                    EPISODEID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 44, 266, 49, false);
                    ...
                    REPORTHEADER1.Value = @"DİYALİZ UYGULAMA DETAYLARI RAPORU";
                    ...
                    EPISODEOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 49, 266, 54, false);
                    ...
                    AYAKYATANCODED = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 54, 255, 58, false);
...
#region MASTER HEADER_Script
            ...
            string objectID = ((DialysisDetailReport)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
...
";
                    ...
                    NewField111141111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 62, 4, 146, 9, false);
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 146, 4, 187, 9, false);
                    NewField1.Name = "NewField1";
                    NewField1.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField1.TextFont.Name = "Arial Narrow";
                    NewField1.TextFont.Size = 9;
                    NewField1.TextFont.Bold = true;
                    NewField1.Value = @"Hemşire";
...
";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    NewField1.CalcValue = NewField1.Value;
                    NewField2.CalcValue = NewField2.Value;
                    return new TTReportObject[] { NewField1121141111,NewField0,NewField111141111,NewField1,NewField2};
                }
            }
        ...
        public partial class ORDERSGroup : TTReportGroup
        {
            ...
            {
                TTBaseReportNqlData[] list = new TTBaseReportNqlData[1];
                list[0] = new TTReportNqlData<DialysisOrderDetail.GetDialysisOrderDetailsByOrderObject_Class>("GetDialysisOrderDetailsByOrderObject", DialysisOrderDetail.GetDialysisOrderDetailsByOrderObject((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
                return new TTReportNqlDataSet(ParentGroup, list);
            }
        ...
        public partial class ORDERDETAILSGroup : TTReportGroup
        {
            ...
            public partial class ORDERDETAILSGroupBody : TTReportSection
            {
                ...
                public ORDERDETAILSGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    STATE.Value = @"TTObjectDefManager.Instance.ObjectDefs[""DialysisOrderDetail""].StateDefs[new Guid({#ORDERS.CURRENTSTATEDEFID#})].DisplayText";

                    PROCEDUREBYUSER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 146, 2, 187, 7, false);
                    ...
                    PROCEDUREOBJECTCODENAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 62, 2, 146, 7, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DialysisOrderDetail.GetDialysisOrderDetailsByOrderObject_Class dataset_GetDialysisOrderDetailsByOrderObject = MyParentReport.ORDERS.rsGroup.GetCurrentRecord<DialysisOrderDetail.GetDialysisOrderDetailsByOrderObject_Class>(0);
                    WORKLISTDATE.CalcValue = (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.PricingDate) : "");
                    PROCEDUREBYUSER.CalcValue = (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.Procedurebyuser) : "");
                    ORDEROBJECTPROCEDUREDOCTOR.CalcValue = (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.Orderobjectproceduredoctor) : "");
                    ORDERDETAILPROCEDUREBYUSER.CalcValue = (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.Procedurebyuser) : "");
                    PROCEDUREOBJECTCODENAME.CalcValue = @" " + (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.Procedureobjectcode) : "") + @" " + (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.Procedureobjectname) : "");
                    ORDEROBJECTOBJECTID.CalcValue = (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.Orderobjectobjectid) : "");
                    ACTIONDATE.CalcValue = @"";
                    CURRENTSTATEDEFID.CalcValue = (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.CurrentStateDefID) : "");
                    ACTIONDATE2.CalcValue = (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.ActionDate) : "");
                    ORDERDETAILOBJECTID.CalcValue = (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.ObjectID) : "");
                    STATE.CalcValue = TTObjectDefManager.Instance.ObjectDefs["DialysisOrderDetail"].StateDefs[new Guid((dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.CurrentStateDefID) : ""))].DisplayText;
                    return new TTReportObject[] { WORKLISTDATE,PROCEDUREBYUSER,ORDEROBJECTPROCEDUREDOCTOR,ORDERDETAILPROCEDUREBYUSER,PROCEDUREOBJECTCODENAME,ORDEROBJECTOBJECTID,ACTIONDATE,CURRENTSTATEDEFID,ACTIONDATE2,ORDERDETAILOBJECTID,STATE};
                }

                public override void RunScript()
                {
#region ORDERDETAILS BODY_Script
                    if (TTObjectDefManager.Instance.ObjectDefs["DialysisOrderDetail"].StateDefs[new Guid(this.CURRENTSTATEDEFID.CalcValue != null ? TTUtils.Globals.ToStringCore(this.CURRENTSTATEDEFID.CalcValue) : "")] != null)
            {
                Guid currentStateDefID = TTObjectDefManager.Instance.ObjectDefs["DialysisOrderDetail"].StateDefs[new Guid(this.CURRENTSTATEDEFID.CalcValue != null ? TTUtils.Globals.ToStringCore(this.CURRENTSTATEDEFID.CalcValue) : "")].StateDefID;
                if (currentStateDefID != TTObjectClasses.DialysisOrderDetail.States.Completed)
...
";
                    ...
                    NOTE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 1, 206, 6, false);
                    NOTE.Name = "NOTE";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    ORDERDETAILOBJECTID.CalcValue = (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.ObjectID) : "");
                    NOTE.CalcValue = (dataset_GetDialysisOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetailsByOrderObject.Note) : "");
                    return new TTReportObject[] { NewField10,ORDERDETAILOBJECTID,NOTE};
                }
            }
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DIALYSISDETAILREPORT";
            Caption = "Diyaliz Detay Raporu";
