...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class InpatientAndDischargedPatientListReport : TTReport
    {
        ...
        {
            public InpatientAndDischargedPatientListReport MyParentReport
            {
                get { return (InpatientAndDischargedPatientListReport)ParentReport; }
            }
        ...
        public partial class HeaderGroup : TTReportGroup
        {
            ...
            public TTReportField LBLTARIHARALIGI { get {return Header().LBLTARIHARALIGI;} }
            ...
            public partial class HeaderGroupHeader : TTReportSection
            {
                ...
                public TTReportField LBLTARIHARALIGI;
                ...
                public HeaderGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1.Value = @"YATAN - TABURCU HASTA LİSTESİ";
                    ...
                    LBLTARIHARALIGI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 14, 46, 33, 51, false);
                    LBLTARIHARALIGI.Name = "LBLTARIHARALIGI";
                    LBLTARIHARALIGI.TextFont.Size = 9;
                    LBLTARIHARALIGI.TextFont.Bold = true;
                    LBLTARIHARALIGI.TextFont.CharSet = 162;
                    LBLTARIHARALIGI.Value = @"Tarih Aralığı  :";

                    TARIHARALIGI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 33, 46, 92, 51, false);
                    TARIHARALIGI.Name = "TARIHARALIGI";
                    TARIHARALIGI.FieldType = ReportFieldTypeEnum.ftVariable;
                    TARIHARALIGI.TextFont.Size = 9;
                    TARIHARALIGI.TextFont.CharSet = 162;
                    TARIHARALIGI.Value = @"{@STARTDATE@} - {@ENDDATE@}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    LBLTARIHARALIGI.CalcValue = LBLTARIHARALIGI.Value;
                    TARIHARALIGI.CalcValue = MyParentReport.RuntimeParameters.STARTDATE.ToString() + @" - " + MyParentReport.RuntimeParameters.ENDDATE.ToString();
                    XXXXXXBaslik.CalcValue = TTObjectClasses.SystemParameter.GetParameterValue("HOSPITALNAME", "") + "\r\n" + TTObjectClasses.SystemParameter.GetParameterValue("HOSPITALCITY", "");
                    return new TTReportObject[] { NewField1,LBLTARIHARALIGI,TARIHARALIGI,XXXXXXBaslik};
                }
            }
        ...
        public partial class KlinikGroup : TTReportGroup
        {
            ...
            public partial class KlinikGroupHeader : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    InPatientTreatmentClinicApplication.GetpatientListReportByDateNQL_Class dataset_GetpatientListReportByDateNQL = ParentGroup.rsGroup.GetCurrentRecord<InPatientTreatmentClinicApplication.GetpatientListReportByDateNQL_Class>(0);
                    YattigiKlinik.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Yattigiklinik) : "");
        ...
        public partial class OdaGrubuGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                InPatientTreatmentClinicApplication.GetpatientListReportByDateNQL_Class dataSet_GetpatientListReportByDateNQL = ParentGroup.rsGroup.GetCurrentRecord<InPatientTreatmentClinicApplication.GetpatientListReportByDateNQL_Class>(0);    
                return new object[] {(dataSet_GetpatientListReportByDateNQL==null ? null : dataSet_GetpatientListReportByDateNQL.Yattigiklinik)};
            }
            private void onConstruct()
            {
                _body = null;
            ...
            public partial class OdaGrubuGroupHeader : TTReportSection
            {
                ...
                public OdaGrubuGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    LBLSORUMLUDOKTOR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 206, 9, 249, 14, false);
                    ...
                    LBLKLINIKYATISTARIHI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 250, 9, 268, 14, false);
                    ...
                    LBLKLINIKTABURCUTARIHI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 270, 9, 291, 14, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    InPatientTreatmentClinicApplication.GetpatientListReportByDateNQL_Class dataset_GetpatientListReportByDateNQL = MyParentReport.Klinik.rsGroup.GetCurrentRecord<InPatientTreatmentClinicApplication.GetpatientListReportByDateNQL_Class>(0);
                    OdaGrubu.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Odagrubu) : "");
                    ...
                    return new TTReportObject[] { OdaGrubu,LBLSıra,LBLTIBBIPROTOKOLNO,LBLTCNO,LBLSINIFRUTBE,LBLHASTAADISOYADI,LBLODA,LBLYATAK,LBLKLINIKYATISTARIHI1,LBLSORUMLUDOKTOR,LBLKLINIKYATISTARIHI,LBLKLINIKTABURCUTARIHI};
                }
            }
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                InPatientTreatmentClinicApplication.GetpatientListReportByDateNQL_Class dataSet_GetpatientListReportByDateNQL = ParentGroup.rsGroup.GetCurrentRecord<InPatientTreatmentClinicApplication.GetpatientListReportByDateNQL_Class>(0);    
                return new object[] {(dataSet_GetpatientListReportByDateNQL==null ? null : dataSet_GetpatientListReportByDateNQL.Odagrubu)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SORUMLUDOKTOR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 206, 4, 249, 9, false);
                    ...
                    KLINIKYATISTARIHI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 250, 4, 268, 9, false);
                    ...
                    HASTAADI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 316, 1, 341, 6, false);
                    ...
                    HASTASOYADI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 343, 2, 368, 7, false);
                    ...
                    OBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 369, 2, 394, 7, false);
                    OBJECTID.Name = "OBJECTID";
                    OBJECTID.Visible = EvetHayirEnum.ehHayir;
                    OBJECTID.FieldType = ReportFieldTypeEnum.ftVariable;
                    OBJECTID.Value = @"{#Klinik.OBJECTID#}";

                    KLINIKTABURCUTARIHI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 270, 4, 291, 9, false);
                    ...
                    KLINIKTABURCUTARIHI.Value = @"{#Klinik.KLINIKTABURCUTARIHI#}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    TCNO.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Tcno) : "");
                    SINIFRUTBE.CalcValue = @"";
                    HASTAADI.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Hastaadi) : "");
                    HASTASOYADI.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Hastasoyadi) : "");
                    HASTAADISOYADI.CalcValue = MyParentReport.MAIN.HASTAADI.CalcValue + @" " + MyParentReport.MAIN.HASTASOYADI.CalcValue;
                    ODA.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Oda) : "");
                    ODA.PostFieldValueCalculation();
                    YATAK.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Yatak) : "");
                    YATAK.PostFieldValueCalculation();
                    KLINIK.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Tedaviklinik) : "");
                    KLINIK.PostFieldValueCalculation();
                    SORUMLUDOKTOR.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Sorumludoktor) : "");
                    KLINIKYATISTARIHI.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Klinikyatistarihi) : "");
                    OBJECTID.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.ObjectID) : "");
                    KLINIKTABURCUTARIHI.CalcValue = (dataset_GetpatientListReportByDateNQL != null ? Globals.ToStringCore(dataset_GetpatientListReportByDateNQL.Kliniktaburcutarihi) : "");
                    return new TTReportObject[] { Sira,TIBBIPROTOKOLNO,TCNO,SINIFRUTBE,HASTAADI,HASTASOYADI,HASTAADISOYADI,ODA,YATAK,KLINIK,SORUMLUDOKTOR,KLINIKYATISTARIHI,OBJECTID,KLINIKTABURCUTARIHI};
                }
...
//            }
        ...
        public InpatientAndDischargedPatientListReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "INPATIENTANDDISCHARGEDPATIENTLISTREPORT";
