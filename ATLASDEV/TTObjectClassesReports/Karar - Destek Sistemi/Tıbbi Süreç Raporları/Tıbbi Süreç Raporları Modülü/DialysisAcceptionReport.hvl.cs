...
{
    /// <summary>
    /// Diyaliz İstek Raporu
    /// </summary>
    public partial class DialysisAcceptionReport : TTReport
    {
        ...
        {
            public DialysisAcceptionReport MyParentReport
            {
                get { return (DialysisAcceptionReport)ParentReport; }
            }
            ...
            public partial class MASTERGroupHeader : TTReportSection
            {
                ...
                public MASTERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DTARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 69, 255, 74, false);
                    DTARIH.Name = "DTARIH";
                    ...
                    DYER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 74, 255, 79, false);
                    DYER.Name = "DYER";
...
";
                    ...
                    NewField20.Value = @"Diyalizin Özellikleri";
                    ...
                    DIALYSISREQUESTOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 64, 255, 69, false);
                    ...
                    EPISODEID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 50, 266, 55, false);
                    ...
                    REPORTHEADER1.Value = @"DİYALİZ İSTEK RAPORU";
                    ...
                    EPISODEOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 55, 266, 60, false);
                    ...
                    AYAKYATANCODED = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 60, 255, 64, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    NOT.CalcValue = (dataset_DialysisAcceptionReportNQL != null ? Globals.ToStringCore(dataset_DialysisAcceptionReportNQL.Note) : "");
                    ...
                    return new TTReportObject[] { NewField2,NAME,DTARIH,RUTBE,KABULSEBEBI,DYER,NOT,SubTypeExplanat,PROTOKOLNO,NewField16,NewField167,NewField17,NewField18,NewField20,NewField22,HASTANO,NewField24,ACTIONID,NewField26,TARIH,NewField27,DYERTAR,DIALYSISREQUESTOBJECTID,AYAKYATANCODED,AYAKTANYATAN,EPISODEID,LOGO1,REPORTHEADER1,NewField1,NewField11,NewField12,NewField121,NewField122,NewField123,NewField124,NewField125,NewField128,EPISODEOBJECTID,UNIQUEREFNO,LBLUNIQUEREFNO,NewField13,XXXXXXBASLIK};
                }
...
#region MASTER HEADER_Script
            ...
            string objectID = ((DialysisAcceptionReport)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
...
";
        ...
        public partial class ORDERSGroup : TTReportGroup
        {
            ...
            public TTReportField NewField11 { get {return Header().NewField11;} }
            public TTReportField ORDEROBJECTORDERNOTE { get {return Header().ORDEROBJECTORDERNOTE;} }
            ...
            {
                TTBaseReportNqlData[] list = new TTBaseReportNqlData[1];
                list[0] = new TTReportNqlData<DialysisOrderDetail.GetDialysisOrderDetails_Class>("GetDialysisOrderDetails", DialysisOrderDetail.GetDialysisOrderDetails((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.MASTER.DIALYSISREQUESTOBJECTID.CalcValue)));
                return new TTReportNqlDataSet(ParentGroup, list);
            }
            ...
            public partial class ORDERSGroupHeader : TTReportSection
            {
                ...
                public TTReportField NewField11;
                public TTReportField ORDEROBJECTORDERNOTE;
                ...
                public ORDERSGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField111141121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 35, 24, 67, 29, false);
                    ...
                    NewField111141121.Value = @"Kür Randevu Tarihi Saati";
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 124, 8, 133, 13, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    TREATMENTDIAGNOSISUNITNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 133, 8, 206, 13, false);
                    ...
                    NewField1121141111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 141, 24, 185, 29, false);
                    ...
                    NewLine12 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 24, 30, 206, 30, false);
                    ...
                    NewField1111141211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 124, 1, 133, 6, false);
                    ...
                    NewField11121411111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 133, 1, 206, 6, false);
                    ...
                    NewField1121141113 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 24, 24, 33, 29, false);
                    ...
                    NewField1121141113.Value = @"Kür No";

                    NewField1121141114 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 67, 24, 140, 29, false);
                    ...
                    NewField1121141114.Value = @"İşlemi Yapacak Hemşire";
                    ...
                    NewField11.TextFont.Size = 9;
                    NewField11.TextFont.Bold = true;
                    NewField11.Value = @"Hemşireye Emirler";

                    ORDEROBJECTORDERNOTE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 16, 206, 21, false);
                    ORDEROBJECTORDERNOTE.Name = "ORDEROBJECTORDERNOTE";
                    ORDEROBJECTORDERNOTE.FieldType = ReportFieldTypeEnum.ftVariable;
                    ORDEROBJECTORDERNOTE.MultiLine = EvetHayirEnum.ehEvet;
                    ORDEROBJECTORDERNOTE.NoClip = EvetHayirEnum.ehEvet;
                    ORDEROBJECTORDERNOTE.WordBreak = EvetHayirEnum.ehEvet;
                    ORDEROBJECTORDERNOTE.ExpandTabs = EvetHayirEnum.ehEvet;
                    ORDEROBJECTORDERNOTE.TextFont.Name = "Arial Narrow";
                    ORDEROBJECTORDERNOTE.TextFont.Size = 9;
                    ORDEROBJECTORDERNOTE.Value = @"{#ORDEROBJECTORDERNOTE#}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DialysisOrderDetail.GetDialysisOrderDetails_Class dataset_GetDialysisOrderDetails = ParentGroup.rsGroup.GetCurrentRecord<DialysisOrderDetail.GetDialysisOrderDetails_Class>(0);
                    ORDEROBJECTOBJECTID.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Orderobjectobjectid) : "");
                    NewField111141121.CalcValue = NewField111141121.Value;
                    PROCEDUREOBJECTCODENAME.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Procedureobjectcode) : "") + @" " + (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Procedureobjectname) : "");
                    DURATION.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Orderobjectduration) : "");
                    AMOUNT.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Orderobjectamount) : "");
                    TREATMENTDIAGNOSISUNITNAME.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Treatmentdiagnosisunitname) : "");
                    ...
                    NewField11.CalcValue = NewField11.Value;
                    ORDEROBJECTORDERNOTE.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Orderobjectordernote) : "");
                    NewField118211.CalcValue = NewField118211.Value;
                    return new TTReportObject[] { ORDEROBJECTOBJECTID,NewField111141121,PROCEDUREOBJECTCODENAME,DURATION,AMOUNT,TREATMENTDIAGNOSISUNITNAME,NewField1121141111,NewField11111411211,NewField11114111,NewField112141111,NewField1111141211,NewField11121411111,NewField1121141113,NewField1121141114,NewField11,ORDEROBJECTORDERNOTE,NewField118211};
                }
            }
        ...
        public partial class ORDERDETAILSGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                DialysisOrderDetail.GetDialysisOrderDetails_Class dataSet_GetDialysisOrderDetails = ParentGroup.rsGroup.GetCurrentRecord<DialysisOrderDetail.GetDialysisOrderDetails_Class>(0);    
                return new object[] {(dataSet_GetDialysisOrderDetails==null ? null : dataSet_GetDialysisOrderDetails.Orderobjectobjectid)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class ORDERDETAILSGroupBody : TTReportSection
            {
                ...
                public ORDERDETAILSGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    WORKLISTDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 35, 1, 67, 6, false);
                    ...
                    TREATMENTEQUIPMENTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 141, 1, 185, 6, false);
                    ...
                    CURENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 24, 1, 33, 6, false);
                    ...
                    PROCEDUREBYUSER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 67, 1, 140, 6, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DialysisOrderDetail.GetDialysisOrderDetails_Class dataset_GetDialysisOrderDetails = MyParentReport.ORDERS.rsGroup.GetCurrentRecord<DialysisOrderDetail.GetDialysisOrderDetails_Class>(0);
                    WORKLISTDATE.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.PricingDate) : "");
                    TREATMENTEQUIPMENTNAME.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Treatmentequipmentname) : "");
                    EMERGENCY.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Emergency) : "");
                    CURENUMBER.CalcValue = ParentGroup.GroupCounter.ToString();
                    PROCEDUREBYUSER.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Procedurebyuser) : "");
                    ORDEROBJECTPROCEDUREDOCTOR.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Orderobjectproceduredoctor) : "");
                    ORDERDETAILPROCEDUREBYUSER.CalcValue = (dataset_GetDialysisOrderDetails != null ? Globals.ToStringCore(dataset_GetDialysisOrderDetails.Procedurebyuser) : "");
...
#region ORDERDETAILS BODY_Script
        ...
        public DialysisAcceptionReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DIALYSISACCEPTIONREPORT";
            Caption = "Diyaliz İstek Raporu";
