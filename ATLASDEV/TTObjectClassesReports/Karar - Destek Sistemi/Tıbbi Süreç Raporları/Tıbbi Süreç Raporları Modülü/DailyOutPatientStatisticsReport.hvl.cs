...
{
    /// <summary>
    /// Günlük Sağlık İstatistikleri (Ayaktan Hasta)
    /// </summary>
    public partial class DailyOutPatientStatisticsReport : TTReport
    {
        ...
        {
            public DailyOutPatientStatisticsReport MyParentReport
            {
                get { return (DailyOutPatientStatisticsReport)ParentReport; }
            }
            ...
            public partial class HEADERGroupHeader : TTReportSection
            {
                ...
                public HEADERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    edate = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 62, 22, 83, 27, false);
                    edate.Name = "edate";
                    ...
                    sdate = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 30, 22, 54, 27, false);
                    sdate.Name = "sdate";
                    ...
                    NewLine12 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 56, 25, 60, 25, false);
...
Amiral";
                    ...
                    NewField112821.Value = @"HİZMET İÇİ";
                    ...
                    NewField1128211.Value = @"HİZMET DIŞI";
                    ...
                    NewField2.Value = @"GÜNLÜK SAĞLIK FAALİYETLERİ (AYAKTAN HASTA)";
...
#region SUBAY HEADER_PreScript
                    TTReportTool.TTReportGroup pg = ((DailyOutPatientStatisticsReport)ParentReport).Groups("SUBAY");
...
#region MAIN BODY_Script
        ...
        public DailyOutPatientStatisticsReport()
        {
            ...
            reportParameter.ListDefID = new Guid("c7f3cdcf-6dd9-447d-836d-f14e33eda1c6");
        }
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DAILYOUTPATIENTSTATISTICSREPORT";
            Caption = "Günlük Sağlık İstatistikleri (Ayaktan Hasta)";
