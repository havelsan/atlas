...
{
    /// <summary>
    /// Uygunluk Şerh Raporu
    /// </summary>
    public partial class HC_RelevanceRejectReport : TTReport
    {
#region Methods
   public class DrBlock_Class {
        ...
        {
            public HC_RelevanceRejectReport MyParentReport
            {
                get { return (HC_RelevanceRejectReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    HEALTHCOMMITTEEOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 218, 45, 255, 50, false);
...
#region PARTA HEADER_Script
            ...
            string sObjectID = ((HC_RelevanceRejectReport)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ONAY = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 218, 25, 243, 30, false);
                    ONAY.Name = "ONAY";
                    ...
                    ONAYTARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 212, 30, 251, 35, false);
                    ...
                    HEADDOCTOR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 207, 34, 255, 40, false);
                    ...
                    ONAYLABEL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 218, 40, 243, 45, false);
...
//            }
        ...
        public partial class COMPLAINTHGroup : TTReportGroup
        {
            public HC_RelevanceRejectReport MyParentReport
            {
                get { return (HC_RelevanceRejectReport)ParentReport; }
            ...
            new public COMPLAINTHGroupHeader Header()
            {
                return (COMPLAINTHGroupHeader)_header;
            }

            new public COMPLAINTHGroupFooter Footer()
            {
                return (COMPLAINTHGroupFooter)_footer;
            }

            public TTReportField NewField111191111 { get {return Header().NewField111191111;} }
            public COMPLAINTHGroup(TTReport parentReport, string name) : base(parentReport, name)
            {
                onConstruct();
            }
            public COMPLAINTHGroup(TTReportGroup parentGroup, string name) : base(parentGroup, name)
            {
                onConstruct();
            }
            ...
            {
                _body = null;
                _header = new COMPLAINTHGroupHeader(this);
                _footer = new COMPLAINTHGroupFooter(this);

            }

            public partial class COMPLAINTHGroupHeader : TTReportSection
            {
                public HC_RelevanceRejectReport MyParentReport
                {
                    get { return (HC_RelevanceRejectReport)ParentReport; }
                ...
                public TTReportField NewField111191111; 
                public COMPLAINTHGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    SectionType = SectionTypeEnum.stHeader;
                    ...
                    NewField111191111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 2, 62, 6, false);
                    NewField111191111.Name = "NewField111191111";
                    NewField111191111.TextFont.Name = "Arial";
                    NewField111191111.TextFont.Size = 9;
                    NewField111191111.TextFont.Bold = true;
                    NewField111191111.TextFont.CharSet = 162;
                    NewField111191111.Value = @"ŞİKAYETLERİ";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    NewField111191111.CalcValue = NewField111191111.Value;
                    return new TTReportObject[] { NewField111191111};
                }
            }
            public partial class COMPLAINTHGroupFooter : TTReportSection
            {
                public HC_RelevanceRejectReport MyParentReport
                {
                    get { return (HC_RelevanceRejectReport)ParentReport; }
                ...
                public COMPLAINTHGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    SectionType = SectionTypeEnum.stFooter;
        ...
        public COMPLAINTHGroup COMPLAINTH;
        ...
        public partial class ACIKLAMAGroup : TTReportGroup
        {
            ...
            public partial class ACIKLAMAGroupBody : TTReportSection
            {
                ...
                public ACIKLAMAGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PEOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 212, 6, 249, 11, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { ComplaintDepartment,COMPLAINT,PEOBJECTID};
                }
...
#region BULGULAR BODY_Script
        ...
        public partial class KARAR1Group : TTReportGroup
        {
            public HC_RelevanceRejectReport MyParentReport
            {
                get { return (HC_RelevanceRejectReport)ParentReport; }
            ...
            new public KARAR1GroupHeader Header()
            {
                return (KARAR1GroupHeader)_header;
            }

            new public KARAR1GroupFooter Footer()
            {
                return (KARAR1GroupFooter)_footer;
            }

            public TTReportField LBLACIKLAMA11 { get {return Header().LBLACIKLAMA11;} }
            public TTReportField ACIKLAMA { get {return Header().ACIKLAMA;} }
            public KARAR1Group(TTReport parentReport, string name) : base(parentReport, name)
            {
                onConstruct();
            }
            public KARAR1Group(TTReportGroup parentGroup, string name) : base(parentGroup, name)
            {
                onConstruct();
            }
            ...
            {
                _body = null;
                _header = new KARAR1GroupHeader(this);
                _footer = new KARAR1GroupFooter(this);

            }

            public partial class KARAR1GroupHeader : TTReportSection
            {
                public HC_RelevanceRejectReport MyParentReport
                {
                    get { return (HC_RelevanceRejectReport)ParentReport; }
                ...
                public TTReportField LBLACIKLAMA11;
                public TTReportField ACIKLAMA; 
                public KARAR1GroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    SectionType = SectionTypeEnum.stHeader;
                    ...
                    LBLACIKLAMA11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 9, 3, 61, 7, false);
                    LBLACIKLAMA11.Name = "LBLACIKLAMA11";
                    LBLACIKLAMA11.TextFont.Name = "Arial";
                    LBLACIKLAMA11.TextFont.Size = 9;
                    LBLACIKLAMA11.TextFont.Bold = true;
                    LBLACIKLAMA11.TextFont.CharSet = 162;
                    LBLACIKLAMA11.Value = @"TIBBI GEREKÇELER";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    LBLACIKLAMA11.CalcValue = LBLACIKLAMA11.Value;
                    ACIKLAMA.CalcValue = ACIKLAMA.Value;
                    return new TTReportObject[] { LBLACIKLAMA11,ACIKLAMA};
                }
                public override void RunPreScript()
                {
#region KARAR1 HEADER_PreScript
                    TTObjectContext context = new TTObjectContext(true);
            string sObjectID = ((HC_RelevanceRejectReport)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
            HealthCommittee statusNotificationReport = (HealthCommittee)context.GetObject(new Guid(sObjectID),"HealthCommittee");
...
#endregion KARAR1 HEADER_PreScript
                }
            }
            public partial class KARAR1GroupFooter : TTReportSection
            {
                public HC_RelevanceRejectReport MyParentReport
                {
                    get { return (HC_RelevanceRejectReport)ParentReport; }
                ...
                public KARAR1GroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    SectionType = SectionTypeEnum.stFooter;
...
#region KARAR BODY_PreScript
            ...
            if(statusNotificationReport.HealthCommitteeDecision != null)
            {
                ...
                this.KARAR.Value = TTObjectClasses.Common.GetTextOfRTFString(statusNotificationReport.HealthCommitteeDecision.ToString());
                    }
        ...
        public partial class RejectedUserGroup : TTReportGroup
        {
            public HC_RelevanceRejectReport MyParentReport
            {
                get { return (HC_RelevanceRejectReport)ParentReport; }
            ...
            new public RejectedUserGroupHeader Header()
            {
                return (RejectedUserGroupHeader)_header;
            }

            new public RejectedUserGroupFooter Footer()
            {
                return (RejectedUserGroupFooter)_footer;
            }

            public TTReportField NewField11 { get {return Header().NewField11;} }
            public TTReportField NewField1 { get {return Header().NewField1;} }
            public TTReportField NewField2 { get {return Header().NewField2;} }
            public RejectedUserGroup(TTReport parentReport, string name) : base(parentReport, name)
            {
                onConstruct();
            }
            public RejectedUserGroup(TTReportGroup parentGroup, string name) : base(parentGroup, name)
            {
                onConstruct();
            }
            ...
            {
                _body = null;
                _header = new RejectedUserGroupHeader(this);
                _footer = new RejectedUserGroupFooter(this);

            }

            public partial class RejectedUserGroupHeader : TTReportSection
            {
                public HC_RelevanceRejectReport MyParentReport
                {
                    get { return (HC_RelevanceRejectReport)ParentReport; }
                ...
                public RejectedUserGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    SectionType = SectionTypeEnum.stHeader;
                    ...
                    NewField11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 9, 0, 34, 5, false);
                    NewField11.Name = "NewField11";
                    NewField11.Value = @"Şerh Koyan Üyeler";

                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 9, 6, 67, 11, false);
                    NewField1.Name = "NewField1";
                    ...
                    NewField2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 71, 6, 199, 11, false);
                    NewField2.Name = "NewField2";
                    NewField2.TextFont.Name = "Arial";
                    NewField2.TextFont.Size = 11;
                    NewField2.TextFont.Bold = true;
                    NewField2.TextFont.CharSet = 162;
                    NewField2.Value = @"Red Nedeni
";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { NewField11,NewField1,NewField2};
                }
            }
            public partial class RejectedUserGroupFooter : TTReportSection
            {
                public HC_RelevanceRejectReport MyParentReport
                {
                    get { return (HC_RelevanceRejectReport)ParentReport; }
                ...
                public RejectedUserGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    SectionType = SectionTypeEnum.stFooter;
        ...
        public RejectedUserGroup RejectedUser;

        public partial class RejectExternalUsersGroup : TTReportGroup
        {
            public HC_RelevanceRejectReport MyParentReport
            {
                get { return (HC_RelevanceRejectReport)ParentReport; }
            ...
            new public RejectExternalUsersGroupBody Body()
            {
                return (RejectExternalUsersGroupBody)_body;
            }
            public TTReportField NewField1 { get {return Body().NewField1;} }
            public TTReportField NewField2 { get {return Body().NewField2;} }
            public RejectExternalUsersGroup(TTReport parentReport, string name) : base(parentReport, name)
            {
                onConstruct();
            }
            public RejectExternalUsersGroup(TTReportGroup parentGroup, string name) : base(parentGroup, name)
            {
                onConstruct();
            }
            ...
            {
                TTBaseReportNqlData[] list = new TTBaseReportNqlData[1];
                list[0] = new TTReportNqlData<BaseHealthCommittee_ExtDoctorGrid.GetExternalRejectedUserByHCID_Class>("GetExternalRejectedUserByHCID", BaseHealthCommittee_ExtDoctorGrid.GetExternalRejectedUserByHCID((Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
                return new TTReportNqlDataSet(ParentGroup, list);
            }
            ...
            private void onConstruct()
            {
                _header = null;
                _footer = null;
                _body = new RejectExternalUsersGroupBody(this);
                DataSourceType = DataSourceTypeEnum.dstSelfRS;
            }

            public partial class RejectExternalUsersGroupBody : TTReportSection
            {
                public HC_RelevanceRejectReport MyParentReport
                {
                    get { return (HC_RelevanceRejectReport)ParentReport; }
                ...
                public TTReportField NewField1;
                public TTReportField NewField2; 
                public RejectExternalUsersGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    SectionType = SectionTypeEnum.stBody;
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 9, 1, 70, 6, false);
                    NewField1.Name = "NewField1";
                    NewField1.DrawStyle = DrawStyleConstants.vbSolid;
                    NewField1.FieldType = ReportFieldTypeEnum.ftVariable;
                    NewField1.Value = @"{#EXTERNALDOCTORNAME#}";

                    NewField2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 71, 1, 199, 6, false);
                    NewField2.Name = "NewField2";
                    NewField2.DrawStyle = DrawStyleConstants.vbSolid;
                    NewField2.FieldType = ReportFieldTypeEnum.ftVariable;
                    NewField2.Value = @"{#DESCRIPTION#}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    BaseHealthCommittee_ExtDoctorGrid.GetExternalRejectedUserByHCID_Class dataset_GetExternalRejectedUserByHCID = ParentGroup.rsGroup.GetCurrentRecord<BaseHealthCommittee_ExtDoctorGrid.GetExternalRejectedUserByHCID_Class>(0);
                    NewField1.CalcValue = (dataset_GetExternalRejectedUserByHCID != null ? Globals.ToStringCore(dataset_GetExternalRejectedUserByHCID.ExternalDoctorName) : "");
                    NewField2.CalcValue = (dataset_GetExternalRejectedUserByHCID != null ? Globals.ToStringCore(dataset_GetExternalRejectedUserByHCID.Description) : "");
        ...
        public RejectExternalUsersGroup RejectExternalUsers;

        public partial class IMZAGroup : TTReportGroup
        {
            public HC_RelevanceRejectReport MyParentReport
            {
                get { return (HC_RelevanceRejectReport)ParentReport; }
            ...
            new public IMZAGroupHeader Header()
            {
                return (IMZAGroupHeader)_header;
            }

            new public IMZAGroupFooter Footer()
            {
                return (IMZAGroupFooter)_footer;
            }

            public IMZAGroup(TTReport parentReport, string name) : base(parentReport, name)
            {
                onConstruct();
            }
            public IMZAGroup(TTReportGroup parentGroup, string name) : base(parentGroup, name)
            {
                onConstruct();
            }
            ...
            {
                _body = null;
                _header = new IMZAGroupHeader(this);
                _footer = new IMZAGroupFooter(this);

            }

            public partial class IMZAGroupHeader : TTReportSection
            {
                public HC_RelevanceRejectReport MyParentReport
                {
                    get { return (HC_RelevanceRejectReport)ParentReport; }
                ...
                public IMZAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    SectionType = SectionTypeEnum.stHeader;
            ...
            public partial class IMZAGroupFooter : TTReportSection
            {
                public HC_RelevanceRejectReport MyParentReport
                {
                    get { return (HC_RelevanceRejectReport)ParentReport; }
                ...
                public IMZAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    SectionType = SectionTypeEnum.stFooter;
        ...
        public IMZAGroup IMZA;

        public partial class RejectInternalUsersGroup : TTReportGroup
        {
            public HC_RelevanceRejectReport MyParentReport
            {
                get { return (HC_RelevanceRejectReport)ParentReport; }
            ...
            new public RejectInternalUsersGroupBody Body()
            {
                return (RejectInternalUsersGroupBody)_body;
            }
            public TTReportField NewField11 { get {return Body().NewField11;} }
            public TTReportField NewField12 { get {return Body().NewField12;} }
            public RejectInternalUsersGroup(TTReport parentReport, string name) : base(parentReport, name)
            {
                onConstruct();
            }
            public RejectInternalUsersGroup(TTReportGroup parentGroup, string name) : base(parentGroup, name)
            {
                onConstruct();
            }
            ...
            {
                TTBaseReportNqlData[] list = new TTBaseReportNqlData[1];
                list[0] = new TTReportNqlData<MemberOfHealthCommiittee.GetInternalRejectedUserByHCID_Class>("GetInternalRejectedUserByHCID", MemberOfHealthCommiittee.GetInternalRejectedUserByHCID((Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
                return new TTReportNqlDataSet(ParentGroup, list);
            }
            ...
            private void onConstruct()
            {
                _header = null;
                _footer = null;
                _body = new RejectInternalUsersGroupBody(this);
                DataSourceType = DataSourceTypeEnum.dstSelfRS;
            }

            public partial class RejectInternalUsersGroupBody : TTReportSection
            {
                public HC_RelevanceRejectReport MyParentReport
                {
                    get { return (HC_RelevanceRejectReport)ParentReport; }
                ...
                public RejectInternalUsersGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    SectionType = SectionTypeEnum.stBody;
                    ...
                    NewField11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 9, 1, 70, 6, false);
                    NewField11.Name = "NewField11";
                    NewField11.DrawStyle = DrawStyleConstants.vbSolid;
                    NewField11.FieldType = ReportFieldTypeEnum.ftVariable;
                    NewField11.Value = @"{#NAME#}";

                    NewField12 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 71, 1, 199, 6, false);
                    NewField12.Name = "NewField12";
                    NewField12.DrawStyle = DrawStyleConstants.vbSolid;
                    NewField12.FieldType = ReportFieldTypeEnum.ftVariable;
                    NewField12.Value = @"{#DESCRIPTION#}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    MemberOfHealthCommiittee.GetInternalRejectedUserByHCID_Class dataset_GetInternalRejectedUserByHCID = ParentGroup.rsGroup.GetCurrentRecord<MemberOfHealthCommiittee.GetInternalRejectedUserByHCID_Class>(0);
                    NewField11.CalcValue = (dataset_GetInternalRejectedUserByHCID != null ? Globals.ToStringCore(dataset_GetInternalRejectedUserByHCID.Name) : "");
                    NewField12.CalcValue = (dataset_GetInternalRejectedUserByHCID != null ? Globals.ToStringCore(dataset_GetInternalRejectedUserByHCID.Description) : "");
                    return new TTReportObject[] { NewField11,NewField12};
                }
            }

        }

        public RejectInternalUsersGroup RejectInternalUsers;
...
#region DRBLOCK BODY_Script
        ...
        public HC_RelevanceRejectReport()
        {
            PARTA = new PARTAGroup(this,"PARTA");
            MAIN = new MAINGroup(PARTA,"MAIN");
            COMPLAINTH = new COMPLAINTHGroup(PARTA,"COMPLAINTH");
            ACIKLAMA = new ACIKLAMAGroup(COMPLAINTH,"ACIKLAMA");
            BULGULAR = new BULGULARGroup(PARTA,"BULGULAR");
            KARAR1 = new KARAR1Group(PARTA,"KARAR1");
            KARAR = new KARARGroup(KARAR1,"KARAR");
            RejectedUser = new RejectedUserGroup(PARTA,"RejectedUser");
            RejectExternalUsers = new RejectExternalUsersGroup(RejectedUser,"RejectExternalUsers");
            IMZA = new IMZAGroup(PARTA,"IMZA");
            RejectInternalUsers = new RejectInternalUsersGroup(IMZA,"RejectInternalUsers");
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "HC_RELEVANCEREJECTREPORT";
            Caption = "Uygunluk Şerh Raporu";
