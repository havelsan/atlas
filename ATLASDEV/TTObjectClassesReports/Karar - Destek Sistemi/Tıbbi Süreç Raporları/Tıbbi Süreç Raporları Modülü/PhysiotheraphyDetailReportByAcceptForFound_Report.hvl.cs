...
{
    /// <summary>
    /// Fizyoterapi Detay Raporu (İstek Bazında)
    /// </summary>
    public partial class PhysiotheraphyDetailReportByAcceptForFound : TTReport
    {
        ...
        {
            public PhysiotheraphyDetailReportByAcceptForFound MyParentReport
            {
                get { return (PhysiotheraphyDetailReportByAcceptForFound)ParentReport; }
            }
...
";
                    ...
                    PHYSIOTHERAPYREQUESTOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 220, 63, 256, 68, false);
                    ...
                    REPORTHEADER1.Value = @"FİZYOTERAPİ DETAY RAPORU (İSTEK BAZINDA)";
...
#region MASTER HEADER_Script
            ...
            string objectID = ((PhysiotheraphyDetailReportByAcceptForFound)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
...
";
        ...
        public partial class ORDERSGroup : TTReportGroup
        {
            ...
            public partial class ORDERSGroupHeader : TTReportSection
            {
                ...
                public ORDERSGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    APPLICATIONAREA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 112, 8, 141, 13, false);
                    ...
                    DURATION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 141, 8, 153, 13, false);
                    ...
                    NewField14 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 121, 24, 165, 29, false);
                    NewField14.Name = "NewField14";
                    NewField14.TextFont.Name = "Arial Narrow";
                    NewField14.TextFont.Size = 9;
                    NewField14.TextFont.Bold = true;
                    NewField14.Value = @"Tedavi Odası";

                    NewField15 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 24, 186, 29, false);
                    ...
                    NewField111141111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 112, 1, 141, 6, false);
                    ...
                    NewField112141111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 141, 1, 153, 6, false);
                    ...
                    NewField13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 43, 24, 119, 29, false);
                    NewField13.Name = "NewField13";
                    NewField13.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField13.TextFont.Name = "Arial Narrow";
                    NewField13.TextFont.Size = 9;
                    NewField13.TextFont.Bold = true;
                    NewField13.Value = @"Fizyoterapist";
                    ...
                    NewField121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 16, 24, 42, 29, false);
                    NewField121.Name = "NewField121";
                    NewField121.TextFont.Name = "Arial Narrow";
                    NewField121.TextFont.Size = 9;
                    NewField121.TextFont.Bold = true;
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    PROCEDUREOBJECTCODENAME.CalcValue = (dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.Procedureobjectcode) : "") + @" " + (dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.Procedureobjectname) : "");
                    APPLICATIONAREA.CalcValue = (dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.Orderobjectapplicationarea) : "");
                    DURATION.CalcValue = (dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.Orderobjectduration) : "");
                    AMOUNT.CalcValue = (dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.Orderobjectamount) : "");
                    ...
                    NewField13.CalcValue = NewField13.Value;
                    NewField11.CalcValue = NewField11.Value;
                    TREATMENTPROPERTIES.CalcValue = (dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.Orderobjecttreatmentproperties) : "");
                    NewField118211.CalcValue = NewField118211.Value;
                    NewField151.CalcValue = NewField151.Value;
                    NewField121.CalcValue = NewField121.Value;
                    return new TTReportObject[] { ORDEROBJECTOBJECTID,PROCEDUREOBJECTCODENAME,APPLICATIONAREA,DURATION,AMOUNT,TREATMENTDIAGNOSISUNITNAME,NewField14,NewField15,NewField11114111,NewField111141111,NewField112141111,NewField1111141211,NewField11121411111,NewField13,NewField11,TREATMENTPROPERTIES,NewField118211,NewField151,NewField121};
                }
            }
        ...
        public partial class ORDERDETAILSGroup : TTReportGroup
        {
            ...
            public TTReportField TREATMENTROOMNAME { get {return Body().TREATMENTROOMNAME;} }
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                PhysiotherapyOrderDetail.GetPhysiotherapyOrderDetails_Class dataSet_GetPhysiotherapyOrderDetails = ParentGroup.rsGroup.GetCurrentRecord<PhysiotherapyOrderDetail.GetPhysiotherapyOrderDetails_Class>(0);    
                return new object[] {(dataSet_GetPhysiotherapyOrderDetails==null ? null : dataSet_GetPhysiotherapyOrderDetails.Orderobjectobjectid)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class ORDERDETAILSGroupBody : TTReportSection
            {
                ...
                public TTReportField TREATMENTROOMNAME;
                ...
                public ORDERDETAILSGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    TREATMENTROOMNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 121, 1, 165, 6, false);
                    TREATMENTROOMNAME.Name = "TREATMENTROOMNAME";
                    TREATMENTROOMNAME.FieldType = ReportFieldTypeEnum.ftVariable;
                    TREATMENTROOMNAME.TextFont.Name = "Arial Narrow";
                    TREATMENTROOMNAME.TextFont.Size = 9;
                    TREATMENTROOMNAME.Value = @"{#ORDERS.TREATMENTROOMNAME#}";

                    EMERGENCY = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 1, 186, 6, false);
                    ...
                    PROCEDUREBYUSER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 43, 1, 119, 6, false);
                    ...
                    ACTIONDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 16, 1, 42, 6, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    TREATMENTROOMNAME.CalcValue = (dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.Treatmentroomname) : "");
                    EMERGENCY.CalcValue = (dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.Emergency) : "");
                    ...
                    ACTIONDATE.CalcValue = (dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.ActionDate) : "");
                    STATE.CalcValue = TTObjectDefManager.Instance.ObjectDefs["PhysiotherapyOrderDetail"].StateDefs[new Guid((dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.CurrentStateDefID) : ""))].DisplayText;
                    return new TTReportObject[] { TREATMENTROOMNAME,EMERGENCY,PROCEDUREBYUSER,ORDEROBJECTPROCEDUREDOCTOR,ORDERDETAILPROCEDUREBYUSER,ACTIONDATE,STATE};
                }
...
#region ORDERDETAILS BODY_Script
        ...
        public PhysiotheraphyDetailReportByAcceptForFound()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "PHYSIOTHERAPHYDETAILREPORTBYACCEPTFORFOUND";
            Caption = "Fizyoterapi Detay Raporu (İstek Bazında-Kurum)";
