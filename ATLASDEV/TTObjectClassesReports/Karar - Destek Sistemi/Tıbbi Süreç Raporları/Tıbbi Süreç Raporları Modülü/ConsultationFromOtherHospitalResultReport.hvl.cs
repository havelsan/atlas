...
{
    /// <summary>
    /// Dış XXXXXX Konsültasyon Sonuç Raporu
    /// </summary>
    public partial class ConsultationFromOtherHospitalResultReport : TTReport
    {
        ...
        {
            public ConsultationFromOtherHospitalResultReport MyParentReport
            {
                get { return (ConsultationFromOtherHospitalResultReport)ParentReport; }
            }
            ...
            public partial class TOPHEADERGroupHeader : TTReportSection
            {
                ...
                public TOPHEADERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DATE1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 170, 42, 205, 46, false);
                    DATE1.Name = "DATE1";
                    DATE1.FieldType = ReportFieldTypeEnum.ftExpression;
                    DATE1.TextFormat = @"Short Date";
                    DATE1.HorzAlign = HorizontalAlignmentEnum.haRight;
                    DATE1.TextFont.Name = "Arial Narrow";
                    DATE1.TextFont.Size = 9;
                    DATE1.Value = @"TTObjectClasses.Common.RecTime().ToString()";

                    NewField102 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 9, 37, 15, false);
                    ...
                    XXXXXXBASLIK1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 38, 9, 183, 32, false);
                    ...
                    BASLIK1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 38, 33, 183, 40, false);
                    ...
                    BASLIK1.Value = @"DİĞER XXXXXXLERDEN KONSÜLTASYON SONUÇ RAPORU";
            ...
            public partial class TOPHEADERGroupFooter : TTReportSection
            {
                ...
                public TOPHEADERGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    HizmetOzel = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 3, 36, 9, false);
                    ...
                    NewLine = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 3, 205, 3, false);
                    NewLine.Name = "NewLine";
                    NewLine.DrawStyle = DrawStyleConstants.vbSolid;

                    PrintDate = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 180, 9, 205, 14, false);
                    ...
                    UserName = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 180, 4, 205, 9, false);
                    UserName.Name = "UserName";
                    UserName.FieldType = ReportFieldTypeEnum.ftExpression;
                    UserName.HorzAlign = HorizontalAlignmentEnum.haRight;
                    UserName.TextFont.Name = "Arial Narrow";
                    UserName.TextFont.Size = 8;
                    UserName.Value = @"TTObjectClasses.Common.CurrentResource.Name;";

                    PageNumber = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 96, 6, 121, 11, false);
        ...
        public partial class NOTGroup : TTReportGroup
        {
            ...
            public partial class NOTGroupHeader : TTReportSection
            {
                ...
                public NOTGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SAG = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 3, 205, 7, false);
                    SAG.Name = "SAG";
                    ...
                    BIRIMPROTOKOL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 45, 33, 49, false);
                    ...
                    RAPORNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 32, 253, 36, false);
                    ...
                    KONU = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 7, 205, 11, false);
                    KONU.Name = "KONU";
                    ...
                    BIRIMADI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 33, 45, 63, 49, false);
                    ...
                    DYERVETARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 59, 103, 206, 107, false);
                    ...
                    NewField8 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 88, 56, 92, false);
                    ...
                    NewField9 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 103, 56, 107, false);
                    ...
                    BABAAD = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 59, 98, 206, 102, false);
                    BABAAD.Name = "BABAAD";
                    ...
                    ADSOYAD = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 59, 83, 206, 87, false);
                    ...
                    NewField12 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 83, 56, 87, false);
                    ...
                    NewField13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 88, 59, 92, false);
                    ...
                    NewField14 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 83, 59, 87, false);
                    ...
                    NewField15 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 98, 56, 102, false);
                    ...
                    SINIFRUTBE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 56, 241, 60, false);
                    ...
                    NewField17 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 103, 59, 107, false);
                    ...
                    NewField18 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 98, 59, 102, false);
                    ...
                    RUTBE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 48, 253, 52, false);
                    RUTBE.Name = "RUTBE";
                    ...
                    SINIF = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 40, 253, 44, false);
                    SINIF.Name = "SINIF";
                    ...
                    DTARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 63, 45, 89, 49, false);
                    DTARIH.Name = "DTARIH";
                    ...
                    DYER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 33, 49, 59, 53, false);
                    DYER.Name = "DYER";
                    ...
                    MAKAM = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 44, 237, 48, false);
                    MAKAM.Name = "MAKAM";
                    ...
                    EVRAKSAYISI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 52, 243, 56, false);
                    ...
                    EVRAKTARIHI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 36, 243, 40, false);
                    ...
                    ACTIONID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 49, 33, 53, false);
                    ...
                    FULLSINIFRUTBE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 59, 88, 206, 92, false);
                    ...
                    NewField40 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 32, 206, 43, false);
                    ...
                    NewField30 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 72, 57, 76, false);
                    ...
                    BIRLIK = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 59, 93, 206, 97, false);
                    BIRLIK.Name = "BIRLIK";
                    ...
                    NewField34 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 93, 56, 97, false);
                    ...
                    GIDECEGIYER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 19, 206, 24, false);
                    ...
                    GIDECEGIBIRIM = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 24, 206, 29, false);
                    ...
                    ACTIONDATE2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 93, 13, 124, 18, false);
                    ...
                    GRUP_KHDJ = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 53, 44, 57, false);
                    ...
                    DAGITIM = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 60, 83, 66, false);
                    ...
                    GIDYER_KOD = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 60, 253, 64, false);
                    ...
                    SAYMANLIK = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 67, 206, 71, false);
                    ...
                    NewField33 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 93, 59, 97, false);
                    ...
                    NewLine13 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 76, 59, 76, false);
                    NewLine13.Name = "NewLine13";
                    NewLine13.DrawStyle = DrawStyleConstants.vbSolid;

                    NewField141 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 72, 59, 76, false);
                    ...
                    NewField143 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 120, 59, 124, false);
                    ...
                    UNIQUEREFNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 59, 78, 206, 82, false);
                    ...
                    LBLUNIQUEREFNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 78, 56, 82, false);
                    ...
                    NewField131 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 78, 59, 82, false);
                    ...
                    REQUESTEDHOSPITALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 66, 261, 71, false);
                    ...
                    REQUESTEDDEPARTMENTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 72, 261, 77, false);
                    ...
                    REQUESTEDEXTERNALHOSPITALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 78, 261, 83, false);
                    ...
                    REQUESTEDEXTERNALDEPARTMENTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 84, 261, 89, false);
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 108, 57, 112, false);
                    ...
                    NewLine1 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 112, 59, 112, false);
                    NewLine1.Name = "NewLine1";
                    NewLine1.DrawStyle = DrawStyleConstants.vbSolid;

                    PREDIAGNOSIS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 113, 206, 124, false);
                    ...
                    ONAY = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 154, 47, 203, 52, false);
                    ONAY.Name = "ONAY";
                    ...
                    ONAYUNVAN = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 154, 52, 203, 57, false);
                    ...
                    ONAYUNVAN2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 154, 57, 203, 62, false);
...
#region NOT HEADER_Script
            ...
            string objectID = ((ConsultationFromOtherHospitalResultReport)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
...
//            if (((ConsultationFromOtherHospitalResultReport)ParentReport).CurrentCopy != 1)
//            {
...
//            }
            ...
            public partial class NOTGroupFooter : TTReportSection
            {
                ...
                public NOTGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField10 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 2, 83, 7, false);
                    ...
                    DIPSIC = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 33, 15, 83, 19, false);
                    DIPSIC.Name = "DIPSIC";
                    ...
                    ADSOYADDOC = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 7, 83, 11, false);
                    ...
                    DIPSICLABEL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 15, 32, 19, false);
                    ...
                    SINRUT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 11, 83, 15, false);
                    SINRUT.Name = "SINRUT";
                    ...
                    UZ = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 19, 83, 23, false);
                    UZ.Name = "UZ";
...
#region NOT FOOTER_Script
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ANAMNEZ = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 9, 205, 17, false);
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 3, 57, 7, false);
                    NewField1.Name = "NewField1";
                    NewField1.TextFont.Name = "Arial Narrow";
                    NewField1.TextFont.Size = 9;
                    NewField1.TextFont.Bold = true;
                    ...
                    NewLine = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 8, 59, 8, false);
                    NewLine.Name = "NewLine";
                    NewLine.DrawStyle = DrawStyleConstants.vbSolid;

                    NewField1341 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 57, 3, 59, 7, false);
        ...
        public partial class RESULTANDOFFERSGroup : TTReportGroup
        {
            ...
            public TTReportField RESULTANDOFFERS { get {return Body().RESULTANDOFFERS;} }
            ...
            public partial class RESULTANDOFFERSGroupBody : TTReportSection
            {
                ...
                public TTReportField RESULTANDOFFERS; 
                public RESULTANDOFFERSGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 1, 57, 5, false);
                    NewField111.Name = "NewField111";
                    NewField111.TextFont.Name = "Arial Narrow";
                    NewField111.TextFont.Size = 9;
                    NewField111.TextFont.Bold = true;
                    NewField111.Value = @"Konsültasyon Sonucu ve Öneriler";

                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 6, 59, 6, false);
                    NewLine11.Name = "NewLine11";
                    NewLine11.DrawStyle = DrawStyleConstants.vbSolid;

                    RESULTANDOFFERS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 7, 205, 15, false);
                    RESULTANDOFFERS.Name = "RESULTANDOFFERS";
                    RESULTANDOFFERS.FieldType = ReportFieldTypeEnum.ftVariable;
                    RESULTANDOFFERS.MultiLine = EvetHayirEnum.ehEvet;
                    RESULTANDOFFERS.NoClip = EvetHayirEnum.ehEvet;
                    RESULTANDOFFERS.WordBreak = EvetHayirEnum.ehEvet;
                    RESULTANDOFFERS.ExpandTabs = EvetHayirEnum.ehEvet;
                    RESULTANDOFFERS.TextFont.Name = "Arial Narrow";
                    RESULTANDOFFERS.TextFont.Size = 9;
                    RESULTANDOFFERS.Value = @"";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    RESULTANDOFFERS.CalcValue = @"";
                    return new TTReportObject[] { NewField111,RESULTANDOFFERS};
                }

                public override void RunScript()
                {
#region RESULTANDOFFERS BODY_Script
                    TTObjectContext context = new TTObjectContext(true);
            string sObjectID = ((ConsultationFromOtherHospitalResultReport)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
            ConsultationFromOtherHospital consultationFromOtherHospital = (ConsultationFromOtherHospital)context.GetObject(new Guid(sObjectID),"ConsultationFromOtherHospital");            
            if(consultationFromOtherHospital.ConsultationResultAndOffers !=null)
                this.RESULTANDOFFERS.CalcValue = consultationFromOtherHospital.ConsultationResultAndOffers.ToString();
#endregion RESULTANDOFFERS BODY_Script
                }
            }
        ...
        public ConsultationFromOtherHospitalResultReport()
        {
            ...
            RESULTANDOFFERS = new RESULTANDOFFERSGroup(NOT,"RESULTANDOFFERS");
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CONSULTATIONFROMOTHERHOSPITALRESULTREPORT";
            Caption = "Dış XXXXXX Konsültasyon Sonuç Raporu";
