...
{
    /// <summary>
    /// CollectedPatientList e AccTrx bağlamadan çalışan
    /// </summary>
    public partial class CollectedInvoiceProcedureDetailReport2 : TTReport
    {
        ...
        {
            public CollectedInvoiceProcedureDetailReport2 MyParentReport
            {
                get { return (CollectedInvoiceProcedureDetailReport2)ParentReport; }
            }
...
#region PARTA HEADER_Script
            ...
            ((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCEFILTER = resFilterList;
            
            if (((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCE == null)
            {
                ((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCEFLAG = 0;
            }
            else
            {
                ((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCEFLAG = 1;
                
                foreach (string objectID in ((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCE)
                {
                    ...
                    if (section is ResDepartment)
                    {
                        ...
                        {
                            //((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCEFILTER.Add(Pol.ObjectID.ToString());
                            foreach(ResourceSpecialityGrid polSpeciality in Pol.ResourceSpecialities)
                            {
                                if(polSpeciality.Speciality != null)
                                    ((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCEFILTER.Add(polSpeciality.Speciality.ObjectID.ToString());
                            }
                        }
                        foreach (ResClinic Cln in department.Clinics)
                        {
                            //((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCEFILTER.Add(Cln.ObjectID.ToString());
                            foreach(ResourceSpecialityGrid clnSpeciality in Cln.ResourceSpecialities)
                            {
                                if(clnSpeciality.Speciality != null)
                                    ((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCEFILTER.Add(clnSpeciality.Speciality.ObjectID.ToString());
                            }
                        }
                    ...
                    {
                        //((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCEFILTER.Add(objectID.ToString());
                        foreach(ResourceSpecialityGrid resSpeciality in section.ResourceSpecialities)
                        {
                            if(resSpeciality.Speciality != null)
                                ((CollectedInvoiceProcedureDetailReport2)ParentReport).RuntimeParameters.RESOURCEFILTER.Add(resSpeciality.Speciality.ObjectID.ToString());
                        }
                    }
                }
            }
        ...
        public partial class HEADGroup : TTReportGroup
        {
            ...
            public TTReportField NewField11211141 { get {return Header().NewField11211141;} }
            public TTReportField NewField112111111 { get {return Header().NewField112111111;} }
            public TTReportField EVTELEFONU { get {return Header().EVTELEFONU;} }
            public TTReportField NewField11211171 { get {return Header().NewField11211171;} }
            public TTReportField NewField112111121 { get {return Header().NewField112111121;} }
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<AccountTransaction.CollectedInvoiceProcedureDetailReportQueryCheck_Class>("CollectedInvoiceProcedureDetailReportQueryCheck", AccountTransaction.CollectedInvoiceProcedureDetailReportQueryCheck((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID),(List<string>) MyParentReport.RuntimeParameters.RESOURCEFILTER,(int)TTObjectDefManager.Instance.DataTypes["Integer"].ConvertValue(MyParentReport.RuntimeParameters.RESOURCEFLAG)));
            ...
            public partial class HEADGroupHeader : TTReportSection
            {
                ...
                public TTReportField NewField11211141;
                public TTReportField NewField112111111;
                public TTReportField EVTELEFONU;
                public TTReportField NewField11211171;
                public TTReportField NewField112111121;
                ...
                public HEADGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1101 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 58, 12, 154, 17, false);
                    ...
                    HASTATURU = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 228, 11, 268, 15, false);
                    ...
                    EPISODE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 228, 21, 268, 25, false);
                    ...
                    PATIENT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 228, 27, 268, 31, false);
                    ...
                    OPENINGDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 228, 48, 268, 52, false);
                    ...
                    QUARANTINEINPATIENTDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 228, 54, 268, 58, false);
                    ...
                    NewField11211141 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 44, 33, 48, false);
                    NewField11211141.Name = "NewField11211141";
                    NewField11211141.TextFont.Name = "Arial";
                    NewField11211141.TextFont.Size = 8;
                    NewField11211141.TextFont.Bold = true;
                    NewField11211141.TextFont.CharSet = 162;
                    NewField11211141.Value = @"Ev Telefonu";

                    NewField112111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 33, 44, 35, 48, false);
                    NewField112111111.Name = "NewField112111111";
                    NewField112111111.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField112111111.TextFont.Name = "Arial";
                    NewField112111111.TextFont.Size = 8;
                    NewField112111111.TextFont.Bold = true;
                    NewField112111111.TextFont.CharSet = 162;
                    NewField112111111.Value = @":";
                    ...
                    NewField11211171 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 49, 33, 53, false);
                    NewField11211171.Name = "NewField11211171";
                    NewField11211171.TextFont.Name = "Arial";
                    NewField11211171.TextFont.Size = 8;
                    NewField11211171.TextFont.Bold = true;
                    NewField11211171.TextFont.CharSet = 162;
                    NewField11211171.Value = @"Ev Adresi";

                    NewField112111121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 33, 49, 35, 53, false);
                    NewField112111121.Name = "NewField112111121";
                    NewField112111121.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField112111121.TextFont.Name = "Arial";
                    NewField112111121.TextFont.Size = 8;
                    NewField112111121.TextFont.Bold = true;
                    NewField112111121.TextFont.CharSet = 162;
                    NewField112111121.Value = @":";
                    ...
                    QUARANTINEDISCHARGEDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 228, 36, 268, 40, false);
                    ...
                    DIS12.WordBreak = EvetHayirEnum.ehEvet;
                    DIS12.Value = @"";
                    ...
                    DIS47 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 31, 129, 34, 134, false);
                    DIS47.Name = "DIS47";
                ...
                {
                    AccountTransaction.CollectedInvoiceProcedureDetailReportQueryCheck_Class dataset_CollectedInvoiceProcedureDetailReportQueryCheck = ParentGroup.rsGroup.GetCurrentRecord<AccountTransaction.CollectedInvoiceProcedureDetailReportQueryCheck_Class>(0);
                    NewField1101.CalcValue = NewField1101.Value;
                    NewField1111.CalcValue = NewField1111.Value;
                    NewField1121.CalcValue = NewField1121.Value;
                    HASTAADI.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Patientname) : "");
                    TCKIMLIKNO.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.UniqueRefNo) : "");
                    ...
                    KURUMADI.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Payername) : "");
                    HOSPITALPROTOCOLNO.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.HospitalProtocolNo) : "");
                    KURUMKODU.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Payercode) : "");
                    ICD10KOD.CalcValue = @"";
                    ICD10.CalcValue = @"";
                    TARIH1.CalcValue = @"";
                    BRANS.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Specialityname) : "");
                    HASTATIP.CalcValue = @"";
                    FATURANO.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.DocumentNo) : "");
                    CINSIYET.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Sex) : "");
                    PROVIZYONNO.CalcValue = @"";
                    HASTATURU.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.PATIENTSTATUS) : "");
                    EPISODE.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Eobjid) : "");
                    PATIENT.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Pobjid) : "");
                    TARIH2LBL.CalcValue = TARIH2LBL.Value;
                    TARIH2.CalcValue = @"";
                    OPENINGDATE.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.OpeningDate) : "");
                    QUARANTINEINPATIENTDATE.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.HospitalInPatientDate) : "");
                    NewField11211141.CalcValue = NewField11211141.Value;
                    NewField112111111.CalcValue = NewField112111111.Value;
                    EVTELEFONU.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Homephone) : "");
                    NewField11211171.CalcValue = NewField11211171.Value;
                    NewField112111121.CalcValue = NewField112111121.Value;
                    EVADRESI.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Homeaddress) : "") + @" " + (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Homecity) : "");
                    ...
                    QUARANTINEDISCHARGEDATE.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.HospitalDischargeDate) : "");
...
#region HEAD HEADER_Script
            ...
            else
            {
                ...
                foreach(InPatientTreatmentClinicApplication clinicApp in inpatientTreatmentClinicList)
                {
                    ...
                    if (clinicApp.BaseInpatientAdmission != null && clinicApp.BaseInpatientAdmission is InpatientAdmission && ((InpatientAdmission)clinicApp.BaseInpatientAdmission).HospitalInPatientDate != null)
                        YAS.CalcValue = e.Patient.AgeBySpecificDate((DateTime)((InpatientAdmission)clinicApp.BaseInpatientAdmission).HospitalInPatientDate).ToString();
                    break;
                }
...
//
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                AccountTransaction.CollectedInvoiceProcedureDetailReportQueryCheck_Class dataSet_CollectedInvoiceProcedureDetailReportQueryCheck = ParentGroup.rsGroup.GetCurrentRecord<AccountTransaction.CollectedInvoiceProcedureDetailReportQueryCheck_Class>(0);    
                return new object[] {(dataSet_CollectedInvoiceProcedureDetailReportQueryCheck==null ? null : dataSet_CollectedInvoiceProcedureDetailReportQueryCheck.HospitalProtocolNo)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ACCTRXOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 241, 1, 270, 5, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    AccountTransaction.CollectedInvoiceProcedureDetailReportQueryCheck_Class dataset_CollectedInvoiceProcedureDetailReportQueryCheck = MyParentReport.HEAD.rsGroup.GetCurrentRecord<AccountTransaction.CollectedInvoiceProcedureDetailReportQueryCheck_Class>(0);
                    HIZMET.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.ExternalCode) : "") + @" " + (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Description) : "");
                    TOPLAMFIYAT.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Totalprice) : "");
                    BIRIMFIYAT.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.UnitPrice) : "");
                    ADET.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Amount) : "");
                    TOPLAMFIYAT1.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Totalprice) : "");
                    TARIH.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Day) : "") + @"." + (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Month) : "") + @"." + (dataset_CollectedInvoiceProcedureDetailReportQueryCheck != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQueryCheck.Year) : "");
...
#region MAIN BODY_Script
        ...
        public CollectedInvoiceProcedureDetailReport2()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "COLLECTEDINVOICEPROCEDUREDETAILREPORT2";
            Caption = "Hizmet Detay Bilgisi";
