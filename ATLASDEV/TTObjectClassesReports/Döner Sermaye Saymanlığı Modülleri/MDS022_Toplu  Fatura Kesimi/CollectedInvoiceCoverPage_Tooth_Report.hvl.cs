...
{
    public partial class CollectedInvoiceCoverPage_Tooth : TTReport
    {
        ...
        {
            public CollectedInvoiceCoverPage_Tooth MyParentReport
            {
                get { return (CollectedInvoiceCoverPage_Tooth)ParentReport; }
            }
        ...
        public partial class HEADGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<CollectedPatientList.CollectedInvoiceCoverPageQuery_Tooth_Class>("CollectedInvoiceCoverPageQuery_Tooth", CollectedPatientList.CollectedInvoiceCoverPageQuery_Tooth((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class HEADGroupHeader : TTReportSection
            {
                ...
                {
                    CollectedPatientList.CollectedInvoiceCoverPageQuery_Tooth_Class dataset_CollectedInvoiceCoverPageQuery_Tooth = ParentGroup.rsGroup.GetCurrentRecord<CollectedPatientList.CollectedInvoiceCoverPageQuery_Tooth_Class>(0);
                    ...
                    STARTDATE.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_Tooth != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_Tooth.STARTDATE) : "");
                    ENDDATE.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_Tooth != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_Tooth.ENDDATE) : "");
                    PATIENTSTATUS.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_Tooth != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_Tooth.PATIENTSTATUS) : "");
                    EPISODECOUNT.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_Tooth != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_Tooth.Episodecount) : "");
                    TOTALPRICE.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_Tooth != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_Tooth.Totalprice) : "");
                    DOCUMENTNO.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_Tooth != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_Tooth.DocumentNo) : "");
...
#region HEAD HEADER_Script
        ...
        public CollectedInvoiceCoverPage_Tooth()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "COLLECTEDINVOICECOVERPAGE_TOOTH";
            Caption = "Toplu Fatura Kapak Sayfası (Diş)";
