...
namespace TTReportClasses
{
    ...
    /// Borç Senedi
    /// </summary>
    public partial class AdvanceDebentureReport : TTReport
    {
        ...
        {
            public AdvanceDebentureReport MyParentReport
            {
                get { return (AdvanceDebentureReport)ParentReport; }
            }
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<Advance.GetAdvanceDebentures_Class>("GetAdvanceDebentures", Advance.GetAdvanceDebentures((string)TTObjectDefManager.Instance.DataTypes["String255"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class HEADGroupHeader : TTReportSection
            {
                ...
                {
                    Advance.GetAdvanceDebentures_Class dataset_GetAdvanceDebentures = ParentGroup.rsGroup.GetCurrentRecord<Advance.GetAdvanceDebentures_Class>(0);
                    DEBENTUREOBJECTID.CalcValue = (dataset_GetAdvanceDebentures != null ? Globals.ToStringCore(dataset_GetAdvanceDebentures.ObjectID) : "");
            ...
            public partial class HEADGroupFooter : TTReportSection
            {
                ...
                public HEADGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    CURRENTUSER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 98, 1, 125, 6, false);
                    ...
                    PageNumber = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 163, 1, 188, 6, false);
                    ...
                    PrintDate = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 12, 1, 59, 6, false);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 73, 4, 143, 24, false);
                    ...
                    TEXT.Value = @"         XXXXXX Döner Sermaye Saymanlığı'na tedavi bedeli olarak  {%PRICE%}  Lira borçlanmış bulunmaktayım.
         Bu borcumu   {%DUEDATE%}  tarihinde ödeyeceğimi şimdiden kabul ve taahhüt ediyorum.
         Aksi takdirde, tahsilat icrası için hakkımda yapılacak kanuni muameleye hiçbir itirazım olmayacağını ve merci olarak XXXXXX Mahkemelerini, ikametime tevcih edildiği takdirde Mahalli Mahkemelerinin takip ve icrasını kabul edeceğime dair iş bu borç senedini imza ediyorum. ";
...
İl-İlçe ve Köy";
                    ...
                    LOGO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 33, 4, 73, 24, false);
                    LOGO.Name = "LOGO";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    TEXT.CalcValue = @"         XXXXXX Döner Sermaye Saymanlığı'na tedavi bedeli olarak  " + MyParentReport.MAIN.PRICE.CalcValue + @"  Lira borçlanmış bulunmaktayım.
         Bu borcumu   " + MyParentReport.MAIN.DUEDATE.FormattedValue + @"  tarihinde ödeyeceğimi şimdiden kabul ve taahhüt ediyorum.
         Aksi takdirde, tahsilat icrası için hakkımda yapılacak kanuni muameleye hiçbir itirazım olmayacağını ve merci olarak XXXXXX Mahkemelerini, ikametime tevcih edildiği takdirde Mahalli Mahkemelerinin takip ve icrasını kabul edeceğime dair iş bu borç senedini imza ediyorum. ";
                    ...
                    return new TTReportObject[] { BOX13,BOX21,BOX20,BOX19,BOX18,BOX17,BOX16,BOX15,BOX14,BOX12,BOX11,BOX1,NewField11,NewField12,NewField3_1,NewField14,NewField13,NewField15,DEBENTURENO,NewField16,NewField161,NewField171,NewField181,DATE,DEPARTMENT,EPISODEID,UNIQUEREFNO,LIRA,KURUS,NewField19,NewField191,PRICE,DUEDATE,TEXT,GUARANTORSIGN11,PATIENTSIGN11,NewField1461,NewField1451,NewField1441,NewField1431,NewField1421,NewField1411,NewField1141,NewField1131,NewField1121,NewField1111,NewField193,NewField1391,USER,PNAME,PSURNAME,LOGO};
                }
