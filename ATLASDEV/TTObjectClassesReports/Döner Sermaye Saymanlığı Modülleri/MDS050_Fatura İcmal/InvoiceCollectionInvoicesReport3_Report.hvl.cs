...
{
    public partial class InvoiceCollectionInvoicesReport3 : TTReport
    {
#region Methods
   Currency PageTotal = 0;
        ...
        {
            public InvoiceCollectionInvoicesReport3 MyParentReport
            {
                get { return (InvoiceCollectionInvoicesReport3)ParentReport; }
            }
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<SubEpisodeProtocol.GetByInvoiceCollection_Class>("GetByInvoiceCollection", SubEpisodeProtocol.GetByInvoiceCollection((Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                {
                    SubEpisodeProtocol.GetByInvoiceCollection_Class dataset_GetByInvoiceCollection = ParentGroup.rsGroup.GetCurrentRecord<SubEpisodeProtocol.GetByInvoiceCollection_Class>(0);
                    PIDOBJECTID.CalcValue = (dataset_GetByInvoiceCollection != null ? Globals.ToStringCore(dataset_GetByInvoiceCollection.Pidobjectid) : "");
                    ICDOBJECTID.CalcValue = (dataset_GetByInvoiceCollection != null ? Globals.ToStringCore(dataset_GetByInvoiceCollection.Icdobjectid) : "");
                    SEOBJECTID.CalcValue = (dataset_GetByInvoiceCollection != null ? Globals.ToStringCore(dataset_GetByInvoiceCollection.Seobjectid) : "");
...
#region MAIN_Script
        ...
        public InvoiceCollectionInvoicesReport3()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "INVOICECOLLECTIONINVOICESREPORT3";
            Caption = "İcmal Faturaları (Kabul Bazlı - Atılış Sırası)";
