...
{
    public partial class ICListAlphabeticReport : TTReport
    {
        ...
        {
            public ICListAlphabeticReport MyParentReport
            {
                get { return (ICListAlphabeticReport)ParentReport; }
            }
...
#region HEAD HEADER_Script
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<InvoiceCollectionDetail.ICListAlphabeticReportNQL_Class>("ICListAlphabeticReportNQL", InvoiceCollectionDetail.ICListAlphabeticReportNQL((Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    InvoiceCollectionDetail.ICListAlphabeticReportNQL_Class dataset_ICListAlphabeticReportNQL = ParentGroup.rsGroup.GetCurrentRecord<InvoiceCollectionDetail.ICListAlphabeticReportNQL_Class>(0);
                    NO.CalcValue = ParentGroup.GroupCounter.ToString();
                    PATIENTNAME.CalcValue = (dataset_ICListAlphabeticReportNQL != null ? Globals.ToStringCore(dataset_ICListAlphabeticReportNQL.Patientname) : "");
                    CLASS.CalcValue = (dataset_ICListAlphabeticReportNQL != null ? Globals.ToStringCore(dataset_ICListAlphabeticReportNQL.Payertype) : "");
                    TCKIMLIKNO.CalcValue = (dataset_ICListAlphabeticReportNQL != null ? Globals.ToStringCore(dataset_ICListAlphabeticReportNQL.UniqueRefNo) : "");
                    OPENINGDATE.CalcValue = (dataset_ICListAlphabeticReportNQL != null ? Globals.ToStringCore(dataset_ICListAlphabeticReportNQL.OpeningDate) : "");
                    EPISODEID.CalcValue = (dataset_ICListAlphabeticReportNQL != null ? Globals.ToStringCore(dataset_ICListAlphabeticReportNQL.Episodeid) : "");
                    INVOICENO.CalcValue = (dataset_ICListAlphabeticReportNQL != null ? Globals.ToStringCore(dataset_ICListAlphabeticReportNQL.Invoiceno) : "");
                    INVOICEPRICE.CalcValue = (dataset_ICListAlphabeticReportNQL != null ? Globals.ToStringCore(dataset_ICListAlphabeticReportNQL.Invoiceprice) : "");
                    SPECIALITYNAME.CalcValue = (dataset_ICListAlphabeticReportNQL != null ? Globals.ToStringCore(dataset_ICListAlphabeticReportNQL.Specialityname) : "");
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "ICLISTALPHABETICREPORT";
            Caption = "İcmal Listesi (Alfabetik)";
