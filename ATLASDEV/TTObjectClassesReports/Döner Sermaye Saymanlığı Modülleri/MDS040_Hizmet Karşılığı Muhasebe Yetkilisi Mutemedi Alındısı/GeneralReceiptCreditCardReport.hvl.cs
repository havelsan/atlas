...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class GeneralReceiptCreditCardReport : TTReport
    {
        ...
        {
            public GeneralReceiptCreditCardReport MyParentReport
            {
                get { return (GeneralReceiptCreditCardReport)ParentReport; }
            }
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<GeneralReceipt.GeneralReceiptCreditCardReportQuery_Class>("GeneralReceiptCreditCardReportQuery", GeneralReceipt.GeneralReceiptCreditCardReportQuery((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
...
";
                ...
                {
                    GeneralReceipt.GeneralReceiptCreditCardReportQuery_Class dataset_GeneralReceiptCreditCardReportQuery = ParentGroup.rsGroup.GetCurrentRecord<GeneralReceipt.GeneralReceiptCreditCardReportQuery_Class>(0);
                    RECEIPTSPECIALNO.CalcValue = (dataset_GeneralReceiptCreditCardReportQuery != null ? Globals.ToStringCore(dataset_GeneralReceiptCreditCardReportQuery.CreditCardSpecialNo) : "");
                    CARDOWNER.CalcValue = (dataset_GeneralReceiptCreditCardReportQuery != null ? Globals.ToStringCore(dataset_GeneralReceiptCreditCardReportQuery.Cardowner) : "");
                    PAYEENAME.CalcValue = (dataset_GeneralReceiptCreditCardReportQuery != null ? Globals.ToStringCore(dataset_GeneralReceiptCreditCardReportQuery.PayeeName) : "");
                    DOCUMENTNO.CalcValue = (dataset_GeneralReceiptCreditCardReportQuery != null ? Globals.ToStringCore(dataset_GeneralReceiptCreditCardReportQuery.CreditCardDocumentNo) : "");
...
";
                    ...
                    TOTALPRICE1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 179, 21, 204, 26, false);
                ...
                {
                    GeneralReceipt.GeneralReceiptCreditCardReportQuery_Class dataset_GeneralReceiptCreditCardReportQuery = ParentGroup.rsGroup.GetCurrentRecord<GeneralReceipt.GeneralReceiptCreditCardReportQuery_Class>(0);
                    TOTALPRICE.CalcValue = (dataset_GeneralReceiptCreditCardReportQuery != null ? Globals.ToStringCore(dataset_GeneralReceiptCreditCardReportQuery.Creditcardpayment) : "");
                    TOTALPRICE1.CalcValue = (dataset_GeneralReceiptCreditCardReportQuery != null ? Globals.ToStringCore(dataset_GeneralReceiptCreditCardReportQuery.Creditcardpayment) : "");
                    PRICEWITHLETTERS.CalcValue = MyParentReport.HEADER.TOTALPRICE1.CalcValue;
                    RECEIPTDATE.CalcValue = (dataset_GeneralReceiptCreditCardReportQuery != null ? Globals.ToStringCore(dataset_GeneralReceiptCreditCardReportQuery.DocumentDate) : "");
                    CASHIERNAME.CalcValue = (dataset_GeneralReceiptCreditCardReportQuery != null ? Globals.ToStringCore(dataset_GeneralReceiptCreditCardReportQuery.Cashiername) : "");
...
;
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 0, 67, 4, false);
        ...
        public GeneralReceiptCreditCardReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "GENERALRECEIPTCREDITCARDREPORT";
            Caption = "Hizmet Karşılığı Kredi Kartı Alındısı";
