...
{
    /// <summary>
    /// Teslim aldım yazılı order rapor versiyonu
    /// </summary>
    public partial class NursingApplicationOrderInfoReportBySign : TTReport
    {
#region Methods
   public class OrderDetail {
            ...
            public string T7;
            public string T8;
            public List<DateTime> uygulamaTarihi;//t1,t2 diye gösterilen saatlerin tam tarihi            
//            public string T9;
//            public string T10;
//            public string T11;
//            public string T12;
...
//            public string T15;
        ...
        public int mainCounterFooter = 0;        
        ...
        {
            public NursingApplicationOrderInfoReportBySign MyParentReport
            {
                get { return (NursingApplicationOrderInfoReportBySign)ParentReport; }
            }
...
#region PAGECOUNTHESAPLA HEADER_Script
        ...
        public partial class HASTAINFOGroup : TTReportGroup
        {
            ...
            public TTReportField txtuygulama { get {return Footer().txtuygulama;} }
...
#region HASTAINFO HEADER_Methods
            public static int CreateOrderPeriods(Type t, int count, OrderDetail newOrderDetail, DrugOrderDetail.GetDrugOrderDetailByNursingApp_Class drugOrderDetail)
        {
            ...
            if (saat != null)
            {
                ...
                newOrderDetail.uygulamaTarihi.Add(drugOrderDetail.Uygulama_tarihi.Value);
...
#region HASTAINFO HEADER_Script
            ...
            string sObjectID = ((NursingApplicationOrderInfoReportBySign)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
            NursingApplication nursingApplication = (NursingApplication)context.GetObject(new Guid(sObjectID), "NursingApplication");

            DateTime startTimeParam = (DateTime)((NursingApplicationOrderInfoReportBySign)ParentReport).RuntimeParameters.STARTTIME;
            startTimeParam = new DateTime(startTimeParam.Year, startTimeParam.Month, startTimeParam.Day);

            DateTime endTimeParam = (DateTime)((NursingApplicationOrderInfoReportBySign)ParentReport).RuntimeParameters.ENDTIME;
            ...
            /* var drugOrderDetails = DrugOrderDetail.GetDrugOrderDetailByNursingApp(nursingApplication.ObjectID.ToString(), MyParentReport.currentDateTime, currentEndDateTime);
                    foreach (var drugOrderDetail in drugOrderDetails)
                    {
                        ...
                        if (lastOrderGuid != drugOrderDetail.Tedavi_objectid) // Aynı İlaç için farklı orderlar yazıldı ise aynı satırda gelsin diye
                        {
                            ...
                            newOrderDetail.uygulamaTarihi = new List<DateTime>();
                ...
                if (nursingOrderDetail.Orderobjectid != null)
                {
                    ...
                    if (count < 9 && count <= dozAralıgı && nursingOrderDetail.Uygulama_tarihi >= orderFilterTime)
                    {
                        ...
                        if (saat != null)
                        {
                            ...
                            newOrderDetail.uygulamaTarihi.Add(nursingOrderDetail.Uygulama_tarihi.Value);
            ...
            MyParentReport.mainCounterFooter = 0;
            ...
            public partial class HASTAINFOGroupFooter : TTReportSection
            {
                ...
                public TTReportField txtuygulama;
                ...
                public HASTAINFOGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    LISTCOUNT1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 213, 7, 235, 11, false);
                    ...
                    txtuygulama = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 217, 18, 226, 23, false);
                    txtuygulama.Name = "txtuygulama";
                    txtuygulama.Visible = EvetHayirEnum.ehHayir;
                    txtuygulama.MultiLine = EvetHayirEnum.ehEvet;
                    txtuygulama.NoClip = EvetHayirEnum.ehEvet;
                    txtuygulama.WordBreak = EvetHayirEnum.ehEvet;
                    txtuygulama.ExpandTabs = EvetHayirEnum.ehEvet;
                    txtuygulama.TextFont.CharSet = 162;
                    txtuygulama.Value = @"";

                    İmza1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 9, 22, 145, 26, false);
                    İmza1.Name = "İmza1";
                    İmza1.TextFormat = @"Short Date";
                    İmza1.TextFont.Size = 9;
                    İmza1.TextFont.CharSet = 162;
                    İmza1.Value = @"................................................................................................................ tedavisi tarafımdan uygulanmıştır.";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    txtuygulama.CalcValue = txtuygulama.Value;
                    İmza1.CalcValue = İmza1.Value;
                    return new TTReportObject[] { LISTCOUNT1,TEDAVİ11,txtuygulama,İmza1};
                }

                public override void RunScript()
                {
#region HASTAINFO FOOTER_Script
                    if (MyParentReport.MAIN.RepeatCount > 0)
                    {
                        ...
                        {
                            obj = orderDetailList[MyParentReport.mainCounterFooter];
                            if (obj.uygulamaTarihi != null)
                            {
                                for (int j = 0; j < obj.uygulamaTarihi.Count; j++)
                                {
                                    timeList.Add(obj.uygulamaTarihi[j]);
                                }
                            }
                            //if (obj.T1 != null)
                            //    timeList.Add(obj.T1);
                            //    //this.txtuygulama.CalcValue += obj.tedavi + " için " + obj.T1 + " tedavisi tarafımdan onaylanmıştır\n\n";
                            //if (obj.T2 != null)
                            //    timeList.Add(obj.T2);
                            ////this.txtuygulama.CalcValue += obj.tedavi + " için " + obj.T2 + " tedavisi tarafımdan onaylanmıştır\n\n";
                            //if (obj.T3 != null)
                            //    timeList.Add(obj.T3);
                            ////this.txtuygulama.CalcValue += obj.tedavi + " için " + obj.T3 + " tedavisi tarafımdan onaylanmıştır\n\n";
                            //if (obj.T4 != null)
                            //    timeList.Add(obj.T4);
                            ////this.txtuygulama.CalcValue += obj.tedavi + " için " + obj.T4 + " tedavisi tarafımdan onaylanmıştır\n\n";
                            //if (obj.T5 != null)
                            //    timeList.Add(obj.T5);
                            ////this.txtuygulama.CalcValue += obj.tedavi + " için " + obj.T5 + " tedavisi tarafımdan onaylanmıştır\n\n";
                            //if (obj.T6 != null)
                            //    timeList.Add(obj.T6);
                            ////this.txtuygulama.CalcValue += obj.tedavi + " için " + obj.T6 + " tedavisi tarafımdan onaylanmıştır\n\n";
                            //if (obj.T7 != null)
                            //    timeList.Add(obj.T7);
                            ////this.txtuygulama.CalcValue += obj.tedavi + " için " + obj.T7 + " tedavisi tarafımdan onaylanmıştır\n\n";
                            //if (obj.T8 != null)
                            //    timeList.Add(obj.T8);
                            ////this.txtuygulama.CalcValue += obj.tedavi + " için " + obj.T8 + " tedavisi tarafımdan onaylanmıştır\n\n\n";
                            MyParentReport.mainCounterFooter += 1;
                        }
                        timeList.Sort();
                        timeList= timeList.Distinct().ToList<DateTime>();
                        for (int i = 0; i < timeList.Count; i++)
                            this.txtuygulama.CalcValue += timeList[i] + " tedavisi tarafımdan uygulanmıştır\n\n";

                    }
#endregion HASTAINFO FOOTER_Script
                }
            }
        ...
        public partial class HEADERGroup : TTReportGroup
        {
            ...
            public partial class HEADERGroupHeader : TTReportSection
            {
                ...
                public HEADERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    BASLIK1111.Value = @"Hemşirelik Uygulamaları Planı";
...
//                    this.T15.CalcValue = obj.T15;
        ...
        public NursingApplicationOrderInfoReportBySign()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "NURSINGAPPLICATIONORDERINFOREPORTBYSIGN";
