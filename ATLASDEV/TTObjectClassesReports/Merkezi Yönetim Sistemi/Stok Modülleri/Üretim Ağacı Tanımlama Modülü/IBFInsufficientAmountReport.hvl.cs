...
{
    /// <summary>
    /// İBF Eksik Miktar Formu
    /// </summary>
    public partial class IBFInsufficientAmountReport : TTReport
    {
        ...
        {
            public IBFInsufficientAmountReport MyParentReport
            {
                get { return (IBFInsufficientAmountReport)ParentReport; }
            }
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    FORMBASLIGI.Value = @"{@IBFYear@} Yılı İBF İsteklerine Göre Eksik Malzeme Durumları";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    FORMBASLIGI.CalcValue = MyParentReport.RuntimeParameters.IBFYear.ToString() + @" Yılı İBF İsteklerine Göre Eksik Malzeme Durumları";
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    CURRENTUSER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 74, 0, 99, 5, false);
...
#region MAIN BODY_Script
                    double sampleAmount = Convert.ToInt64(this.SAMPLEAMOUNT.CalcValue);
                    double ibfAmount = Convert.ToInt64(this.IBFAMOUNT.CalcValue); 
                    double amount = Convert.ToInt64(this.AMOUNT.CalcValue);
                    double inheld = Convert.ToInt64(this.INHELD.CalcValue);
        ...
        public IBFInsufficientAmountReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "IBFINSUFFICIENTAMOUNTREPORT";
            Caption = "İBF Eksik Miktar Formu";
