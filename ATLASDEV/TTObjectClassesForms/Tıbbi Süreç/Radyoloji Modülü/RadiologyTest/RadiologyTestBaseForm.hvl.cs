...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public RadiologyTestBaseForm() : base("RADIOLOGYTEST", "RadiologyTestBaseForm")
        {
        }

        protected RadiologyTestBaseForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}