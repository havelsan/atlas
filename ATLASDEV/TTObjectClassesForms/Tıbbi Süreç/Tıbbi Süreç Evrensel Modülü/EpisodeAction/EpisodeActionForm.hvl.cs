...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public EpisodeActionForm() : base("EPISODEACTION", "EpisodeActionForm")
        {
        }

        protected EpisodeActionForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}