...
namespace TTFormClasses
{
    ...
    public partial class StoneBreakUpCancelledForm : EpisodeActionForm
    {
        ...
        {
#region StoneBreakUpCancelledForm_PreScript
    base.PreScript();
            this.Age.Text = this._StoneBreakUpRequest.Episode.Patient.Age.ToString();
...
#endregion StoneBreakUpCancelledForm_PreScript
