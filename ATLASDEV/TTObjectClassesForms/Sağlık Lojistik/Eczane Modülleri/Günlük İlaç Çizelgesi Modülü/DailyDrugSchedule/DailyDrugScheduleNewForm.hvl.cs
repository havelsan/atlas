...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public DailyDrugScheduleNewForm() : base("DAILYDRUGSCHEDULE", "DailyDrugScheduleNewForm")
        {
        }

        protected DailyDrugScheduleNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}