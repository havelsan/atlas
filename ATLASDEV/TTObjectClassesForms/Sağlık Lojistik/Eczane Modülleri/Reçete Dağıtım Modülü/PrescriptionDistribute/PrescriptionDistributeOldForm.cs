...
namespace TTFormClasses
{
    ...
    public partial class PrescriptionDistributeOldForm : TTForm
    {
        ...
        {
#region PrescriptionDistributeOldForm_cmdSelectPharmacy_Click
...
#endregion PrescriptionDistributeOldForm_cmdSelectPharmacy_Click
        }

        private void PharmacyCountCombo_SelectedIndexChanged()
        {
#region PrescriptionDistributeOldForm_PharmacyCountCombo_SelectedIndexChanged
...
#endregion PrescriptionDistributeOldForm_PharmacyCountCombo_SelectedIndexChanged
        }

        private void cmdDistribute_Click()
        {
#region PrescriptionDistributeOldForm_cmdDistribute_Click
   TTObjectContext context = new TTObjectContext(false);
            ...
            foreach(Common.TTDoubleSortableList sortedItem in prescriptionList)
            {
                ...
                addedRow.Cells["DPatientNo"].Value = prescription.Episode.Patient.FullName.ToString();
            ...
            this.PharmacyCountCombo.Enabled = false;
#endregion PrescriptionDistributeOldForm_cmdDistribute_Click
        }

        private void cmdClear_Click()
        {
#region PrescriptionDistributeOldForm_cmdClear_Click
...
//            this.cmdDistribute.Enabled = true ;
//            this.PharmacyCountCombo.Enabled = true;
#endregion PrescriptionDistributeOldForm_cmdClear_Click
        }

        private void cmdSelect_Click()
        {
#region PrescriptionDistributeOldForm_cmdSelect_Click
...
#endregion PrescriptionDistributeOldForm_cmdSelect_Click
        }

        private void cmdUnSelect_Click()
        {
#region PrescriptionDistributeOldForm_cmdUnSelect_Click
   if(this.PrescriptionGrid.Rows.Count > 0)
            {
                for (int i = 0; i < this.PrescriptionGrid.Rows.Count; i++)
                {
...
#endregion PrescriptionDistributeOldForm_cmdUnSelect_Click
        }

        private void PrescriptionDateTime_ValueChanged()
        {
#region PrescriptionDistributeOldForm_PrescriptionDateTime_ValueChanged
   TTObjectContext context = new TTObjectContext(false);
...
#endregion PrescriptionDistributeOldForm_PrescriptionDateTime_ValueChanged
        }

        protected override void PreScript()
        {
            #region PrescriptionDistributeOldForm_PreScript
            this.PrescriptionDateTime.NullableValue = DateTime.Today;

            //PrescriptionDistribute pd = _PrescriptionDistribute ;
            IList myExternalPharmacy = _ttObject.ObjectContext.QueryObjects("EXTERNALPHARMACY","STATUS = 1") ;
            PharmacyCountCombo.Items.Add(new TTComboBoxItem("",0));
            for (int i = 1; i < myExternalPharmacy.Count; i++)
            {
                PharmacyCountCombo.Items.Add(new TTComboBoxItem(i.ToString(), i));
            }
#endregion PrescriptionDistributeOldForm_PreScript

            }
            
        protected override void PostScript(TTObjectStateTransitionDef transDef)
        {
#region PrescriptionDistributeOldForm_PostScript
    for ( int i = 0; i < this.DistributeGrid.Rows.Count; i++)
                {
                    ...
                    ExternalPharmacy externalPharmacy = (ExternalPharmacy)this._ttObject.ObjectContext.GetObject(pharmacyGuid,"EXTERNALPHARMACY");
                    Guid prescriptionGuid = new Guid(this.DistributeGrid.Rows[i].Cells["PrescriptionGuid"].Value.ToString());
                    Prescription prescription = (Prescription)this._ttObject.ObjectContext.GetObject(prescriptionGuid,"PRESCRIPTION");
                    if(prescription is InpatientPrescription)
                    {
                    ...
                    ExternalPharmacyPrescriptionTransaction prescriptionTransaction = new ExternalPharmacyPrescriptionTransaction(_ttObject.ObjectContext);
...
#endregion PrescriptionDistributeOldForm_PostScript

            }
            
#region PrescriptionDistributeOldForm_Methods
        public void GetPrescriptionType(Prescription prescription)
        {
//            if(prescription is InpatientPrescription)
//                this.PrescriptionName.Text ="InpatientPrescription";
//            if(prescription is OutPatientPrescription)
//                this.PrescriptionName.Text ="OutPatientPrescription";
        }
        
#endregion PrescriptionDistributeOldForm_Methods
    }
}