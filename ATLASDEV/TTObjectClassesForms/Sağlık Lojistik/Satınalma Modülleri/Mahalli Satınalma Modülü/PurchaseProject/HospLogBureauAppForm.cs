...
namespace TTFormClasses
{
    public partial class HospLogBureauAppForm : TTForm
    {
        ...
        {
#region HospLogBureauAppForm_ItemDetailsGrid_CellContentClick
   try
            {
            ...
            { }
#endregion HospLogBureauAppForm_ItemDetailsGrid_CellContentClick
        }

        protected override void PreScript()
        {
#region HospLogBureauAppForm_PreScript
    base.PreScript();

            if (this.PurchaseMainType.SelectedItem == null)
                return;
            ...
            if (this.PurchaseMainType.SelectedItem.Value != null)
            {
                ...
                {
                    this.DropStateButton(PurchaseProject.States.HeadDoctorApproval1);
                    AddStateButton(PurchaseProject.States.ProjectDetailing);
                }
                else
                {
                    this.DropStateButton(PurchaseProject.States.ProjectDetailing);
                    AddStateButton(PurchaseProject.States.HeadDoctorApproval1);
                }
            }
#endregion HospLogBureauAppForm_PreScript
