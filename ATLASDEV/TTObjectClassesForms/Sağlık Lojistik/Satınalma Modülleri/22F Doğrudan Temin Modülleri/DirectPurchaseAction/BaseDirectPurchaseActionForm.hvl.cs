...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public BaseDirectPurchaseActionForm() : base("DIRECTPURCHASEACTION", "BaseDirectPurchaseActionForm")
        {
        }

        protected BaseDirectPurchaseActionForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}