...
namespace TTFormClasses
{
    ...
    public partial class IBFDemand_ClinicApproveForm : IBFDemand_BaseForm
    {
        ...
        {
#region IBFDemand_ClinicApproveForm_cmdApproveAll_Click
   foreach(IBFBaseDemandDetail ibd in _IBFDemand.IBFBaseDemandDetails)
            {
                if(ibd.CurrentStateDefID == IBFBaseDemandDetail.States.New)
                    ibd.ClinicApprovedAmount = ibd.RequestAmount;
            }
#endregion IBFDemand_ClinicApproveForm_cmdApproveAll_Click
        }
    }
}