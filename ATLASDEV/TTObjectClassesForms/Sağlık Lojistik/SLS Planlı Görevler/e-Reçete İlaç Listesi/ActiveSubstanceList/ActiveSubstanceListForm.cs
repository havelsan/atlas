...
namespace TTFormClasses
{
    public partial class ActiveSubstanceListForm : ScheduledTaskBaseForm
    {
        ...
        {
#region ActiveSubstanceListForm_btnChoose_Click
   ...
   //         fbd.ShowNewFolderButton = true;
            ...
            //else
            //{
            //    InfoBox.Show("Etkin Madde Listesini Kaydetmek İstediğiniz Dosya Yolunu Seçiniz");
            //}
            var a = 1;
#endregion ActiveSubstanceListForm_btnChoose_Click
        }
    }
}