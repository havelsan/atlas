...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public SectionRequirementNewStateForm() : base("SECTIONREQUIREMENT", "SectionRequirementNewStateForm")
        {
        }

        protected SectionRequirementNewStateForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}