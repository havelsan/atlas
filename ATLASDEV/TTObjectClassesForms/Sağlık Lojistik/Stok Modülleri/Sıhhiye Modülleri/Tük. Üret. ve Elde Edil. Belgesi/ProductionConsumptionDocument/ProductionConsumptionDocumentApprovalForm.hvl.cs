...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public ProductionConsumptionDocumentApprovalForm() : base("PRODUCTIONCONSUMPTIONDOCUMENT", "ProductionConsumptionDocumentApprovalForm")
        {
        }

        protected ProductionConsumptionDocumentApprovalForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}