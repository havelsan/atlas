...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public ReturningDocumentForm() : base("RETURNINGDOCUMENT", "ReturningDocumentForm")
        {
        }

        protected ReturningDocumentForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}