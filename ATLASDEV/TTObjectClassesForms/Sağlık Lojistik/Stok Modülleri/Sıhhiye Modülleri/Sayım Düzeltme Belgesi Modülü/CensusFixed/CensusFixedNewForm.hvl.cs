...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public CensusFixedNewForm() : base("CENSUSFIXED", "CensusFixedNewForm")
        {
        }

        protected CensusFixedNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}