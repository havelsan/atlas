...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public SubStoreConsumptionNewForm() : base("SUBSTORECONSUMPTIONACTION", "SubStoreConsumptionNewForm")
        {
        }

        protected SubStoreConsumptionNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}