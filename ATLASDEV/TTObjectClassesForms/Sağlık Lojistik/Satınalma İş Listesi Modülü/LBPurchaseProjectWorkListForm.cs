...
#region LBPurchaseProjectWorkListForm_Methods
        public override IList ExecuteNQL(TTObjectContext context, DateTime dtStart, DateTime dtEnd, string sExpression)
        {
            return LBPurchaseProject.WorkListNQL(context, dtStart, dtEnd, sExpression);
        }
        ...
        public override void OnSave()
        {
            ...
            {
                //ID
                this.SaveCriteria("PURCHASEPROJECTNO", "System.Int64", this.txtProjectNo.Text);
...
#endregion LBPurchaseProjectWorkListForm_Methods
    }
}