...
#region AnnualRequirementWorkListForm_Methods
        public override IList ExecuteNQL(TTObjectContext context, DateTime dtStart, DateTime dtEnd, string sExpression)
        {
            return AnnualRequirement.WorkListNQL(context, dtStart, dtEnd, sExpression);
        }
...
#endregion AnnualRequirementWorkListForm_Methods
    }
}