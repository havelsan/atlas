...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class DepReturningDocumentReport : TTReport
    {
        ...
        {
            public DepReturningDocumentReport MyParentReport
            {
                get { return (DepReturningDocumentReport)ParentReport; }
            }
...
#region MAIN BODY_Script
                    if (MyParentReport.RuntimeParameters.TTOBJECTID.HasValue)
            {
                ReturnDepStoreMaterial returnDepStoreMaterial = (ReturnDepStoreMaterial)MyParentReport.ReportObjectContext.GetObject(new Guid(STOCKACTIONDETAILOBJECTID.CalcValue), typeof(ReturnDepStoreMaterial));
                AMOUNT.CalcValue = returnDepStoreMaterial.Amount.ToString();
                //  if (stockAction is DistributionDocument)
                //{
        ...
        public DepReturningDocumentReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DEPRETURNINGDOCUMENTREPORT";
