...
{
    public partial class StockMergeCensusFixedReport : TTReport
    {
        ...
        {
            public StockMergeCensusFixedReport MyParentReport
            {
                get { return (StockMergeCensusFixedReport)ParentReport; }
            }
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 16, 201, 25, false);
                    ...
                    NewField15111231 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 25, 71, 34, false);
                    ...
                    TASINIRMALSAYMANLIGI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 71, 25, 201, 34, false);
...
S. Nu.";
                    ...
                    NewField111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 18, 0, 39, 18, false);
                    ...
                    NewField1111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 39, 0, 96, 18, false);
...
Tutarı";
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewLine1112 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 39, 6, 39, 27, false);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<StockMerge.StockMergeReportForReportQuery_Class>("StockMergeReportForReportQuery", StockMerge.StockMergeReportForReportQuery((Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    CENSUSAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 119, 0, 131, 5, false);
                    ...
                    CARDAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 107, 0, 119, 5, false);
                    ...
                    DISTRIBUTIONTYPE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 96, 0, 107, 5, false);
                    ...
                    ORDERSEQUENCENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 0, 18, 5, false);
                    ...
                    NATOSTOCKNOANDNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 18, 0, 39, 5, false);
                    ...
                    FAZLAMIKTAR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 131, 0, 143, 5, false);
                    ...
                    EKSIKMIKTAR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 143, 0, 155, 5, false);
                    ...
                    BIRININTUTARI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 155, 0, 171, 5, false);
                    BIRININTUTARI.Name = "BIRININTUTARI";
                    BIRININTUTARI.DrawStyle = DrawStyleConstants.vbSolid;
                    BIRININTUTARI.TextFormat = @"#,##0.0000";
                    ...
                    FAZLANINTUTARI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 171, 0, 186, 5, false);
                    ...
                    EKSIGININTUTARI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 186, 0, 201, 5, false);
                    ...
                    MATERIALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 39, 0, 96, 5, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    StockMerge.StockMergeReportForReportQuery_Class dataset_StockMergeReportForReportQuery = ParentGroup.rsGroup.GetCurrentRecord<StockMerge.StockMergeReportForReportQuery_Class>(0);
                    CENSUSAMOUNT.CalcValue = (dataset_StockMergeReportForReportQuery != null ? Globals.ToStringCore(dataset_StockMergeReportForReportQuery.Censusamount) : "");
                    CARDAMOUNT.CalcValue = (dataset_StockMergeReportForReportQuery != null ? Globals.ToStringCore(dataset_StockMergeReportForReportQuery.Cardamount) : "");
                    DISTRIBUTIONTYPE.CalcValue = (dataset_StockMergeReportForReportQuery != null ? Globals.ToStringCore(dataset_StockMergeReportForReportQuery.DistributionType) : "");
                    ORDERSEQUENCENUMBER.CalcValue = ParentGroup.Counter.ToString();
                    NATOSTOCKNO.CalcValue = (dataset_StockMergeReportForReportQuery != null ? Globals.ToStringCore(dataset_StockMergeReportForReportQuery.NATOStockNO) : "");
                    NATOSTOCKNOANDNAME.CalcValue = MyParentReport.MAIN.NATOSTOCKNO.CalcValue;
                    STOCKACTIONDETAILOBJECTID.CalcValue = (dataset_StockMergeReportForReportQuery != null ? Globals.ToStringCore(dataset_StockMergeReportForReportQuery.Stockactiondetailobjectid) : "");
                    NAME.CalcValue = (dataset_StockMergeReportForReportQuery != null ? Globals.ToStringCore(dataset_StockMergeReportForReportQuery.Name) : "");
                    AMOUNT.CalcValue = (dataset_StockMergeReportForReportQuery != null ? Globals.ToStringCore(dataset_StockMergeReportForReportQuery.Amount) : "");
                    UNITPRICE.CalcValue = (dataset_StockMergeReportForReportQuery != null ? Globals.ToStringCore(dataset_StockMergeReportForReportQuery.Unitprice) : "");
                    ...
                    ISLEMTIPI.CalcValue = (dataset_StockMergeReportForReportQuery != null ? Globals.ToStringCore(dataset_StockMergeReportForReportQuery.Islemtipi) : "");
...
#region MAIN BODY_Script
            ...
            if (ISLEMTIPI.CalcValue.Equals("EKSILTILEN"))
            {
                ...
                {
                    StockMergeMaterialOut stockMergeMaterialOut = MyParentReport.ReportObjectContext.GetObject(new Guid(STOCKACTIONDETAILOBJECTID.CalcValue), typeof(StockMergeMaterialOut)) as StockMergeMaterialOut;
                    if (stockMergeMaterialOut != null)
                    {
                        BIRININTUTARI.CalcValue = stockMergeMaterialOut.OutableStockTransaction.UnitPrice.ToString();
                        if (string.IsNullOrEmpty(AMOUNT.CalcValue) == false && string.IsNullOrEmpty(BIRININTUTARI.CalcValue) == false)
                            EKSIGININTUTARI.CalcValue = Convert.ToString(Convert.ToDouble(AMOUNT.CalcValue) * Convert.ToDouble(BIRININTUTARI.CalcValue));
                    }
                }
        ...
        public StockMergeCensusFixedReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "STOCKMERGECENSUSFIXEDREPORT";
