...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (Tüm Sayım Düzeltme Belgeleri Dökümleri(Çıkış))
    /// </summary>
    public partial class Census_AllCensusFixesOuts : TTReport
    {
        ...
        {
            public Census_AllCensusFixesOuts MyParentReport
            {
                get { return (Census_AllCensusFixesOuts)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME.Value = @"TÜM SAYIM DÜZELTME BELGELERİ DÖKÜM ÇİZELGESİ (ÇIKIŞ)";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_AllCensusFixesOuts)ParentReport).RuntimeParameters.TERMID.ToString();
...
#region MAIN BODY_Script
        ...
        public Census_AllCensusFixesOuts()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_ALLCENSUSFIXESOUTS";
            Caption = "Stok Devir Belge Dökümleri (Tüm Sayım Düzeltme Belgeleri Dökümleri(Çıkış))";
