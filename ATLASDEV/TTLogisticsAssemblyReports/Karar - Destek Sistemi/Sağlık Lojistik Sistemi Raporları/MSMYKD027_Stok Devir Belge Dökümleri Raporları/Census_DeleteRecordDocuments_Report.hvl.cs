...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (TMİB Ayıklama Tutanağı Döküm Çizelgesi EK-129F)
    /// </summary>
    public partial class Census_DeleteRecordDocuments : TTReport
    {
        ...
        {
            public Census_DeleteRecordDocuments MyParentReport
            {
                get { return (Census_DeleteRecordDocuments)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 12, 186, 30, false);
                    ...
                    REPORTNAME.Value = @"TMİB AYIKLAMA TUTANAĞI DÖKÜM ÇİZELGESİ";

                    AdditionNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 161, 1, 186, 6, false);
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 161, 6, 186, 11, false);
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 1, 1, 185, 6, false);
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField12221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 159, 0, 176, 10, false);
                    ...
                    NewField13221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 159, 10, false);
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 176, 0, 186, 10, false);
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    TOTAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 7, 186, 12, false);
                    TOTAL.Name = "TOTAL";
                    ...
                    TEFTIS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 13, 186, 25, false);
                    TEFTIS.Name = "TEFTIS";
                    ...
                    COUNTTEXT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 1, 186, 6, false);
                    ...
                    SIGNS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 29, 186, 49, false);
                    SIGNS.Name = "SIGNS";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_DeleteRecordDocuments)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet TMİB Ayıklama Tutanağının 4'üncü nüshaları "
...
#region PARTB_Methods
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<DeleteRecordDocumentDestroyable.CensusReportNQL_DeleteRecordDocument_Class>("CensusReportNQL_DeleteRecordDocument", DeleteRecordDocumentDestroyable.CensusReportNQL_DeleteRecordDocument((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TERMID)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 159, 0, 176, 5, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    MATERIALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 159, 5, false);
                    ...
                    EXTRA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 176, 0, 186, 5, false);
                    EXTRA.Name = "EXTRA";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DeleteRecordDocumentDestroyable.CensusReportNQL_DeleteRecordDocument_Class dataset_CensusReportNQL_DeleteRecordDocument = ParentGroup.rsGroup.GetCurrentRecord<DeleteRecordDocumentDestroyable.CensusReportNQL_DeleteRecordDocument_Class>(0);
                    ObjectID.CalcValue = (dataset_CensusReportNQL_DeleteRecordDocument != null ? Globals.ToStringCore(dataset_CensusReportNQL_DeleteRecordDocument.ObjectID) : "");
...
#region MAIN BODY_Script
                    TTObjectContext ctx = new TTObjectContext(true);
            DeleteRecordDocumentDestroyable cd = (DeleteRecordDocumentDestroyable)ctx.GetObject(new Guid(ObjectID.CalcValue), typeof(DeleteRecordDocumentDestroyable).Name);
            if(cd.DeleteRecordDocumentDestroyableOutMaterials.Count > 0)
            {
                if(cd.DeleteRecordDocumentDestroyableOutMaterials[0].Material.StockCard == null)
                    return;
                PARTBGroup.totalAmount = cd.DeleteRecordDocumentDestroyableOutMaterials.Count + PARTBGroup.totalAmount;
                AMOUNT.CalcValue = cd.DeleteRecordDocumentDestroyableOutMaterials.Count.ToString() + " ";
                MATERIALNAME.CalcValue = " " + cd.DeleteRecordDocumentDestroyableOutMaterials[0].Material.StockCard.NATOStockNO + " | " + cd.DeleteRecordDocumentDestroyableOutMaterials[0].Amount + " " + cd.DeleteRecordDocumentDestroyableOutMaterials[0].Material.StockCard.DistributionType.QRef + " | " + cd.DeleteRecordDocumentDestroyableOutMaterials[0].Material.StockCard.Name;
        ...
        public Census_DeleteRecordDocuments()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_DELETERECORDDOCUMENTS";
            Caption = "Stok Devir Belge Dökümleri (TMİB Ayıklama Tutanağı Döküm Çizelgesi EK-129F)";
