...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (TMİB Sayım Düzeltme Döküm Çizelgesi EK-129E)
    /// </summary>
    public partial class Census_CensusFixes : TTReport
    {
        ...
        {
            public Census_CensusFixes MyParentReport
            {
                get { return (Census_CensusFixes)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME.Value = @"TMİB SAYIM DÜZELTME DÖKÜM ÇİZELGESİ";
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    TEFTIS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), -1, 3, 192, 15, false);
                    TEFTIS.Name = "TEFTIS";
                    ...
                    SIGNS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 17, 192, 34, false);
                    SIGNS.Name = "SIGNS";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_CensusFixes)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet TMİB Sayım Düzeltmenin 4'üncü nüshaları "
...
#region MAIN BODY_Script
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_CENSUSFIXES";
            Caption = "Stok Devir Belge Dökümleri (TMİB Sayım Düzeltme Döküm Çizelgesi EK-129E)";
