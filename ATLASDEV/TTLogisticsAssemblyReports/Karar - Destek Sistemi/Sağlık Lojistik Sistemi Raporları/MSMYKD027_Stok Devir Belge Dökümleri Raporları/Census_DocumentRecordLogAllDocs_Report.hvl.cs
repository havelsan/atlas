...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (Tüm Belgeler Döküm)
    /// </summary>
    public partial class Census_DocumentRecordLogAllDocs : TTReport
    {
        ...
        {
            public Census_DocumentRecordLogAllDocs MyParentReport
            {
                get { return (Census_DocumentRecordLogAllDocs)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 7, 192, 25, false);
                    ...
                    REPORTNAME.Value = @"TÜM BELGELER DÖKÜM ÇİZELGESİ";
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 167, 2, 192, 7, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { REPORTNAME,AccountingTerm,AccountYear,ENDDATE};
                }
            }
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 1, 1, 192, 6, false);
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField12221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 0, 182, 10, false);
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SIGNS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 29, 192, 38, false);
                    SIGNS.Name = "SIGNS";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_DocumentRecordLogAllDocs)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet Tüm Belgelerin 4'üncü nüshaları "
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 0, 182, 5, false);
                    AMOUNT.Name = "AMOUNT";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    ObjectID.CalcValue = (dataset_CensusReportNQL_DocumentRecLog != null ? Globals.ToStringCore(dataset_CensusReportNQL_DocumentRecLog.Stockactionobjectid) : "");
...
#region MAIN BODY_Script
            ...
            if(dr.DocumentTransactionType == 0)
            {
                ...
                MATERIALNAME.CalcValue = " " + cd.StockActionInDetails[0].Material.StockCard.NATOStockNO + " | " + cd.StockActionInDetails[0].Amount + " " + cd.StockActionInDetails[0].Material.StockCard.DistributionType.QRef + " | " + cd.StockActionInDetails[0].Material.StockCard.Name;
            ...
            else
            {
                ...
                MATERIALNAME.CalcValue = " " + cd.StockActionOutDetails[0].Material.StockCard.NATOStockNO + " | " + cd.StockActionOutDetails[0].Amount + " " + cd.StockActionOutDetails[0].Material.StockCard.DistributionType.QRef + " | " + cd.StockActionOutDetails[0].Material.StockCard.Name;
        ...
        public Census_DocumentRecordLogAllDocs()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_DOCUMENTRECORDLOGALLDOCS";
            Caption = "Stok Devir Belge Dökümleri (Tüm Belgeler Döküm)";
