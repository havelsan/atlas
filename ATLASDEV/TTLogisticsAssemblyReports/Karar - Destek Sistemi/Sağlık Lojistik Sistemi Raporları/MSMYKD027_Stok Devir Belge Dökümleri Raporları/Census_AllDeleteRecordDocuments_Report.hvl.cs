...
{
    /// <summary>
    /// Stok Devir Belge Dökümleri (Tüm Kayıt Silme Belgeleri Döküm Çizelgesi EK-129D)
    /// </summary>
    public partial class Census_AllDeleteRecordDocuments : TTReport
    {
        ...
        {
            public Census_AllDeleteRecordDocuments MyParentReport
            {
                get { return (Census_AllDeleteRecordDocuments)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 10, 190, 28, false);
                    ...
                    REPORTNAME.Value = @"TÜM KAYIT SİLME BELGELERİ DÖKÜM ÇİZELGESİ";

                    AdditionNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 0, 190, 5, false);
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 5, 190, 10, false);
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 1, 1, 190, 6, false);
                    ...
                    PAGENUMBER.Value = @"129D-{@pagenumber@}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    PAGENUMBER.CalcValue = @"129D-" + ParentReport.CurrentPageNumber.ToString();
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField12221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 162, 0, 179, 10, false);
                    ...
                    NewField13221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 162, 10, false);
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 179, 0, 190, 10, false);
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    TOTAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 7, 190, 12, false);
                    TOTAL.Name = "TOTAL";
                    ...
                    TEFTIS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), -1, 13, 190, 25, false);
                    TEFTIS.Name = "TEFTIS";
                    ...
                    COUNTTEXT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 1, 190, 6, false);
                    ...
                    SIGNS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 29, 190, 49, false);
                    SIGNS.Name = "SIGNS";
...
#region PARTB FOOTER_Script
            ...
            string termID = ((Census_AllDeleteRecordDocuments)ParentReport).RuntimeParameters.TERMID.ToString();
            TTObjectContext ctx = new TTObjectContext(true);
            AccountingTerm term = (AccountingTerm)ctx.GetObject(new Guid(termID), typeof(AccountingTerm));
            if(term.EndDate != null)
            {
                TEFTIS.CalcValue = "Yukarıda cinsi belirtilen toplam " + SUBGROUPCOUNT.FormattedValue + " adet Tüm Kayıt Silme Belgelerinin 4'üncü nüshaları "
...
#region PARTB_Methods
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<DocumentRecordLog.CensusReportNQL_DocumentRecLogAllDeleteRecords_Class>("CensusReportNQL_DocumentRecLogAllDeleteRecords", DocumentRecordLog.CensusReportNQL_DocumentRecLogAllDeleteRecords((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TERMID)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 162, 0, 179, 5, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    MATERIALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 162, 5, false);
                    ...
                    EXTRA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 179, 0, 190, 5, false);
                    EXTRA.Name = "EXTRA";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DocumentRecordLog.CensusReportNQL_DocumentRecLogAllDeleteRecords_Class dataset_CensusReportNQL_DocumentRecLogAllDeleteRecords = ParentGroup.rsGroup.GetCurrentRecord<DocumentRecordLog.CensusReportNQL_DocumentRecLogAllDeleteRecords_Class>(0);
                    ObjectID.CalcValue = (dataset_CensusReportNQL_DocumentRecLogAllDeleteRecords != null ? Globals.ToStringCore(dataset_CensusReportNQL_DocumentRecLogAllDeleteRecords.ObjectID) : "");
...
#region MAIN BODY_Script
        ...
        public Census_AllDeleteRecordDocuments()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CENSUS_ALLDELETERECORDDOCUMENTS";
            Caption = "Stok Devir Belge Dökümleri (Tüm Kayıt Silme Belgeleri Döküm Çizelgesi EK-129D)";
