...
namespace TTFormClasses
{
    ...
    public partial class PA_ExpertNonComForm : PatientAdmissionForm
    {
        ...
        {
#region PA_ExpertNonComForm_MilitaryUnit_SelectedObjectChanged
   if(this.SenderChair.SelectedObject == null)
                this.SenderChair.SelectedObject = this.MilitaryUnit.SelectedObject;
#endregion PA_ExpertNonComForm_MilitaryUnit_SelectedObjectChanged
        }

        protected override void PreScript()
        {
#region PA_ExpertNonComForm_PreScript
    base.PreScript();
#endregion PA_ExpertNonComForm_PreScript
