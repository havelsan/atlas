...
namespace TTFormClasses
{
    ...
    public partial class PA_NoncommissionedOfficerForm : PatientAdmissionForm
    {
        ...
        {
#region PA_NoncommissionedOfficerForm_MilitaryUnit_SelectedObjectChanged
   if(this.SenderChair.SelectedObject == null)
                this.SenderChair.SelectedObject = this.MilitaryUnit.SelectedObject;
#endregion PA_NoncommissionedOfficerForm_MilitaryUnit_SelectedObjectChanged
        }

        protected override void PreScript()
        {
#region PA_NoncommissionedOfficerForm_PreScript
    base.PreScript();
#endregion PA_NoncommissionedOfficerForm_PreScript
