...
namespace TTFormClasses
{
    ...
    public partial class PA_RetiredExpertNonComForm : PA_MilitaryRetiredForm
    {
        ...
        {
#region PA_RetiredExpertNonComForm_PreScript
    base.PreScript();
            // Faturalama Yöntemindeki Hasta Grubuna göre Kurumların filtreli gelmesi
            /*
            string payerTypeList = null;
            PatientGroupDefinition pGroup = Common.PatientGroupDefinitionByEnum(this._PA_RetiredExpertNonCom.ObjectContext,this._PA_RetiredExpertNonCom.Episode.PatientGroup.Value);
            ...
            if (payerTypeList != null)
            {
                ...
                */
#endregion PA_RetiredExpertNonComForm_PreScript
