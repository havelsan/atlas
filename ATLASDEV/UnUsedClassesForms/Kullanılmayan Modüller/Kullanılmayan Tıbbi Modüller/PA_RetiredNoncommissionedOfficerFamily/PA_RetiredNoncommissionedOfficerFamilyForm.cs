...
namespace TTFormClasses
{
    ...
    public partial class PA_RetiredNoncommissionedOfficerFamilyForm : PA_MilitaryRetiredFamiliyForm
    {
        ...
        {
#region PA_RetiredNoncommissionedOfficerFamilyForm_PreScript
    base.PreScript();
            // Faturalama Yöntemindeki Hasta Grubuna göre Kurumların filtreli gelmesi
            /*
            string payerTypeList = null;
            PatientGroupDefinition pGroup = Common.PatientGroupDefinitionByEnum(this._PA_RetiredNoncommissionedOfficerFamily.ObjectContext,this._PA_RetiredNoncommissionedOfficerFamily.Episode.PatientGroup.Value);
            ...
            if (payerTypeList != null)
            {
                ...
                */
#endregion PA_RetiredNoncommissionedOfficerFamilyForm_PreScript
