...
namespace TTFormClasses
{
    ...
    public partial class PA_RetiredNoncommissionedOfficerForm : PA_MilitaryRetiredForm
    {
        ...
        {
#region PA_RetiredNoncommissionedOfficerForm_PreScript
    base.PreScript();
            // Faturalama Yöntemindeki Hasta Grubuna göre Kurumların filtreli gelmesi
            /*
            string payerTypeList = null;
            PatientGroupDefinition pGroup = Common.PatientGroupDefinitionByEnum(this._PA_RetiredNoncommissionedOfficer.ObjectContext,this._PA_RetiredNoncommissionedOfficer.Episode.PatientGroup.Value);
            ...
            if (payerTypeList != null)
            {
                ...
                */
#endregion PA_RetiredNoncommissionedOfficerForm_PreScript
