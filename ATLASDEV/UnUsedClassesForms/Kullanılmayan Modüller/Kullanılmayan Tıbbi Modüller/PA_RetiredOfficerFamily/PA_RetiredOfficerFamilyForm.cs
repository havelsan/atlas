...
namespace TTFormClasses
{
    ...
    public partial class PA_RetiredOfficerFamilyForm : PA_MilitaryRetiredFamiliyForm
    {
        ...
        {
#region PA_RetiredOfficerFamilyForm_PreScript
    base.PreScript();
            // Faturalama Yöntemindeki Hasta Grubuna göre Kurumların filtreli gelmesi
            /*
            string payerTypeList = null;
            PatientGroupDefinition pGroup = Common.PatientGroupDefinitionByEnum(this._PA_RetiredOfficerFamily.ObjectContext,this._PA_RetiredOfficerFamily.Episode.PatientGroup.Value);
            ...
            if (payerTypeList != null)
            {
                ...
                */
#endregion PA_RetiredOfficerFamilyForm_PreScript
