...
{
    public class NeTabPanel
    {
        private readonly ViewContext _viewContext;
        public NeTabPanel(IHtmlHelper htmlHelper, string name, string width, string height, string dataSource, string disabled = null, string visible = null, int tabIndex = 0)
        {
            TagBuilder builder = new TagBuilder("dx-tab-panel");
