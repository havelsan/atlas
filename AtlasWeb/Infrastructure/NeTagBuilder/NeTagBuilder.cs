...
namespace Infrastructure.NeTagBuilder
{
    public class NeTagBuilder
    {
        private static class Html401IdUtil
        {
            ...
            {
                return NeTagBuilder.Html401IdUtil.IsLetter(c) || NeTagBuilder.Html401IdUtil.IsDigit(c) || NeTagBuilder.Html401IdUtil.IsAllowableSpecialCharacter(c);
            }
        }
        ...
        public string IdAttributeDotReplacement
        {
            get
            {
                ...
                {
                    this._idAttributeDotReplacement = "_";
                }
        ...
        public NeTagBuilder(string tagName)
        {
        ...
        {
            return NeTagBuilder.CreateSanitizedId(originalId, "_");
        }
        ...
        public static string CreateSanitizedId(string originalId, string invalidCharReplacement)
        {
            ...
            char c = originalId[0];
            if (!NeTagBuilder.Html401IdUtil.IsLetter(c))
            {
                return null;
            }
            ...
            for (int i = 1; i < originalId.Length; i++)
            {
                ...
                if (NeTagBuilder.Html401IdUtil.IsValidIdCharacter(c2))
                {
        ...
        public void GenerateId(string name)
        {
            ...
            {
                string value = NeTagBuilder.CreateSanitizedId(name, this.IdAttributeDotReplacement);
        ...
        private void AppendAttributes(StringBuilder sb)
        {
            foreach (KeyValuePair<string, string> current in this.Attributes)
            {
                ...
                {
                    string value = WebUtility.HtmlEncode(current.Value);
        ...
        {
            this.InnerHtml = WebUtility.HtmlEncode(innerText);
        }
