...
import { GetEpisodeDocuments_Input, DeleteDocument_Input } from './PatientDocumentDownloadForm';
...
@Component({
    selector: 'PatientDocumentUploadForm',
    templateUrl: './PatientDocumentUploadForm.html',
    providers: [MessageService]
})
export class PatientDocumentUploadForm implements OnInit, OnDestroy, IModal {
    ...
    Upload() {
        ...
        for (let doc of this.docs) {
            if (doc.IsNew) {
                ...
                formData.append('EpisodeID', this.getEpisodeObjectId(this.document.Episode));
    ...
    addDocument() {
        if (this.newDocType !== undefined && this.newDocType.IsNew !== undefined && this.Description !== undefined && this.Description !== "" && this.document.FileName !== undefined) {
        ...
        else if (this.newDocType == null || this.newDocType.IsNew !== false)
