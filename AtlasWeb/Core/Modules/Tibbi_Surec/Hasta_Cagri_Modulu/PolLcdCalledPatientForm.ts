...
@Component({
    selector: 'PolLcdCalledPatientForm',
    templateUrl: './PolLcdCalledPatientForm.html',
    providers: [MessageService]
})
export class PolLcdCalledPatientForm {
    public IDS;
    public DrName;
    public DrObjectID;
    ...
    updateScreen() {
        ...
        this.currentItem.LcdNotification = this._Model.LcdNotification;
    ...
    public async LoadData() {
        return this.httpService.get("/api/PoliclinicLcdForm/GetPolLcdOnlyCalledPatient?outPatientResID=" + this.IDS + "&DrName=" + this.DrName + "&DrObjectID=" + this.DrObjectID).toPromise().then(response => {
