...
{
    [HttpGet]
    public PhysiotherapyOrderPlannedFormViewModel PhysiotherapyOrderPlannedForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return PhysiotherapyOrderPlannedFormLoadInternal(input);
    }

    [HttpPost]
    public PhysiotherapyOrderPlannedFormViewModel PhysiotherapyOrderPlannedFormLoad(FormLoadInput input)
    {
        return PhysiotherapyOrderPlannedFormLoadInternal(input);
    }

    private PhysiotherapyOrderPlannedFormViewModel PhysiotherapyOrderPlannedFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("255f156b-8525-4e84-974a-a31b913408b4");
    ...
    [HttpPost]
    public BaseViewModel PhysiotherapyOrderPlannedForm(PhysiotherapyOrderPlannedFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            AfterContextSaveScript_PhysiotherapyOrderPlannedForm(viewModel, physiotherapyOrder, transDef, objectContext);
    ...
    partial void AfterContextSaveScript_PhysiotherapyOrderPlannedForm(PhysiotherapyOrderPlannedFormViewModel viewModel, PhysiotherapyOrder physiotherapyOrder, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(PhysiotherapyOrderPlannedFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class PhysiotherapyOrderPlannedFormViewModel : BaseViewModel
    {
