...
{
    [HttpGet]
    public PhysiotherapyPlanningFormViewModel PhysiotherapyPlanningForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return PhysiotherapyPlanningFormLoadInternal(input);
    }

    [HttpPost]
    public PhysiotherapyPlanningFormViewModel PhysiotherapyPlanningFormLoad(FormLoadInput input)
    {
        return PhysiotherapyPlanningFormLoadInternal(input);
    }

    private PhysiotherapyPlanningFormViewModel PhysiotherapyPlanningFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        ...
        var viewModel = new PhysiotherapyPlanningFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_PhysiotherapyPlanningForm(viewModel, viewModel._PhysiotherapyRequest, objectContext);
    ...
    [HttpPost]
    public BaseViewModel PhysiotherapyPlanningForm(PhysiotherapyPlanningFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_PhysiotherapyPlanningForm(viewModel, physiotherapyRequest, transDef, objectContext);
            ...
            AfterContextSaveScript_PhysiotherapyPlanningForm(viewModel, physiotherapyRequest, transDef, objectContext);
    ...
    partial void AfterContextSaveScript_PhysiotherapyPlanningForm(PhysiotherapyPlanningFormViewModel viewModel, PhysiotherapyRequest physiotherapyRequest, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(PhysiotherapyPlanningFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class PhysiotherapyPlanningFormViewModel : BaseViewModel
    {
