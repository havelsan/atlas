...
{
    [HttpGet]
    public PhysiotherapyRequestPlanningFormViewModel PhysiotherapyRequestPlanningForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return PhysiotherapyRequestPlanningFormLoadInternal(input);
    }

    [HttpPost]
    public PhysiotherapyRequestPlanningFormViewModel PhysiotherapyRequestPlanningFormLoad(FormLoadInput input)
    {
        return PhysiotherapyRequestPlanningFormLoadInternal(input);
    }

    private PhysiotherapyRequestPlanningFormViewModel PhysiotherapyRequestPlanningFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("2099345a-74d6-4d03-917c-d355e7697a9d");
        var objectDefID = Guid.Parse("43225fba-1931-42a1-b745-23599ea82b65");
        var viewModel = new PhysiotherapyRequestPlanningFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_PhysiotherapyRequestPlanningForm(viewModel, viewModel._PhysiotherapyRequest, objectContext);
    ...
    [HttpPost]
    public BaseViewModel PhysiotherapyRequestPlanningForm(PhysiotherapyRequestPlanningFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_PhysiotherapyRequestPlanningForm(viewModel, physiotherapyRequest, transDef, objectContext);
            ...
            AfterContextSaveScript_PhysiotherapyRequestPlanningForm(viewModel, physiotherapyRequest, transDef, objectContext);
    ...
    partial void AfterContextSaveScript_PhysiotherapyRequestPlanningForm(PhysiotherapyRequestPlanningFormViewModel viewModel, PhysiotherapyRequest physiotherapyRequest, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(PhysiotherapyRequestPlanningFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class PhysiotherapyRequestPlanningFormViewModel : BaseViewModel
    {
