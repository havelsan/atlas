...
export class PhysiotherapyPlannedOrdersFormViewModel extends BaseViewModel {
    ...
    // NOT: Burasi sunucudan gelmeyecek üstteki ViewModel'den geliyor
    @Exclude()
    ...
    public IsSGKPatient: boolean; //Ücretli hasta mı?

    public IsMedulaNotWorking: boolean; //Medulasız Rapor Sorgulamak için! true ise medula çalışmıyor
}
