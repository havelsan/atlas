...
namespace Core.Controllers
{
    ...
    {
        partial void PreScript_PhysiotherapyOrderPlannedForm(PhysiotherapyOrderPlannedFormViewModel viewModel, PhysiotherapyOrder physiotherapyOrder, TTObjectContext objectContext)
        {
        ...
        partial void PostScript_PhysiotherapyOrderPlannedForm(PhysiotherapyOrderPlannedFormViewModel viewModel, PhysiotherapyOrder physiotherapyOrder, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext)
        {
            ...
            if (viewModel.ProcedureObjectList.Length > 0)
            {
                    ...
                    physiotherapyOrder.PhysiotherapyOrderDetails.Where(c => c.CurrentStateDefID == PhysiotherapyOrderDetail.States.Aborted || c.CurrentStateDefID == PhysiotherapyOrderDetail.States.Completed).Count() == 0)
                {
                    ...
                    calculateSessions(physiotherapyOrder.PhysiotherapyRequest, objectContext);
                }
                else
                {
            ...
            Max5DaysControlBySession(physiotherapyOrder.PhysiotherapyRequest);//iki seans aras� max 5 g�n olabilir kontrol� ve yatan ayaktan i�in planm-lama yap�lacak v�cut b�lgesi-grup konrol�
        }
        ...
        public PhysiotherapyOrderPlannedFormViewModel GetMedulaReportInfo(ReportTypeWithEpisodeId reportTypeWithEpisodeId)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PhysiotherapyOrderPlannedFormViewModel viewModel = new PhysiotherapyOrderPlannedFormViewModel();
                viewModel.Message = "";
        ...
        [HttpPost]
        [AtlasRequiredRoles(TTRoleNames.Fizyoterapi_Rapor_Sorgulama)]
        public PhysiotherapyOrderPlannedFormViewModel GetInstitutionMedulaReportInfo(ReportTypeWithEpisodeId reportTypeWithEpisodeId)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                TreatmentQueryReportTypeEnum treatmentType = reportTypeWithEpisodeId.treatmentType;
        ...
        [HttpPost]
        [AtlasRequiredRoles(TTRoleNames.Fizyoterapi_Rapor_Sorgulama)]
        public PhysiotherapyOrderPlannedFormViewModel GetInstitutionReportInfo(ReportTypeWithEpisodeId reportTypeWithEpisodeId)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                TreatmentQueryReportTypeEnum treatmentType = reportTypeWithEpisodeId.treatmentType;
        ...
        public void CalculateOrderDetails(PhysiotherapyOrderPlannedFormViewModel viewModel, PhysiotherapyOrder physiotherapyOrder, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext)
        {
            ...
            if (viewModel._PhysiotherapyOrder.PhysiotherapyStartDate != null)
            {
                ...
                //Seans bilgisi olu�turuluyor // calculateSessions fonksiyonu kullan�laca�� i�in kapat�ld�
                //foreach (var orderDetailItem in physiotherapyOrder.PhysiotherapyOrderDetails)
                //{
                //    var sessionObject = physiotherapyOrder.PhysiotherapyRequest.PhysiotherapySessions.Where(c => c.PlannedDate.Value.Date == orderDetailItem.PlannedDate.Value.Date);
                //    if (sessionObject.Count() == 0)//e�er o tarihteki i�leme ait bir seans yoksa yenisi olu�turulur 
                //    {
                //        PhysiotherapySessionInfo _sessionInfo = new PhysiotherapySessionInfo(objectContext);
                //        _sessionInfo.PlannedDate = orderDetailItem.PlannedDate;
                //        _sessionInfo.PhysiotherapyRequest = orderDetailItem.PhysiotherapyRequest;
                //        orderDetailItem.PhysiotherapySession = _sessionInfo;
                //    }
                //    else//e�er o tarihteki i�leme ait bir seans varsa set edilir
                //    {
                //        orderDetailItem.PhysiotherapySession = sessionObject.FirstOrDefault();
                //    }
                //}
            }
        }

        public void calculateSessions(PhysiotherapyRequest request, TTObjectContext objectContext)
        {
        ...
        public static PhysiotherapyOrderPlannedFormViewModel GetPhysiotherapyOrderPlannedFormViewModel(PhysiotherapyOrder order)
        {
            PhysiotherapyOrderServiceController physiotherapyOrderServiceController = new PhysiotherapyOrderServiceController();
            PhysiotherapyOrderPlannedFormViewModel physiotherapyOrderPlannedFormViewModel = new PhysiotherapyOrderPlannedFormViewModel();
            physiotherapyOrderPlannedFormViewModel = physiotherapyOrderServiceController.PhysiotherapyOrderPlannedForm(order.ObjectID);
            return physiotherapyOrderPlannedFormViewModel;
        }


        public PhysiotherapyOrderPlannedFormViewModel GetPhysiotherapyOrderPlannedFormViewModelById(OrderInfo orderInfo)
        {
            PhysiotherapyOrderServiceController physiotherapyOrderServiceController = new PhysiotherapyOrderServiceController();
            PhysiotherapyOrderPlannedFormViewModel physiotherapyOrderPlannedFormViewModel = new PhysiotherapyOrderPlannedFormViewModel();
            physiotherapyOrderPlannedFormViewModel = physiotherapyOrderServiceController.PhysiotherapyOrderPlannedForm(orderInfo.OrderObjectId);
            return physiotherapyOrderPlannedFormViewModel;
        }

        public static void SavePhysiotherapyOrderPlannedFormViewModelObject(TTObjectContext objectContext, PhysiotherapyOrderPlannedFormViewModel viewModel)
        {
            PhysiotherapyOrderServiceController physiotherapyOrderServiceController = new PhysiotherapyOrderServiceController();
            physiotherapyOrderServiceController.SavePhysiotherapyOrderPlannedFormViewModel(objectContext, viewModel);
        }

        public void SavePhysiotherapyOrderPlannedFormViewModel(TTObjectContext objectContext, PhysiotherapyOrderPlannedFormViewModel viewModel)
        {
            ...
            PostScript_PhysiotherapyOrderPlannedForm(viewModel, physiotherapyOrder, transDef, objectContext);
        ...
        public PhysiotherapyOrderPlannedFormViewModel GetNewPhysiotherapyOrderPlannedFormViewModel(PhysiotherapyRequest physiotherapyRequest)
        {
            var formDefID = Guid.Parse("87df6e56-4417-4e38-a6fd-66ee06820ccc");
            var objectDefID = Guid.Parse("ee1a78c9-9c9d-4fb5-9a00-e719b53ca848");
            var viewModel = new PhysiotherapyOrderPlannedFormViewModel();
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_PhysiotherapyOrderPlannedForm(viewModel, viewModel._PhysiotherapyOrder, objectContext);
        ...
        public void Max5DaysControlBySession(PhysiotherapyRequest physiotherapyRequest)
        {
            ...
            var packageList = physiotherapyRequest.PhysiotherapyOrders.Where(c => c.CurrentStateDefID != PhysiotherapyOrder.States.Cancelled && c.PackageProcedure != null).GroupBy(x => x.PackageProcedure);
            if (physiotherapyRequest.SubEpisode.StarterEpisodeAction.SubEpisode.PatientStatus.Value == SubEpisodeStatusEnum.Outpatient && packageList.Count() > 1)
            {
                throw new Exception("Ayaktan hasta i�in birden fazla paket hizmeti i�in planlama yap�lamaz !");
            }
            else if (physiotherapyRequest.SubEpisode.StarterEpisodeAction.SubEpisode.PatientStatus.Value != SubEpisodeStatusEnum.Outpatient && packageList.Count() > 2)
            {
            ...
            {
                var dayDifference = ((sessionList[i].PlannedDate.Value.Date) - (sessionList[i - 1].PlannedDate.Value.Date)).TotalDays;//iki tarih aras�ndaki g�n say�s�
                int weekendCount = CountWeekEnds(sessionList[i - 1].PlannedDate.Value.Date, sessionList[i].PlannedDate.Value.Date);//iki tarih aras�ndaki haftasonu say�s�
                ...
                if (dayDifference > 5)
                {
                    ...
                    var holidayCount = holidayList.Where(
                        c => c.Date.Value.Date < sessionList[i].PlannedDate.Value.Date &&
                        c.Date.Value.Date > sessionList[i - 1].PlannedDate.Value.Date &&
...
{
    public partial class PhysiotherapyOrderPlannedFormViewModel
    {
    ...
    public class ReportTypeWithEpisodeId
    {
        public TreatmentQueryReportTypeEnum treatmentType { get; set; }
        public Guid? activeEpisodeObjectID { get; set; }
    }
}
