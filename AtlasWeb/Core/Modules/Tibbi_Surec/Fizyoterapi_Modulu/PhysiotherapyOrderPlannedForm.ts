...
import { PhysiotherapyOrderPlannedFormViewModel, PhysiotherapyOrderComponentInfoViewModel, ReportTypeWithEpisodeId } from './PhysiotherapyOrderPlannedFormViewModel';
import { NeHttpService } from 'Fw/Services/NeHttpService';
import { MessageService } from 'Fw/Services/MessageService';
import * as TTVisual from "NebulaClient/Visual/TTVisualControlInterfaces";
import { PhysiotherapyOrder, PhysiotherapyOrderDetail } from 'NebulaClient/Model/AtlasClientModel';
...
@Component({
    selector: 'PhysiotherapyOrderPlannedForm',
    templateUrl: './PhysiotherapyOrderPlannedForm.html',
    providers: [MessageService]
})
export class PhysiotherapyOrderPlannedForm extends TTVisual.TTForm implements OnInit {
    ...
    //public physiotherapyOrderPlannedFormViewModel: PhysiotherapyOrderPlannedFormViewModel = new PhysiotherapyOrderPlannedFormViewModel();
    public get _PhysiotherapyOrder(): PhysiotherapyOrder {
        return this._TTObject as PhysiotherapyOrder;
    }
    private PhysiotherapyOrderPlannedForm_DocumentUrl: string = '/api/PhysiotherapyOrderService/PhysiotherapyOrderPlannedForm';
    constructor(protected httpService: NeHttpService, protected messageService: MessageService) {
        super('PHYSIOTHERAPYORDER', 'PhysiotherapyOrderPlannedForm');
        this._DocumentServiceUrl = this.PhysiotherapyOrderPlannedForm_DocumentUrl;
        //this.initViewModel();
    ...
    private _physiotherapyPlannedOrdersFormViewModel: PhysiotherapyOrderPlannedFormViewModel;
    @Input() set physiotherapyOrderPlannedFormViewModel(value: PhysiotherapyOrderPlannedFormViewModel) {
        this._physiotherapyPlannedOrdersFormViewModel = value;
        this._ViewModel = this.physiotherapyOrderPlannedFormViewModel;
        this.loadViewModel();
        this.PreScript();
    }
    get physiotherapyOrderPlannedFormViewModel(): PhysiotherapyOrderPlannedFormViewModel {
    ...
    protected async PreScript() {
        super.PreScript();
        if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports != null) {
            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportStartDate != null) {
                this.PhysiotherapyStartDate.Min = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportStartDate;
                this.PhysiotherapyStartDate.Max = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportEndDate;
                let startDate = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportStartDate;
                //this.PhysiotherapyStartDate.Max = startDate.AddDays(15); //rapor başlangıç tarihinden itibaren 15 gün içinde tedavi planlaması yapılmalı
            }

            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportNo != null) {
                this.reportInfo = "Rapor No: " + this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportNo.toString();
            }

            //-------------------//Kullanıcı, rapor kür sayısına göre limitlenmiş seans oluşturmaya zorlanıyor
            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.SessionLimit != null && this._PhysiotherapyOrder.StartSession != null) {
                this.maxFinishSession = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.SessionLimit + this._PhysiotherapyOrder.StartSession - 1; //Max seans sayısı başlangıç ve bitiş seansları arasındaki fark kadar oluşturulabilir
            } else if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.SessionLimit != null) {
                this.maxFinishSession = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.SessionLimit - 1;
            }
            ...
            //if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports == null || this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportNo == null) {
            //    this.showTreatmentTypePopup = true;//Raporu yok ise rapor seçmeye zorlanıyor
            //}
            if (this.physiotherapyOrderPlannedFormViewModel._physiotherapyRequestDate != null) {
                if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportStartDate != null && this.physiotherapyOrderPlannedFormViewModel._physiotherapyRequestDate > this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportStartDate) {
                    this.PhysiotherapyStartDate.Min = this.physiotherapyOrderPlannedFormViewModel._physiotherapyRequestDate;
                } else if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportStartDate == null) {
                    this.PhysiotherapyStartDate.Min = this.physiotherapyOrderPlannedFormViewModel._physiotherapyRequestDate;
                }
            }
        } else {
        ...
        if (this.physiotherapyOrderPlannedFormViewModel.ReportList != null && this.physiotherapyOrderPlannedFormViewModel.ReportList.length > 0) {
            this.showTreatmentTypePopup = false;
        } else if (this.physiotherapyOrderPlannedFormViewModel.ReportList != null) {/*|| this.physiotherapyOrderPlannedFormViewModel.IsReportExistsAndCalculateDetail != true*/
            this.showTreatmentTypePopup = true;
        }

        if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyOrderDetails != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyOrderDetails.length > 0) {
            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyOrderDetails.filter(c => c.IsAdditionalProcess == true && c.CurrentStateDefID.valueOf() != PhysiotherapyOrderDetail.PhysiotherapyOrderDetailStates.Cancelled.id).length) {
                this.IsAdditionalProcess.Value = true;
                this.physiotherapyOrderPlannedFormViewModel.IsAdditionalProcess = true;
                //this.onIsAdditionalProcessChanged(true);
            } else {
                this.physiotherapyOrderPlannedFormViewModel.IsAdditionalProcess = false;
        ...
        if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeSaturday == true && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnSaturday == false) {
        ...
        if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeSunday == true && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnSunday == false) {
        ...
        if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.StartSession != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.FinishSession != null) {
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.FinishSession = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.FinishSession + this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.StartSession - 1;
        }
        //Başlangıç seansı alanı ekrandan kaldırılarak default 1 set edildi
        this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.StartSession = 1;
    }
    ...
    public static getComponentInfoViewModel(physiotherapyRequest: Guid): PhysiotherapyOrderComponentInfoViewModel {
        ...
        componentInfo.ComponentName = 'PhysiotherapyOrderPlannedForm';
    ...
    async CancelTreatmentType() {
        if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports == null) {
            ...
            if (messageResult === "E") {
                this.showTreatmentTypePopup = false;
                this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IsPaidTreatment = true;
                this.IsPaidTreatment.ForeColor = "#ff0000";

            } else {
                if ((this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports == null || (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportNo == null)) && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IsPaidTreatment == false) {
                    this.physiotherapyOrderPlannedFormViewModel.IsReportExistsAndCalculateDetail = true;
            ...
            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportNo == null) {
                ...
                if (messageResult === "E") {
                    ...
                    if ((this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports == null || (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportNo == null)) && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IsPaidTreatment == false) {
                        this.physiotherapyOrderPlannedFormViewModel.IsReportExistsAndCalculateDetail = false;
                        TTVisual.InfoBox.Alert(i18n("M20836", "Rapor seçilmeyen işlemler ücretli yapılmadığı sürece planlaması yapılamaz!"), MessageIconEnum.ErrorMessage);
                    }
                    this.showTreatmentTypePopup = false;
                }
    ...
    SaveTreatmentType() {
        ...
        if (this.physiotherapyOrderPlannedFormViewModel.ReportItemList == null || this.lastTreatmentType != this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.TreatmentType) {
            //!!! TODO TODO TODO NİDA
            this.lastTreatmentType = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.TreatmentType;
            let _reportTypeWithEpisodeId: ReportTypeWithEpisodeId = new ReportTypeWithEpisodeId();
            _reportTypeWithEpisodeId.treatmentType = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.TreatmentType;
            if (typeof this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.Episode === "string") {
                _reportTypeWithEpisodeId.activeEpisodeObjectID = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.Episode;
            } else {
                _reportTypeWithEpisodeId.activeEpisodeObjectID = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.Episode.ObjectID;
            }

            if (this.physiotherapyOrderPlannedFormViewModel.IsSGKPatient == true && this.physiotherapyOrderPlannedFormViewModel.IsMedulaNotWorking == false) {//SGK hastası ama medula çalışıyor ise

                this.httpService.post<PhysiotherapyOrderPlannedFormViewModel>("api/PhysiotherapyOrderService/GetMedulaReportInfo?reportTypeWithEpisodeId", _reportTypeWithEpisodeId, PhysiotherapyOrderPlannedFormViewModel).then(response => {
                    let result: PhysiotherapyOrderPlannedFormViewModel = <PhysiotherapyOrderPlannedFormViewModel>response;

                    this.physiotherapyOrderPlannedFormViewModel.ReportItemList = result.ReportItemList;
                    this.physiotherapyOrderPlannedFormViewModel.Message = result.Message;

                    this.showTreatmentTypePopup = false;
                    this.showPhysiotherapyReportPopup = true;

                    if (this.physiotherapyOrderPlannedFormViewModel.Message != null && this.physiotherapyOrderPlannedFormViewModel.Message != "") {
                        TTVisual.InfoBox.Alert(this.physiotherapyOrderPlannedFormViewModel.Message);
                    }
            ...
            } else if (this.physiotherapyOrderPlannedFormViewModel.IsSGKPatient == true && this.physiotherapyOrderPlannedFormViewModel.IsMedulaNotWorking == true) {//SGK hastası ama medula çalışmıyor ise

                this.httpService.post<PhysiotherapyOrderPlannedFormViewModel>("api/PhysiotherapyOrderService/GetInstitutionMedulaReportInfo?reportTypeWithEpisodeId", _reportTypeWithEpisodeId, PhysiotherapyOrderPlannedFormViewModel).then(response => {
                    let result: PhysiotherapyOrderPlannedFormViewModel = <PhysiotherapyOrderPlannedFormViewModel>response;
                ...
                this.httpService.post<PhysiotherapyOrderPlannedFormViewModel>("api/PhysiotherapyOrderService/GetInstitutionReportInfo?reportTypeWithEpisodeId", _reportTypeWithEpisodeId, PhysiotherapyOrderPlannedFormViewModel).then(response => {
                    let result: PhysiotherapyOrderPlannedFormViewModel = <PhysiotherapyOrderPlannedFormViewModel>response;
    ...
    async SavePhysiotherapyReportModal() {
        if (this.selectedReportItem != null) {
            ...
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.DiagnosisGroup = this.selectedReportItem.DiagnosisGroup;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.PackageProcedureInfo = this.selectedReportItem.PackageProcedureInfo;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportDate = this.selectedReportItem.ReportDate;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportEndDate = this.selectedReportItem.ReportEndDate;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportInfo = this.selectedReportItem.ReportInfo;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportNo = this.selectedReportItem.ReportNo;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportStartDate = this.selectedReportItem.ReportStartDate;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportTime = this.selectedReportItem.ReportTime;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportType = this.selectedReportItem.ReportType;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.TreatmentProcessType = this.selectedReportItem.TreatmentProcessType;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.TreatmentType = this.selectedReportItem.TreatmentType;
            ...
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PackageProcedure = this.selectedPackageProcedureDefinition;
            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PackageProcedure != null) {
                this.PackageProcedure.ReadOnly = true;
            }

            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.FTRApplicationAreaDef = this.selectedApplicarionArea;
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.SessionLimit = this.selectedReportItem.SessionLimit;
            ...
            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.FTRApplicationAreaDef == null) {
                this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.FTRApplicationAreaDef = this.selectedApplicarionArea;
            }
            ...
            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportEndDate != null) {
                this.PhysiotherapyStartDate.Max = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportEndDate;
                //rapor başlangıç tarihinden itibaren 15 gün içinde tedavi planlaması yapılmalı
                let startDate = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportStartDate;
                //this.PhysiotherapyStartDate.Max = startDate.AddDays(15);
            }
    ...
    protected loadViewModel() {
        let that = this;
        //that.physiotherapyOrderPlannedFormViewModel = this._ViewModel as PhysiotherapyOrderPlannedFormViewModel;
        that._TTObject = this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder;
        //if (this.physiotherapyOrderPlannedFormViewModel == null)
        //    this.physiotherapyOrderPlannedFormViewModel = new PhysiotherapyOrderPlannedFormViewModel();
        if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder == null)
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder = new PhysiotherapyOrder();
        let packageProcedureObjectID = that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder["PackageProcedure"];
        if (packageProcedureObjectID != null && (typeof packageProcedureObjectID === "string")) {
            let packageProcedure = that.physiotherapyOrderPlannedFormViewModel.PackageProcedureDefinitions.find(o => o.ObjectID.toString() === packageProcedureObjectID.toString());
            if (packageProcedure) {
                that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PackageProcedure = packageProcedure;
            }
        }
        let physiotherapyReportsObjectID = that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder["PhysiotherapyReports"];
        if (physiotherapyReportsObjectID != null && (typeof physiotherapyReportsObjectID === "string")) {
            let physiotherapyReports = that.physiotherapyOrderPlannedFormViewModel.PhysiotherapyReportss.find(o => o.ObjectID.toString() === physiotherapyReportsObjectID.toString());
            if (physiotherapyReports) {
                that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports = physiotherapyReports;
            }
            if (physiotherapyReports != null) {
                ...
                if (fTRApplicationAreaDefObjectID != null && (typeof fTRApplicationAreaDefObjectID === "string")) {
                    let fTRApplicationAreaDef = that.physiotherapyOrderPlannedFormViewModel.FTRVucutBolgesis.find(o => o.ObjectID.toString() === fTRApplicationAreaDefObjectID.toString());
        ...
        that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyOrderDetails = that.physiotherapyOrderPlannedFormViewModel.PhysiotherapyOrderDetailsGridList;
        for (let detailItem of that.physiotherapyOrderPlannedFormViewModel.PhysiotherapyOrderDetailsGridList) {
        }
        let procedureDoctorObjectID = that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder["ProcedureDoctor"];
        if (procedureDoctorObjectID != null && (typeof procedureDoctorObjectID === "string")) {
            let procedureDoctor = that.physiotherapyOrderPlannedFormViewModel.ResUsers.find(o => o.ObjectID.toString() === procedureDoctorObjectID.toString());
            if (procedureDoctor) {
                that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.ProcedureDoctor = procedureDoctor;
            }
        }
        let procedureObjectObjectID = that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder["ProcedureObject"];
        if (procedureObjectObjectID != null && (typeof procedureObjectObjectID === "string")) {
            let procedureObject = that.physiotherapyOrderPlannedFormViewModel.PhysiotherapyDefinitions.find(o => o.ObjectID.toString() === procedureObjectObjectID.toString());
            if (procedureObject) {
                that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.ProcedureObject = procedureObject;
            }
        }
        let fTRApplicationAreaDefObjectID = that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder["FTRApplicationAreaDef"];
        if (fTRApplicationAreaDefObjectID != null && (typeof fTRApplicationAreaDefObjectID === "string")) {
            let fTRApplicationAreaDef = that.physiotherapyOrderPlannedFormViewModel.FTRVucutBolgesis.find(o => o.ObjectID.toString() === fTRApplicationAreaDefObjectID.toString());
            if (fTRApplicationAreaDef) {
                that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.FTRApplicationAreaDef = fTRApplicationAreaDef;
            }
        }
        let treatmentDiagnosisUnitObjectID = that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder["TreatmentDiagnosisUnit"];
        if (treatmentDiagnosisUnitObjectID != null && (typeof treatmentDiagnosisUnitObjectID === "string")) {
            let treatmentDiagnosisUnit = that.physiotherapyOrderPlannedFormViewModel.ResTreatmentDiagnosisUnits.find(o => o.ObjectID.toString() === treatmentDiagnosisUnitObjectID.toString());
            if (treatmentDiagnosisUnit) {
                that.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit = treatmentDiagnosisUnit;
            }
        }

        //this.showTreatmentTypePopup = true;
        if (this.physiotherapyOrderPlannedFormViewModel.IsReadOnlyFields == true) {


            ////Son girilen veriler default set ediliyor
            //if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyStartDate != null) {
            //    //this.PhysiotherapyStartDate.ReadOnly = true;
            //}

            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.SeansGunSayisi != null || this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.SeansGunSayisi != 0) {
            ...
            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeSaturday != null) {
                //this.IncludeSaturday.ReadOnly = true;
            }
            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeSunday != null) {
                //this.IncludeSunday.ReadOnly = true;
            }

            if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeFriday != null ||
                this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeMonday != null ||
                this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeThursday != null ||
                this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeTuesday != null ||
                this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeWednesday != null) {
                //this.SeansGunSayisi.ReadOnly = true;
        ...
        if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IsAdditionalTreatment == true) {
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyStartDate = this.physiotherapyOrderPlannedFormViewModel.endDate;
        } else {
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyStartDate = this.physiotherapyOrderPlannedFormViewModel.startDate;
        }
        if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IsPaidTreatment == null) {
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IsPaidTreatment = false;
        }

        if (this.physiotherapyOrderPlannedFormViewModel.IsPaymentObject == true) {
            this.IsPaidTreatment.ReadOnly = true;
        }

        let procedureObjectListTarget = new Array<ProcedureDefinition>();
        if (this.physiotherapyOrderPlannedFormViewModel.ProcedureObjectList != null) {
            const procedureObjectList = this.physiotherapyOrderPlannedFormViewModel.ProcedureObjectList;
            for (const sourceProcedureObj of procedureObjectList) {
                const targetProcedureObj = this.physiotherapyOrderPlannedFormViewModel.ProcedureObjectDataSource.find(p => p.ObjectID.toString() === sourceProcedureObj.ObjectID.toString());
                if (targetProcedureObj) {
                    procedureObjectListTarget.push(targetProcedureObj);
                }
            }

            this.physiotherapyOrderPlannedFormViewModel.ProcedureObjectList = procedureObjectListTarget;
        }
    }
    ...
    public onFinishSessionChanged(event): void {
        ...
        if (this._PhysiotherapyOrder.StartSession != null && this._PhysiotherapyOrder.FinishSession != null) {
            this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.SessionCount = this._PhysiotherapyOrder.FinishSession - this._PhysiotherapyOrder.StartSession + 1;
        }
    }
    ...
    public onFTRApplicationAreaDefChanged(event): void {
        if (event != null) {
            if (this._PhysiotherapyOrder != null && this._PhysiotherapyOrder.FTRApplicationAreaDef != event) {
                ...
                if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportNo == null && this._PhysiotherapyOrder.PackageProcedure != null) {//order'ın raporu yoksa seçim yapılırken mevcut raporların arasından eşleşen varsa set edilir.
                    let reportObj = this.physiotherapyOrderPlannedFormViewModel.ReportList.filter(c => c.FTRApplicationAreaDef.toString() == this._PhysiotherapyOrder.FTRApplicationAreaDef.ObjectID.toString() && c.PackageProcedureInfo == this._PhysiotherapyOrder.PackageProcedure.Code);
    ...
    public onIncludeFridayChanged(event): void {
        if (event != null) {
            if (this._PhysiotherapyOrder != null && this._PhysiotherapyOrder.IncludeFriday != event) {
                ...
                if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeFriday == true && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnFriday != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnFriday == false) {
    ...
    public onIncludeMondayChanged(event): void {
        if (event != null) {
            if (this._PhysiotherapyOrder != null && this._PhysiotherapyOrder.IncludeMonday != event) {
                ...
                if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeMonday == true && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnMonday != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnMonday == false) {
    ...
    public onIncludeSaturdayChanged(event): void {
        if (event != null) {
            if (this._PhysiotherapyOrder != null && this._PhysiotherapyOrder.IncludeSaturday != event) {
                ...
                if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeSaturday == true && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnSaturday != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnSaturday == false) {
                    TTVisual.InfoBox.Alert("Ünite Cumartesi günü çalışmamaktadır!");
                }
            }
        }
    ...
    public onIncludeSundayChanged(event): void {
        if (event != null) {
            if (this._PhysiotherapyOrder != null && this._PhysiotherapyOrder.IncludeSunday != event) {
                ...
                if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeSunday == true && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnSaturday != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnSaturday == false) {
                    TTVisual.InfoBox.Alert("Ünite Pazar günü çalışmamaktadır!");
                }
            }
        }
    ...
    public onIncludeThursdayChanged(event): void {
        if (event != null) {
            if (this._PhysiotherapyOrder != null && this._PhysiotherapyOrder.IncludeThursday != event) {
                ...
                if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeThursday == true && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnThursday != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnThursday == false) {
    ...
    public onIncludeTuesdayChanged(event): void {
        if (event != null) {
            if (this._PhysiotherapyOrder != null && this._PhysiotherapyOrder.IncludeTuesday != event) {
                ...
                if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeTuesday == true && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnTuesday != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnTuesday == false) {
    ...
    public onIncludeWednesdayChanged(event): void {
        if (event != null) {
            if (this._PhysiotherapyOrder != null && this._PhysiotherapyOrder.IncludeWednesday != event) {
                ...
                if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeWednesday == true && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnWednesday != null && this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.TreatmentDiagnosisUnit.OpenOnWednesday == false) {
    ...
    public onIsAdditionalProcessChanged(event): void {
        if (event != null) {
            ...
            this.physiotherapyOrderPlannedFormViewModel.IsAdditionalProcess = event;
        }
    }
    ...
    public onIsMedulaNotWorkingChanged(event): void {
        if (event != null) {
            ...
            this.physiotherapyOrderPlannedFormViewModel.IsMedulaNotWorking = event;
        }
    }
    ...
    public onPackageProcedureChanged(event): void {
        if (event != null) {
            if (this._PhysiotherapyOrder != null && this._PhysiotherapyOrder.PackageProcedure != event) {
                ...
                if (this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.PhysiotherapyReports.ReportNo == null && this._PhysiotherapyOrder.FTRApplicationAreaDef != null) {//order'ın raporu yoksa seçim yapılırken mevcut raporların arasından eşleşen varsa set edilir.
                    let reportObj = this.physiotherapyOrderPlannedFormViewModel.ReportList.filter(c => c.FTRApplicationAreaDef.toString() == this._PhysiotherapyOrder.FTRApplicationAreaDef.ObjectID.toString() && c.PackageProcedureInfo == this._PhysiotherapyOrder.PackageProcedure.Code);
                    if (reportObj.length > 0) {
                        this.selectedReportItem = reportObj[0];
    ...
    public onDaySelectionActiveChanged(event): void {
        if (event != null) {
            //this.physiotherapyOrderPlannedFormViewModel.daySelectionActive = event;
            if (this.daySelectionActive.Value !== event) {
                ...
                if (this.daySelectionActive.Value == false) {
                    ...
                    this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.SeansGunSayisi = null;
                    this.SeansGunSayisi.ReadOnly = true;
            ...
            if (this.physiotherapyOrderPlannedFormViewModel.daySelectionActive !== event) {
                this.physiotherapyOrderPlannedFormViewModel.daySelectionActive = event;
                ...
                if (this.daySelectionActive.Value == false) {
                    ...
                    this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeFriday = null;
                    this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeMonday = null;
                    this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeThursday = null;
                    this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeTuesday = null;
                    this.physiotherapyOrderPlannedFormViewModel._PhysiotherapyOrder.IncludeWednesday = null;
