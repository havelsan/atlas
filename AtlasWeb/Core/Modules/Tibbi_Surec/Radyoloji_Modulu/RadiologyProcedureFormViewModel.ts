...
export class RadiologyProcedureFormViewModel extends BaseViewModel {
    public _Radiology: Radiology = new Radiology();
    public GridRadiologyTestsGridList: Array<RadiologyTest> = new Array<RadiologyTest>();
    public GridMaterialGridList: Array<BaseTreatmentMaterial> = new Array<BaseTreatmentMaterial>();
