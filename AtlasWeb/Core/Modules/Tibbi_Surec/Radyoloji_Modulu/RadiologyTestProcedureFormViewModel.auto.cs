...
{
    [HttpGet]
    public RadiologyTestProcedureFormViewModel RadiologyTestProcedureForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return RadiologyTestProcedureFormLoadInternal(input);
    }

    [HttpPost]
    public RadiologyTestProcedureFormViewModel RadiologyTestProcedureFormLoad(FormLoadInput input)
    {
        return RadiologyTestProcedureFormLoadInternal(input);
    }

    private RadiologyTestProcedureFormViewModel RadiologyTestProcedureFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("bff7e676-9bd3-4892-9de3-bc39bccae5b8");
        var objectDefID = Guid.Parse("2cf639c4-5819-4cf4-b295-2594a294c6a0");
        var viewModel = new RadiologyTestProcedureFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_RadiologyTestProcedureForm(viewModel, viewModel._RadiologyTest, objectContext);
    ...
    [HttpPost]
    public BaseViewModel RadiologyTestProcedureForm(RadiologyTestProcedureFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_RadiologyTestProcedureForm(viewModel, radiologyTest, transDef, objectContext);
            ...
            AfterContextSaveScript_RadiologyTestProcedureForm(viewModel, radiologyTest, transDef, objectContext);
    ...
    partial void PostScript_RadiologyTestProcedureForm(RadiologyTestProcedureFormViewModel viewModel, RadiologyTest radiologyTest, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    ...
    void ContextToViewModel(RadiologyTestProcedureFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class RadiologyTestProcedureFormViewModel : BaseViewModel
    {
        ...
        public TTObjectClasses.RadiologyRepeatReasonDefinition[] RadiologyRepeatReasonDefinitions { get; set; }
