...
import { RadiologyTestDentalToothSchemaViewModel } from "./RadiologyTestDentalToothSchemaViewModel";
...
@Component({
    selector: 'RadiologyTestDentalToothSchema',
    templateUrl: './RadiologyTestDentalToothSchema.html',
    providers: [MessageService]
})
export class RadiologyTestDentalToothSchema extends TTVisual.TTForm implements OnInit {
    ...
    public radiologyTestDentalToothSchemaViewModel: RadiologyTestDentalToothSchemaViewModel = new RadiologyTestDentalToothSchemaViewModel();
    public get _RadiologyTest(): RadiologyTest {
        return this._TTObject as RadiologyTest;
    }
    private RadiologyTestDentalToothSchema_DocumentUrl: string = '/api/RadiologyTestService/RadiologyTestDentalToothSchema';
    constructor(protected httpService: NeHttpService,
                protected messageService: MessageService,
                protected ngZone: NgZone) {
        super("RADIOLOGYTEST", "RadiologyTestDentalToothSchema");
        this._DocumentServiceUrl = this.RadiologyTestDentalToothSchema_DocumentUrl;
        this.initViewModel();
    ...
    public async ttbutton11_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth11;
    }
    public async ttbutton12_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth12;
    }
    public async ttbutton13_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth13;
    }
    public async ttbutton14_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth14;
    }
    public async ttbutton15_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth15;
    }
    public async ttbutton16_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth16;
    }
    public async ttbutton17_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth17;
    }
    public async ttbutton18_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth18;
    }
    public async ttbutton19_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.leftLowerJaw7;
    }
    public async ttbutton21_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth21;
    }
    public async ttbutton22_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth22;
    }
    public async ttbutton23_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth23;
    }
    public async ttbutton24_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth24;
    }
    public async ttbutton25_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth25;
    }
    public async ttbutton26_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth26;
    }
    public async ttbutton27_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth27;
    }
    public async ttbutton28_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth28;
    }
    public async ttbutton31_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth31;
    }
    public async ttbutton32_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth32;
    }
    public async ttbutton33_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth33;
    }
    public async ttbutton34_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth34;
    }
    public async ttbutton35_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth35;
    }
    public async ttbutton36_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth36;
    }
    public async ttbutton37_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth37;
    }
    public async ttbutton38_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth38;
    }
    public async ttbutton41_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth41;
    }
    public async ttbutton42_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth42;
    }
    public async ttbutton43_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth43;
    }
    public async ttbutton44_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth44;
    }
    public async ttbutton45_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth45;
    }
    public async ttbutton46_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth46;
    }
    public async ttbutton47_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth47;
    }
    public async ttbutton48_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.adultTooth48;
    }
    public async ttbutton51_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth51;
    }
    public async ttbutton52_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth52;
    }
    public async ttbutton53_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth53;
    }
    public async ttbutton54_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth54;
    }
    public async ttbutton55_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth55;
    }
    public async ttbutton61_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth61;
    }
    public async ttbutton62_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth62;
    }
    public async ttbutton63_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth63;
    }
    public async ttbutton64_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth64;
    }
    public async ttbutton65_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth65;
    }
    public async ttbutton71_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth71;
    }
    public async ttbutton72_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth72;
    }
    public async ttbutton73_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth73;
    }
    public async ttbutton74_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth74;
    }
    public async ttbutton75_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth75;
    }
    public async ttbutton81_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth81;
    }
    public async ttbutton82_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth82;
    }
    public async ttbutton83_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth83;
    }
    public async ttbutton84_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth84;
    }
    public async ttbutton85_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.milkTooth85;
    }
    public async ttbutton91_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.anomalyTooth91;
    }
    public async ttbutton92_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.anomalyTooth92;
    }
    public async ttbutton93_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.anomalyTooth93;
    }
    public async ttbutton94_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.anomalyTooth94;
    }
    public async ttbuttonLeftUpperJaw_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.leftUpperJaw5;
    }
    public async ttbuttonLowerJaw_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.lowerJaw3;
    }
    public async ttbuttonRightLowerJaw_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.rightLowerJaw6;
    }
    public async ttbuttonRightUpperJaw_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.rightUpperJaw4;
    }
    public async ttbuttonUpperJaw_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.upperJaw2;
    }
    public async ttbuttonWholeJaw_Click(): Promise<void> {
        this._RadiologyTest.TestToothNumber = ToothNumberEnum.wholeJaw1;
    }
    ...
    public initViewModel(): void {
        ...
        this.radiologyTestDentalToothSchemaViewModel = new RadiologyTestDentalToothSchemaViewModel();
        this._ViewModel = this.radiologyTestDentalToothSchemaViewModel;
        this.radiologyTestDentalToothSchemaViewModel._RadiologyTest = this._TTObject as RadiologyTest;
        this.radiologyTestDentalToothSchemaViewModel._RadiologyTest.ProcedureObject = new ProcedureDefinition();
    }

    protected loadViewModel() {
        let that = this;
        that.radiologyTestDentalToothSchemaViewModel = this._ViewModel as RadiologyTestDentalToothSchemaViewModel;
        that._TTObject = this.radiologyTestDentalToothSchemaViewModel._RadiologyTest;
        if (this.radiologyTestDentalToothSchemaViewModel == null)
            this.radiologyTestDentalToothSchemaViewModel = new RadiologyTestDentalToothSchemaViewModel();
        if (this.radiologyTestDentalToothSchemaViewModel._RadiologyTest == null)
            this.radiologyTestDentalToothSchemaViewModel._RadiologyTest = new RadiologyTest();
        let procedureObjectObjectID = that.radiologyTestDentalToothSchemaViewModel._RadiologyTest["ProcedureObject"];
        if (procedureObjectObjectID != null && (typeof procedureObjectObjectID === 'string')) {
            let procedureObject = that.radiologyTestDentalToothSchemaViewModel.ProcedureDefinitions.find(o => o.ObjectID.toString() === procedureObjectObjectID.toString());
             if (procedureObject) {
                that.radiologyTestDentalToothSchemaViewModel._RadiologyTest.ProcedureObject = procedureObject;
            }
        }
    }
    ...
    async ngOnInit()  {
        let that = this;
        await this.load(RadiologyTestDentalToothSchemaViewModel);
    ...
    public onAnomaliChanged(event): void {
        if (event != null) {
            if (this._RadiologyTest != null && this._RadiologyTest.Anomali != event) {
                this._RadiologyTest.Anomali = event;
            }
        }
    }
    ...
    protected redirectProperties(): void {
        ...
        redirectProperty(this.ToothNumber, "Value", this.__ttObject, "TestToothNumber");
