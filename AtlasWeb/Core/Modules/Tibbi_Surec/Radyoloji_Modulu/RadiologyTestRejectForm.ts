...
import { RadiologyTestRejectFormViewModel } from './RadiologyTestRejectFormViewModel';
...
@Component({
    selector: 'RadiologyTestRejectForm',
    templateUrl: './RadiologyTestRejectForm.html',
    providers: [MessageService]
})
export class RadiologyTestRejectForm extends TTVisual.TTForm implements OnInit {
    ...
    public radiologyTestRejectFormViewModel: RadiologyTestRejectFormViewModel = new RadiologyTestRejectFormViewModel();
    public get _RadiologyTest(): RadiologyTest {
        return this._TTObject as RadiologyTest;
    }
    private RadiologyTestRejectForm_DocumentUrl: string = '/api/RadiologyTestService/RadiologyTestRejectForm';
    constructor(protected httpService: NeHttpService,
        protected messageService: MessageService,
        private sideBarMenuService: ISidebarMenuService,
        protected helpMenuService: HelpMenuService,
                protected ngZone: NgZone) {
        super('RADIOLOGYTEST', 'RadiologyTestRejectForm');
        this._DocumentServiceUrl = this.RadiologyTestRejectForm_DocumentUrl;
        this.initViewModel();
    ...
    public initViewModel(): void {
        ...
        this.radiologyTestRejectFormViewModel = new RadiologyTestRejectFormViewModel();
        this._ViewModel = this.radiologyTestRejectFormViewModel;
        this.radiologyTestRejectFormViewModel._RadiologyTest = this._TTObject as RadiologyTest;
        this.radiologyTestRejectFormViewModel._RadiologyTest.Equipment = new ResRadiologyEquipment();
        this.radiologyTestRejectFormViewModel._RadiologyTest.ProcedureObject = new ProcedureDefinition();
        this.radiologyTestRejectFormViewModel._RadiologyTest.Department = new ResRadiologyDepartment();
        this.radiologyTestRejectFormViewModel._RadiologyTest.RadiologyTestTreatmentMaterial = new Array<RadiologyMaterial>();
        this.radiologyTestRejectFormViewModel._RadiologyTest.Radiology = new Radiology();
        this.radiologyTestRejectFormViewModel._RadiologyTest.Radiology.RequestDoctor = new ResUser();
        this.radiologyTestRejectFormViewModel._RadiologyTest.Episode = new Episode();
        this.radiologyTestRejectFormViewModel._RadiologyTest.Episode.Diagnosis = new Array<DiagnosisGrid>();
        this.radiologyTestRejectFormViewModel._RadiologyTest.RejectReason = new RadiologyRejectReasonDefinition();
    }

    protected loadViewModel() {
        let that = this;
        that.radiologyTestRejectFormViewModel = this._ViewModel as RadiologyTestRejectFormViewModel;
        that._TTObject = this.radiologyTestRejectFormViewModel._RadiologyTest;
        if (this.radiologyTestRejectFormViewModel == null)
            this.radiologyTestRejectFormViewModel = new RadiologyTestRejectFormViewModel();
        if (this.radiologyTestRejectFormViewModel._RadiologyTest == null)
            this.radiologyTestRejectFormViewModel._RadiologyTest = new RadiologyTest();
        let equipmentObjectID = that.radiologyTestRejectFormViewModel._RadiologyTest["Equipment"];
        if (equipmentObjectID != null && (typeof equipmentObjectID === 'string')) {
            let equipment = that.radiologyTestRejectFormViewModel.ResRadiologyEquipments.find(o => o.ObjectID.toString() === equipmentObjectID.toString());
             if (equipment) {
                that.radiologyTestRejectFormViewModel._RadiologyTest.Equipment = equipment;
            }
        }
        let procedureObjectObjectID = that.radiologyTestRejectFormViewModel._RadiologyTest["ProcedureObject"];
        if (procedureObjectObjectID != null && (typeof procedureObjectObjectID === 'string')) {
            let procedureObject = that.radiologyTestRejectFormViewModel.ProcedureDefinitions.find(o => o.ObjectID.toString() === procedureObjectObjectID.toString());
             if (procedureObject) {
                that.radiologyTestRejectFormViewModel._RadiologyTest.ProcedureObject = procedureObject;
            }
        }
        let departmentObjectID = that.radiologyTestRejectFormViewModel._RadiologyTest["Department"];
        if (departmentObjectID != null && (typeof departmentObjectID === 'string')) {
            let department = that.radiologyTestRejectFormViewModel.ResRadiologyDepartments.find(o => o.ObjectID.toString() === departmentObjectID.toString());
             if (department) {
                that.radiologyTestRejectFormViewModel._RadiologyTest.Department = department;
            }
        }
        that.radiologyTestRejectFormViewModel._RadiologyTest.RadiologyTestTreatmentMaterial = that.radiologyTestRejectFormViewModel.MaterialsGridList;
        for (let detailItem of that.radiologyTestRejectFormViewModel.MaterialsGridList) {
            let materialObjectID = detailItem["Material"];
            if (materialObjectID != null && (typeof materialObjectID === 'string')) {
                let material = that.radiologyTestRejectFormViewModel.Materials.find(o => o.ObjectID.toString() === materialObjectID.toString());
                 if (material) {
                    detailItem.Material = material;
                }
            }
        }
        let radiologyObjectID = that.radiologyTestRejectFormViewModel._RadiologyTest["EpisodeAction"];
        if (radiologyObjectID != null && (typeof radiologyObjectID === 'string')) {
            let radiology = that.radiologyTestRejectFormViewModel.Radiologys.find(o => o.ObjectID.toString() === radiologyObjectID.toString());
             if (radiology) {
                that.radiologyTestRejectFormViewModel._RadiologyTest.Radiology = radiology;
            }
            if (radiology != null) {
                let requestDoctorObjectID = radiology["RequestDoctor"];
                if (requestDoctorObjectID != null && (typeof requestDoctorObjectID === 'string')) {
                    let requestDoctor = that.radiologyTestRejectFormViewModel.ResUsers.find(o => o.ObjectID.toString() === requestDoctorObjectID.toString());
                     if (requestDoctor) {
        ...
        let episodeObjectID = that.radiologyTestRejectFormViewModel._RadiologyTest["Episode"];
        if (episodeObjectID != null && (typeof episodeObjectID === 'string')) {
            let episode = that.radiologyTestRejectFormViewModel.Episodes.find(o => o.ObjectID.toString() === episodeObjectID.toString());
             if (episode) {
                that.radiologyTestRejectFormViewModel._RadiologyTest.Episode = episode;
            }
            that.radiologyTestRejectFormViewModel._RadiologyTest.Radiology.Episode = episode;
            if (episode != null) {
                episode.Diagnosis = that.radiologyTestRejectFormViewModel.GridEpisodeDiagnosisGridList;
                for (let detailItem of that.radiologyTestRejectFormViewModel.GridEpisodeDiagnosisGridList) {
                    let diagnoseObjectID = detailItem["Diagnose"];
                    if (diagnoseObjectID != null && (typeof diagnoseObjectID === 'string')) {
                        let diagnose = that.radiologyTestRejectFormViewModel.DiagnosisDefinitions.find(o => o.ObjectID.toString() === diagnoseObjectID.toString());
                         if (diagnose) {
                    ...
                    if (responsibleUserObjectID != null && (typeof responsibleUserObjectID === 'string')) {
                        let responsibleUser = that.radiologyTestRejectFormViewModel.ResUsers.find(o => o.ObjectID.toString() === responsibleUserObjectID.toString());
                         if (responsibleUser) {
        ...
        let rejectReasonObjectID = that.radiologyTestRejectFormViewModel._RadiologyTest["RejectReason"];
        if (rejectReasonObjectID != null && (typeof rejectReasonObjectID === 'string')) {
            let rejectReason = that.radiologyTestRejectFormViewModel.RadiologyRejectReasonDefinitions.find(o => o.ObjectID.toString() === rejectReasonObjectID.toString());
             if (rejectReason) {
                that.radiologyTestRejectFormViewModel._RadiologyTest.RejectReason = rejectReason;
            }
        }
    }
    ...
    async ngOnInit()  {
        let that = this;
        await this.load(RadiologyTestRejectFormViewModel);
        this.AddHelpMenu();
    ...
    public onttvaluelistbox1Changed(event): void {
        if (event != null) {
            if (this._RadiologyTest != null && this._RadiologyTest.RejectReason != event) {
                this._RadiologyTest.RejectReason = event;
            }
        }
    }
    ...
    public initFormControls(): void {
        ...
        this.ttlabel8.Text = i18n("M20975", "Red Nedeni");
        ...
        this.Controls = [this.tttabcontrol1, this.tttabpage1, this.ttlabel4, this.Description, this.ttlabel5, this.ttlabel10, this.Equipment, this.ProcedureObject, this.ttlabel9, this.Deparment, this.ttlabel1, this.TestTechnicianNote, this.tttabpage2, this.Materials, this.Material, this.Barcode, this.Amount, this.ttlabel3, this.OwnerType, this.CommonDescription, this.PREDIAGNOSIS, this.ttlabel6, this.ttobjectlistbox1, this.ActionDate, this.labelProcessTime, this.ttlabel13, this.ttlabel7, this.ttlabel15, this.PATIENTGROUPENUM, this.ttlabel16, this.GridEpisodeDiagnosis, this.EpisodeAddToHistory, this.EpisodeDiagnose, this.EpisodeDiagnosisType, this.EpisodeIsMainDiagnose, this.EpisodeResponsibleUser, this.EpisodeDiagnoseDate, this.EntryActionType, this.ReasonForAdmission, this.ttvaluelistbox1, this.ttlabel8];
