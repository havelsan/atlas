...
{
    [HttpGet]
    public NuclearMedicineRejectedFormViewModel NuclearMedicineRejectedForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return NuclearMedicineRejectedFormLoadInternal(input);
    }

    [HttpPost]
    public NuclearMedicineRejectedFormViewModel NuclearMedicineRejectedFormLoad(FormLoadInput input)
    {
        return NuclearMedicineRejectedFormLoadInternal(input);
    }

    private NuclearMedicineRejectedFormViewModel NuclearMedicineRejectedFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("c5a13900-4724-4e6f-855a-e347d07fffa4");
        var objectDefID = Guid.Parse("ffb5f11a-93ec-4b54-881c-57ca00f26f63");
        var viewModel = new NuclearMedicineRejectedFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_NuclearMedicineRejectedForm(viewModel, viewModel._NuclearMedicine, objectContext);
    ...
    [HttpPost]
    public BaseViewModel NuclearMedicineRejectedForm(NuclearMedicineRejectedFormViewModel viewModel)
    {
        using (var objectContext = new TTObjectContext(false))
        {
            return NuclearMedicineRejectedFormInternal(viewModel, objectContext);
        }
    }

    internal BaseViewModel NuclearMedicineRejectedFormInternal(NuclearMedicineRejectedFormViewModel viewModel, TTObjectContext objectContext)
    {
        ...
        PostScript_NuclearMedicineRejectedForm(viewModel, nuclearMedicine, transDef, objectContext);
        ...
        AfterContextSaveScript_NuclearMedicineRejectedForm(viewModel, nuclearMedicine, transDef, objectContext);
    ...
    partial void PreScript_NuclearMedicineRejectedForm(NuclearMedicineRejectedFormViewModel viewModel, NuclearMedicine nuclearMedicine, TTObjectContext objectContext);
    partial void PostScript_NuclearMedicineRejectedForm(NuclearMedicineRejectedFormViewModel viewModel, NuclearMedicine nuclearMedicine, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_NuclearMedicineRejectedForm(NuclearMedicineRejectedFormViewModel viewModel, NuclearMedicine nuclearMedicine, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(NuclearMedicineRejectedFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class NuclearMedicineRejectedFormViewModel
    {
