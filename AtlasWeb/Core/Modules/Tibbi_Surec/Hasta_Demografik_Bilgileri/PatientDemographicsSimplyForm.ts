...
import { PatientDemographicsViewModel, DynamicComponentInfoDVO, PatientDetailsViewModel } from './PatientDemographicsViewModel';
...
@Component({
    selector: "patient-demographics-simply-form",
    inputs: ['patientDemographicsViewModel'],
    templateUrl: './PatientDemographicsSimplyForm.html',
    outputs: ['PatientDemographicInfoLoaded']
})


export class PatientDemographicsSimplyForm extends TTUnboundForm implements OnInit {
    ...
    ClearLoadedViewModel() {
        ...
        this.patientDemographicsViewModel.BirthDate = null;
    ...
    loadViewModel(result) {
        ...
        this.patientDemographicsViewModel.BirthDate = result.BirthDate;
