...
@Component({
    selector: "patient-demographics-new-form",
    inputs: ['patientDemographicsViewModel'],
    templateUrl: './PatientDemographicsNewForm.html',
    outputs: ['PatientDemographicInfoLoaded']
})


export class PatientDemographicsNewForm extends TTUnboundForm implements OnInit {
    ...
    public _AddButtonShowable: boolean = true;
    ...
    ClearLoadedViewModel() {
        ...
        this.patientDemographicsViewModel.formattedRequestDate = null;
        this.patientDemographicsViewModel.admissionType = null;
        this.patientDemographicsViewModel.provisionNo = null;
        this.patientDemographicsViewModel.archiveNo = null;
        ...
        this.patientDemographicsViewModel.ExaminationProcessAndEndDate = null;
    ...
    async loadViewModel(result) {
        ...
        this.patientDemographicsViewModel.formattedRequestDate = result.formattedRequestDate;
        ...
        this.patientDemographicsViewModel.ExaminationProcessAndEndDate = result.ExaminationProcessAndEndDate;
