...
{
    [HttpGet]
    public DirectMaterialSupplyCompletedFormViewModel DirectMaterialSupplyCompletedForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return DirectMaterialSupplyCompletedFormLoadInternal(input);
    }

    [HttpPost]
    public DirectMaterialSupplyCompletedFormViewModel DirectMaterialSupplyCompletedFormLoad(FormLoadInput input)
    {
        return DirectMaterialSupplyCompletedFormLoadInternal(input);
    }

    private DirectMaterialSupplyCompletedFormViewModel DirectMaterialSupplyCompletedFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("079c9cb4-4373-45a7-b4be-0c9df823250c");
        var objectDefID = Guid.Parse("eb8545ad-b542-4489-8e4c-b903b5f0fe28");
        var viewModel = new DirectMaterialSupplyCompletedFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_DirectMaterialSupplyCompletedForm(viewModel, viewModel._DirectMaterialSupplyAction, objectContext);
    ...
    [HttpPost]
    public BaseViewModel DirectMaterialSupplyCompletedForm(DirectMaterialSupplyCompletedFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_DirectMaterialSupplyCompletedForm(viewModel, directMaterialSupplyAction, transDef, objectContext);
            ...
            AfterContextSaveScript_DirectMaterialSupplyCompletedForm(viewModel, directMaterialSupplyAction, transDef, objectContext);
    ...
    partial void PreScript_DirectMaterialSupplyCompletedForm(DirectMaterialSupplyCompletedFormViewModel viewModel, DirectMaterialSupplyAction directMaterialSupplyAction, TTObjectContext objectContext);
    partial void PostScript_DirectMaterialSupplyCompletedForm(DirectMaterialSupplyCompletedFormViewModel viewModel, DirectMaterialSupplyAction directMaterialSupplyAction, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_DirectMaterialSupplyCompletedForm(DirectMaterialSupplyCompletedFormViewModel viewModel, DirectMaterialSupplyAction directMaterialSupplyAction, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(DirectMaterialSupplyCompletedFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class DirectMaterialSupplyCompletedFormViewModel : BaseViewModel
    {
