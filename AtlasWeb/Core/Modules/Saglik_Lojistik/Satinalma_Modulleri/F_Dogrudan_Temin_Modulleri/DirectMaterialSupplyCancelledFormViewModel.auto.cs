...
{
    [HttpGet]
    public DirectMaterialSupplyCancelledFormViewModel DirectMaterialSupplyCancelledForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return DirectMaterialSupplyCancelledFormLoadInternal(input);
    }

    [HttpPost]
    public DirectMaterialSupplyCancelledFormViewModel DirectMaterialSupplyCancelledFormLoad(FormLoadInput input)
    {
        return DirectMaterialSupplyCancelledFormLoadInternal(input);
    }

    private DirectMaterialSupplyCancelledFormViewModel DirectMaterialSupplyCancelledFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("7f26483e-765f-4c19-899d-72643ad90d9e");
        var objectDefID = Guid.Parse("eb8545ad-b542-4489-8e4c-b903b5f0fe28");
        var viewModel = new DirectMaterialSupplyCancelledFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_DirectMaterialSupplyCancelledForm(viewModel, viewModel._DirectMaterialSupplyAction, objectContext);
    ...
    [HttpPost]
    public BaseViewModel DirectMaterialSupplyCancelledForm(DirectMaterialSupplyCancelledFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_DirectMaterialSupplyCancelledForm(viewModel, directMaterialSupplyAction, transDef, objectContext);
            ...
            AfterContextSaveScript_DirectMaterialSupplyCancelledForm(viewModel, directMaterialSupplyAction, transDef, objectContext);
    ...
    partial void PreScript_DirectMaterialSupplyCancelledForm(DirectMaterialSupplyCancelledFormViewModel viewModel, DirectMaterialSupplyAction directMaterialSupplyAction, TTObjectContext objectContext);
    partial void PostScript_DirectMaterialSupplyCancelledForm(DirectMaterialSupplyCancelledFormViewModel viewModel, DirectMaterialSupplyAction directMaterialSupplyAction, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_DirectMaterialSupplyCancelledForm(DirectMaterialSupplyCancelledFormViewModel viewModel, DirectMaterialSupplyAction directMaterialSupplyAction, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(DirectMaterialSupplyCancelledFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class DirectMaterialSupplyCancelledFormViewModel : BaseViewModel
    {
