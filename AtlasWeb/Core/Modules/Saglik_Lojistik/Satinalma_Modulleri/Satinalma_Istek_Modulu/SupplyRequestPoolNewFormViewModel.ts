...
export class SupplyRequestPoolNewFormViewModel extends BaseViewModel  {
    ...
    public SupplyRequestDetails: Array<SupplyRequestDetail> = new Array<SupplyRequestDetail>();
}
