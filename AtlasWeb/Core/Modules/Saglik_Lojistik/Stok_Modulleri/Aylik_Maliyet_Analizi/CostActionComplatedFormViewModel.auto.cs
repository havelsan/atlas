...
{
    [HttpGet]
    public CostActionComplatedFormViewModel CostActionComplatedForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return CostActionComplatedFormLoadInternal(input);
    }

    [HttpPost]
    public CostActionComplatedFormViewModel CostActionComplatedFormLoad(FormLoadInput input)
    {
        return CostActionComplatedFormLoadInternal(input);
    }

    private CostActionComplatedFormViewModel CostActionComplatedFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("774f65af-975c-4d97-b54c-417d17645b53");
        var objectDefID = Guid.Parse("7ec5f9b5-fc7c-4b8a-8f60-9b24f7380090");
        var viewModel = new CostActionComplatedFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_CostActionComplatedForm(viewModel, viewModel._CostAction, objectContext);
    ...
    [HttpPost]
    public BaseViewModel CostActionComplatedForm(CostActionComplatedFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_CostActionComplatedForm(viewModel, costAction, transDef, objectContext);
            ...
            AfterContextSaveScript_CostActionComplatedForm(viewModel, costAction, transDef, objectContext);
    ...
    partial void PreScript_CostActionComplatedForm(CostActionComplatedFormViewModel viewModel, CostAction costAction, TTObjectContext objectContext);
    partial void PostScript_CostActionComplatedForm(CostActionComplatedFormViewModel viewModel, CostAction costAction, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_CostActionComplatedForm(CostActionComplatedFormViewModel viewModel, CostAction costAction, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(CostActionComplatedFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class CostActionComplatedFormViewModel : BaseViewModel
    {
