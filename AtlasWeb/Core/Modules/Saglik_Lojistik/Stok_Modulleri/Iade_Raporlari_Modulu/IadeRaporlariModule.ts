...
import { DrugReturnReportForm } from './DrugReturnReportForm';
...
@NgModule({
    ...
    declarations: [DrugReturnReportForm],
    exports: [DrugReturnReportForm],
    entryComponents: [DrugReturnReportForm]
})
export class IadeRaporlariModule {
