...
import { Store, DrugSpecificationEnum } from 'app/NebulaClient/Model/AtlasClientModel';
import { StoreInTotalOutputDTO, StoreInTotalInputDTO } from './StoreInTotalReportViewModel';
import { DxDropDownBoxComponent } from 'devextreme-angular';
import { EnumItem } from 'app/NebulaClient/Mscorlib/EnumItem';


@Component({
    selector: "StoreInTotalReport",
    templateUrl: './StoreInTotalReport.html',
    providers: [SystemApiService, MessageService]
})

export class StoreInTotalReport {
    ...
    public stockInTotal: Array<StoreInTotalOutputDTO> = new Array<StoreInTotalOutputDTO>();
        ...
        this.materialDataSource = new DataSource({
            store: new CustomStore({
                ...
                load: (loadOptions: any) => {
                    ...
                    return this.httpService.post<any>('/api/StoreInTotalReportService/GetMaterialList', loadOptions);
                },
            }),
            paginate: true,
            pageSize: 10
    ...
    async GetStockInheldList() {
        try {
            ...
            let input: StoreInTotalInputDTO = new StoreInTotalInputDTO();
            ...
            let apiUrl: string = 'api/StoreInTotalReportService/GetStockInList';
            this.httpService.post<Array<StoreInTotalOutputDTO>>(apiUrl, input).then(
                result => {
                    this.stockInTotal = result;
