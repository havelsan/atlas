...
{
    [HttpGet]
    public BaseDistributionDocumentFormViewModel BaseDistributionDocumentForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return BaseDistributionDocumentFormLoadInternal(input);
    }

    [HttpPost]
    public BaseDistributionDocumentFormViewModel BaseDistributionDocumentFormLoad(FormLoadInput input)
    {
        return BaseDistributionDocumentFormLoadInternal(input);
    }

    private BaseDistributionDocumentFormViewModel BaseDistributionDocumentFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("f54b1a2f-1713-4b6c-96f3-5e195f57e302");
        var objectDefID = Guid.Parse("a06d6465-0fe8-4fb1-a0df-a62373fef8de");
        var viewModel = new BaseDistributionDocumentFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_BaseDistributionDocumentForm(viewModel, viewModel._DistributionDocument, objectContext);
    ...
    [HttpPost]
    public BaseViewModel BaseDistributionDocumentForm(BaseDistributionDocumentFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_BaseDistributionDocumentForm(viewModel, distributionDocument, transDef, objectContext);
            ...
            AfterContextSaveScript_BaseDistributionDocumentForm(viewModel, distributionDocument, transDef, objectContext);
    ...
    partial void PreScript_BaseDistributionDocumentForm(BaseDistributionDocumentFormViewModel viewModel, DistributionDocument distributionDocument, TTObjectContext objectContext);
    partial void PostScript_BaseDistributionDocumentForm(BaseDistributionDocumentFormViewModel viewModel, DistributionDocument distributionDocument, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_BaseDistributionDocumentForm(BaseDistributionDocumentFormViewModel viewModel, DistributionDocument distributionDocument, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(BaseDistributionDocumentFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class BaseDistributionDocumentFormViewModel : BaseViewModel
    {
