...
export class ReviewActionNewFormViewModel extends BaseViewModel {
  @Type(() => ReviewAction)
    ...
    @Type(() => StockCollectedTrx)
    public StockCollectedTrxs: Array<StockCollectedTrx> = new Array<StockCollectedTrx>();
}
