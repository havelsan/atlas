...
import { GrantMaterialApprovalFormViewModel } from './GrantMaterialApprovalFormViewModel';
...
@Component({
    selector: 'GrantMaterialApprovalForm',
    templateUrl: './GrantMaterialApprovalForm.html',
    providers: [MessageService]
})
export class GrantMaterialApprovalForm extends BaseGrantMaterialForm implements OnInit {
    public GrantMaterialDetailsColumns = [];
    public StockActionSignDetailsColumns = [];
    public grantMaterialApprovalFormViewModel: GrantMaterialApprovalFormViewModel = new GrantMaterialApprovalFormViewModel();
    public get _GrantMaterial(): GrantMaterial {
        return this._TTObject as GrantMaterial;
    }
    private GrantMaterialApprovalForm_DocumentUrl: string = '/api/GrantMaterialService/GrantMaterialApprovalForm';
    constructor(protected httpService: NeHttpService,
        protected messageService: MessageService,
        private reportService: AtlasReportService,
        protected ngZone: NgZone) {
        super(httpService, messageService, ngZone);
        this._DocumentServiceUrl = this.GrantMaterialApprovalForm_DocumentUrl;
        this.initViewModel();
    ...
    public initViewModel(): void {
        ...
        this.grantMaterialApprovalFormViewModel = new GrantMaterialApprovalFormViewModel();
        this._ViewModel = this.grantMaterialApprovalFormViewModel;
        this.grantMaterialApprovalFormViewModel._GrantMaterial = this._TTObject as GrantMaterial;
        this.grantMaterialApprovalFormViewModel._GrantMaterial.BudgetTypeDefinition = new BudgetTypeDefinition();
        this.grantMaterialApprovalFormViewModel._GrantMaterial.Store = new Store();
        this.grantMaterialApprovalFormViewModel._GrantMaterial.GrantMaterialDetails = new Array<GrantMaterialDetail>();
        this.grantMaterialApprovalFormViewModel._GrantMaterial.StockActionSignDetails = new Array<StockActionSignDetail>();
    }

    protected loadViewModel() {
        let that = this;

        that.grantMaterialApprovalFormViewModel = this._ViewModel as GrantMaterialApprovalFormViewModel;
        that._TTObject = this.grantMaterialApprovalFormViewModel._GrantMaterial;
        if (this.grantMaterialApprovalFormViewModel == null) {
            this.grantMaterialApprovalFormViewModel = new GrantMaterialApprovalFormViewModel();
        }
        if (this.grantMaterialApprovalFormViewModel._GrantMaterial == null) {
            this.grantMaterialApprovalFormViewModel._GrantMaterial = new GrantMaterial();
        }
        let budgetTypeDefinitionObjectID = that.grantMaterialApprovalFormViewModel._GrantMaterial['BudgetTypeDefinition'];
        if (budgetTypeDefinitionObjectID != null && (typeof budgetTypeDefinitionObjectID === 'string')) {
            let budgetTypeDefinition = that.grantMaterialApprovalFormViewModel.BudgetTypeDefinitions.find(o => o.ObjectID.toString() === budgetTypeDefinitionObjectID.toString());
            if (budgetTypeDefinition) {
                that.grantMaterialApprovalFormViewModel._GrantMaterial.BudgetTypeDefinition = budgetTypeDefinition;
            }
        }
        let storeObjectID = that.grantMaterialApprovalFormViewModel._GrantMaterial['Store'];
        if (storeObjectID != null && (typeof storeObjectID === 'string')) {
            let store = that.grantMaterialApprovalFormViewModel.Stores.find(o => o.ObjectID.toString() === storeObjectID.toString());
            if (store) {
                that.grantMaterialApprovalFormViewModel._GrantMaterial.Store = store;
            }
        }
        that.grantMaterialApprovalFormViewModel._GrantMaterial.GrantMaterialDetails = that.grantMaterialApprovalFormViewModel.GrantMaterialDetailsGridList;
        for (let detailItem of that.grantMaterialApprovalFormViewModel.GrantMaterialDetailsGridList) {
            let materialObjectID = detailItem['Material'];
            if (materialObjectID != null && (typeof materialObjectID === 'string')) {
                let material = that.grantMaterialApprovalFormViewModel.Materials.find(o => o.ObjectID.toString() === materialObjectID.toString());
                if (material) {
                ...
                if (material != null) {
                    ...
                    if (stockCardObjectID != null && (typeof stockCardObjectID === 'string')) {
                        let stockCard = that.grantMaterialApprovalFormViewModel.StockCards.find(o => o.ObjectID.toString() === stockCardObjectID.toString());
                        if (stockCard) {
                        ...
                        if (stockCard != null) {
                            ...
                            if (distributionTypeObjectID != null && (typeof distributionTypeObjectID === 'string')) {
                                let distributionType = that.grantMaterialApprovalFormViewModel.DistributionTypeDefinitions.find(o => o.ObjectID.toString() === distributionTypeObjectID.toString());
                                if (distributionType) {
            ...
            if (stockLevelTypeObjectID != null && (typeof stockLevelTypeObjectID === 'string')) {
                let stockLevelType = that.grantMaterialApprovalFormViewModel.StockLevelTypes.find(o => o.ObjectID.toString() === stockLevelTypeObjectID.toString());
                if (stockLevelType) {
                    detailItem.StockLevelType = stockLevelType;
                }
            }
        }
        that.grantMaterialApprovalFormViewModel._GrantMaterial.StockActionSignDetails = that.grantMaterialApprovalFormViewModel.StockActionSignDetailsGridList;
        for (let detailItem of that.grantMaterialApprovalFormViewModel.StockActionSignDetailsGridList) {
            let signUserObjectID = detailItem['SignUser'];
            if (signUserObjectID != null && (typeof signUserObjectID === 'string')) {
                let signUser = that.grantMaterialApprovalFormViewModel.ResUsers.find(o => o.ObjectID.toString() === signUserObjectID.toString());
                if (signUser) {
    ...
    async ngOnInit() {
        let that = this;
        await this.load(GrantMaterialApprovalFormViewModel);
        ...
        this.FormCaption = i18n("M11408", "Bağış / Yardım ( Onay )");
    ...
    public initFormControls(): void {
        ...
        //this.BudgetTypeDefinition.ReadOnly = true;  // 43368 nolu TFS işine bağlı olarak kapatıldı.
        ...
        this.ExpirationDateGrantMaterialDetail, this.StockLevelType, this.RetrievalYearGrantMaterialDetail,
        this.ProductionDateGrantMaterialDetail];
        ...
        this.Controls = [this.GranttedByUniqNo, this.TTTeslimEdenButon, this.MaterialGranttedBy, this.TTTeslimAlanButon,
        this.TTFirma, this.labelMKYS_TeslimEden, this.labelBudgetTypeDefinition, this.MKYS_TeslimEden, this.BudgetTypeDefinition,
        this.MKYS_TeslimAlan, this.labelGranttedByUniqNo, this.Description, this.labelMKYS_EMalzemeGrup, this.StockActionID,
        this.MKYS_EMalzemeGrup, this.labelMKYS_TeslimAlan, this.Store, this.labelTransactionDate, this.labelDestinationStore,
        this.TransactionDate, this.labelMaterialGranttedBy, this.labelStockActionID, this.ChattelDocumentTabcontrol,
