...
export class ChattelDocumentWithPurchaseCompletedFormViewModel extends BaseViewModel {
...
export class UTSReceiveNotificationSendViewModel {

    public ObjectId: string;
    public Amount: number;
    public IncomingDeliveryNotifID: string;
}


export class UTSReceiveNotificationResultViewModel {

    public ObjectId: string;
    public ReceiveNotificationID: string;
