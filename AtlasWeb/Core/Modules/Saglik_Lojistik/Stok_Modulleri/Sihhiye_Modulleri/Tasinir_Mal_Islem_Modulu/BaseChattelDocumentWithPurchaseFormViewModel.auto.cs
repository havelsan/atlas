...
{
    [HttpGet]
    public BaseChattelDocumentWithPurchaseFormViewModel BaseChattelDocumentWithPurchaseForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return BaseChattelDocumentWithPurchaseFormLoadInternal(input);
    }

    [HttpPost]
    public BaseChattelDocumentWithPurchaseFormViewModel BaseChattelDocumentWithPurchaseFormLoad(FormLoadInput input)
    {
        return BaseChattelDocumentWithPurchaseFormLoadInternal(input);
    }

    private BaseChattelDocumentWithPurchaseFormViewModel BaseChattelDocumentWithPurchaseFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("42619efe-8f3b-4216-9e57-4e37793ad61c");
        var objectDefID = Guid.Parse("3799bd27-4d89-4cd5-83e3-7aea9801138e");
        var viewModel = new BaseChattelDocumentWithPurchaseFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_BaseChattelDocumentWithPurchaseForm(viewModel, viewModel._ChattelDocumentWithPurchase, objectContext);
    ...
    [HttpPost]
    public BaseViewModel BaseChattelDocumentWithPurchaseForm(BaseChattelDocumentWithPurchaseFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_BaseChattelDocumentWithPurchaseForm(viewModel, chattelDocumentWithPurchase, transDef, objectContext);
            ...
            AfterContextSaveScript_BaseChattelDocumentWithPurchaseForm(viewModel, chattelDocumentWithPurchase, transDef, objectContext);
    ...
    partial void PreScript_BaseChattelDocumentWithPurchaseForm(BaseChattelDocumentWithPurchaseFormViewModel viewModel, ChattelDocumentWithPurchase chattelDocumentWithPurchase, TTObjectContext objectContext);
    partial void PostScript_BaseChattelDocumentWithPurchaseForm(BaseChattelDocumentWithPurchaseFormViewModel viewModel, ChattelDocumentWithPurchase chattelDocumentWithPurchase, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_BaseChattelDocumentWithPurchaseForm(BaseChattelDocumentWithPurchaseFormViewModel viewModel, ChattelDocumentWithPurchase chattelDocumentWithPurchase, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(BaseChattelDocumentWithPurchaseFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class BaseChattelDocumentWithPurchaseFormViewModel : BaseViewModel
    {
