...
{
    [HttpGet]
    public BaseChattelDocumentInputWithAccountancyFormViewModel BaseChattelDocumentInputWithAccountancyForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return BaseChattelDocumentInputWithAccountancyFormLoadInternal(input);
    }

    [HttpPost]
    public BaseChattelDocumentInputWithAccountancyFormViewModel BaseChattelDocumentInputWithAccountancyFormLoad(FormLoadInput input)
    {
        return BaseChattelDocumentInputWithAccountancyFormLoadInternal(input);
    }

    private BaseChattelDocumentInputWithAccountancyFormViewModel BaseChattelDocumentInputWithAccountancyFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("82840fbb-14d8-4f2c-880c-4ab9c434539c");
        var objectDefID = Guid.Parse("1c5c4fc6-72e8-4c58-8d6a-21e17d1eacf3");
        var viewModel = new BaseChattelDocumentInputWithAccountancyFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_BaseChattelDocumentInputWithAccountancyForm(viewModel, viewModel._ChattelDocumentInputWithAccountancy, objectContext);
    ...
    [HttpPost]
    public BaseViewModel BaseChattelDocumentInputWithAccountancyForm(BaseChattelDocumentInputWithAccountancyFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_BaseChattelDocumentInputWithAccountancyForm(viewModel, chattelDocumentInputWithAccountancy, transDef, objectContext);
            ...
            AfterContextSaveScript_BaseChattelDocumentInputWithAccountancyForm(viewModel, chattelDocumentInputWithAccountancy, transDef, objectContext);
    ...
    partial void PreScript_BaseChattelDocumentInputWithAccountancyForm(BaseChattelDocumentInputWithAccountancyFormViewModel viewModel, ChattelDocumentInputWithAccountancy chattelDocumentInputWithAccountancy, TTObjectContext objectContext);
    partial void PostScript_BaseChattelDocumentInputWithAccountancyForm(BaseChattelDocumentInputWithAccountancyFormViewModel viewModel, ChattelDocumentInputWithAccountancy chattelDocumentInputWithAccountancy, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_BaseChattelDocumentInputWithAccountancyForm(BaseChattelDocumentInputWithAccountancyFormViewModel viewModel, ChattelDocumentInputWithAccountancy chattelDocumentInputWithAccountancy, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(BaseChattelDocumentInputWithAccountancyFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class BaseChattelDocumentInputWithAccountancyFormViewModel : BaseViewModel
    {
