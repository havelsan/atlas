...
{
    [HttpGet]
    public BaseExtendExpDateFormViewModel BaseExtendExpDateForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return BaseExtendExpDateFormLoadInternal(input);
    }

    [HttpPost]
    public BaseExtendExpDateFormViewModel BaseExtendExpDateFormLoad(FormLoadInput input)
    {
        return BaseExtendExpDateFormLoadInternal(input);
    }

    private BaseExtendExpDateFormViewModel BaseExtendExpDateFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("7f24dd21-3f56-4afc-80b9-b8e00d13c81f");
        var objectDefID = Guid.Parse("8d36aad0-1bbc-41d8-b3b8-aff0351fbc7a");
        var viewModel = new BaseExtendExpDateFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_BaseExtendExpDateForm(viewModel, viewModel._ExtendExpirationDate, objectContext);
    ...
    [HttpPost]
    public BaseViewModel BaseExtendExpDateForm(BaseExtendExpDateFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_BaseExtendExpDateForm(viewModel, extendExpirationDate, transDef, objectContext);
            ...
            AfterContextSaveScript_BaseExtendExpDateForm(viewModel, extendExpirationDate, transDef, objectContext);
    ...
    partial void PreScript_BaseExtendExpDateForm(BaseExtendExpDateFormViewModel viewModel, ExtendExpirationDate extendExpirationDate, TTObjectContext objectContext);
    partial void PostScript_BaseExtendExpDateForm(BaseExtendExpDateFormViewModel viewModel, ExtendExpirationDate extendExpirationDate, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_BaseExtendExpDateForm(BaseExtendExpDateFormViewModel viewModel, ExtendExpirationDate extendExpirationDate, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(BaseExtendExpDateFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class BaseExtendExpDateFormViewModel : BaseViewModel
    {
