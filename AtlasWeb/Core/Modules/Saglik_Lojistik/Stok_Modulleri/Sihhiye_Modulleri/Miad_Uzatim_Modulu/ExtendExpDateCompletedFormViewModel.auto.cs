...
{
    [HttpGet]
    public ExtendExpDateCompletedFormViewModel ExtendExpDateCompletedForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return ExtendExpDateCompletedFormLoadInternal(input);
    }

    [HttpPost]
    public ExtendExpDateCompletedFormViewModel ExtendExpDateCompletedFormLoad(FormLoadInput input)
    {
        return ExtendExpDateCompletedFormLoadInternal(input);
    }

    private ExtendExpDateCompletedFormViewModel ExtendExpDateCompletedFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("4f4767fa-505b-446f-9a98-e359f8f9d3ff");
        var objectDefID = Guid.Parse("8d36aad0-1bbc-41d8-b3b8-aff0351fbc7a");
        var viewModel = new ExtendExpDateCompletedFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_ExtendExpDateCompletedForm(viewModel, viewModel._ExtendExpirationDate, objectContext);
    ...
    [HttpPost]
    public BaseViewModel ExtendExpDateCompletedForm(ExtendExpDateCompletedFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_ExtendExpDateCompletedForm(viewModel, extendExpirationDate, transDef, objectContext);
            ...
            AfterContextSaveScript_ExtendExpDateCompletedForm(viewModel, extendExpirationDate, transDef, objectContext);
    ...
    partial void PreScript_ExtendExpDateCompletedForm(ExtendExpDateCompletedFormViewModel viewModel, ExtendExpirationDate extendExpirationDate, TTObjectContext objectContext);
    partial void PostScript_ExtendExpDateCompletedForm(ExtendExpDateCompletedFormViewModel viewModel, ExtendExpirationDate extendExpirationDate, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    ...
    void ContextToViewModel(ExtendExpDateCompletedFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class ExtendExpDateCompletedFormViewModel : BaseViewModel
    {
