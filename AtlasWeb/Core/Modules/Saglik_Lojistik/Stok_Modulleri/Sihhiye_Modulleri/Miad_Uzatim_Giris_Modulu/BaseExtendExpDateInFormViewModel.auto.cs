...
{
    [HttpGet]
    public BaseExtendExpDateInFormViewModel BaseExtendExpDateInForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return BaseExtendExpDateInFormLoadInternal(input);
    }

    [HttpPost]
    public BaseExtendExpDateInFormViewModel BaseExtendExpDateInFormLoad(FormLoadInput input)
    {
        return BaseExtendExpDateInFormLoadInternal(input);
    }

    private BaseExtendExpDateInFormViewModel BaseExtendExpDateInFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("040ba1aa-e1c7-4862-acaa-ba535417643c");
        var objectDefID = Guid.Parse("2fbd8835-bc61-4dd1-b98a-d003a62b4a75");
        var viewModel = new BaseExtendExpDateInFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_BaseExtendExpDateInForm(viewModel, viewModel._ExtendExpDateIn, objectContext);
    ...
    [HttpPost]
    public BaseViewModel BaseExtendExpDateInForm(BaseExtendExpDateInFormViewModel viewModel)
    {
        using (var objectContext = new TTObjectContext(false))
        {
            return BaseExtendExpDateInFormInternal(viewModel, objectContext);
        }
    }

    internal BaseViewModel BaseExtendExpDateInFormInternal(BaseExtendExpDateInFormViewModel viewModel, TTObjectContext objectContext)
    {
        ...
        PostScript_BaseExtendExpDateInForm(viewModel, extendExpDateIn, transDef, objectContext);
        ...
        AfterContextSaveScript_BaseExtendExpDateInForm(viewModel, extendExpDateIn, transDef, objectContext);
    ...
    partial void PreScript_BaseExtendExpDateInForm(BaseExtendExpDateInFormViewModel viewModel, ExtendExpDateIn extendExpDateIn, TTObjectContext objectContext);
    partial void PostScript_BaseExtendExpDateInForm(BaseExtendExpDateInFormViewModel viewModel, ExtendExpDateIn extendExpDateIn, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_BaseExtendExpDateInForm(BaseExtendExpDateInFormViewModel viewModel, ExtendExpDateIn extendExpDateIn, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(BaseExtendExpDateInFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class BaseExtendExpDateInFormViewModel
    {
