...
import { ExtendExpDateIn, DocumentRecordLog } from "NebulaClient/Model/AtlasClientModel";
...
export class ExtendExpDateInCompFormViewModel extends BaseViewModel {
    @Type(() => ExtendExpDateIn)
    public _ExtendExpDateIn: ExtendExpDateIn = new ExtendExpDateIn();
    @Type(() => ExtendExpDateInDetail)
