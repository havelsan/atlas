...
import { DeleteRecordDocumentDestroyableInspectionFormViewModel } from './DeleteRecordDocumentDestroyableInspectionFormViewModel';
...
@Component({
    selector: 'DeleteRecordDocumentDestroyableInspectionForm',
    templateUrl: './DeleteRecordDocumentDestroyableInspectionForm.html',
    providers: [MessageService]
})
export class DeleteRecordDocumentDestroyableInspectionForm extends BaseDeleteRecordDocumentDestroyableForm implements OnInit {
   ...
   // public StockActionOutDetailsColumns = [];
    ...
    public deleteRecordDocumentDestroyableInspectionFormViewModel: DeleteRecordDocumentDestroyableInspectionFormViewModel = new DeleteRecordDocumentDestroyableInspectionFormViewModel();
    ...
    private DeleteRecordDocumentDestroyableInspectionForm_DocumentUrl: string = '/api/DeleteRecordDocumentDestroyableService/DeleteRecordDocumentDestroyableInspectionForm';
    constructor(protected httpService: NeHttpService,
                protected messageService: MessageService,
                protected ngZone: NgZone) {
        super(httpService, messageService, ngZone);
        this._DocumentServiceUrl = this.DeleteRecordDocumentDestroyableInspectionForm_DocumentUrl;
        this.initViewModel();
    ...
    public initViewModel(): void {
        ...
        this.deleteRecordDocumentDestroyableInspectionFormViewModel = new DeleteRecordDocumentDestroyableInspectionFormViewModel();
        this._ViewModel = this.deleteRecordDocumentDestroyableInspectionFormViewModel;
        this.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable = this._TTObject as DeleteRecordDocumentDestroyable;
        this.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials = new Array<DeleteRecordDocumentDestroyableMaterialOut>();
        this.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable.StockActionSignDetails = new Array<StockActionSignDetail>();
        this.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable.Store = new Store();
        this.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection = new StockActionInspection();
        this.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection.StockActionInspectionDetails = new Array<StockActionInspectionDetail>();
    }

    protected loadViewModel() {
        let that = this;

        that.deleteRecordDocumentDestroyableInspectionFormViewModel = this._ViewModel as DeleteRecordDocumentDestroyableInspectionFormViewModel;
        that._TTObject = this.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable;
        if (this.deleteRecordDocumentDestroyableInspectionFormViewModel == null)
            this.deleteRecordDocumentDestroyableInspectionFormViewModel = new DeleteRecordDocumentDestroyableInspectionFormViewModel();
        if (this.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable == null)
            this.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable = new DeleteRecordDocumentDestroyable();
        that.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials = that.deleteRecordDocumentDestroyableInspectionFormViewModel.StockActionOutDetailsGridList;
        for (let detailItem of that.deleteRecordDocumentDestroyableInspectionFormViewModel.StockActionOutDetailsGridList) {
            let materialObjectID = detailItem["Material"];
            if (materialObjectID != null && (typeof materialObjectID === 'string')) {
                let material = that.deleteRecordDocumentDestroyableInspectionFormViewModel.Materials.find(o => o.ObjectID.toString() === materialObjectID.toString());
                 if (material) {
                ...
                if (material != null) {
                    ...
                    if (stockCardObjectID != null && (typeof stockCardObjectID === 'string')) {
                        let stockCard = that.deleteRecordDocumentDestroyableInspectionFormViewModel.StockCards.find(o => o.ObjectID.toString() === stockCardObjectID.toString());
                         if (stockCard) {
                        ...
                        if (stockCard != null) {
                            ...
                            if (distributionTypeObjectID != null && (typeof distributionTypeObjectID === 'string')) {
                                let distributionType = that.deleteRecordDocumentDestroyableInspectionFormViewModel.DistributionTypeDefinitions.find(o => o.ObjectID.toString() === distributionTypeObjectID.toString());
                                 if (distributionType) {
            ...
            if (stockLevelTypeObjectID != null && (typeof stockLevelTypeObjectID === 'string')) {
                let stockLevelType = that.deleteRecordDocumentDestroyableInspectionFormViewModel.StockLevelTypes.find(o => o.ObjectID.toString() === stockLevelTypeObjectID.toString());
                 if (stockLevelType) {
                    detailItem.StockLevelType = stockLevelType;
                }
            }
        }
        that.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable.StockActionSignDetails = that.deleteRecordDocumentDestroyableInspectionFormViewModel.StockActionSignDetailsGridList;
        for (let detailItem of that.deleteRecordDocumentDestroyableInspectionFormViewModel.StockActionSignDetailsGridList) {
            let signUserObjectID = detailItem["SignUser"];
            if (signUserObjectID != null && (typeof signUserObjectID === 'string')) {
                let signUser = that.deleteRecordDocumentDestroyableInspectionFormViewModel.ResUsers.find(o => o.ObjectID.toString() === signUserObjectID.toString());
                 if (signUser) {
                    detailItem.SignUser = signUser;
                }
            }
        }
        let storeObjectID = that.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable["Store"];
        if (storeObjectID != null && (typeof storeObjectID === 'string')) {
            let store = that.deleteRecordDocumentDestroyableInspectionFormViewModel.Stores.find(o => o.ObjectID.toString() === storeObjectID.toString());
             if (store) {
                that.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable.Store = store;
            }
        }
        let stockActionInspectionObjectID = that.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable["StockActionInspection"];
        if (stockActionInspectionObjectID != null && (typeof stockActionInspectionObjectID === 'string')) {
            let stockActionInspection = that.deleteRecordDocumentDestroyableInspectionFormViewModel.StockActionInspections.find(o => o.ObjectID.toString() === stockActionInspectionObjectID.toString());
             if (stockActionInspection) {
                that.deleteRecordDocumentDestroyableInspectionFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection = stockActionInspection;
            }
            if (stockActionInspection != null) {
                stockActionInspection.StockActionInspectionDetails = that.deleteRecordDocumentDestroyableInspectionFormViewModel.StockActionInspectionDetailsStockActionInspectionDetailGridList;
                for (let detailItem of that.deleteRecordDocumentDestroyableInspectionFormViewModel.StockActionInspectionDetailsStockActionInspectionDetailGridList) {
                    let inspectionUserObjectID = detailItem["InspectionUser"];
                    if (inspectionUserObjectID != null && (typeof inspectionUserObjectID === 'string')) {
                        let inspectionUser = that.deleteRecordDocumentDestroyableInspectionFormViewModel.ResUsers.find(o => o.ObjectID.toString() === inspectionUserObjectID.toString());
                         if (inspectionUser) {
    ...
    async ngOnInit()  {
        let that = this;
        await this.load(DeleteRecordDocumentDestroyableInspectionFormViewModel);
        this.FormCaption = "Kayıt Silme Belgesi Yok Edilen ( Muayene )";
