...
import { BaseDeleteRecordDocumentDestroyableFormViewModel } from './BaseDeleteRecordDocumentDestroyableFormViewModel';
import { NeHttpService } from 'Fw/Services/NeHttpService';
import { MessageService } from 'Fw/Services/MessageService';
import * as TTVisual from "NebulaClient/Visual/TTVisualControlInterfaces";
import { BaseDeleteRecordDocumentForm } from "Modules/Saglik_Lojistik/Stok_Modulleri/Sihhiye_Modulleri/Tasinir_Mal_Kayit_Silme_Belgesi/BaseDeleteRecordDocumentForm";
...
import { DeleteRecordReasonEnum } from 'NebulaClient/Model/AtlasClientModel';
...
@Component({
    selector: 'BaseDeleteRecordDocumentDestroyableForm',
    templateUrl: './BaseDeleteRecordDocumentDestroyableForm.html',
    providers: [MessageService]
})
export class BaseDeleteRecordDocumentDestroyableForm extends BaseDeleteRecordDocumentForm implements OnInit {
    Amount: TTVisual.ITTTextBoxColumn;
    Barcode: TTVisual.ITTTextBoxColumn;
    DeleteRecordReason: TTVisual.ITTEnumComboBoxColumn;
    DestroyLocation: TTVisual.ITTTextBoxColumn;
    ...
    Opinions: TTVisual.ITTTextBoxColumn;
    ...
    public baseDeleteRecordDocumentDestroyableFormViewModel: BaseDeleteRecordDocumentDestroyableFormViewModel = new BaseDeleteRecordDocumentDestroyableFormViewModel();
    ...
    private BaseDeleteRecordDocumentDestroyableForm_DocumentUrl: string = '/api/DeleteRecordDocumentDestroyableService/BaseDeleteRecordDocumentDestroyableForm';
    constructor(protected httpService: NeHttpService,
                protected messageService: MessageService,
                protected ngZone: NgZone) {
        super(httpService, messageService, ngZone);
        this._DocumentServiceUrl = this.BaseDeleteRecordDocumentDestroyableForm_DocumentUrl;
        this.initViewModel();
    ...
    private async StockActionOutDetails_CellContentClick(rowIndex: number, columnIndex: number) {
    ...
    public async onStockLevelTypeSelectionChange(event: any) {
    ...
    public async btnAddClick() {
        ...
        else if (this.selectedStockLevelType == null || this.selectedStockLevelType.ObjectID == null)
            ServiceLocator.MessageService.showError('Malın Durumu seçimi yapınız!');
        else if (this.selectedDeleteRecordReason == null )
            ServiceLocator.MessageService.showError('Kayıt Silme Nedeni seçimi yapınız!');
        else {
            if (!this._DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials.find(x => x.Material.ObjectID == this.selectedMaterial.ObjectID)) {
                let newRow: DeleteRecordDocumentDestroyableMaterialOut = new DeleteRecordDocumentDestroyableMaterialOut();
                ...
                newRow.DeleteRecordReason = this.selectedDeleteRecordReason;
                ...
                let stockInheld: number = await StockLevelService.StockInheldWithStockLevel(newRow.Material.ObjectID, this._DeleteRecordDocumentDestroyable.Store.ObjectID, newRow.StockLevelType.ObjectID);
                newRow.StoreStock = stockInheld;
                this._DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials.push(newRow);
    ...
    public onStockActionOutDetailsGridRowUpdating(event: any) {
        let row = <DeleteRecordDocumentDestroyableMaterialOut>event.key;
        // Zaten sadece "RequireAmount" alanı update edilebiliyor
        if (row.Amount == null) {
            ServiceLocator.MessageService.showError('Miktarı boş olmaz!');
    ...
    // Detail Butonunun içi boştu kaldırıldı, Birim Fiyatı,Tutarı Alanları,Yetki Sembolü Visibleı false olduğu için kaldırıldı
    public StockActionOutDetailsColumns = [
        ...
        { // ?Enum name? DeleteRecordReasonEnum
            caption: i18n("M17417", "Kayıt Silme Nedeni"),
            dataField: 'DeleteRecordReason',
        ...
        {
            caption: i18n("M10483", "Açıklamalar"),
            dataField: 'Opinions',
            width: 200
        },
        {
            caption: i18n("M19442", "Nerede Yok Edildiği"),
            dataField: 'DestroyLocation',
            width: 200
        },
        {
    ...
    public async DeleteRecordDocumentDestroyable_CellValueChanged(data: any, rowIndex: number, columnIndex: number): Promise<void> {
        let materialDetail: DeleteRecordDocumentDestroyableMaterialOut = <DeleteRecordDocumentDestroyableMaterialOut>(data.Row.TTObject);
        if (materialDetail.Status === undefined) {
            ...
            materialDetail.StockLevelType = stockLeveltypeArray[0];
        }
        if (data.Column.Name === "Material" || data.Column.Name === "StockLevelType") {
            if (materialDetail.Material != null && materialDetail.StockLevelType != null) {
                if (materialDetail.Material.ObjectID != null) {
                    let stockInheld: number = await StockLevelService.StockInheldWithStockLevel(materialDetail.Material.ObjectID, this._DeleteRecordDocumentDestroyable.Store.ObjectID, materialDetail.StockLevelType.ObjectID);
                    materialDetail.StoreStock = stockInheld;
                }
            }
        }
    }
    ...
    public initViewModel(): void {
        ...
        this.baseDeleteRecordDocumentDestroyableFormViewModel = new BaseDeleteRecordDocumentDestroyableFormViewModel();
        this._ViewModel = this.baseDeleteRecordDocumentDestroyableFormViewModel;
        this.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable = this._TTObject as DeleteRecordDocumentDestroyable;
        this.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials = new Array<DeleteRecordDocumentDestroyableMaterialOut>();
        this.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable.StockActionSignDetails = new Array<StockActionSignDetail>();
        this.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable.Store = new Store();
        this.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection = new StockActionInspection();
        this.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection.StockActionInspectionDetails = new Array<StockActionInspectionDetail>();
    }

    protected loadViewModel() {
        let that = this;

        that.baseDeleteRecordDocumentDestroyableFormViewModel = this._ViewModel as BaseDeleteRecordDocumentDestroyableFormViewModel;
        that._TTObject = this.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable;
        if (this.baseDeleteRecordDocumentDestroyableFormViewModel == null)
            this.baseDeleteRecordDocumentDestroyableFormViewModel = new BaseDeleteRecordDocumentDestroyableFormViewModel();
        if (this.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable == null)
            this.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable = new DeleteRecordDocumentDestroyable();
        that.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials = that.baseDeleteRecordDocumentDestroyableFormViewModel.StockActionOutDetailsGridList;
        for (let detailItem of that.baseDeleteRecordDocumentDestroyableFormViewModel.StockActionOutDetailsGridList) {
            let materialObjectID = detailItem["Material"];
            if (materialObjectID != null && (typeof materialObjectID === 'string')) {
                let material = that.baseDeleteRecordDocumentDestroyableFormViewModel.Materials.find(o => o.ObjectID.toString() === materialObjectID.toString());
                 if (material) {
                ...
                if (material != null) {
                    ...
                    if (stockCardObjectID != null && (typeof stockCardObjectID === 'string')) {
                        let stockCard = that.baseDeleteRecordDocumentDestroyableFormViewModel.StockCards.find(o => o.ObjectID.toString() === stockCardObjectID.toString());
                         if (stockCard) {
                        ...
                        if (stockCard != null) {
                            ...
                            if (distributionTypeObjectID != null && (typeof distributionTypeObjectID === 'string')) {
                                let distributionType = that.baseDeleteRecordDocumentDestroyableFormViewModel.DistributionTypeDefinitions.find(o => o.ObjectID.toString() === distributionTypeObjectID.toString());
                                 if (distributionType) {
            ...
            if (stockLevelTypeObjectID != null && (typeof stockLevelTypeObjectID === 'string')) {
                let stockLevelType = that.baseDeleteRecordDocumentDestroyableFormViewModel.StockLevelTypes.find(o => o.ObjectID.toString() === stockLevelTypeObjectID.toString());
                 if (stockLevelType) {
                    detailItem.StockLevelType = stockLevelType;
                }
            }
        }
        that.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable.StockActionSignDetails = that.baseDeleteRecordDocumentDestroyableFormViewModel.StockActionSignDetailsGridList;
        for (let detailItem of that.baseDeleteRecordDocumentDestroyableFormViewModel.StockActionSignDetailsGridList) {
            let signUserObjectID = detailItem["SignUser"];
            if (signUserObjectID != null && (typeof signUserObjectID === 'string')) {
                let signUser = that.baseDeleteRecordDocumentDestroyableFormViewModel.ResUsers.find(o => o.ObjectID.toString() === signUserObjectID.toString());
                 if (signUser) {
                    detailItem.SignUser = signUser;
                }
            }
        }
        let storeObjectID = that.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable["Store"];
        if (storeObjectID != null && (typeof storeObjectID === 'string')) {
            let store = that.baseDeleteRecordDocumentDestroyableFormViewModel.Stores.find(o => o.ObjectID.toString() === storeObjectID.toString());
             if (store) {
                that.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable.Store = store;
            }
        }
        let stockActionInspectionObjectID = that.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable["StockActionInspection"];
        if (stockActionInspectionObjectID != null && (typeof stockActionInspectionObjectID === 'string')) {
            let stockActionInspection = that.baseDeleteRecordDocumentDestroyableFormViewModel.StockActionInspections.find(o => o.ObjectID.toString() === stockActionInspectionObjectID.toString());
             if (stockActionInspection) {
                that.baseDeleteRecordDocumentDestroyableFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection = stockActionInspection;
            }
            if (stockActionInspection != null) {
                stockActionInspection.StockActionInspectionDetails = that.baseDeleteRecordDocumentDestroyableFormViewModel.StockActionInspectionDetailsStockActionInspectionDetailGridList;
                for (let detailItem of that.baseDeleteRecordDocumentDestroyableFormViewModel.StockActionInspectionDetailsStockActionInspectionDetailGridList) {
                    let inspectionUserObjectID = detailItem["InspectionUser"];
                    if (inspectionUserObjectID != null && (typeof inspectionUserObjectID === 'string')) {
                        let inspectionUser = that.baseDeleteRecordDocumentDestroyableFormViewModel.ResUsers.find(o => o.ObjectID.toString() === inspectionUserObjectID.toString());
                         if (inspectionUser) {
    ...
    async ngOnInit()  {
        let that = this;
        await this.load(BaseDeleteRecordDocumentDestroyableFormViewModel);
