...
import { DeleteRecordDocumentDestroyableStockCardRegistryFormViewModel } from './DeleteRecordDocumentDestroyableStockCardRegistryFormViewModel';
...
@Component({
    selector: 'DeleteRecordDocumentDestroyableStockCardRegistryForm',
    templateUrl: './DeleteRecordDocumentDestroyableStockCardRegistryForm.html',
    providers: [MessageService]
})
export class DeleteRecordDocumentDestroyableStockCardRegistryForm extends BaseDeleteRecordDocumentDestroyableForm implements OnInit {
   ...
   // public StockActionOutDetailsColumns = [];
    ...
    public deleteRecordDocumentDestroyableStockCardRegistryFormViewModel: DeleteRecordDocumentDestroyableStockCardRegistryFormViewModel = new DeleteRecordDocumentDestroyableStockCardRegistryFormViewModel();
    ...
    private DeleteRecordDocumentDestroyableStockCardRegistryForm_DocumentUrl: string = '/api/DeleteRecordDocumentDestroyableService/DeleteRecordDocumentDestroyableStockCardRegistryForm';
    constructor(protected httpService: NeHttpService,
                protected messageService: MessageService,
                protected ngZone: NgZone) {
        super(httpService, messageService, ngZone);
        this._DocumentServiceUrl = this.DeleteRecordDocumentDestroyableStockCardRegistryForm_DocumentUrl;
        this.initViewModel();
    ...
    public initViewModel(): void {
        ...
        this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel = new DeleteRecordDocumentDestroyableStockCardRegistryFormViewModel();
        this._ViewModel = this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel;
        this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable = this._TTObject as DeleteRecordDocumentDestroyable;
        this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials = new Array<DeleteRecordDocumentDestroyableMaterialOut>();
        this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable.StockActionSignDetails = new Array<StockActionSignDetail>();
        this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable.Store = new Store();
        this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection = new StockActionInspection();
        this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection.StockActionInspectionDetails = new Array<StockActionInspectionDetail>();
    }

    protected loadViewModel() {
        let that = this;

        that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel = this._ViewModel as DeleteRecordDocumentDestroyableStockCardRegistryFormViewModel;
        that._TTObject = this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable;
        if (this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel == null)
            this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel = new DeleteRecordDocumentDestroyableStockCardRegistryFormViewModel();
        if (this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable == null)
            this.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable = new DeleteRecordDocumentDestroyable();
        that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.StockActionOutDetailsGridList;
        for (let detailItem of that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.StockActionOutDetailsGridList) {
            let materialObjectID = detailItem["Material"];
            if (materialObjectID != null && (typeof materialObjectID === 'string')) {
                let material = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.Materials.find(o => o.ObjectID.toString() === materialObjectID.toString());
                 if (material) {
                ...
                if (material != null) {
                    ...
                    if (stockCardObjectID != null && (typeof stockCardObjectID === 'string')) {
                        let stockCard = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.StockCards.find(o => o.ObjectID.toString() === stockCardObjectID.toString());
                         if (stockCard) {
                        ...
                        if (stockCard != null) {
                            ...
                            if (distributionTypeObjectID != null && (typeof distributionTypeObjectID === 'string')) {
                                let distributionType = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.DistributionTypeDefinitions.find(o => o.ObjectID.toString() === distributionTypeObjectID.toString());
                                 if (distributionType) {
            ...
            if (stockLevelTypeObjectID != null && (typeof stockLevelTypeObjectID === 'string')) {
                let stockLevelType = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.StockLevelTypes.find(o => o.ObjectID.toString() === stockLevelTypeObjectID.toString());
                 if (stockLevelType) {
                    detailItem.StockLevelType = stockLevelType;
                }
            }
        }
        that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable.StockActionSignDetails = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.StockActionSignDetailsGridList;
        for (let detailItem of that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.StockActionSignDetailsGridList) {
            let signUserObjectID = detailItem["SignUser"];
            if (signUserObjectID != null && (typeof signUserObjectID === 'string')) {
                let signUser = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.ResUsers.find(o => o.ObjectID.toString() === signUserObjectID.toString());
                 if (signUser) {
                    detailItem.SignUser = signUser;
                }
            }
        }
        let storeObjectID = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable["Store"];
        if (storeObjectID != null && (typeof storeObjectID === 'string')) {
            let store = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.Stores.find(o => o.ObjectID.toString() === storeObjectID.toString());
             if (store) {
                that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable.Store = store;
            }
        }
        let stockActionInspectionObjectID = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable["StockActionInspection"];
        if (stockActionInspectionObjectID != null && (typeof stockActionInspectionObjectID === 'string')) {
            let stockActionInspection = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.StockActionInspections.find(o => o.ObjectID.toString() === stockActionInspectionObjectID.toString());
             if (stockActionInspection) {
                that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection = stockActionInspection;
            }
            if (stockActionInspection != null) {
                stockActionInspection.StockActionInspectionDetails = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.StockActionInspectionDetailsStockActionInspectionDetailGridList;
                for (let detailItem of that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.StockActionInspectionDetailsStockActionInspectionDetailGridList) {
                    let inspectionUserObjectID = detailItem["InspectionUser"];
                    if (inspectionUserObjectID != null && (typeof inspectionUserObjectID === 'string')) {
                        let inspectionUser = that.deleteRecordDocumentDestroyableStockCardRegistryFormViewModel.ResUsers.find(o => o.ObjectID.toString() === inspectionUserObjectID.toString());
                         if (inspectionUser) {
    ...
    async ngOnInit()  {
        let that = this;
        await this.load(DeleteRecordDocumentDestroyableStockCardRegistryFormViewModel);
        this.FormCaption = "Kayıt Silme Belgesi Yok Edilen ( Stok Kayıt )";
