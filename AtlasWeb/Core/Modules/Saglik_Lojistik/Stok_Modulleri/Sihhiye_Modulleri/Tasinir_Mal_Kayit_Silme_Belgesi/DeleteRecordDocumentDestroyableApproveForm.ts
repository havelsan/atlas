...
import { DeleteRecordDocumentDestroyableApproveFormViewModel } from './DeleteRecordDocumentDestroyableApproveFormViewModel';
...
@Component({
    selector: 'DeleteRecordDocumentDestroyableApproveForm',
    templateUrl: './DeleteRecordDocumentDestroyableApproveForm.html',
    providers: [MessageService]
})
export class DeleteRecordDocumentDestroyableApproveForm extends BaseDeleteRecordDocumentDestroyableForm implements OnInit {
    ...
    public deleteRecordDocumentDestroyableApproveFormViewModel: DeleteRecordDocumentDestroyableApproveFormViewModel = new DeleteRecordDocumentDestroyableApproveFormViewModel();
    ...
    private DeleteRecordDocumentDestroyableApproveForm_DocumentUrl: string = '/api/DeleteRecordDocumentDestroyableService/DeleteRecordDocumentDestroyableApproveForm';
    constructor(protected httpService: NeHttpService,
        protected messageService: MessageService,
        private reportService: AtlasReportService,
        protected ngZone: NgZone) {
        super(httpService, messageService, ngZone);
        this._DocumentServiceUrl = this.DeleteRecordDocumentDestroyableApproveForm_DocumentUrl;
        this.initViewModel();
    ...
    public initViewModel(): void {
        ...
        this.deleteRecordDocumentDestroyableApproveFormViewModel = new DeleteRecordDocumentDestroyableApproveFormViewModel();
        this._ViewModel = this.deleteRecordDocumentDestroyableApproveFormViewModel;
        this.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable = this._TTObject as DeleteRecordDocumentDestroyable;
        this.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials = new Array<DeleteRecordDocumentDestroyableMaterialOut>();
        this.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable.StockActionSignDetails = new Array<StockActionSignDetail>();
        this.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable.Store = new Store();
        this.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection = new StockActionInspection();
        this.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection.StockActionInspectionDetails = new Array<StockActionInspectionDetail>();
    }

    protected loadViewModel() {
        let that = this;

        that.deleteRecordDocumentDestroyableApproveFormViewModel = this._ViewModel as DeleteRecordDocumentDestroyableApproveFormViewModel;
        that._TTObject = this.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable;
        if (this.deleteRecordDocumentDestroyableApproveFormViewModel == null)
            this.deleteRecordDocumentDestroyableApproveFormViewModel = new DeleteRecordDocumentDestroyableApproveFormViewModel();
        if (this.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable == null)
            this.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable = new DeleteRecordDocumentDestroyable();
        that.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable.DeleteRecordDocumentDestroyableOutMaterials = that.deleteRecordDocumentDestroyableApproveFormViewModel.StockActionOutDetailsGridList;
        for (let detailItem of that.deleteRecordDocumentDestroyableApproveFormViewModel.StockActionOutDetailsGridList) {
            let materialObjectID = detailItem["Material"];
            if (materialObjectID != null && (typeof materialObjectID === 'string')) {
                let material = that.deleteRecordDocumentDestroyableApproveFormViewModel.Materials.find(o => o.ObjectID.toString() === materialObjectID.toString());
                if (material) {
                ...
                if (material != null) {
                    ...
                    if (stockCardObjectID != null && (typeof stockCardObjectID === 'string')) {
                        let stockCard = that.deleteRecordDocumentDestroyableApproveFormViewModel.StockCards.find(o => o.ObjectID.toString() === stockCardObjectID.toString());
                        if (stockCard) {
                        ...
                        if (stockCard != null) {
                            ...
                            if (distributionTypeObjectID != null && (typeof distributionTypeObjectID === 'string')) {
                                let distributionType = that.deleteRecordDocumentDestroyableApproveFormViewModel.DistributionTypeDefinitions.find(o => o.ObjectID.toString() === distributionTypeObjectID.toString());
                                if (distributionType) {
            ...
            if (stockLevelTypeObjectID != null && (typeof stockLevelTypeObjectID === 'string')) {
                let stockLevelType = that.deleteRecordDocumentDestroyableApproveFormViewModel.StockLevelTypes.find(o => o.ObjectID.toString() === stockLevelTypeObjectID.toString());
                if (stockLevelType) {
                    detailItem.StockLevelType = stockLevelType;
                }
            }
        }
        that.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable.StockActionSignDetails = that.deleteRecordDocumentDestroyableApproveFormViewModel.StockActionSignDetailsGridList;
        for (let detailItem of that.deleteRecordDocumentDestroyableApproveFormViewModel.StockActionSignDetailsGridList) {
            let signUserObjectID = detailItem["SignUser"];
            if (signUserObjectID != null && (typeof signUserObjectID === 'string')) {
                let signUser = that.deleteRecordDocumentDestroyableApproveFormViewModel.ResUsers.find(o => o.ObjectID.toString() === signUserObjectID.toString());
                if (signUser) {
                    detailItem.SignUser = signUser;
                }
            }
        }
        let storeObjectID = that.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable["Store"];
        if (storeObjectID != null && (typeof storeObjectID === 'string')) {
            let store = that.deleteRecordDocumentDestroyableApproveFormViewModel.Stores.find(o => o.ObjectID.toString() === storeObjectID.toString());
            if (store) {
                that.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable.Store = store;
            }
        }
        let stockActionInspectionObjectID = that.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable["StockActionInspection"];
        if (stockActionInspectionObjectID != null && (typeof stockActionInspectionObjectID === 'string')) {
            let stockActionInspection = that.deleteRecordDocumentDestroyableApproveFormViewModel.StockActionInspections.find(o => o.ObjectID.toString() === stockActionInspectionObjectID.toString());
            if (stockActionInspection) {
                that.deleteRecordDocumentDestroyableApproveFormViewModel._DeleteRecordDocumentDestroyable.StockActionInspection = stockActionInspection;
            }
            if (stockActionInspection != null) {
                stockActionInspection.StockActionInspectionDetails = that.deleteRecordDocumentDestroyableApproveFormViewModel.StockActionInspectionDetailsStockActionInspectionDetailGridList;
                for (let detailItem of that.deleteRecordDocumentDestroyableApproveFormViewModel.StockActionInspectionDetailsStockActionInspectionDetailGridList) {
                    let inspectionUserObjectID = detailItem["InspectionUser"];
                    if (inspectionUserObjectID != null && (typeof inspectionUserObjectID === 'string')) {
                        let inspectionUser = that.deleteRecordDocumentDestroyableApproveFormViewModel.ResUsers.find(o => o.ObjectID.toString() === inspectionUserObjectID.toString());
                        if (inspectionUser) {
    ...
    async ngOnInit() {
        let that = this;
        await this.load(DeleteRecordDocumentDestroyableApproveFormViewModel);
        this.FormCaption = "Kayıt Silme Belgesi Yok Edilen ( Onay )";
