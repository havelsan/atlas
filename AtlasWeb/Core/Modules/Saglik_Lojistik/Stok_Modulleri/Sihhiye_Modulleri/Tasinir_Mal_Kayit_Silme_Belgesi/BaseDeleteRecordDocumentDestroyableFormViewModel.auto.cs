...
{
    [HttpGet]
    public BaseDeleteRecordDocumentDestroyableFormViewModel BaseDeleteRecordDocumentDestroyableForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return BaseDeleteRecordDocumentDestroyableFormLoadInternal(input);
    }

    [HttpPost]
    public BaseDeleteRecordDocumentDestroyableFormViewModel BaseDeleteRecordDocumentDestroyableFormLoad(FormLoadInput input)
    {
        return BaseDeleteRecordDocumentDestroyableFormLoadInternal(input);
    }

    private BaseDeleteRecordDocumentDestroyableFormViewModel BaseDeleteRecordDocumentDestroyableFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("b997c2ea-ecbd-484e-90bb-60936b8e391f");
        var objectDefID = Guid.Parse("655c24fc-729d-4fe7-aae4-d6f6add7263d");
        var viewModel = new BaseDeleteRecordDocumentDestroyableFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_BaseDeleteRecordDocumentDestroyableForm(viewModel, viewModel._DeleteRecordDocumentDestroyable, objectContext);
    ...
    [HttpPost]
    public BaseViewModel BaseDeleteRecordDocumentDestroyableForm(BaseDeleteRecordDocumentDestroyableFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_BaseDeleteRecordDocumentDestroyableForm(viewModel, deleteRecordDocumentDestroyable, transDef, objectContext);
            ...
            AfterContextSaveScript_BaseDeleteRecordDocumentDestroyableForm(viewModel, deleteRecordDocumentDestroyable, transDef, objectContext);
    ...
    partial void PreScript_BaseDeleteRecordDocumentDestroyableForm(BaseDeleteRecordDocumentDestroyableFormViewModel viewModel, DeleteRecordDocumentDestroyable deleteRecordDocumentDestroyable, TTObjectContext objectContext);
    partial void PostScript_BaseDeleteRecordDocumentDestroyableForm(BaseDeleteRecordDocumentDestroyableFormViewModel viewModel, DeleteRecordDocumentDestroyable deleteRecordDocumentDestroyable, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_BaseDeleteRecordDocumentDestroyableForm(BaseDeleteRecordDocumentDestroyableFormViewModel viewModel, DeleteRecordDocumentDestroyable deleteRecordDocumentDestroyable, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(BaseDeleteRecordDocumentDestroyableFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class BaseDeleteRecordDocumentDestroyableFormViewModel : BaseViewModel
    {
