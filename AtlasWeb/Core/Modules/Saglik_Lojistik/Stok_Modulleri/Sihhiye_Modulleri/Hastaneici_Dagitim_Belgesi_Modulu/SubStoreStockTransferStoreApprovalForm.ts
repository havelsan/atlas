...
import { SubStoreStockTransferStoreApprovalFormViewModel } from './SubStoreStockTransferStoreApprovalFormViewModel';
...
@Component({
    selector: 'SubStoreStockTransferStoreApprovalForm',
    templateUrl: './SubStoreStockTransferStoreApprovalForm.html',
    providers: [MessageService]
})
export class SubStoreStockTransferStoreApprovalForm extends BaseSubStoreStockTransferForm implements OnInit {
    public StockActionSignDetailsColumns = [];
    public SubStoreStockTransferMaterialsColumns = [];
    public subStoreStockTransferStoreApprovalFormViewModel: SubStoreStockTransferStoreApprovalFormViewModel = new SubStoreStockTransferStoreApprovalFormViewModel();
    public get _SubStoreStockTransfer(): SubStoreStockTransfer {
        return this._TTObject as SubStoreStockTransfer;
    }
    private SubStoreStockTransferStoreApprovalForm_DocumentUrl: string = '/api/SubStoreStockTransferService/SubStoreStockTransferStoreApprovalForm';
    constructor(protected httpService: NeHttpService,
                protected messageService: MessageService,
                protected ngZone: NgZone) {
        super(httpService, messageService, ngZone);
        this._DocumentServiceUrl = this.SubStoreStockTransferStoreApprovalForm_DocumentUrl;
        this.initViewModel();
    ...
    public initViewModel(): void {
        ...
        this.subStoreStockTransferStoreApprovalFormViewModel = new SubStoreStockTransferStoreApprovalFormViewModel();
        this._ViewModel = this.subStoreStockTransferStoreApprovalFormViewModel;
        this.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer = this._TTObject as SubStoreStockTransfer;
        this.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer.DestinationStore = new Store();
        this.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer.Store = new Store();
        this.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer.StockActionSignDetails = new Array<StockActionSignDetail>();
        this.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer.SubStoreStockTransferMaterials = new Array<SubStoreStockTransferMat>();
    }

    protected loadViewModel() {
        let that = this;

        that.subStoreStockTransferStoreApprovalFormViewModel = this._ViewModel as SubStoreStockTransferStoreApprovalFormViewModel;
        that._TTObject = this.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer;
        if (this.subStoreStockTransferStoreApprovalFormViewModel == null)
            this.subStoreStockTransferStoreApprovalFormViewModel = new SubStoreStockTransferStoreApprovalFormViewModel();
        if (this.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer == null)
            this.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer = new SubStoreStockTransfer();
        let destinationStoreObjectID = that.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer["DestinationStore"];
        if (destinationStoreObjectID != null && (typeof destinationStoreObjectID === 'string')) {
            let destinationStore = that.subStoreStockTransferStoreApprovalFormViewModel.Stores.find(o => o.ObjectID.toString() === destinationStoreObjectID.toString());
             if (destinationStore) {
                that.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer.DestinationStore = destinationStore;
            }
        }
        let storeObjectID = that.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer["Store"];
        if (storeObjectID != null && (typeof storeObjectID === 'string')) {
            let store = that.subStoreStockTransferStoreApprovalFormViewModel.Stores.find(o => o.ObjectID.toString() === storeObjectID.toString());
             if (store) {
                that.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer.Store = store;
            }
        }
        that.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer.StockActionSignDetails = that.subStoreStockTransferStoreApprovalFormViewModel.StockActionSignDetailsGridList;
        for (let detailItem of that.subStoreStockTransferStoreApprovalFormViewModel.StockActionSignDetailsGridList) {
            let signUserObjectID = detailItem["SignUser"];
            if (signUserObjectID != null && (typeof signUserObjectID === 'string')) {
                let signUser = that.subStoreStockTransferStoreApprovalFormViewModel.ResUsers.find(o => o.ObjectID.toString() === signUserObjectID.toString());
                 if (signUser) {
                    detailItem.SignUser = signUser;
                }
            }
        }
        that.subStoreStockTransferStoreApprovalFormViewModel._SubStoreStockTransfer.SubStoreStockTransferMaterials = that.subStoreStockTransferStoreApprovalFormViewModel.SubStoreStockTransferMaterialsGridList;
        for (let detailItem of that.subStoreStockTransferStoreApprovalFormViewModel.SubStoreStockTransferMaterialsGridList) {
            let materialObjectID = detailItem["Material"];
            if (materialObjectID != null && (typeof materialObjectID === 'string')) {
                let material = that.subStoreStockTransferStoreApprovalFormViewModel.Materials.find(o => o.ObjectID.toString() === materialObjectID.toString());
                 if (material) {
                ...
                if (material != null) {
                    ...
                    if (stockCardObjectID != null && (typeof stockCardObjectID === 'string')) {
                        let stockCard = that.subStoreStockTransferStoreApprovalFormViewModel.StockCards.find(o => o.ObjectID.toString() === stockCardObjectID.toString());
                         if (stockCard) {
                        ...
                        if (stockCard != null) {
                            ...
                            if (distributionTypeObjectID != null && (typeof distributionTypeObjectID === 'string')) {
                                let distributionType = that.subStoreStockTransferStoreApprovalFormViewModel.DistributionTypeDefinitions.find(o => o.ObjectID.toString() === distributionTypeObjectID.toString());
                                 if (distributionType) {
            ...
            if (stockLevelTypeObjectID != null && (typeof stockLevelTypeObjectID === 'string')) {
                let stockLevelType = that.subStoreStockTransferStoreApprovalFormViewModel.StockLevelTypes.find(o => o.ObjectID.toString() === stockLevelTypeObjectID.toString());
                 if (stockLevelType) {
    ...
    async ngOnInit()  {
        let that = this;
        await this.load(SubStoreStockTransferStoreApprovalFormViewModel);
        ...
        this.FormCaption = i18n("M21671", "Servisler Arası Transfer Belgesi ( Depo Onay )");
