...
import { SubStoreStockTransferApprovalFormViewModel } from './SubStoreStockTransferApprovalFormViewModel';
...
@Component({
    selector: 'SubStoreStockTransferApprovalForm',
    templateUrl: './SubStoreStockTransferApprovalForm.html',
    providers: [MessageService]
})
export class SubStoreStockTransferApprovalForm extends BaseSubStoreStockTransferForm implements OnInit {
    public StockActionSignDetailsColumns = [];
    public SubStoreStockTransferMaterialsColumns = [];
    public subStoreStockTransferApprovalFormViewModel: SubStoreStockTransferApprovalFormViewModel = new SubStoreStockTransferApprovalFormViewModel();
    public get _SubStoreStockTransfer(): SubStoreStockTransfer {
        return this._TTObject as SubStoreStockTransfer;
    }
    private SubStoreStockTransferApprovalForm_DocumentUrl: string = '/api/SubStoreStockTransferService/SubStoreStockTransferApprovalForm';
    constructor(protected httpService: NeHttpService,
                protected messageService: MessageService,
                protected ngZone: NgZone) {
        super(httpService, messageService, ngZone);
        this._DocumentServiceUrl = this.SubStoreStockTransferApprovalForm_DocumentUrl;
        this.initViewModel();
    ...
    public initViewModel(): void {
        ...
        this.subStoreStockTransferApprovalFormViewModel = new SubStoreStockTransferApprovalFormViewModel();
        this._ViewModel = this.subStoreStockTransferApprovalFormViewModel;
        this.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer = this._TTObject as SubStoreStockTransfer;
        this.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer.DestinationStore = new Store();
        this.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer.Store = new Store();
        this.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer.StockActionSignDetails = new Array<StockActionSignDetail>();
        this.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer.SubStoreStockTransferMaterials = new Array<SubStoreStockTransferMat>();
    }

    protected loadViewModel() {
        let that = this;

        that.subStoreStockTransferApprovalFormViewModel = this._ViewModel as SubStoreStockTransferApprovalFormViewModel;
        that._TTObject = this.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer;
        if (this.subStoreStockTransferApprovalFormViewModel == null)
            this.subStoreStockTransferApprovalFormViewModel = new SubStoreStockTransferApprovalFormViewModel();
        if (this.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer == null)
            this.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer = new SubStoreStockTransfer();
        let destinationStoreObjectID = that.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer["DestinationStore"];
        if (destinationStoreObjectID != null && (typeof destinationStoreObjectID === 'string')) {
            let destinationStore = that.subStoreStockTransferApprovalFormViewModel.Stores.find(o => o.ObjectID.toString() === destinationStoreObjectID.toString());
             if (destinationStore) {
                that.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer.DestinationStore = destinationStore;
            }
        }
        let storeObjectID = that.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer["Store"];
        if (storeObjectID != null && (typeof storeObjectID === 'string')) {
            let store = that.subStoreStockTransferApprovalFormViewModel.Stores.find(o => o.ObjectID.toString() === storeObjectID.toString());
             if (store) {
                that.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer.Store = store;
            }
        }
        that.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer.StockActionSignDetails = that.subStoreStockTransferApprovalFormViewModel.StockActionSignDetailsGridList;
        for (let detailItem of that.subStoreStockTransferApprovalFormViewModel.StockActionSignDetailsGridList) {
            let signUserObjectID = detailItem["SignUser"];
            if (signUserObjectID != null && (typeof signUserObjectID === 'string')) {
                let signUser = that.subStoreStockTransferApprovalFormViewModel.ResUsers.find(o => o.ObjectID.toString() === signUserObjectID.toString());
                 if (signUser) {
                    detailItem.SignUser = signUser;
                }
            }
        }
        that.subStoreStockTransferApprovalFormViewModel._SubStoreStockTransfer.SubStoreStockTransferMaterials = that.subStoreStockTransferApprovalFormViewModel.SubStoreStockTransferMaterialsGridList;
        for (let detailItem of that.subStoreStockTransferApprovalFormViewModel.SubStoreStockTransferMaterialsGridList) {
            let materialObjectID = detailItem["Material"];
            if (materialObjectID != null && (typeof materialObjectID === 'string')) {
                let material = that.subStoreStockTransferApprovalFormViewModel.Materials.find(o => o.ObjectID.toString() === materialObjectID.toString());
                 if (material) {
                ...
                if (material != null) {
                    ...
                    if (stockCardObjectID != null && (typeof stockCardObjectID === 'string')) {
                        let stockCard = that.subStoreStockTransferApprovalFormViewModel.StockCards.find(o => o.ObjectID.toString() === stockCardObjectID.toString());
                         if (stockCard) {
                        ...
                        if (stockCard != null) {
                            ...
                            if (distributionTypeObjectID != null && (typeof distributionTypeObjectID === 'string')) {
                                let distributionType = that.subStoreStockTransferApprovalFormViewModel.DistributionTypeDefinitions.find(o => o.ObjectID.toString() === distributionTypeObjectID.toString());
                                 if (distributionType) {
            ...
            if (stockLevelTypeObjectID != null && (typeof stockLevelTypeObjectID === 'string')) {
                let stockLevelType = that.subStoreStockTransferApprovalFormViewModel.StockLevelTypes.find(o => o.ObjectID.toString() === stockLevelTypeObjectID.toString());
                 if (stockLevelType) {
    ...
    async ngOnInit()  {
        let that = this;
        await this.load(SubStoreStockTransferApprovalFormViewModel);
        this.FormCaption = i18n("M21672", "Servisler Arası Transfer Belgesi ( Onay )");
