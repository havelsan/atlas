...
{
    [HttpGet]
    public SubStoreStockTransferApprovalFormViewModel SubStoreStockTransferApprovalForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return SubStoreStockTransferApprovalFormLoadInternal(input);
    }

    [HttpPost]
    public SubStoreStockTransferApprovalFormViewModel SubStoreStockTransferApprovalFormLoad(FormLoadInput input)
    {
        return SubStoreStockTransferApprovalFormLoadInternal(input);
    }

    private SubStoreStockTransferApprovalFormViewModel SubStoreStockTransferApprovalFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("69c95077-e3f7-47d3-9103-af84efe1fc51");
        var objectDefID = Guid.Parse("4bcc82dc-5d81-463f-82cd-f7c327ca01ea");
        var viewModel = new SubStoreStockTransferApprovalFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_SubStoreStockTransferApprovalForm(viewModel, viewModel._SubStoreStockTransfer, objectContext);
    ...
    [HttpPost]
    public BaseViewModel SubStoreStockTransferApprovalForm(SubStoreStockTransferApprovalFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_SubStoreStockTransferApprovalForm(viewModel, subStoreStockTransfer, transDef, objectContext);
            ...
            AfterContextSaveScript_SubStoreStockTransferApprovalForm(viewModel, subStoreStockTransfer, transDef, objectContext);
    ...
    partial void PreScript_SubStoreStockTransferApprovalForm(SubStoreStockTransferApprovalFormViewModel viewModel, SubStoreStockTransfer subStoreStockTransfer, TTObjectContext objectContext);
    partial void PostScript_SubStoreStockTransferApprovalForm(SubStoreStockTransferApprovalFormViewModel viewModel, SubStoreStockTransfer subStoreStockTransfer, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_SubStoreStockTransferApprovalForm(SubStoreStockTransferApprovalFormViewModel viewModel, SubStoreStockTransfer subStoreStockTransfer, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(SubStoreStockTransferApprovalFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class SubStoreStockTransferApprovalFormViewModel : BaseViewModel
    {
