...
{
    [HttpGet]
    public BaseSubStoreStockTransferFormViewModel BaseSubStoreStockTransferForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return BaseSubStoreStockTransferFormLoadInternal(input);
    }

    [HttpPost]
    public BaseSubStoreStockTransferFormViewModel BaseSubStoreStockTransferFormLoad(FormLoadInput input)
    {
        return BaseSubStoreStockTransferFormLoadInternal(input);
    }

    private BaseSubStoreStockTransferFormViewModel BaseSubStoreStockTransferFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("4d96a0fd-c58f-41d1-9c0e-61a14908b8e3");
        var objectDefID = Guid.Parse("4bcc82dc-5d81-463f-82cd-f7c327ca01ea");
        var viewModel = new BaseSubStoreStockTransferFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_BaseSubStoreStockTransferForm(viewModel, viewModel._SubStoreStockTransfer, objectContext);
    ...
    [HttpPost]
    public BaseViewModel BaseSubStoreStockTransferForm(BaseSubStoreStockTransferFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_BaseSubStoreStockTransferForm(viewModel, subStoreStockTransfer, transDef, objectContext);
            ...
            AfterContextSaveScript_BaseSubStoreStockTransferForm(viewModel, subStoreStockTransfer, transDef, objectContext);
    ...
    partial void PreScript_BaseSubStoreStockTransferForm(BaseSubStoreStockTransferFormViewModel viewModel, SubStoreStockTransfer subStoreStockTransfer, TTObjectContext objectContext);
    partial void PostScript_BaseSubStoreStockTransferForm(BaseSubStoreStockTransferFormViewModel viewModel, SubStoreStockTransfer subStoreStockTransfer, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_BaseSubStoreStockTransferForm(BaseSubStoreStockTransferFormViewModel viewModel, SubStoreStockTransfer subStoreStockTransfer, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(BaseSubStoreStockTransferFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class BaseSubStoreStockTransferFormViewModel : BaseViewModel
    {
