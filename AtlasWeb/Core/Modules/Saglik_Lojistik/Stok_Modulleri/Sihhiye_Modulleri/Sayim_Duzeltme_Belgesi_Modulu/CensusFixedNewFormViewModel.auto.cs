...
{
    [HttpGet]
    public CensusFixedNewFormViewModel CensusFixedNewForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return CensusFixedNewFormLoadInternal(input);
    }

    [HttpPost]
    public CensusFixedNewFormViewModel CensusFixedNewFormLoad(FormLoadInput input)
    {
        return CensusFixedNewFormLoadInternal(input);
    }

    private CensusFixedNewFormViewModel CensusFixedNewFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("6dde9650-cc10-4879-b437-821569619e09");
        var objectDefID = Guid.Parse("6fa99efd-e615-41a6-ae85-3eaa77d730d6");
        var viewModel = new CensusFixedNewFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_CensusFixedNewForm(viewModel, viewModel._CensusFixed, objectContext);
        ...
        else
        {
            using (var objectContext = new TTObjectContext(false))
            {
                viewModel._CensusFixed = new CensusFixed(objectContext);
                var entryStateID = Guid.Parse("1b960acc-0ba5-4b0c-ab2d-8c4ba1f46e6a");
                viewModel._CensusFixed.CurrentStateDefID = entryStateID;
                viewModel.StockActionInDetailsGridList = new TTObjectClasses.CensusFixedMaterialIn[]{};
                viewModel.StockActionSignDetailsGridList = new TTObjectClasses.StockActionSignDetail[]{};
                viewModel.StockActionOutDetailsGridList = new TTObjectClasses.CensusFixedMaterialOut[]{};
                viewModel.ReadOnly = TTDefinitionManagement.TTFormDef.CheckFormSecurity(viewModel._CensusFixed, formDefID);
                viewModel.ReadOnlyFields = TTDefinitionManagement.TTFormDef.CheckFieldSecurity(viewModel._CensusFixed, formDefID);
                viewModel.OutgoingTransitions = TTDefinitionManagement.TTFormDef.GetOutgouingTransitions(viewModel._CensusFixed);
                viewModel.CurrentStateReports = TTDefinitionManagement.TTFormDef.GetStateReports(viewModel._CensusFixed);
    ...
    [HttpPost]
    public BaseViewModel CensusFixedNewForm(CensusFixedNewFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            var entryStateID = Guid.Parse("1b960acc-0ba5-4b0c-ab2d-8c4ba1f46e6a");
            objectContext.AddToRawObjectList(viewModel._CensusFixed, entryStateID);
            ...
            var transDef = objectContext.GetTransitionDefFromNeedAdvanceList(censusFixed);
            PostScript_CensusFixedNewForm(viewModel, censusFixed, transDef, objectContext);
            ...
            AfterContextSaveScript_CensusFixedNewForm(viewModel, censusFixed, transDef, objectContext);
    ...
    partial void PreScript_CensusFixedNewForm(CensusFixedNewFormViewModel viewModel, CensusFixed censusFixed, TTObjectContext objectContext);
    partial void PostScript_CensusFixedNewForm(CensusFixedNewFormViewModel viewModel, CensusFixed censusFixed, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_CensusFixedNewForm(CensusFixedNewFormViewModel viewModel, CensusFixed censusFixed, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(CensusFixedNewFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class CensusFixedNewFormViewModel : BaseViewModel
    {
