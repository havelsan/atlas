...
{
    [HttpGet]
    public MainStoreStockTransferStoreAppropvalFormViewModel MainStoreStockTransferStoreAppropvalForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return MainStoreStockTransferStoreAppropvalFormLoadInternal(input);
    }

    [HttpPost]
    public MainStoreStockTransferStoreAppropvalFormViewModel MainStoreStockTransferStoreAppropvalFormLoad(FormLoadInput input)
    {
        return MainStoreStockTransferStoreAppropvalFormLoadInternal(input);
    }

    private MainStoreStockTransferStoreAppropvalFormViewModel MainStoreStockTransferStoreAppropvalFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("b25ec07e-f690-4312-8280-4fe76a4ddc03");
        var objectDefID = Guid.Parse("2e411643-ae98-4235-bb26-517909d043a6");
        var viewModel = new MainStoreStockTransferStoreAppropvalFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_MainStoreStockTransferStoreAppropvalForm(viewModel, viewModel._MainStoreStockTransfer, objectContext);
    ...
    [HttpPost]
    public BaseViewModel MainStoreStockTransferStoreAppropvalForm(MainStoreStockTransferStoreAppropvalFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_MainStoreStockTransferStoreAppropvalForm(viewModel, mainStoreStockTransfer, transDef, objectContext);
            ...
            AfterContextSaveScript_MainStoreStockTransferStoreAppropvalForm(viewModel, mainStoreStockTransfer, transDef, objectContext);
    ...
    partial void PreScript_MainStoreStockTransferStoreAppropvalForm(MainStoreStockTransferStoreAppropvalFormViewModel viewModel, MainStoreStockTransfer mainStoreStockTransfer, TTObjectContext objectContext);
    partial void PostScript_MainStoreStockTransferStoreAppropvalForm(MainStoreStockTransferStoreAppropvalFormViewModel viewModel, MainStoreStockTransfer mainStoreStockTransfer, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    ...
    void ContextToViewModel(MainStoreStockTransferStoreAppropvalFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class MainStoreStockTransferStoreAppropvalFormViewModel : BaseViewModel
    {
