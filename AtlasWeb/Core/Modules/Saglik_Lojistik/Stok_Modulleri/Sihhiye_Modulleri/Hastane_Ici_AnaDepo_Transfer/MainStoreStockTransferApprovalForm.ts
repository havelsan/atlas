...
import { MainStoreStockTransferApprovalFormViewModel } from './MainStoreStockTransferApprovalFormViewModel';
...
@Component({
    selector: 'MainStoreStockTransferApprovalForm',
    templateUrl: './MainStoreStockTransferApprovalForm.html',
    providers: [MessageService]
})
export class MainStoreStockTransferApprovalForm extends BaseMainStoreStockTransferForm implements OnInit {
    public StockActionSignDetailsColumns = [];
    public mainStoreStockTransferApprovalFormViewModel: MainStoreStockTransferApprovalFormViewModel = new MainStoreStockTransferApprovalFormViewModel();
    public get _MainStoreStockTransfer(): MainStoreStockTransfer {
        return this._TTObject as MainStoreStockTransfer;
    }
    private MainStoreStockTransferApprovalForm_DocumentUrl: string = '/api/MainStoreStockTransferService/MainStoreStockTransferApprovalForm';
    constructor(protected httpService: NeHttpService,
        protected messageService: MessageService,
        private reportService: AtlasReportService,
        protected ngZone: NgZone) {
        super(httpService, messageService, ngZone);
        this._DocumentServiceUrl = this.MainStoreStockTransferApprovalForm_DocumentUrl;
        this.initViewModel();
    ...
    public initViewModel(): void {
        ...
        this.mainStoreStockTransferApprovalFormViewModel = new MainStoreStockTransferApprovalFormViewModel();
        this._ViewModel = this.mainStoreStockTransferApprovalFormViewModel;
        this.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer = this._TTObject as MainStoreStockTransfer;
        this.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer.Store = new Store();
        this.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer.DestinationStore = new Store();
        this.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer.StockActionSignDetails = new Array<StockActionSignDetail>();
        this.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer.MainStoreStockTransferMats = new Array<MainStoreStockTransferMat>();
    }

    protected loadViewModel() {
        let that = this;

        that.mainStoreStockTransferApprovalFormViewModel = this._ViewModel as MainStoreStockTransferApprovalFormViewModel;
        that._TTObject = this.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer;
        if (this.mainStoreStockTransferApprovalFormViewModel == null) {
            this.mainStoreStockTransferApprovalFormViewModel = new MainStoreStockTransferApprovalFormViewModel();
        }
        if (this.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer == null) {
            this.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer = new MainStoreStockTransfer();
        }
        let storeObjectID = that.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer['Store'];
        if (storeObjectID != null && (typeof storeObjectID === 'string')) {
            let store = that.mainStoreStockTransferApprovalFormViewModel.Stores.find(o => o.ObjectID.toString() === storeObjectID.toString());
            if (store) {
                that.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer.Store = store;
            }
        }
        let destinationStoreObjectID = that.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer['DestinationStore'];
        if (destinationStoreObjectID != null && (typeof destinationStoreObjectID === 'string')) {
            let destinationStore = that.mainStoreStockTransferApprovalFormViewModel.Stores.find(o => o.ObjectID.toString() === destinationStoreObjectID.toString());
            if (destinationStore) {
                that.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer.DestinationStore = destinationStore;
            }
        }
        that.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer.StockActionSignDetails = that.mainStoreStockTransferApprovalFormViewModel.StockActionSignDetailsGridList;
        for (let detailItem of that.mainStoreStockTransferApprovalFormViewModel.StockActionSignDetailsGridList) {
            let signUserObjectID = detailItem['SignUser'];
            if (signUserObjectID != null && (typeof signUserObjectID === 'string')) {
                let signUser = that.mainStoreStockTransferApprovalFormViewModel.ResUsers.find(o => o.ObjectID.toString() === signUserObjectID.toString());
                if (signUser) {
                    detailItem.SignUser = signUser;
                }
            }
        }
        that.mainStoreStockTransferApprovalFormViewModel._MainStoreStockTransfer.MainStoreStockTransferMats = that.mainStoreStockTransferApprovalFormViewModel.MainStoreStockTransferMaterialsGridList;
        for (let detailItem of that.mainStoreStockTransferApprovalFormViewModel.MainStoreStockTransferMaterialsGridList) {
            let materialObjectID = detailItem['Material'];
            if (materialObjectID != null && (typeof materialObjectID === 'string')) {
                let material = that.mainStoreStockTransferApprovalFormViewModel.Materials.find(o => o.ObjectID.toString() === materialObjectID.toString());
                if (material) {
                ...
                if (material != null) {
                    ...
                    if (stockCardObjectID != null && (typeof stockCardObjectID === 'string')) {
                        let stockCard = that.mainStoreStockTransferApprovalFormViewModel.StockCards.find(o => o.ObjectID.toString() === stockCardObjectID.toString());
                        if (stockCard) {
                        ...
                        if (stockCard != null) {
                            ...
                            if (distributionTypeObjectID != null && (typeof distributionTypeObjectID === 'string')) {
                                let distributionType =
                                    that.mainStoreStockTransferApprovalFormViewModel.DistributionTypeDefinitions.find(o => o.ObjectID.toString() === distributionTypeObjectID.toString());
                                if (distributionType) {
            ...
            if (stockLevelTypeObjectID != null && (typeof stockLevelTypeObjectID === 'string')) {
                let stockLevelType = that.mainStoreStockTransferApprovalFormViewModel.StockLevelTypes.find(o => o.ObjectID.toString() === stockLevelTypeObjectID.toString());
                if (stockLevelType) {
    ...
    async ngOnInit() {
        let that = this;
        await this.load(MainStoreStockTransferApprovalFormViewModel);
        ...
        this.FormCaption = i18n("M10907", "Ana Depolar Arası Transfer ( Onay )");
    ...
    public initFormControls(): void {
        ...
        this.SignUser, this.IsDeputy, this.DescriptionTabpage, this.tttabcontrol1, this.MaterialTabPage, this.MainStoreStockTransferMaterials, this.MKYS_TeslimAlan,
        this.MKYS_TeslimEden, this.ttlabel1, this.labelMKYS_TeslimEden, this.labelMKYS_TeslimAlan, this.TTTeslimAlanButon, this.TTTeslimEdenButon];
    }
}