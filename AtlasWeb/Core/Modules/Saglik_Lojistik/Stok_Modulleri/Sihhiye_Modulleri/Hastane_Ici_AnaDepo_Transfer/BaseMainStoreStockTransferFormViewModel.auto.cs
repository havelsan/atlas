...
{
    [HttpGet]
    public BaseMainStoreStockTransferFormViewModel BaseMainStoreStockTransferForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return BaseMainStoreStockTransferFormLoadInternal(input);
    }

    [HttpPost]
    public BaseMainStoreStockTransferFormViewModel BaseMainStoreStockTransferFormLoad(FormLoadInput input)
    {
        return BaseMainStoreStockTransferFormLoadInternal(input);
    }

    private BaseMainStoreStockTransferFormViewModel BaseMainStoreStockTransferFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("293bc478-29d1-41a4-b398-0d099510637b");
        var objectDefID = Guid.Parse("2e411643-ae98-4235-bb26-517909d043a6");
        var viewModel = new BaseMainStoreStockTransferFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_BaseMainStoreStockTransferForm(viewModel, viewModel._MainStoreStockTransfer, objectContext);
    ...
    [HttpPost]
    public BaseViewModel BaseMainStoreStockTransferForm(BaseMainStoreStockTransferFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_BaseMainStoreStockTransferForm(viewModel, mainStoreStockTransfer, transDef, objectContext);
            ...
            AfterContextSaveScript_BaseMainStoreStockTransferForm(viewModel, mainStoreStockTransfer, transDef, objectContext);
    ...
    partial void PreScript_BaseMainStoreStockTransferForm(BaseMainStoreStockTransferFormViewModel viewModel, MainStoreStockTransfer mainStoreStockTransfer, TTObjectContext objectContext);
    partial void PostScript_BaseMainStoreStockTransferForm(BaseMainStoreStockTransferFormViewModel viewModel, MainStoreStockTransfer mainStoreStockTransfer, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_BaseMainStoreStockTransferForm(BaseMainStoreStockTransferFormViewModel viewModel, MainStoreStockTransfer mainStoreStockTransfer, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(BaseMainStoreStockTransferFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class BaseMainStoreStockTransferFormViewModel : BaseViewModel
    {
