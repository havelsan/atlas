...
{
    [HttpGet]
    public MainStoreStockTransferApprovalFormViewModel MainStoreStockTransferApprovalForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return MainStoreStockTransferApprovalFormLoadInternal(input);
    }

    [HttpPost]
    public MainStoreStockTransferApprovalFormViewModel MainStoreStockTransferApprovalFormLoad(FormLoadInput input)
    {
        return MainStoreStockTransferApprovalFormLoadInternal(input);
    }

    private MainStoreStockTransferApprovalFormViewModel MainStoreStockTransferApprovalFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("fec00330-12a4-45a1-8496-19ea01728ed6");
        var objectDefID = Guid.Parse("2e411643-ae98-4235-bb26-517909d043a6");
        var viewModel = new MainStoreStockTransferApprovalFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_MainStoreStockTransferApprovalForm(viewModel, viewModel._MainStoreStockTransfer, objectContext);
    ...
    [HttpPost]
    public BaseViewModel MainStoreStockTransferApprovalForm(MainStoreStockTransferApprovalFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_MainStoreStockTransferApprovalForm(viewModel, mainStoreStockTransfer, transDef, objectContext);
            ...
            AfterContextSaveScript_MainStoreStockTransferApprovalForm(viewModel, mainStoreStockTransfer, transDef, objectContext);
    ...
    partial void PreScript_MainStoreStockTransferApprovalForm(MainStoreStockTransferApprovalFormViewModel viewModel, MainStoreStockTransfer mainStoreStockTransfer, TTObjectContext objectContext);
    partial void PostScript_MainStoreStockTransferApprovalForm(MainStoreStockTransferApprovalFormViewModel viewModel, MainStoreStockTransfer mainStoreStockTransfer, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_MainStoreStockTransferApprovalForm(MainStoreStockTransferApprovalFormViewModel viewModel, MainStoreStockTransfer mainStoreStockTransfer, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(MainStoreStockTransferApprovalFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class MainStoreStockTransferApprovalFormViewModel : BaseViewModel
    {
