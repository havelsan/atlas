...
namespace Core.Controllers
{
    ...
    public partial class MaterialDefinitionViewModelServiceController : Controller
    {

        [HttpPost]
        public MaterialDefinitionViewModel WorkListQuery(QueryFilter param)
        {

            TTObjectContext context = new TTObjectContext(false);
            MaterialDefinitionViewModel viewModel = new MaterialDefinitionViewModel();
            ...
            //else
            //{
            //    param.AllDrugSpecifications = true;
            //}
            //Buraya bir bak
