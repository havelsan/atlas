...
namespace Core.Controllers
{
    ...
    public partial class DepletionMaterialDefinitionBaseViewModelServiceController : Controller
    {

        [HttpPost]
        public DepletionMaterialDefinitionBaseViewModel WorkListQuery(QueryFilter param)
        {

            TTObjectContext context = new TTObjectContext(false);
            DepletionMaterialDefinitionBaseViewModel viewModel = new DepletionMaterialDefinitionBaseViewModel();
            string filterExpression = "WHERE 1=1 AND THIS.AllowToGivePatient =0  "; //SADECE Tüketim MALZEME GELSİN
            if (param.IsActive == 1){
...
{
    public class DepletionMaterialDefinitionBaseViewModel
    {
    ...
    public class DepletionMaterialDefinitionQueryFilter
    {
    ...
    public class DepletionMaterialDefinitionEnumItem
    {
