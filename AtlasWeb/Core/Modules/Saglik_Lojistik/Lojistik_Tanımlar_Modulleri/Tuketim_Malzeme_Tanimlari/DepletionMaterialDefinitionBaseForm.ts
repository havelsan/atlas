...
import { DepletionMaterialDefinitionBaseFormViewModel, DepletionMaterialDefinitionQueryFilter } from './DepletionMaterialDefinitionBaseViewModel';
...
@Component({
    selector: 'DepletionMaterialDefinitionBaseForm',
    templateUrl: './DepletionMaterialDefinitionBaseForm.html',
    providers: [MessageService, SystemApiService]
})
export class DepletionMaterialDefinitionBaseForm implements OnInit, OnDestroy {
    @ViewChild(DxDataGridComponent, {}) dataGrid: DxDataGridComponent;
    StoreID: any;
    private editorFormInstance: any;
    private selectedRowData: any;
    public componentInfo: DynamicComponentInfo;
    public ViewModel: DepletionMaterialDefinitionBaseFormViewModel;
    public QueryModel: DepletionMaterialDefinitionQueryFilter;
    ...
    constructor(private systemApi: SystemApiService, protected activeUserService: IActiveUserService,
        ...
        this.ViewModel = new DepletionMaterialDefinitionBaseFormViewModel();
        this.QueryModel = new DepletionMaterialDefinitionQueryFilter();
        this.QueryModel.ActionStatus = -1;
        this.QueryModel.IsActive = -1;
        this.QueryModel.StockInheld = -1;
   ...
   async newConsumableMaterialAdd() {
    ...
    getConsumableMaterialList() {
        let apiUrl: string = '/api/DepletionMaterialDefinitionBaseViewModelService/WorkListQuery';
        let params: DepletionMaterialDefinitionQueryFilter = new DepletionMaterialDefinitionQueryFilter();
