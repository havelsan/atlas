...
import { OutPatientPresDetailFormViewModel } from './OutPatientPresDetailFormViewModel';
import { NeHttpService } from 'Fw/Services/NeHttpService';
import { MessageService } from 'Fw/Services/MessageService';
import * as TTVisual from "NebulaClient/Visual/TTVisualControlInterfaces";
import { Convert } from 'NebulaClient/Mscorlib/Convert';
import { EReceteIslemleri } from 'NebulaClient/Services/External/EReceteIslemleri';
...
@Component({
    selector: 'OutPatientPresDetailForm',
    templateUrl: './OutPatientPresDetailForm.html',
    providers: [MessageService]
})
export class OutPatientPresDetailForm extends TTVisual.TTForm implements OnInit {
    ...
    public outPatientPresDetailFormViewModel: OutPatientPresDetailFormViewModel = new OutPatientPresDetailFormViewModel();
    public get _OutPatientPrescription(): OutPatientPrescription {
        return this._TTObject as OutPatientPrescription;
    }
    private OutPatientPresDetailForm_DocumentUrl: string = '/api/OutPatientPrescriptionService/OutPatientPresDetailForm';
    constructor(protected httpService: NeHttpService,
                protected messageService: MessageService,
                protected ngZone: NgZone) {
        super('OUTPATIENTPRESCRIPTION', 'OutPatientPresDetailForm');
        this._DocumentServiceUrl = this.OutPatientPresDetailForm_DocumentUrl;
        this.initViewModel();
    ...
    public async cmdAddDiag_Click(): Promise<void> {
        /*if (this.Diag.SelectedObjectID !== null) {
            ...
            ereceteTaniEkleIstekDVO.doktorTcKimlikNo = Convert.ToInt64(this._OutPatientPrescription.ProcedureDoctor.UniqueNo);
            ereceteTaniEkleIstekDVO.ereceteNo = this._OutPatientPrescription.EReceteNo;
            ...
            let response: EReceteIslemleri.ereceteTaniEkleCevapDVO = EReceteIslemleri.WebMethods.ereceteTaniEkle(Sites.SiteLocalHost, this._OutPatientPrescription.ProcedureDoctor.UniqueNo.toString(), this._OutPatientPrescription.ERecetePassword.toString(), ereceteTaniEkleIstekDVO);
            if (response !== null) {
    ...
    public async cmdAddDrugDetail_Click(): Promise<void> {
        ...
        if (String.isNullOrEmpty(this.DrugDescription.Text)) {
            TTVisual.InfoBox.Show(i18n("M13554", "Eklenecek Açıklama boş geçilemez"), MessageIconEnum.ErrorMessage);
            error = true;
        }
        if (this.descriptionType.SelectedItem === null) {
            TTVisual.InfoBox.Show(i18n("M10480", "Açıklama Türü boş geçilemez"), MessageIconEnum.ErrorMessage);
            error = true;
        }
        if (error === false) {
            ...
            for (let i: number = 0; i < this.DrugGrid.Rows.length; i++) {
                if (Convert.ToBoolean(this.DrugGrid.Rows[i].Cells["Select"].Value)) {
                    if (this.DrugGrid.Rows[i].Cells["Barcode"].Value != null) {
            ...
            /*if (count === 1) {
                ...
                ereceteIlacAciklamaEkleIstekDVO.doktorTcKimlikNo = Convert.ToInt64(this._OutPatientPrescription.ProcedureDoctor.UniqueNo);
                ereceteIlacAciklamaEkleIstekDVO.ereceteNo = this._OutPatientPrescription.EReceteNo;
                ...
                let response: EReceteIslemleri.ereceteIlacAciklamaEkleCevapDVO = EReceteIslemleri.WebMethods.ereceteIlacAciklamaEkle(Sites.SiteLocalHost, this._OutPatientPrescription.ProcedureDoctor.UniqueNo.toString(), this._OutPatientPrescription.ERecetePassword.toString(), ereceteIlacAciklamaEkleIstekDVO);
                if (response !== null) {
                    if (response.sonucKodu.Equals("0000"))
    ...
    public async cmdAddPresDesc_Click(): Promise<void> {
        ...
        /*if (error === false) {
            ...
            ereceteAciklamaEkleIstekDVO.doktorTcKimlikNo = Convert.ToInt64(this._OutPatientPrescription.ProcedureDoctor.UniqueNo);
            ereceteAciklamaEkleIstekDVO.ereceteNo = this._OutPatientPrescription.EReceteNo;
            ...
            let response: EReceteIslemleri.ereceteAciklamaEkleCevapDVO = EReceteIslemleri.WebMethods.ereceteAciklamaEkle(Sites.SiteLocalHost, this._OutPatientPrescription.ProcedureDoctor.UniqueNo.toString(), this._OutPatientPrescription.ERecetePassword.toString(), ereceteAciklamaEkleIstekDVO);
            if (response !== null) {
                if (response.sonucKodu.Equals("0000"))
                    TTVisual.InfoBox.Show("Açıklama eklenmiştir.", MessageIconEnum.InformationMessage);
                else TTVisual.InfoBox.Show("e-Reçete Servisinden Gelen Sonuç Mesajı : " + response.sonucMesaji + "\n\r e-Reçete ServisindenGelen Uyarı Mesajı :" + response.uyariMesaji, MessageIconEnum.ErrorMessage);
    ...
    public async cmdAddSignedDiag_Click(): Promise<void> {
      /*  if (this.Diag.SelectedObjectID !== null) {
            ...
            let response: EReceteIslemleri.imzaliEreceteTaniEkleCevapDVO = EReceteIslemleri.WebMethods.imzaliEreceteTaniEkleSync(Sites.SiteLocalHost, this._OutPatientPrescription.ProcedureDoctor.UniqueNo.toString(), this._OutPatientPrescription.ERecetePassword.toString(), imzaliEreceteTaniEkleIstekDVO);
            if (response !== null) {
                if (response.sonucKodu.Equals("0000")) {
                    TTVisual.InfoBox.Show("Tanı eklenmiştir.", MessageIconEnum.InformationMessage);
                    this.Close();
      ...
      /*  let error: boolean = false;
        ...
        if (error === false) {
            ...
            if (count === 1) {
                ...
                let response: EReceteIslemleri.imzaliEreceteIlacAciklamaEkleCevapDVO = EReceteIslemleri.WebMethods.imzaliEreceteIlacAciklamaEkleSync(Sites.SiteLocalHost, this._OutPatientPrescription.ProcedureDoctor.UniqueNo.toString(), this._OutPatientPrescription.ERecetePassword.toString(), imzaliEreceteIlacAciklamaEkleIstekDVO);
                if (response !== null) {
                    if (response.sonucKodu.Equals("0000"))
                        TTVisual.InfoBox.Show("Açıklama eklenmiştir.", MessageIconEnum.InformationMessage);
                    else TTVisual.InfoBox.Show("e-Reçete Servisinden Gelen Sonuç Mesajı : " + response.sonucMesaji + "\n\r e-Reçete ServisindenGelen Uyarı Mesajı :" + response.uyariMesaji, MessageIconEnum.ErrorMessage);
    ...
    public async cmdAddSignedPresDesc_Click(): Promise<void> {
      /*  let error: boolean = false;
        ...
        if (error === false) {
            ...
            let response: EReceteIslemleri.imzaliEreceteAciklamaEkleCevapDVO = EReceteIslemleri.WebMethods.imzaliEreceteAciklamaEkleSync(Sites.SiteLocalHost, this._OutPatientPrescription.ProcedureDoctor.UniqueNo.toString(), this._OutPatientPrescription.ERecetePassword.toString(), imzaliEreceteAciklamaEkleIstekDVO);
            if (response !== null) {
                if (response.sonucKodu.Equals("0000"))
                    TTVisual.InfoBox.Show("Açıklama eklenmiştir.", MessageIconEnum.InformationMessage);
                else TTVisual.InfoBox.Show("e-Reçete Servisinden Gelen Sonuç Mesajı : " + response.sonucMesaji + "\n\r e-Reçete ServisindenGelen Uyarı Mesajı :" + response.uyariMesaji, MessageIconEnum.ErrorMessage);
    ...
    protected async PreScript() {
        ...
        for (let outPatientDrugOrder of this._OutPatientPrescription.OutPatientDrugOrders) {
    ...
    public initViewModel(): void {
        ...
        this.outPatientPresDetailFormViewModel = new OutPatientPresDetailFormViewModel();
        this._ViewModel = this.outPatientPresDetailFormViewModel;
        this.outPatientPresDetailFormViewModel._OutPatientPrescription = this._TTObject as OutPatientPrescription;
    }

    protected loadViewModel() {
        let that = this;

        that.outPatientPresDetailFormViewModel = this._ViewModel as OutPatientPresDetailFormViewModel;
        that._TTObject = this.outPatientPresDetailFormViewModel._OutPatientPrescription;
        if (this.outPatientPresDetailFormViewModel == null)
            this.outPatientPresDetailFormViewModel = new OutPatientPresDetailFormViewModel();
        if (this.outPatientPresDetailFormViewModel._OutPatientPrescription == null)
            this.outPatientPresDetailFormViewModel._OutPatientPrescription = new OutPatientPrescription();

    }

    async ngOnInit()  {
        let that = this;
        await this.load(OutPatientPresDetailFormViewModel);
    ...
    public initFormControls(): void {
        ...
        this.ttlabel10.Text = i18n("M20928", "Reçete Açıklama Türü");
        this.ttlabel10.Name = "ttlabel10";
        this.ttlabel10.TabIndex = 11;
        ...
        this.ttgroupbox1.Controls = [this.DrugGrid, this.DrugDescription, this.ttlabel1, this.cmdAddDrugDetail, this.descriptionType, this.cmdAddSignedDrugDetail, this.ttlabel2, this.ttlabel4];
        this.ttgroupbox2.Controls = [this.Diag, this.ttlabel3, this.cmdAddDiag, this.cmdAddSignedDiag];
        this.ttgroupbox3.Controls = [this.cmdAddPresDesc, this.PresDesc, this.presDescriptionType, this.ttlabel10, this.cmdAddSignedPresDesc];
        this.Controls = [this.labelEReceteNo, this.ttgroupbox1, this.DrugGrid, this.Select, this.Drug, this.Frequency, this.DoseAmount, this.Barcode, this.DrugDescription, this.ttlabel1, this.cmdAddDrugDetail, this.descriptionType, this.cmdAddSignedDrugDetail, this.ttlabel2, this.ttlabel4, this.ttgroupbox2, this.Diag, this.ttlabel3, this.cmdAddDiag, this.cmdAddSignedDiag, this.ttgroupbox3, this.cmdAddPresDesc, this.PresDesc, this.presDescriptionType, this.ttlabel10, this.cmdAddSignedPresDesc, this.EReceteNo];
