...
export class KScheduleApprovalFormViewModel extends BaseViewModel {
    @Type(() => KSchedule)
    ...
    public alletMessage: string;
    public overDoseMessage: string;
    public drugSpecMessage: string;
    public ageDifferenceValidateMessage: string;
    public drugNutrientInteractionMessage: string;
    public ingredientsOverDoseMessage: string;
    public doctorDescriptionOnDrug: string;
    public stopSameIngredientMessage: string;
    public drugDescriptionMessage: string;
    public repeatDayWarning: string;
    public patientLastUseDrugs: Array<PatientLastUseDrugDVO> = new Array<PatientLastUseDrugDVO>();
    public OuttableLotList: Array<OuttableLotDTO> = new Array<OuttableLotDTO>();
}

export class OrderTimeScheduleDetail {
...
export class PatientLastUseDrugDVO {
    public DrugName: string;
