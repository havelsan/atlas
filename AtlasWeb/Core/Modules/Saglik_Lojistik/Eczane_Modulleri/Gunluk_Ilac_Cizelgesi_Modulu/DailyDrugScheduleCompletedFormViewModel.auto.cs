...
{
    [HttpGet]
    public DailyDrugScheduleCompletedFormViewModel DailyDrugScheduleCompletedForm(Guid? id)
    {
        var input = new FormLoadInput();
        input.Id = id;
        return DailyDrugScheduleCompletedFormLoadInternal(input);
    }

    [HttpPost]
    public DailyDrugScheduleCompletedFormViewModel DailyDrugScheduleCompletedFormLoad(FormLoadInput input)
    {
        return DailyDrugScheduleCompletedFormLoadInternal(input);
    }

    private DailyDrugScheduleCompletedFormViewModel DailyDrugScheduleCompletedFormLoadInternal(FormLoadInput input)
    {
        Guid? id = input.Id;
        var formDefID = Guid.Parse("eacb2644-4b9e-43cd-ab95-36382fd84b78");
        var objectDefID = Guid.Parse("2faf2b7b-63b1-40f6-8946-23ec393e0b4a");
        var viewModel = new DailyDrugScheduleCompletedFormViewModel();
        ...
        if (id.HasValue && id.Value != Guid.Empty)
        {
            using (var objectContext = new TTObjectContext(false))
            {
                ...
                PreScript_DailyDrugScheduleCompletedForm(viewModel, viewModel._DailyDrugSchedule, objectContext);
    ...
    [HttpPost]
    public BaseViewModel DailyDrugScheduleCompletedForm(DailyDrugScheduleCompletedFormViewModel viewModel)
    {
        ...
        using (var objectContext = new TTObjectContext(false))
        {
            ...
            PostScript_DailyDrugScheduleCompletedForm(viewModel, dailyDrugSchedule, transDef, objectContext);
            ...
            AfterContextSaveScript_DailyDrugScheduleCompletedForm(viewModel, dailyDrugSchedule, transDef, objectContext);
    ...
    partial void PreScript_DailyDrugScheduleCompletedForm(DailyDrugScheduleCompletedFormViewModel viewModel, DailyDrugSchedule dailyDrugSchedule, TTObjectContext objectContext);
    partial void PostScript_DailyDrugScheduleCompletedForm(DailyDrugScheduleCompletedFormViewModel viewModel, DailyDrugSchedule dailyDrugSchedule, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    partial void AfterContextSaveScript_DailyDrugScheduleCompletedForm(DailyDrugScheduleCompletedFormViewModel viewModel, DailyDrugSchedule dailyDrugSchedule, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext);
    void ContextToViewModel(DailyDrugScheduleCompletedFormViewModel viewModel, TTObjectContext objectContext)
    {
...
{
    public partial class DailyDrugScheduleCompletedFormViewModel : BaseViewModel
    {
