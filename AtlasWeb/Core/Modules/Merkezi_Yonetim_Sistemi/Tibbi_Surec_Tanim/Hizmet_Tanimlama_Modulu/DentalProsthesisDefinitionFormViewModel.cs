...
{
    public partial class DentalProsthesisDefinitionServiceController
    {
        ...
        {
            var _imported = objectContext.GetObject<DentalProsthesisDefinition>(dentalProsthesisDefinition.ObjectID);
            objectContext.LoadFormObjects(new Guid("77d576d2-5ef5-4462-a9ea-da15c2c35966"), dentalProsthesisDefinition.ObjectID, new Guid("3d2f1e54-0d74-468f-b931-4c51ac60b090"));
            ...
            viewModel.GridSubProceduresGridList = viewModel._DentalProsthesisDefinition.SubProcedureDefinitions.OfType<SubProcedureDefinition>().ToArray();
            ...
            viewModel.GridRequiredDiagnosisGridList = viewModel._DentalProsthesisDefinition.RequiredDiagnoseProcedures.OfType<RequiredDiagnoseProcedure>().ToArray();
        ...
        partial void PostScript_DentalProsthesisDefinitionForm(DentalProsthesisDefinitionFormViewModel viewModel, DentalProsthesisDefinition dentalProsthesisDefinition, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext)
        {
            ...
            procedureDefinitionService.Global_PostScript(objectContext, viewModel.PackageProcedureDefinitions, viewModel.GridSubProceduresGridList, viewModel.GridRequiredDiagnosisGridList, viewModel._DentalProsthesisDefinition.ObjectID, dentalProsthesisDefinition.GetType());
        }
    }
}
...
{
    public partial class DentalProsthesisDefinitionFormViewModel: ProcedureFormViewModel
    {
    }
}
