...
{
    public partial class PackageProcedureDefinitionServiceController
    {
        ...
        {
            var _imported = objectContext.GetObject<PackageProcedureDefinition>(packageProcedureDefinition.ObjectID);
            objectContext.LoadFormObjects(new Guid("77d576d2-5ef5-4462-a9ea-da15c2c35966"), packageProcedureDefinition.ObjectID, new Guid("3d2f1e54-0d74-468f-b931-4c51ac60b090"));
            ...
            viewModel.GridSubProceduresGridList = viewModel._PackageProcedureDefinition.SubProcedureDefinitions.OfType<SubProcedureDefinition>().ToArray();
            ...
            viewModel.GridRequiredDiagnosisGridList = viewModel._PackageProcedureDefinition.RequiredDiagnoseProcedures.OfType<RequiredDiagnoseProcedure>().ToArray();
        ...
        partial void PostScript_PackageProcedureDefinitionForm(PackageProcedureDefinitionFormViewModel viewModel, PackageProcedureDefinition packageProcedureDefinition, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext)
        {
            ...
            procedureDefinitionService.Global_PostScript(objectContext, viewModel.PackageProcedureDefinitions, viewModel.GridSubProceduresGridList, viewModel.GridRequiredDiagnosisGridList, viewModel._PackageProcedureDefinition.ObjectID, packageProcedureDefinition.GetType());
        }
    }
}
...
{
    public partial class PackageProcedureDefinitionFormViewModel: ProcedureFormViewModel
    {
    }
}
