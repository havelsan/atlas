...
{
    public partial class EstheticAlternativeProcedureDefinitionServiceController
    {
        ...
        {
            var _imported = objectContext.GetObject<EstheticAlternativeProcedureDefinition>(estheticAlternativeProcedureDefinition.ObjectID);
            objectContext.LoadFormObjects(new Guid("77d576d2-5ef5-4462-a9ea-da15c2c35966"), estheticAlternativeProcedureDefinition.ObjectID, new Guid("3d2f1e54-0d74-468f-b931-4c51ac60b090"));
            ...
            viewModel.GridSubProceduresGridList = viewModel._EstheticAlternativeProcedureDefinition.SubProcedureDefinitions.OfType<SubProcedureDefinition>().ToArray();
            ...
            viewModel.GridRequiredDiagnosisGridList = viewModel._EstheticAlternativeProcedureDefinition.RequiredDiagnoseProcedures.OfType<RequiredDiagnoseProcedure>().ToArray();
        ...
        partial void PostScript_EstheticAlternativeProcedureDefinitionForm(EstheticAlternativeProcedureDefinitionFormViewModel viewModel, EstheticAlternativeProcedureDefinition estheticAlternativeProcedureDefinition, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext)
        {
            ...
            procedureDefinitionService.Global_PostScript(objectContext, viewModel.PackageProcedureDefinitions, viewModel.GridSubProceduresGridList, viewModel.GridRequiredDiagnosisGridList, viewModel._EstheticAlternativeProcedureDefinition.ObjectID, estheticAlternativeProcedureDefinition.GetType());
        }
    }
}
...
{
    public partial class EstheticAlternativeProcedureDefinitionFormViewModel: ProcedureFormViewModel
    {
    }
}
