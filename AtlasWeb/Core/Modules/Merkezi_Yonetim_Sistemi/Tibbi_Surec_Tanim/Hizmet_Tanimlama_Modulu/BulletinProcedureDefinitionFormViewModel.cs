...
{
    public partial class BulletinProcedureDefinitionServiceController
    {
        ...
        {
            var _imported = objectContext.GetObject<BulletinProcedureDefinition>(bulletinProcedureDefinition.ObjectID);
            objectContext.LoadFormObjects(new Guid("77d576d2-5ef5-4462-a9ea-da15c2c35966"), bulletinProcedureDefinition.ObjectID, new Guid("3d2f1e54-0d74-468f-b931-4c51ac60b090"));
            ...
            viewModel.GridSubProceduresGridList = viewModel._BulletinProcedureDefinition.SubProcedureDefinitions.OfType<SubProcedureDefinition>().ToArray();
            ...
            viewModel.GridRequiredDiagnosisGridList = viewModel._BulletinProcedureDefinition.RequiredDiagnoseProcedures.OfType<RequiredDiagnoseProcedure>().ToArray();
        ...
        partial void PostScript_BulletinProcedureDefinitionForm(BulletinProcedureDefinitionFormViewModel viewModel, BulletinProcedureDefinition bulletinProcedureDefinition, TTDefinitionManagement.TTObjectStateTransitionDef transDef, TTObjectContext objectContext)
        {
            ...
            procedureDefinitionService.Global_PostScript(objectContext, viewModel.PackageProcedureDefinitions, viewModel.GridSubProceduresGridList, viewModel.GridRequiredDiagnosisGridList, viewModel._BulletinProcedureDefinition.ObjectID, bulletinProcedureDefinition.GetType());
        }
    }
}
...
{
    public partial class BulletinProcedureDefinitionFormViewModel: ProcedureFormViewModel
    {
    }
}
