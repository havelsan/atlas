...
namespace Core.Controllers
{
    ...
    [HvlResult]
    public partial class LogisticDocumentsServiceController : Controller
    {
                    ...
                    if (viewModel.File != null)
                    {
                        ...
                        if (StreamHelpers.ToByteArray(formFile.OpenReadStream()).Length <= 10000000)
                        {
                            ...
                            if (FileTypeCheck.fileTypeCheck(StreamHelpers.ToByteArray(formFile.OpenReadStream()), viewModel.FileName))
                            {
                                ...
                                doc.MaterialDocumentType = viewModel.DocumentType;
        ...
        public void DeleteDocument(DeleteDocument_Input input)
        {
            using (var context = new TTObjectContext(false))
            {
                MaterialDocumentation doc = context.GetObject<MaterialDocumentation>(input.documentid);
    ...
    [Route("api/[controller]/[action]/{id?}")]
    public partial class LogisticDownloadServiceController : Controller
    {
