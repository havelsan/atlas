...
export class LayoutConfig implements ConfigModel {
	public config: any = {
		...
		self: {
			...
			background: './assets/metronic/app/media/img/bg/bg-4.jpg' // boxed layout background
		},
		...
		header: {
			...
			self: {
				...
				logo: {
					dark: './assets/metronic/demo/default/media/img/logo/atlaslogo.svg',
                  light: './assets/metronic/demo/default/media/img/logo/atlaslogo.svg'
				}
			},
