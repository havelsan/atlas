...
@Component({
    selector: "ApproveFormContainerComponent",
    template: `
<h1>Taşınır Mal Giriş Onay Formu</h1>
<div class="row">
    <comp-compose [Info]="componentInfo"></comp-compose>
</div>
`
})
export class ApproveFormContainerComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        compInfo.ComponentName = 'ChattelDocumentInputWithAccountancyApproveForm';
