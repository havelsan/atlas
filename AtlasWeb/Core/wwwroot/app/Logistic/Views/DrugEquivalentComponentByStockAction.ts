...
@Component({
    ...
    template: `
<p class="navbar-text" style="color:red">Seçmiş olduğunuz ilacın mevcudu ana depoda bulunmamıştır.Eşdeğelerinden birini seçmek istermisiniz?</p>
<div class="col-xs-12">
    ...
    <div style="float: left">
        <dx-button text="Değiştir" style="width:60px" (onClick)="okClick()"></dx-button>
    </div>
    <div style="float: right">
        <dx-button text="Devam" style="width:60px" (onClick)="cancelClick()"></dx-button>
    </div>
</div>
 `
})
export class DrugEquivalentComponentByStockAction implements IModal {
