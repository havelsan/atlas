...
extends DictionaryBase<string, TValue> implements IStringKeyDictionary<TValue>
{
	...
	containsValue(value: TValue): boolean
	{
		...
		let map = this._map, equal: (a: any, b: any, strict?: boolean) => boolean = areEqual;
		for (let key in map)
		{
	...
	{
		let _ = this, map = _._map, old = map[key];
		if (old !== value)
		{
	...
	protected getValues(): TValue[]
	{
		...
		let result: any[] = Object.keys(this._map);
