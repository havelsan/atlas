...
export class ClassTransformer {
    ...
    getClassType(typeName: string): Function {
        const metadata = defaultMetadataStorage.getClassTypeMetada(typeName);
        return metadata.target;
    }

    getClassTypeWithObjectDefID(objectDefID: string): Function {
        const metadata = defaultMetadataStorage.getClassTypeMetadaWithObjectDefID(objectDefID);
        return metadata.target;
    }

    getEnumListType(typeName: string): Function {
    ...
    deserializeObject<T>(cls: ClassType<T>, jsonObject: T, options?: ClassTransformOptions): T {
        return this.plainToClass(cls, jsonObject, options);
    }
