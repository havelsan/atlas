...
namespace TTObjectClasses
{
    ...
    /// </summary>
    public  partial class ExtendExpDateIn : BaseChattelDocument, IAutoDocumentNumber, IAutoDocumentRecordLog, IStockInTransaction, ICheckStockActionInDetail
    {
        ...
        public List<AutoDocumentRecordLogAttribute.DocumentRecordLogContent> DocumentRecordLogContents
        {
            get
            {
                ...
                foreach (ExtendExpDateInDetail detail in ExtendExpDateInDetails)
                {
