...
namespace TTObjectClasses
{
    ...
    /// </summary>
    public partial class MainStoreStockTransfer: IAutoDocumentRecordLog
    {
        ...
        public List<AutoDocumentRecordLogAttribute.DocumentRecordLogContent> DocumentRecordLogContents
        {
            get
            {
                ...
                foreach (MainStoreStockTransferMat detail in MainStoreStockTransferMats)
                {
        ...
        #endregion
        #region IMainStoreStockTransfer Members
