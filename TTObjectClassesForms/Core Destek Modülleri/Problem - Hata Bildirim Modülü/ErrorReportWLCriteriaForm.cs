...
#region ErrorReportWLCriteriaForm_Methods
        public override IList ExecuteNQL(TTObjectContext context, DateTime dtStart, DateTime dtEnd, string sExpression)
        {
            return ErrorReportAction.ErrorReportWorkListNQL(context, dtStart, dtEnd, sExpression);
        }
...
#endregion ErrorReportWLCriteriaForm_Methods
    }
}