...
namespace TTFormClasses
{
    ...
    public partial class FunctionalExaminationForm : StockActionBaseForm
    {
        ...
        {
#region FunctionalExaminationForm_StockActionInDetails_CellContentClick
...
#endregion FunctionalExaminationForm_StockActionInDetails_CellContentClick
        }

        protected override void PreScript()
        {
#region FunctionalExaminationForm_PreScript
    base.PreScript();
#endregion FunctionalExaminationForm_PreScript
