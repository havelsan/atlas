...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public ProductionConsumptionDocumentStockCardRegistryForm() : base("PRODUCTIONCONSUMPTIONDOCUMENT", "ProductionConsumptionDocumentStockCardRegistryForm")
        {
        }

        protected ProductionConsumptionDocumentStockCardRegistryForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}