...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public DistributionDepStoreNewForm() : base("DISTRIBUTIONDEPSTORE", "DistributionDepStoreNewForm")
        {
        }

        protected DistributionDepStoreNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}