...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public VoucherReturnDocumentNewForm() : base("VOUCHERRETURNDOCUMENT", "VoucherReturnDocumentNewForm")
        {
        }

        protected VoucherReturnDocumentNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}