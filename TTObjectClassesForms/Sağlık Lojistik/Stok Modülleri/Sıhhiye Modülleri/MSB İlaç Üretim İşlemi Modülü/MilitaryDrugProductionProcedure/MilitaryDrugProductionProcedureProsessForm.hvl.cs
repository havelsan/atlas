...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public MilitaryDrugProductionProcedureProsessForm() : base("MILITARYDRUGPRODUCTIONPROCEDURE", "MilitaryDrugProductionProcedureProsessForm")
        {
        }

        protected MilitaryDrugProductionProcedureProsessForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}