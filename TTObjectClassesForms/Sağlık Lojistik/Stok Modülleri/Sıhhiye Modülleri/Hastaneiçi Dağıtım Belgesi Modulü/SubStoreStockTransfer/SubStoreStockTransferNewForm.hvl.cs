...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public SubStoreStockTransferNewForm() : base("SUBSTORESTOCKTRANSFER", "SubStoreStockTransferNewForm")
        {
        }

        protected SubStoreStockTransferNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}