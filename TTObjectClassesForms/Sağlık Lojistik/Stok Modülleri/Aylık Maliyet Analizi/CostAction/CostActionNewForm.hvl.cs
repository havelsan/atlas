...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public CostActionNewForm() : base("COSTACTION", "CostActionNewForm")
        {
        }

        protected CostActionNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}