...
namespace TTFormClasses
{
    ...
    public partial class SpecialWorkForm_MaintenanceO : TTForm
    {
        ...
        {
#region SpecialWorkForm_MaintenanceO_cmdForkWorkStep_Click
...
#endregion SpecialWorkForm_MaintenanceO_cmdForkWorkStep_Click
        }

        private void chkOrderCompleted_CheckedChanged()
        {
#region SpecialWorkForm_MaintenanceO_chkOrderCompleted_CheckedChanged
   this.SetStateButtons((bool)chkOrderCompleted.Value);
#endregion SpecialWorkForm_MaintenanceO_chkOrderCompleted_CheckedChanged
        }

        protected override void PreScript()
        {
#region SpecialWorkForm_MaintenanceO_PreScript
    base.PreScript();
            base.PreScript();
            this.SetStateButtons((bool)chkOrderCompleted.Value);
...
#endregion SpecialWorkForm_MaintenanceO_PreScript

            }
            
#region SpecialWorkForm_MaintenanceO_Methods
        ...
        public void SetStateButtons(bool orderCompleted)
        {
            ...
            if (orderCompleted)
            {
                this.AddStateButton(MaintenanceOrder.States.SupplyApproval);
            }
            else
            {
...
#endregion SpecialWorkForm_MaintenanceO_Methods
    }
}