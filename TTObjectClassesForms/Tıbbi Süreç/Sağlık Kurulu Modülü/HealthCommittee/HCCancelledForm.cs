...
namespace TTFormClasses
{
    ...
    public partial class HCCancelledForm : EpisodeActionForm
    {
        ...
        {
#region HCCancelledForm_PreScript
    base.PreScript();

         
#endregion HCCancelledForm_PreScript

            }
            
#region HCCancelledForm_Methods
        private void SetEpisodeRelations()
        {
            ...
            this.Adres.Text = SubEpisode.MyAddress(this._HealthCommittee.SubEpisode);
...
#endregion HCCancelledForm_Methods
    }
}