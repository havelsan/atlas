...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public DentalConsultationStartForm() : base("DENTALCONSULTATION", "DentalConsultationStartForm")
        {
        }

        protected DentalConsultationStartForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}