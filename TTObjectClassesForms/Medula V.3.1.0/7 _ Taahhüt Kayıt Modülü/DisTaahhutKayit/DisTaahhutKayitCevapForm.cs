...
namespace TTFormClasses
{
    public partial class DisTaahhutKayitCevapForm : DisTaahhutKayitForm
    {
        ...
        {
            #region DisTaahhutKayitCevapForm_printTaahhut_Click
            //SaveFileDialog saveFileDialog = new SaveFileDialog();
            //         saveFileDialog.DefaultExt = "pdf";
            //         saveFileDialog.Filter = "Adobe PDF Files (*.pdf)|*.pdf";
            //         saveFileDialog.FileName = TTUtils.Globals.MakeFileName(_DisTaahhutKayit.taahhutKayitDVO.taahhutCevapDVO.taahhutNo.Value.ToString());
            //         DialogResult dialogResult = saveFileDialog.ShowDialog();
            //         if (dialogResult == DialogResult.OK)
            //         {
            //             try
            //             {
            //                 if (_DisTaahhutKayit.taahhutKayitDVO.taahhutCevapDVO.taahhutCikti == null)
            //                     throw new TTException("Taahhüt Çıktı verisi olmadığından PDF dönüştürme işlemi gerçekleştirilemedi");

            //                 byte[] buff = (byte[])_DisTaahhutKayit.taahhutKayitDVO.taahhutCevapDVO.taahhutCikti;
            ...
            //         }
            var a = 1;
#endregion DisTaahhutKayitCevapForm_printTaahhut_Click
        }

        protected override void PreScript()
        {
#region DisTaahhutKayitCevapForm_PreScript
    base.PreScript();
            ...
            {
                if (_DisTaahhutKayit.CurrentStateDefID.Equals(DisTaahhutKayit.States.CompletedSuccessfully))
                {
...
#endregion DisTaahhutKayitCevapForm_PreScript
