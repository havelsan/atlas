...
{
    public class UninvoicedProceduresReport
    {
        public static UninvoicedProceduresReportData GetReportData(string parameters)
        {
            return ApiCaller.CallAnyApiWithParams<UninvoicedProceduresReportData>(parameters, "GetUninvoicedProceduresReport");
        }

        public static UninvoicedProceduresReportData GetUninvoicedProceduresReport(string parameters)
        {
            UninvoicedProceduresReportData data = new UninvoicedProceduresReportData();

            if (!string.IsNullOrWhiteSpace(parameters))
            {
                var param = JsonConvert.DeserializeObject<UninvoicedProceduresReportParamters>(parameters.ToString());
                ...
                var result = AccountTransaction.UninvoicedProceduresReportQuery(data.StartDate, data.EndDate, type, typeControl);
        ...
        [Serializable]
        public class UninvoicedProceduresReportParamters
        {
            [DataMember]
        ...
        [Serializable]
        public class UninvoicedProceduresReportData
        {
            [DataMember]
            public DateTime StartDate { get; set; }
            ...
            public UninvoicedProceduresReportData()
            {
