...
{
    public class TedavisiPlanlananHastaRaporu
    {
        public static FTRReportData GetReportData(string parameters)
        {
            return ApiCaller.CallAnyApiWithParams<FTRReportData>(parameters, "GetTedavisiPlanlananHastaReportData");
        }

        public static FTRReportData GetTedavisiPlanlananHastaReportData(string parameters)
        {
