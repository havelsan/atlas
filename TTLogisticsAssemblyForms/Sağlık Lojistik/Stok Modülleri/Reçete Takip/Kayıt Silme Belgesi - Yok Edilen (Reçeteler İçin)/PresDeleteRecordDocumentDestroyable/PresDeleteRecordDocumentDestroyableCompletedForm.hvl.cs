...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public PresDeleteRecordDocumentDestroyableCompletedForm() : base("PRESDELETERECORDDOCUMENTDESTROYABLE", "PresDeleteRecordDocumentDestroyableCompletedForm")
        {
        }

        protected PresDeleteRecordDocumentDestroyableCompletedForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}