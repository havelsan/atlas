...
namespace TTFormClasses
{
    public partial class PesChaDocDetWithPurchaseForm : BaseStockActionDetailInForm
    {
        ...
        {
#region PesChaDocDetWithPurchaseForm_ttbuttonSorgula_Click
...
#endregion PesChaDocDetWithPurchaseForm_ttbuttonSorgula_Click
        }

        protected override void PreScript()
        {
#region PesChaDocDetWithPurchaseForm_PreScript
    base.PreScript();
    ((ITTMultiRowControl)this.PrescriptionPaperInDetails).MaximumRowCount = (int)_StockActionDetailIn.Amount;
#endregion PesChaDocDetWithPurchaseForm_PreScript
