...
namespace TTFormClasses
{
    ...
    public partial class PresCensusFixedMaterialInForm : BaseStockActionDetailInForm
    {
        ...
        {
#region PresCensusFixedMaterialInForm_ttbuttonSorgula_Click
...
#endregion PresCensusFixedMaterialInForm_ttbuttonSorgula_Click
        }

        protected override void PreScript()
        {
#region PresCensusFixedMaterialInForm_PreScript
    base.PreScript();
            ((ITTMultiRowControl)this.PrescriptionPaperInDetails).MaximumRowCount = (int)_StockActionDetailIn.Amount;
#endregion PresCensusFixedMaterialInForm_PreScript
