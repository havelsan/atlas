...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public PrescriptionConsumptionDocumentStockCardRegistryForm() : base("PRESCRIPTIONCONSUMPTIONDOCUMENT", "PrescriptionConsumptionDocumentStockCardRegistryForm")
        {
        }

        protected PrescriptionConsumptionDocumentStockCardRegistryForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}