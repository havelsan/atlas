...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public PrescriptionConsumptionDocumentApprovalForm() : base("PRESCRIPTIONCONSUMPTIONDOCUMENT", "PrescriptionConsumptionDocumentApprovalForm")
        {
        }

        protected PrescriptionConsumptionDocumentApprovalForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}