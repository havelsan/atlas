...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public PresChaDocOutputWithAccountancyNewForm() : base("PRESCHADOCOUTPUTWITHACCOUNTANCY", "PresChaDocOutputWithAccountancyNewForm")
        {
        }

        protected PresChaDocOutputWithAccountancyNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}