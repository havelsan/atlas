...
namespace TTFormClasses
{
    public partial class ChattelDocumentInputWithAccountancyApproveForm : BaseChattelDocumentInputWithAccountancyForm
    {
        ...
        public ChattelDocumentInputWithAccountancyApproveForm() : base("CHATTELDOCUMENTINPUTWITHACCOUNTANCY", "ChattelDocumentInputWithAccountancyApproveForm")
        {
        }

        protected ChattelDocumentInputWithAccountancyApproveForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}