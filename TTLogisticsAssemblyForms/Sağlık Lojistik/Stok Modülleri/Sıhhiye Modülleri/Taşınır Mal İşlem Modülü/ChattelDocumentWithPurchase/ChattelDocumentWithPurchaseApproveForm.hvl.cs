...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public ChattelDocumentWithPurchaseApproveForm() : base("CHATTELDOCUMENTWITHPURCHASE", "ChattelDocumentWithPurchaseApproveForm")
        {
        }

        protected ChattelDocumentWithPurchaseApproveForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}