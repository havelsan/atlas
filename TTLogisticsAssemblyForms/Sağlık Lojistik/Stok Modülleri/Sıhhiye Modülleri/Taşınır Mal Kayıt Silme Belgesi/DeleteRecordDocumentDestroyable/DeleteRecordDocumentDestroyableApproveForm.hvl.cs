...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public DeleteRecordDocumentDestroyableApproveForm() : base("DELETERECORDDOCUMENTDESTROYABLE", "DeleteRecordDocumentDestroyableApproveForm")
        {
        }

        protected DeleteRecordDocumentDestroyableApproveForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}