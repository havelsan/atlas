...
namespace TTFormClasses
{
    ...
    public partial class DeleteRecordDocumentWasteInspectionForm : BaseDeleteRecordDocumentWasteForm
    {
        ...
        {
#region DeleteRecordDocumentWasteInspectionForm_PreScript
    //Önce Create edilmeli sonra PreScript çalışmalıdır.
            _DeleteRecordDocumentWaste.CreateStockActionInspection();
            
            base.PreScript();
#endregion DeleteRecordDocumentWasteInspectionForm_PreScript
