...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public DeleteAnimalRecordNewForm() : base("DELETEANIMALRECORDDOCUMENT", "DeleteAnimalRecordNewForm")
        {
        }

        protected DeleteAnimalRecordNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}