...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public MainStoreStockTransferNewForm() : base("MAINSTORESTOCKTRANSFER", "MainStoreStockTransferNewForm")
        {
        }

        protected MainStoreStockTransferNewForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}