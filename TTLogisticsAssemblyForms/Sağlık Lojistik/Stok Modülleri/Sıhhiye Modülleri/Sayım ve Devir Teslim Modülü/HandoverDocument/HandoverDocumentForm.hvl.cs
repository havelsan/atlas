...
namespace TTFormClasses
{
    ...
    /// </summary>
        ...
        public HandoverDocumentForm() : base("HANDOVERDOCUMENT", "HandoverDocumentForm")
        {
        }

        protected HandoverDocumentForm(string objectDefName, string formDefName) : base(objectDefName, formDefName)
        {
        }
    }
}