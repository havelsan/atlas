...
{
    public partial class YENIDONERHASTAKABULREPORT : TTReport
    {
        ...
        {
            public YENIDONERHASTAKABULREPORT MyParentReport
            {
                get { return (YENIDONERHASTAKABULREPORT)ParentReport; }
            }
            ...
            public TTReportField DONORTCKIMLIKNO { get {return Header().DONORTCKIMLIKNO;} }
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public TTReportField DONORTCKIMLIKNO; 
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField145.Value = @"Donör TC Kimlik Nu.";
                    ...
                    DONORTCKIMLIKNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 86, 102, 91, false);
                    DONORTCKIMLIKNO.Name = "DONORTCKIMLIKNO";
                    DONORTCKIMLIKNO.FieldType = ReportFieldTypeEnum.ftVariable;
                    DONORTCKIMLIKNO.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    DONORTCKIMLIKNO.ObjectDefName = "BaseHastaKabul";
                    DONORTCKIMLIKNO.DataMember = "PROVIZYONGIRISDVO.DONORTCKIMLIKNO";
                    DONORTCKIMLIKNO.Value = @"{@TTOBJECTID@}";
...
#region PARTB HEADER_Script
        ...
        public YENIDONERHASTAKABULREPORT()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "YENIDONERHASTAKABULREPORT";
            Caption = "Donör Hasta Kabul Dökümü";
