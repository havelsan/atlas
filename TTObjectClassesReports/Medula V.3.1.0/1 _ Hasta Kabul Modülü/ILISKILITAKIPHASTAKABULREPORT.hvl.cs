...
{
    public partial class ILISKILITAKIPHASTAKABULREPORT : TTReport
    {
        ...
        {
            public ILISKILITAKIPHASTAKABULREPORT MyParentReport
            {
                get { return (ILISKILITAKIPHASTAKABULREPORT)ParentReport; }
            }
            ...
            public TTReportField ILISKILENDIRILENTAKIPNO { get {return Header().ILISKILENDIRILENTAKIPNO;} }
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public TTReportField ILISKILENDIRILENTAKIPNO; 
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 0, 99, 170, 99, false);
                    NewLine11.Name = "NewLine11";
                    NewLine11.DrawStyle = DrawStyleConstants.vbSolid;

                    NewField11311 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 94, 119, 99, false);
                    ...
                    NewField4 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 106, 50, 111, false);
                    ...
                    NewField45 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 106, 52, 111, false);
                    ...
                    NewField14 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 112, 50, 117, false);
                    ...
                    NewField154 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 112, 52, 117, false);
                    ...
                    NewField141 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 118, 50, 123, false);
                    ...
                    NewField1451 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 118, 52, 123, false);
                    ...
                    NewField142 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 124, 50, 129, false);
                    ...
                    NewField1452 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 124, 52, 129, false);
                    ...
                    NewField143 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 130, 50, 135, false);
                    ...
                    NewField1453 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 130, 52, 135, false);
                    ...
                    NewField144 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 136, 50, 141, false);
                    ...
                    NewField1454 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 136, 52, 141, false);
                    ...
                    NewField1441 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 142, 50, 147, false);
                    ...
                    NewField14541 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 142, 52, 147, false);
                    ...
                    HASTABASVURUNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 106, 102, 111, false);
                    ...
                    TAKIPNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 112, 102, 117, false);
                    ...
                    TCKIMLIKNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 118, 102, 123, false);
                    ...
                    DOGUMTARIHI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 130, 102, 135, false);
                    ...
                    NewField15 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 100, 50, 105, false);
                    ...
                    NewField155 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 100, 52, 105, false);
                    ...
                    SONUCKODU = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 100, 64, 105, false);
                    ...
                    SONUCMESAJI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 65, 100, 170, 105, false);
                    ...
                    ADSOYAD = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 124, 170, 129, false);
                    ...
                    CINSIYETDESC = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 136, 102, 141, false);
                    ...
                    CEVAPSIGORTALITURUDESC = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 142, 102, 147, false);
                    ...
                    NewField145.Value = @"İlişkilendirilen Takip Nu.";
                    ...
                    ILISKILENDIRILENTAKIPNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 86, 102, 91, false);
                    ILISKILENDIRILENTAKIPNO.Name = "ILISKILENDIRILENTAKIPNO";
                    ILISKILENDIRILENTAKIPNO.FieldType = ReportFieldTypeEnum.ftVariable;
                    ILISKILENDIRILENTAKIPNO.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    ILISKILENDIRILENTAKIPNO.ObjectDefName = "BaseHastaKabul";
                    ILISKILENDIRILENTAKIPNO.DataMember = "PROVIZYONGIRISDVO.TAKIPNO";
                    ILISKILENDIRILENTAKIPNO.Value = @"{@TTOBJECTID@}";
...
#region PARTB HEADER_Script
        ...
        public ILISKILITAKIPHASTAKABULREPORT()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "ILISKILITAKIPHASTAKABULREPORT";
            Caption = "İlişkili Hasta Kabul Dökümü";
