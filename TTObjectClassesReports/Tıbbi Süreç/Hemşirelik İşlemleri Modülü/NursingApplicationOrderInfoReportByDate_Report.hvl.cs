...
{
    public partial class NursingApplicationOrderInfoReportByDate : TTReport
    {
#region Methods
...
//            public string T15;
        ...
        {
            public NursingApplicationOrderInfoReportByDate MyParentReport
            {
                get { return (NursingApplicationOrderInfoReportByDate)ParentReport; }
            }
...
#region HASTAINFO HEADER_Script
                    ...
                    if (nursingApplication.InPatientTreatmentClinicApp != null)
                    {
                      ...
                      DateTime dateTime = (DateTime)((NursingApplicationOrderInfoReport)ParentReport).RuntimeParameters.STARTTIME;
                   //  DateTime currentEndDateTime = (DateTime)((NursingApplicationOrderInfoReport)ParentReport).RuntimeParameters.ENDTIME;
        ...
        public partial class HEADERGroup : TTReportGroup
        {
            ...
            public partial class HEADERGroupHeader : TTReportSection
            {
                ...
                public HEADERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DURUMU11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 72, 84, 85, 91, false);
                    ...
                    TEDAVİ11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 35, 84, 72, 91, false);
                    TEDAVİ11.Name = "TEDAVİ11";
                    TEDAVİ11.DrawStyle = DrawStyleConstants.vbSolid;
                    TEDAVİ11.TextFormat = @"dd/MM/yyyy";
                    TEDAVİ11.TextFont.Bold = true;
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ORDERTURU = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 8, 0, 23, 13, false);
                    ...
                    DURUMU = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 72, 0, 85, 13, false);
                    DURUMU.Name = "DURUMU";
                    ...
                    TEDAVİ = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 35, 0, 72, 13, false);
                    TEDAVİ.Name = "TEDAVİ";
                    ...
                    ACIKLAMA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 85, 0, 109, 13, false);
                    ...
                    UYGULAMASEK = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 109, 0, 130, 13, false);
                    ...
                    DOZ = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 130, 0, 140, 13, false);
                    DOZ.Name = "DOZ";
                    DOZ.DrawStyle = DrawStyleConstants.vbSolid;
                    DOZ.FieldType = ReportFieldTypeEnum.ftVariable;
                    DOZ.Value = @"";

                    T1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 140, 0, 148, 6, false);
                    T1.Name = "T1";
                    T1.DrawStyle = DrawStyleConstants.vbSolid;
                    T1.FieldType = ReportFieldTypeEnum.ftVariable;
                    T1.Value = @"";

                    T2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 148, 0, 156, 6, false);
                    T2.Name = "T2";
                    T2.DrawStyle = DrawStyleConstants.vbSolid;
                    T2.FieldType = ReportFieldTypeEnum.ftVariable;
                    T2.Value = @"";

                    T3 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 156, 0, 164, 6, false);
                    T3.Name = "T3";
                    T3.DrawStyle = DrawStyleConstants.vbSolid;
                    T3.FieldType = ReportFieldTypeEnum.ftVariable;
                    T3.Value = @"";

                    T4 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 164, 0, 172, 6, false);
                    T4.Name = "T4";
                    T4.DrawStyle = DrawStyleConstants.vbSolid;
                    T4.FieldType = ReportFieldTypeEnum.ftVariable;
                    T4.Value = @"";

                    T5 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 172, 0, 180, 6, false);
                    T5.Name = "T5";
                    T5.DrawStyle = DrawStyleConstants.vbSolid;
                    T5.FieldType = ReportFieldTypeEnum.ftVariable;
                    T5.Value = @"";

                    T6 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 180, 0, 188, 6, false);
                    T6.Name = "T6";
                    T6.DrawStyle = DrawStyleConstants.vbSolid;
                    T6.FieldType = ReportFieldTypeEnum.ftVariable;
                    T6.Value = @"";

                    T7 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 188, 0, 196, 6, false);
                    T7.Name = "T7";
                    T7.DrawStyle = DrawStyleConstants.vbSolid;
                    T7.FieldType = ReportFieldTypeEnum.ftVariable;
                    T7.Value = @"";

                    T8 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 196, 0, 204, 6, false);
                    T8.Name = "T8";
                    T8.DrawStyle = DrawStyleConstants.vbSolid;
                    T8.FieldType = ReportFieldTypeEnum.ftVariable;
                    T8.Value = @"";

                    P1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 140, 6, 148, 13, false);
                    P1.Name = "P1";
                    P1.DrawStyle = DrawStyleConstants.vbSolid;
                    P1.FieldType = ReportFieldTypeEnum.ftVariable;
                    P1.Value = @"";

                    P2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 148, 6, 156, 13, false);
                    P2.Name = "P2";
                    P2.DrawStyle = DrawStyleConstants.vbSolid;
                    P2.FieldType = ReportFieldTypeEnum.ftVariable;
                    P2.Value = @"";

                    P3 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 156, 6, 164, 13, false);
                    P3.Name = "P3";
                    P3.DrawStyle = DrawStyleConstants.vbSolid;
                    P3.FieldType = ReportFieldTypeEnum.ftVariable;
                    P3.Value = @"";

                    P4 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 164, 6, 172, 13, false);
                    P4.Name = "P4";
                    P4.DrawStyle = DrawStyleConstants.vbSolid;
                    P4.FieldType = ReportFieldTypeEnum.ftVariable;
                    P4.Value = @"";

                    P5 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 172, 6, 180, 13, false);
                    P5.Name = "P5";
                    P5.DrawStyle = DrawStyleConstants.vbSolid;
                    P5.FieldType = ReportFieldTypeEnum.ftVariable;
                    P5.Value = @"";

                    P6 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 180, 6, 188, 13, false);
                    P6.Name = "P6";
                    P6.DrawStyle = DrawStyleConstants.vbSolid;
                    P6.FieldType = ReportFieldTypeEnum.ftVariable;
                    P6.Value = @"";

                    P7 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 188, 6, 196, 13, false);
                    P7.Name = "P7";
                    P7.DrawStyle = DrawStyleConstants.vbSolid;
                    P7.FieldType = ReportFieldTypeEnum.ftVariable;
                    P7.Value = @"";

                    P8 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 196, 6, 204, 13, false);
                    P8.Name = "P8";
                    P8.DrawStyle = DrawStyleConstants.vbSolid;
                    P8.FieldType = ReportFieldTypeEnum.ftVariable;
                    P8.Value = @"";

                    ORDERTARIHI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 23, 0, 35, 13, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { ORDERTURU,DURUMU,TEDAVİ,ACIKLAMA,UYGULAMASEK,DOZ,T1,T2,T3,T4,T5,T6,T7,T8,P1,P2,P3,P4,P5,P6,P7,P8,ORDERTARIHI};
                }
...
//                    this.T15.CalcValue = obj.T15;
        ...
        public NursingApplicationOrderInfoReportByDate()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "NURSINGAPPLICATIONORDERINFOREPORTBYDATE";
            Caption = "Hasta Tedavi Defteri(Günlük)";
