...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class CMRRegistrationHospitalReportByRepair : TTReport
    {
        ...
        {
            public CMRRegistrationHospitalReportByRepair MyParentReport
            {
                get { return (CMRRegistrationHospitalReportByRepair)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 217, 14, 235, 41, false);
...
TARİHİ";
                    ...
                    REPORTHEADER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 6, 175, 14, false);
                    ...
                    NewField14 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 14, 9, 41, false);
...
SIRA NU.";
                    ...
                    NewField1141 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 264, 22, 279, 41, false);
...
ÜKS";
                    ...
                    NewField1142 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 249, 22, 264, 41, false);
...
PB";
                    ...
                    NewField12411 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 235, 14, 279, 22, false);
                    ...
                    NewField111421 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 235, 22, 250, 41, false);
...
O";
                    ...
                    NewField111422 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 66, 21, 116, 41, false);
...
KLİNİĞİ";
                    ...
                    NewField15 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 8, 21, 24, 41, false);
...
NU.";
                    ...
                    NewField16 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 133, 14, 155, 41, false);
...
EDEN";
                    ...
                    NewField161 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 24, 21, 66, 41, false);
                    ...
                    NewField1161 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 155, 14, 177, 41, false);
...
ALAN";
                    ...
                    NewField11611 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 175, 14, 203, 41, false);
...
KISIM";
                    ...
                    NewField111611 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 203, 14, 221, 41, false);
...
TARİHİ";
                    ...
                    NewField111423 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 235, 6, 279, 14, false);
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 8, 14, 116, 21, false);
                    ...
                    NewField2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 116, 14, 133, 41, false);
...
FORMMU NU.";
                    ...
                    NewField3 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 317, 26, 342, 31, false);
                    NewField3.Name = "NewField3";
                    NewField3.Visible = EvetHayirEnum.ehHayir;
                    NewField3.FieldType = ReportFieldTypeEnum.ftVariable;
                    NewField3.Value = @"{@ENDDATE@}";

                    NewField4 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 314, 19, 339, 24, false);
                    NewField4.Name = "NewField4";
                    NewField4.Visible = EvetHayirEnum.ehHayir;
                    NewField4.FieldType = ReportFieldTypeEnum.ftVariable;
                    NewField4.Value = @"{@STARTDATE@}";

                    NewField1151 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 176, 7, 202, 13, false);
                    NewField1151.Name = "NewField1151";
                    NewField1151.FieldType = ReportFieldTypeEnum.ftVariable;
                    NewField1151.TextFormat = @"Short Date";
                    ...
                    NewField1151.Value = @"{@STARTDATE@}";

                    NewField1261 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 203, 7, 208, 12, false);
                    ...
                    NewField1171 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 209, 7, 234, 12, false);
                    NewField1171.Name = "NewField1171";
                    NewField1171.FieldType = ReportFieldTypeEnum.ftVariable;
                    NewField1171.TextFormat = @"Short Date";
                    NewField1171.TextFont.Size = 11;
                    NewField1171.TextFont.Bold = true;
                    NewField1171.TextFont.CharSet = 162;
                    NewField1171.Value = @"{@ENDDATE@}";

                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 176, 14, 238, 14, false);
                    NewLine11.Name = "NewLine11";
                    NewLine11.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine112 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 171, 6, 235, 6, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    NewField1151.CalcValue = MyParentReport.RuntimeParameters.STARTDATE.ToString();
                    NewField1261.CalcValue = NewField1261.Value;
                    NewField1171.CalcValue = MyParentReport.RuntimeParameters.ENDDATE.ToString();
                    return new TTReportObject[] { NewField11,REPORTHEADER,NewField14,NewField1141,NewField1142,NewField12411,NewField111421,NewField111422,NewField15,NewField16,NewField161,NewField1161,NewField11611,NewField111611,NewField111423,NewField1,NewField2,NewField3,NewField4,NewField1151,NewField1261,NewField1171};
                }
...
#region PARTA HEADER_Script
                    ...
                    if (Sites.SiteXXXXXX06XXXXXX == siteIDGuid || Sites.SiteXXXXXX04 == siteIDGuid)
                        REPORTHEADER.CalcValue = "XXXXXX BİYOMEDİKAL MÜHENDİSLİK MERKEZİ TIBBİ CİHAZ BAKIM-ONARIM KAYIT DEFTERİ";
                    else
                        REPORTHEADER.CalcValue = "TIBBİ CİHAZ BAKIM-ONARIM KAYIT DEFTERİ";
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewLine111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 0, 1, 280, 1, false);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    STOCKNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 8, 0, 24, 15, false);
...
";
                    ...
                    CLINIC = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 66, 0, 116, 15, false);
                    CLINIC.Name = "CLINIC";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    CMRActionRequest.CMRActionHospitalReportQueryByRepair_Class dataset_CMRActionHospitalReportQueryByRepair = ParentGroup.rsGroup.GetCurrentRecord<CMRActionRequest.CMRActionHospitalReportQueryByRepair_Class>(0);
                    COUNT.CalcValue = ParentGroup.Counter.ToString();
                    STOCKNO.CalcValue = (dataset_CMRActionHospitalReportQueryByRepair != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByRepair.Stockno) : "") + @"
";
                    MATERIALNAME.CalcValue = (dataset_CMRActionHospitalReportQueryByRepair != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByRepair.Materialname) : "");
                    CLINIC.CalcValue = (dataset_CMRActionHospitalReportQueryByRepair != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByRepair.Sendersection) : "");
                    REQUESTNO.CalcValue = (dataset_CMRActionHospitalReportQueryByRepair != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByRepair.RequestNo) : "");
                    DELIVERERUSER.CalcValue = @"";
                    WORKSHOP.CalcValue = (dataset_CMRActionHospitalReportQueryByRepair != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByRepair.Workshopname) : "");
                    STARTDATE.CalcValue = (dataset_CMRActionHospitalReportQueryByRepair != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByRepair.RequestDate) : "");
                    ENDDATE.CalcValue = @"";
                    O.CalcValue = @"";
                    PB.CalcValue = @"";
                    UKS.CalcValue = @"";
                    OBJECTID.CalcValue = (dataset_CMRActionHospitalReportQueryByRepair != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByRepair.ObjectID) : "");
                    DELIVEREDPERSON.CalcValue = @"";
                    REQUESTDATE.CalcValue = (dataset_CMRActionHospitalReportQueryByRepair != null ? Globals.ToStringCore(dataset_CMRActionHospitalReportQueryByRepair.RequestDate) : "");
...
#region MAIN BODY_Script
            ...
            if (TTUtils.Globals.IsGuid(OBJECTID.CalcValue))
            {
                ...
                if(action != null)
                {
                    if (action is Repair)
                    {
                        if(!string.IsNullOrEmpty(this.ENDDATE.CalcValue))
                        {
                            O.CalcValue = "X";
                        }
        ...
        public CMRRegistrationHospitalReportByRepair()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CMRREGISTRATIONHOSPITALREPORTBYREPAIR";
            Caption = "Bakım-Onarım Kayıt Defteri Raporu(XXXXXX)";
