...
{
    /// <summary>
    /// Yatan Hastalara Verilen İlaç Reçete Toplam Raporu
    /// </summary>
    public partial class InPatientDrugPrescriptionTotalReport : TTReport
    {
        ...
        {
            public InPatientDrugPrescriptionTotalReport MyParentReport
            {
                get { return (InPatientDrugPrescriptionTotalReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName.Value = @"YATAN HASTALARA VERİLEN İLAÇ REÇETE TOPLAM RAPORU";
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<InpatientPrescription.GetInPatientDrugPrescriptionTotalReportQuery_Class>("GetInPatientDrugPrescriptionTotalReportQuery", InpatientPrescription.GetInPatientDrugPrescriptionTotalReportQuery((DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.STARTDATE),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.ENDDATE)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    InpatientPrescription.GetInPatientDrugPrescriptionTotalReportQuery_Class dataset_GetInPatientDrugPrescriptionTotalReportQuery = ParentGroup.rsGroup.GetCurrentRecord<InpatientPrescription.GetInPatientDrugPrescriptionTotalReportQuery_Class>(0);
                    OrderNO.CalcValue = ParentGroup.Counter.ToString();
                    DrugName.CalcValue = (dataset_GetInPatientDrugPrescriptionTotalReportQuery != null ? Globals.ToStringCore(dataset_GetInPatientDrugPrescriptionTotalReportQuery.Name) : "");
                    Code.CalcValue = (dataset_GetInPatientDrugPrescriptionTotalReportQuery != null ? Globals.ToStringCore(dataset_GetInPatientDrugPrescriptionTotalReportQuery.Code) : "");
                    TotalAmount.CalcValue = (dataset_GetInPatientDrugPrescriptionTotalReportQuery != null ? Globals.ToStringCore(dataset_GetInPatientDrugPrescriptionTotalReportQuery.Amount) : "");
        ...
        public InPatientDrugPrescriptionTotalReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "INPATIENTDRUGPRESCRIPTIONTOTALREPORT";
            Caption = "Yatan Hastalara Verilen İlaç Reçete Toplam Raporu";
