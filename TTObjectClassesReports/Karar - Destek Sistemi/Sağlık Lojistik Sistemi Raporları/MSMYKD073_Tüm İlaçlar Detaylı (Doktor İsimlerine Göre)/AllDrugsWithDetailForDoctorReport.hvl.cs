...
{
    /// <summary>
    /// Tüm İlaçlar Detaylı (Doktor İsimlerine Göre/Doktor İsim Seçmeli)
    /// </summary>
    public partial class AllDrugsWithDetailForDoctorReport : TTReport
    {
        public class ReportRuntimeParameters 
        {
            public DateTime? STARTDATE = (DateTime?)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue("");
            public DateTime? ENDDATE = (DateTime?)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue("");
            public Guid? DOCTORID = (Guid?)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue("00000000-0000-0000-0000-000000000000");
        }

        public partial class PARTAGroup : TTReportGroup
        {
            public AllDrugsWithDetailForDoctorReport MyParentReport
            {
                get { return (AllDrugsWithDetailForDoctorReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName.Value = @"TÜM İLAÇLAR DETAYLI (DOKTOR İSİMLERİNE GÖRE/DOKTOR İSİM SEÇMELİ)";
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<DrugOrder.GetAllDrugsWithDetailForDoctorReportQuery_Class>("GetAllDrugsWithDetailForDoctorReportQuery", DrugOrder.GetAllDrugsWithDetailForDoctorReportQuery((DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.STARTDATE),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.ENDDATE),(string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.DOCTORID)));
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DrugOrder.GetAllDrugsWithDetailForDoctorReportQuery_Class dataset_GetAllDrugsWithDetailForDoctorReportQuery = ParentGroup.rsGroup.GetCurrentRecord<DrugOrder.GetAllDrugsWithDetailForDoctorReportQuery_Class>(0);
                    Doctor.CalcValue = (dataset_GetAllDrugsWithDetailForDoctorReportQuery != null ? Globals.ToStringCore(dataset_GetAllDrugsWithDetailForDoctorReportQuery.ProcedureDoctor) : "");
                    Doctor.PostFieldValueCalculation();
                    return new TTReportObject[] { Doctor};
                }
            }
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                DrugOrder.GetAllDrugsWithDetailForDoctorReportQuery_Class dataSet_GetAllDrugsWithDetailForDoctorReportQuery = ParentGroup.rsGroup.GetCurrentRecord<DrugOrder.GetAllDrugsWithDetailForDoctorReportQuery_Class>(0);    
                return new object[] {(dataSet_GetAllDrugsWithDetailForDoctorReportQuery==null ? null : dataSet_GetAllDrugsWithDetailForDoctorReportQuery.ProcedureDoctor)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DrugName = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 5, 1, 30, 6, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DrugOrder.GetAllDrugsWithDetailForDoctorReportQuery_Class dataset_GetAllDrugsWithDetailForDoctorReportQuery = MyParentReport.PARTB.rsGroup.GetCurrentRecord<DrugOrder.GetAllDrugsWithDetailForDoctorReportQuery_Class>(0);
                    DrugName.CalcValue = (dataset_GetAllDrugsWithDetailForDoctorReportQuery != null ? Globals.ToStringCore(dataset_GetAllDrugsWithDetailForDoctorReportQuery.Name) : "");
                    Amount.CalcValue = (dataset_GetAllDrugsWithDetailForDoctorReportQuery != null ? Globals.ToStringCore(dataset_GetAllDrugsWithDetailForDoctorReportQuery.Amount) : "");
        ...
        public AllDrugsWithDetailForDoctorReport()
        {
            ...
            reportParameter = Parameters.Add("DOCTORID", "00000000-0000-0000-0000-000000000000", "Doktoru Seçiniz", @"", true, true, false, new Guid("b91c9866-f2fe-44bc-9d36-ae524ee4d2ef"));
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            if (parameters.ContainsKey("DOCTORID"))
                _runtimeParameters.DOCTORID = (Guid?)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(parameters["DOCTORID"]);
            Name = "ALLDRUGSWITHDETAILFORDOCTORREPORT";
            Caption = "Tüm İlaçlar Detaylı (Doktor İsimlerine Göre/Doktor İsim Seçmeli)";
