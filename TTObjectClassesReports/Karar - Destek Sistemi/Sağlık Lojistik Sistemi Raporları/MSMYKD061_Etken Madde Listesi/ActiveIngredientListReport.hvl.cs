...
namespace TTReportClasses
{
    ...
    public partial class ActiveIngredientListReport : TTReport
    {
        ...
        {
            public ActiveIngredientListReport MyParentReport
            {
                get { return (ActiveIngredientListReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName.Value = @"ETKEN MADDE LİSTESİ";
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 1, 14, 6, false);
                    ...
                    NewField2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 1, 89, 6, false);
                    NewField2.Name = "NewField2";
                    NewField2.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    NewField2.TextFont.Size = 11;
                    NewField2.TextFont.Bold = true;
                    NewField2.TextFont.CharSet = 162;
                    NewField2.Value = @"Etken Maddenin İsmi";
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<ActiveIngredientDefinition.GetActiveIngredientListReportQuery_Class>("GetActiveIngredientListReportQuery", ActiveIngredientDefinition.GetActiveIngredientListReportQuery());
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    OrderNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 1, 14, 6, false);
                    OrderNO.Name = "OrderNO";
                    OrderNO.FieldType = ReportFieldTypeEnum.ftVariable;
                    OrderNO.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    OrderNO.Value = @"{@counter@}";

                    Name = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 1, 170, 6, false);
                    Name.Name = "Name";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ActiveIngredientDefinition.GetActiveIngredientListReportQuery_Class dataset_GetActiveIngredientListReportQuery = ParentGroup.rsGroup.GetCurrentRecord<ActiveIngredientDefinition.GetActiveIngredientListReportQuery_Class>(0);
                    OrderNO.CalcValue = ParentGroup.Counter.ToString();
                    Name.CalcValue = (dataset_GetActiveIngredientListReportQuery != null ? Globals.ToStringCore(dataset_GetActiveIngredientListReportQuery.Name) : "");
                    return new TTReportObject[] { OrderNO,Name};
                }
            }
        ...
        public ActiveIngredientListReport()
        {
        ...
        {
            Name = "ACTIVEINGREDIENTLISTREPORT";
            Caption = "Etken Madde Listesi";
