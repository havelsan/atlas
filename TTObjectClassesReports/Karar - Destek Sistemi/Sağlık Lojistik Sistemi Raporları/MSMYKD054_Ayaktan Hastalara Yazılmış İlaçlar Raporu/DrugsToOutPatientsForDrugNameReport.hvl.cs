...
{
    /// <summary>
    /// Ayaktan Hastalara Yazılmış İlaçlar Raporu (İlaç Seçmeli)
    /// </summary>
    public partial class DrugsToOutPatientsForDrugNameReport : TTReport
    {
        ...
        {
            public DrugsToOutPatientsForDrugNameReport MyParentReport
            {
                get { return (DrugsToOutPatientsForDrugNameReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName.Value = @"AYAKTAN HASTALARA YAZILMIŞ İLAÇLAR RAPORU
(İLAÇ SEÇMELİ)";
        ...
        public partial class PARTCGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<OutPatientDrugOrder.GetDrugsToOutPatientsForDrugNameReportQuery_Class>("GetDrugsToOutPatientsForDrugNameReportQuery", OutPatientDrugOrder.GetDrugsToOutPatientsForDrugNameReportQuery((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.DRUGID),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.STARTDATE),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.ENDDATE)));
            ...
            public partial class PARTCGroupHeader : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    OutPatientDrugOrder.GetDrugsToOutPatientsForDrugNameReportQuery_Class dataset_GetDrugsToOutPatientsForDrugNameReportQuery = ParentGroup.rsGroup.GetCurrentRecord<OutPatientDrugOrder.GetDrugsToOutPatientsForDrugNameReportQuery_Class>(0);
                    Doctor.CalcValue = (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.Name) : "") + @" - " + (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.Work) : "");
                    NewField1.CalcValue = NewField1.Value;
                    NewField11.CalcValue = NewField11.Value;
                    NewField12.CalcValue = NewField12.Value;
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                OutPatientDrugOrder.GetDrugsToOutPatientsForDrugNameReportQuery_Class dataSet_GetDrugsToOutPatientsForDrugNameReportQuery = ParentGroup.rsGroup.GetCurrentRecord<OutPatientDrugOrder.GetDrugsToOutPatientsForDrugNameReportQuery_Class>(0);    
                return new object[] {(dataSet_GetDrugsToOutPatientsForDrugNameReportQuery==null ? null : dataSet_GetDrugsToOutPatientsForDrugNameReportQuery.Material)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    OutPatientDrugOrder.GetDrugsToOutPatientsForDrugNameReportQuery_Class dataset_GetDrugsToOutPatientsForDrugNameReportQuery = MyParentReport.PARTC.rsGroup.GetCurrentRecord<OutPatientDrugOrder.GetDrugsToOutPatientsForDrugNameReportQuery_Class>(0);
                    PatientNO.CalcValue = (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.ID) : "");
                    PatientName.CalcValue = (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.Patientname) : "") + @" " + (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.Patientsurname) : "");
                    Dose.CalcValue = (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.DoseAmount) : "");
                    NewFrequency.CalcValue = NewFrequency.Value;
                    Day.CalcValue = (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.Day) : "");
                    Amount.CalcValue = (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.Amount) : "");
                    UnitPrice.CalcValue = (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.Price) : "");
                    TotalPrice.CalcValue = (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.Totalprice) : "");
                    Frequency.CalcValue = (dataset_GetDrugsToOutPatientsForDrugNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDrugNameReportQuery.Frequency) : "");
...
#region MAIN BODY_Script
        ...
        public DrugsToOutPatientsForDrugNameReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DRUGSTOOUTPATIENTSFORDRUGNAMEREPORT";
            Caption = "Ayaktan Hastalara Yazılmış İlaçlar Raporu (İlaç Seçmeli)";
