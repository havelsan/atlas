...
{
    /// <summary>
    /// Ayaktan Hastalara Yazılmış İlaçlar Raporu (Doktor Seçmeli)
    /// </summary>
    public partial class DrugsToOutPatientsForDoctorNameReport : TTReport
    {
        ...
        {
            public DrugsToOutPatientsForDoctorNameReport MyParentReport
            {
                get { return (DrugsToOutPatientsForDoctorNameReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName.Value = @"AYAKTAN HASTALARA YAZILMIŞ İLAÇLAR RAPORU (DOKTOR SEÇMELİ)";
        ...
        public partial class PARTCGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<OutPatientDrugOrder.GetDrugsToOutPatientsForDoctorNameReportQuery_Class>("GetDrugsToOutPatientsForDoctorNameReportQuery", OutPatientDrugOrder.GetDrugsToOutPatientsForDoctorNameReportQuery((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.DOCTORID),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.STARTDATE),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.ENDDATE)));
            ...
            public partial class PARTCGroupHeader : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    OutPatientDrugOrder.GetDrugsToOutPatientsForDoctorNameReportQuery_Class dataset_GetDrugsToOutPatientsForDoctorNameReportQuery = ParentGroup.rsGroup.GetCurrentRecord<OutPatientDrugOrder.GetDrugsToOutPatientsForDoctorNameReportQuery_Class>(0);
                    PatientNO.CalcValue = (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.ID) : "");
                    NewField1.CalcValue = NewField1.Value;
                    NewField11.CalcValue = NewField11.Value;
                    NewField12.CalcValue = NewField12.Value;
                    ...
                    PatientName.CalcValue = (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.Patientname) : "") + @" " + (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.Patientsurname) : "");
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                OutPatientDrugOrder.GetDrugsToOutPatientsForDoctorNameReportQuery_Class dataSet_GetDrugsToOutPatientsForDoctorNameReportQuery = ParentGroup.rsGroup.GetCurrentRecord<OutPatientDrugOrder.GetDrugsToOutPatientsForDoctorNameReportQuery_Class>(0);    
                return new object[] {(dataSet_GetDrugsToOutPatientsForDoctorNameReportQuery==null ? null : dataSet_GetDrugsToOutPatientsForDoctorNameReportQuery.ID)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    OutPatientDrugOrder.GetDrugsToOutPatientsForDoctorNameReportQuery_Class dataset_GetDrugsToOutPatientsForDoctorNameReportQuery = MyParentReport.PARTC.rsGroup.GetCurrentRecord<OutPatientDrugOrder.GetDrugsToOutPatientsForDoctorNameReportQuery_Class>(0);
                    Code.CalcValue = (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.Material) : "");
                    Code.PostFieldValueCalculation();
                    DrugName.CalcValue = (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.Material) : "");
                    DrugName.PostFieldValueCalculation();
                    Dose.CalcValue = (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.DoseAmount) : "");
                    NewFrequency.CalcValue = NewFrequency.Value;
                    Day.CalcValue = (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.Day) : "");
                    Amount.CalcValue = (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.Amount) : "");
                    UnitPrice.CalcValue = (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.Price) : "");
                    TotalPrice.CalcValue = (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.Totalprice) : "");
                    Frequency.CalcValue = (dataset_GetDrugsToOutPatientsForDoctorNameReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsToOutPatientsForDoctorNameReportQuery.Frequency) : "");
...
#region MAIN BODY_Script
        ...
        public DrugsToOutPatientsForDoctorNameReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DRUGSTOOUTPATIENTSFORDOCTORNAMEREPORT";
            Caption = "Ayaktan Hastalara Yazılmış İlaçlar Raporu (Doktor Seçmeli)";
