...
{
    /// <summary>
    /// Günlük İlaç Çizelgesi İle Verilen İlaçlar Toplam Raporu ( İlaça Göre)
    /// </summary>
    public partial class KSchDrugPrescTotalRptNotComplated : TTReport
    {
        ...
        {
            public KSchDrugPrescTotalRptNotComplated MyParentReport
            {
                get { return (KSchDrugPrescTotalRptNotComplated)ParentReport; }
            }
...
#region PARTA HEADER_PreScript
                    if (String.IsNullOrEmpty(((KSchDrugPrescTotalRptNotComplated)ParentReport).RuntimeParameters.STOREID) || ((KSchDrugPrescTotalRptNotComplated)ParentReport).RuntimeParameters.STOREID == Guid.Empty.ToString())
                ((KSchDrugPrescTotalRptNotComplated)ParentReport).RuntimeParameters.STOREID_FLAG = 0;
            else
                ((KSchDrugPrescTotalRptNotComplated)ParentReport).RuntimeParameters.STOREID_FLAG = 1;
...
//            }
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    KSchedule.GetKScheduleDrugPrescriptionTotalMainQueryNotComp_Class dataset_GetKScheduleDrugPrescriptionTotalMainQueryNotComp = ParentGroup.rsGroup.GetCurrentRecord<KSchedule.GetKScheduleDrugPrescriptionTotalMainQueryNotComp_Class>(0);
                    NewField1.CalcValue = NewField1.Value;
                    NewField11.CalcValue = NewField11.Value;
                    NewField111.CalcValue = NewField111.Value;
                    NewField112.CalcValue = NewField112.Value;
                    STORENAME.CalcValue = (dataset_GetKScheduleDrugPrescriptionTotalMainQueryNotComp != null ? Globals.ToStringCore(dataset_GetKScheduleDrugPrescriptionTotalMainQueryNotComp.Storename) : "");
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                KSchedule.GetKScheduleDrugPrescriptionTotalMainQueryNotComp_Class dataSet_GetKScheduleDrugPrescriptionTotalMainQueryNotComp = ParentGroup.rsGroup.GetCurrentRecord<KSchedule.GetKScheduleDrugPrescriptionTotalMainQueryNotComp_Class>(0);    
                return new object[] {(dataSet_GetKScheduleDrugPrescriptionTotalMainQueryNotComp==null ? null : dataSet_GetKScheduleDrugPrescriptionTotalMainQueryNotComp.Storename)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    KSchedule.GetKScheduleDrugPrescriptionTotalMainQueryNotComp_Class dataset_GetKScheduleDrugPrescriptionTotalMainQueryNotComp = MyParentReport.PARTB.rsGroup.GetCurrentRecord<KSchedule.GetKScheduleDrugPrescriptionTotalMainQueryNotComp_Class>(0);
                    OrderNO.CalcValue = ParentGroup.GroupCounter.ToString();
                    DrugName.CalcValue = (dataset_GetKScheduleDrugPrescriptionTotalMainQueryNotComp != null ? Globals.ToStringCore(dataset_GetKScheduleDrugPrescriptionTotalMainQueryNotComp.Name) : "");
                    Code.CalcValue = (dataset_GetKScheduleDrugPrescriptionTotalMainQueryNotComp != null ? Globals.ToStringCore(dataset_GetKScheduleDrugPrescriptionTotalMainQueryNotComp.Barcode) : "");
                    TotalAmount.CalcValue = (dataset_GetKScheduleDrugPrescriptionTotalMainQueryNotComp != null ? Globals.ToStringCore(dataset_GetKScheduleDrugPrescriptionTotalMainQueryNotComp.Amount) : "");
        ...
        public KSchDrugPrescTotalRptNotComplated()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "KSCHDRUGPRESCTOTALRPTNOTCOMPLATED";
            Caption = "K-Çizelgesi İle Verilen İlaç Reçete Toplam Raporu (İlaça Göre)";
