...
{
    /// <summary>
    /// Günlük İlaç Çizelgesi İle Verilen İlaçlar Toplam Raporu Hastalara Göre
    /// </summary>
    public partial class KScheduleDrugPrescTotalForPatients : TTReport
    {
        ...
        {
            public KScheduleDrugPrescTotalForPatients MyParentReport
            {
                get { return (KScheduleDrugPrescTotalForPatients)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, -1, 184, 19, false);
...
#region PARTA HEADER_PreScript
                    if (String.IsNullOrEmpty(((KScheduleDrugPrescTotalForPatients)ParentReport).RuntimeParameters.STOREID) || ((KScheduleDrugPrescTotalForPatients)ParentReport).RuntimeParameters.STOREID == Guid.Empty.ToString())
                ((KScheduleDrugPrescTotalForPatients)ParentReport).RuntimeParameters.STOREID_FLAG = 0;
            else
                ((KScheduleDrugPrescTotalForPatients)ParentReport).RuntimeParameters.STOREID_FLAG = 1;
...
//            }
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    KSchedule.GetKScheduleWithPatient_Class dataset_GetKScheduleWithPatient = ParentGroup.rsGroup.GetCurrentRecord<KSchedule.GetKScheduleWithPatient_Class>(0);
                    NewField1.CalcValue = NewField1.Value;
                    NewField112.CalcValue = NewField112.Value;
                    STORENAME.CalcValue = (dataset_GetKScheduleWithPatient != null ? Globals.ToStringCore(dataset_GetKScheduleWithPatient.Storename) : "");
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    NewField11.CalcValue = (dataset_GetKScheduleWithPatient != null ? Globals.ToStringCore(dataset_GetKScheduleWithPatient.Storename) : "") + " TOPLAM";
        ...
        public partial class PatientGROUPGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                KSchedule.GetKScheduleWithPatient_Class dataSet_GetKScheduleWithPatient = ParentGroup.rsGroup.GetCurrentRecord<KSchedule.GetKScheduleWithPatient_Class>(0);    
                return new object[] {(dataSet_GetKScheduleWithPatient==null ? null : dataSet_GetKScheduleWithPatient.Storename)};
            }
            private void onConstruct()
            {
                _body = null;
            ...
            public partial class PatientGROUPGroupHeader : TTReportSection
            {
                ...
                public PatientGROUPGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 29, 8, 125, 13, false);
                    ...
                    NewField1111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 125, 8, 141, 13, false);
                    ...
                    NewField12111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 141, 8, 157, 13, false);
                    ...
                    NewField13111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 157, 8, 185, 13, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    KSchedule.GetKScheduleWithPatient_Class dataset_GetKScheduleWithPatient = MyParentReport.PARTB.rsGroup.GetCurrentRecord<KSchedule.GetKScheduleWithPatient_Class>(0);
                    PATIENTNAME.CalcValue = (dataset_GetKScheduleWithPatient != null ? Globals.ToStringCore(dataset_GetKScheduleWithPatient.Patient) : "");
            ...
            public partial class PatientGROUPGroupFooter : TTReportSection
            {
                ...
                public PatientGROUPGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SUMOFAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 124, 0, 140, 5, false);
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 103, 0, 122, 5, false);
                    NewField1.Name = "NewField1";
                    NewField1.HorzAlign = HorizontalAlignmentEnum.haRight;
                    NewField1.TextFont.CharSet = 162;
                    NewField1.Value = @"Hasta Toplam";

                    NewField11212 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 123, 0, 124, 5, false);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                KSchedule.GetKScheduleWithPatient_Class dataSet_GetKScheduleWithPatient = ParentGroup.rsGroup.GetCurrentRecord<KSchedule.GetKScheduleWithPatient_Class>(0);    
                return new object[] {(dataSet_GetKScheduleWithPatient==null ? null : dataSet_GetKScheduleWithPatient.Patient)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DrugName = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 1, 124, 6, false);
                    ...
                    TotalAmount = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 124, 1, 140, 6, false);
                    ...
                    DistributionType = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 140, 1, 156, 6, false);
                    ...
                    ExpirationDate = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 156, 1, 185, 6, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    DrugName.CalcValue = (dataset_GetKScheduleWithPatient != null ? Globals.ToStringCore(dataset_GetKScheduleWithPatient.Name) : "");
                    Code.CalcValue = (dataset_GetKScheduleWithPatient != null ? Globals.ToStringCore(dataset_GetKScheduleWithPatient.Barcode) : "");
                    TotalAmount.CalcValue = (dataset_GetKScheduleWithPatient != null ? Globals.ToStringCore(dataset_GetKScheduleWithPatient.Amount) : "");
                    TransactionDate.CalcValue = (dataset_GetKScheduleWithPatient != null ? Globals.ToStringCore(dataset_GetKScheduleWithPatient.TransactionDate) : "");
                    DistributionType.CalcValue = (dataset_GetKScheduleWithPatient != null ? Globals.ToStringCore(dataset_GetKScheduleWithPatient.DistributionType) : "");
                    DistributionType.PostFieldValueCalculation();
                    ExpirationDate.CalcValue = (dataset_GetKScheduleWithPatient != null ? Globals.ToStringCore(dataset_GetKScheduleWithPatient.ExpirationDate) : "");
        ...
        public KScheduleDrugPrescTotalForPatients()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "KSCHEDULEDRUGPRESCTOTALFORPATIENTS";
            Caption = "Günlük İlaç Çizelgesi İle Verilen İlaçlar Toplam Raporu Hastalara Göre";
