...
{
    /// <summary>
    /// İlaç Reçete Toplam Raporu
    /// </summary>
    public partial class DrugPrescriptionTotalReport : TTReport
    {
        ...
        {
            public DrugPrescriptionTotalReport MyParentReport
            {
                get { return (DrugPrescriptionTotalReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName.Value = @"İLAÇ REÇETE TOPLAM RAPORU";
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<BaseDrugOrder.GetDrugPrescriptionTotalReportQuery_Class>("GetDrugPrescriptionTotalReportQuery", BaseDrugOrder.GetDrugPrescriptionTotalReportQuery((DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.STARTDATE),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.ENDDATE)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    BaseDrugOrder.GetDrugPrescriptionTotalReportQuery_Class dataset_GetDrugPrescriptionTotalReportQuery = ParentGroup.rsGroup.GetCurrentRecord<BaseDrugOrder.GetDrugPrescriptionTotalReportQuery_Class>(0);
                    OrderNO.CalcValue = ParentGroup.Counter.ToString();
                    DrugName.CalcValue = (dataset_GetDrugPrescriptionTotalReportQuery != null ? Globals.ToStringCore(dataset_GetDrugPrescriptionTotalReportQuery.Material) : "");
                    DrugName.PostFieldValueCalculation();
                    Code.CalcValue = (dataset_GetDrugPrescriptionTotalReportQuery != null ? Globals.ToStringCore(dataset_GetDrugPrescriptionTotalReportQuery.Material) : "");
                    Code.PostFieldValueCalculation();
                    TotalAmount.CalcValue = (dataset_GetDrugPrescriptionTotalReportQuery != null ? Globals.ToStringCore(dataset_GetDrugPrescriptionTotalReportQuery.Amount) : "");
        ...
        public DrugPrescriptionTotalReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DRUGPRESCRIPTIONTOTALREPORT";
            Caption = "İlaç Reçete Toplam Raporu";
