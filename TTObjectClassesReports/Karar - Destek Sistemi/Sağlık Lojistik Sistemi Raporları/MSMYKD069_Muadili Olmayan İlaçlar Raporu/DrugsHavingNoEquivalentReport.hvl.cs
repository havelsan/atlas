...
{
    /// <summary>
    /// Muadili Olmayan İlaçlar
    /// </summary>
    public partial class DrugsHavingNoEquivalentReport : TTReport
    {
        ...
        {
            public DrugsHavingNoEquivalentReport MyParentReport
            {
                get { return (DrugsHavingNoEquivalentReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ReportName.Value = @"MUADİLİ OLMAYAN İLAÇLAR";
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 0, 13, 5, false);
                    NewField11.Name = "NewField11";
                    NewField11.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    NewField11.TextFont.Size = 11;
                    NewField11.TextFont.Bold = true;
                    NewField11.TextFont.CharSet = 162;
                    NewField11.Value = @"Sıra Nu.";

                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 45, 0, 170, 5, false);
                    NewField111.Name = "NewField111";
                    NewField111.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    NewField111.TextFont.Size = 11;
                    NewField111.TextFont.Bold = true;
                    NewField111.TextFont.CharSet = 162;
                    NewField111.Value = @"İlaç İsmi";

                    NewField121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 14, 0, 44, 5, false);
                    ...
                    NewField121.Value = @"Barkodu";

                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 0, 5, 170, 5, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { NewField11,NewField111,NewField121};
                }
            }
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<DrugDefinition.GetDrugsHavingNoEquivalentReportQuery_Class>("GetDrugsHavingNoEquivalentReportQuery", DrugDefinition.GetDrugsHavingNoEquivalentReportQuery());
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DrugDefinition.GetDrugsHavingNoEquivalentReportQuery_Class dataset_GetDrugsHavingNoEquivalentReportQuery = ParentGroup.rsGroup.GetCurrentRecord<DrugDefinition.GetDrugsHavingNoEquivalentReportQuery_Class>(0);
                    OrderNO.CalcValue = ParentGroup.Counter.ToString();
                    DrugName.CalcValue = (dataset_GetDrugsHavingNoEquivalentReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsHavingNoEquivalentReportQuery.Name) : "");
                    Barcode.CalcValue = (dataset_GetDrugsHavingNoEquivalentReportQuery != null ? Globals.ToStringCore(dataset_GetDrugsHavingNoEquivalentReportQuery.Barcode) : "");
        ...
        public DrugsHavingNoEquivalentReport()
        {
        ...
        {
            Name = "DRUGSHAVINGNOEQUIVALENTREPORT";
            Caption = "Muadili Olmayan İlaçlar";
