...
{
    /// <summary>
    /// Sağlık Kurulu Defteri (Sağlık Kurulu A3)
    /// </summary>
    public partial class HealthCommitteeReportBook_A3 : TTReport
    {
#region Methods
   public int isFlagZero = 0;
        ...
        {
            public HealthCommitteeReportBook_A3 MyParentReport
            {
                get { return (HealthCommitteeReportBook_A3)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    BASLIK = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 17, 395, 25, false);
                    BASLIK.Name = "BASLIK";
                    ...
                    DATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 375, 25, 395, 30, false);
                    DATE.Name = "DATE";
...
#region PARTA HEADER_Script
            ...
            if(((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.HEALTHCOMITEETYPE == HealthCommitteeTypeEnum.FlierCommittee)
            ...
            ((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.STARTDATE = Convert.ToDateTime(DATE.FormattedValue + " 00:00:00");
            ((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.ENDDATE = Convert.ToDateTime(DATE.FormattedValue + " 23:59:59");
            
            ((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.HEALTHCOMITEETYPEFLAG = ((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.HEALTHCOMITEETYPE == null ? 0 : 1;
            
            if(((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.HEALTHCOMITEETYPEFLAG == 0 || ((HealthCommitteeReportBook_A3)ParentReport).isFlagZero == 1)
            {
                if(((HealthCommitteeReportBook_A3)ParentReport).isFlagZero == 0)
                    ((HealthCommitteeReportBook_A3)ParentReport).isFlagZero = 1;
                if(((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.HEALTHCOMITEETYPEFLAG != 0)
                    ((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.HEALTHCOMITEETYPEFLAG = 0;
            }
            
            // NQL de hata vermemesi için bu şekilde herhangi bir değere set ediliyor
            if(((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.HEALTHCOMITEETYPEFLAG == 0)
                ((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.HEALTHCOMITEETYPE = HealthCommitteeTypeEnum.NormalCommittee;
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 1, 395, 6, false);
        ...
        public partial class CAPTIONGroup : TTReportGroup
        {
            ...
            public partial class CAPTIONGroupHeader : TTReportSection
            {
                ...
                public CAPTIONGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 4, 52, 13, false);
                    ...
                    NewField12 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 52, 4, 102, 13, false);
                    ...
                    NewField13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 102, 4, 151, 13, false);
                    ...
                    NewField131 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 151, 4, 199, 13, false);
                    ...
                    NewField132 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 199, 4, 244, 13, false);
                    ...
                    NewField133 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 244, 4, 360, 13, false);
                    ...
                    NewField134 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 360, 4, 395, 13, false);
                    ...
                    NewLine121 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 4, 395, 4, false);
                    NewLine121.Name = "NewLine121";
                    NewLine121.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine122 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 13, 395, 13, false);
                    NewLine122.Name = "NewLine122";
                    NewLine122.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 4, 36, 13, false);
                    NewLine1111.Name = "NewLine1111";
                    NewLine1111.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1112 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 52, 4, 52, 13, false);
                    NewLine1112.Name = "NewLine1112";
                    NewLine1112.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1113 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 102, 4, 102, 13, false);
                    NewLine1113.Name = "NewLine1113";
                    NewLine1113.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1114 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 151, 4, 151, 13, false);
                    NewLine1114.Name = "NewLine1114";
                    NewLine1114.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1115 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 199, 4, 199, 13, false);
                    NewLine1115.Name = "NewLine1115";
                    NewLine1115.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1116 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 244, 4, 244, 13, false);
                    NewLine1116.Name = "NewLine1116";
                    NewLine1116.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1117 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 360, 4, 360, 13, false);
                    NewLine1117.Name = "NewLine1117";
                    NewLine1117.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1118 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 395, 4, 395, 13, false);
                    NewLine1118.Name = "NewLine1118";
                    NewLine1118.DrawStyle = DrawStyleConstants.vbSolid;

                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 429, 5, 455, 10, false);
                    PAGENUMBER.Name = "PAGENUMBER";
                    ...
                    PAGECOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 458, 5, 485, 10, false);
...
//                this.Visible = EvetHayirEnum.ehHayir;
            ...
            public partial class CAPTIONGroupFooter : TTReportSection
            {
                ...
                public CAPTIONGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 429, 19, 454, 24, false);
                    ...
                    DESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 113, 395, 118, false);
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 35, 68, 40, false);
                    ...
                    SK_CHAIRMAN = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 42, 85, 59, false);
                    ...
                    SK_MEMBER1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 97, 42, 148, 59, false);
                    ...
                    SK_MEMBER2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 159, 42, 209, 59, false);
                    ...
                    SK_MEMBER3 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 222, 42, 272, 59, false);
                    ...
                    SK_MEMBER4 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 284, 42, 334, 59, false);
                    ...
                    SK_MEMBER5 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 345, 42, 395, 59, false);
                    ...
                    SK_MEMBER6 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 67, 85, 84, false);
                    ...
                    SK_MEMBER7 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 97, 67, 148, 84, false);
                    ...
                    SK_MEMBER8 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 159, 67, 209, 84, false);
                    ...
                    SK_MEMBER9 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 222, 67, 272, 84, false);
                    ...
                    SK_MEMBER10 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 284, 67, 334, 84, false);
                    ...
                    SK_MEMBER11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 345, 67, 395, 84, false);
                    ...
                    SK_MEMBER12 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 93, 85, 110, false);
                    ...
                    SK_MEMBER13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 97, 93, 148, 110, false);
                    ...
                    SK_MEMBER14 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 159, 93, 209, 110, false);
                    ...
                    SK_MEMBER15 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 222, 93, 272, 110, false);
                    ...
                    NewField1111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 4, 55, 9, false);
                    ...
                    COUNTOFA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 41, 10, 65, 15, false);
                    ...
                    NewField11111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 10, 41, 15, false);
                    ...
                    NewField11112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 15, 41, 20, false);
                    ...
                    NewField11113 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 20, 41, 25, false);
                    ...
                    NewField11114 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 25, 41, 30, false);
                    ...
                    COUNTOFB = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 41, 15, 65, 20, false);
                    ...
                    COUNTOFC = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 41, 20, 65, 25, false);
                    ...
                    COUNTOFD = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 41, 25, 65, 30, false);
                    ...
                    COUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 370, 4, 395, 9, false);
                    COUNT.Name = "COUNT";
                    COUNT.FieldType = ReportFieldTypeEnum.ftVariable;
                    COUNT.HorzAlign = HorizontalAlignmentEnum.haRight;
                    COUNT.Value = @"";

                    NewField11113111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 325, 4, 369, 9, false);
                    ...
                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 325, 3, 395, 3, false);
...
#region CAPTION FOOTER_Script
                    this.COUNT.CalcValue = ((HealthCommitteeReportBook_A3)ParentReport).groupCounter.ToString();
            
            // Toplam madde/dilim/fıkra sayıları set edilir ve sıfırlanır(rapor refresh edilince üzerine eklemesin)
            this.COUNTOFA.CalcValue = ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfA.ToString();
            this.COUNTOFB.CalcValue = ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfB.ToString();
            this.COUNTOFC.CalcValue = ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfC.ToString();
            this.COUNTOFD.CalcValue = ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfD.ToString();
            
            ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfA = 0;
            ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfB = 0;
            ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfC = 0;
            ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfD = 0;
            
            TTObjectContext context = new TTObjectContext(true);
            HealthCommitteeTypeEnum committeeType = HealthCommitteeTypeEnum.NormalCommittee;
            
            if (((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.HEALTHCOMITEETYPE != null)
                committeeType = (HealthCommitteeTypeEnum)((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.HEALTHCOMITEETYPE;
            
            //IList<MemberOfHealthCommitteeDefinition> currentDefs = (IList<MemberOfHealthCommitteeDefinition>)MemberOfHealthCommitteeDefinition.GetTodaysMemberDefinition(context, Convert.ToDateTime(((HealthCommitteeReportBook_A3)ParentReport).RuntimeParameters.STARTDATE), HealthCommitteeTypeEnum.NormalCommittee);
        ...
        public partial class PARTCGroup : TTReportGroup
        {
            ...
            public partial class PARTCGroupFooter : TTReportSection
            {
                ...
                public PARTCGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewLine111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 2, 395, 2, false);
                    NewLine111.Name = "NewLine111";
                    NewLine111.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1211 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 0, 36, 2, false);
                    ...
                    NewLine12111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 52, 0, 52, 2, false);
                    ...
                    NewLine12121 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 102, 0, 102, 2, false);
                    ...
                    NewLine12131 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 151, 0, 151, 2, false);
                    ...
                    NewLine12141 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 199, 0, 199, 2, false);
                    ...
                    NewLine12151 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 244, 0, 244, 2, false);
                    ...
                    NewLine12161 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 360, 0, 360, 2, false);
                    ...
                    NewLine116121 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 395, 0, 395, 2, false);
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    COUNTER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 427, 2, 452, 7, false);
...
#region PARTB HEADER_Script
                    ((HealthCommitteeReportBook_A3)ParentReport).groupCounter = Convert.ToInt16(this.COUNTER.CalcValue);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNODATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 0, 52, 42, false);
                    ...
                    SENDERDATENO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 52, 0, 102, 42, false);
                    ...
                    INFOS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 102, 0, 151, 42, false);
                    INFOS.Name = "INFOS";
                    ...
                    GONDERILEN = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 151, 0, 199, 42, false);
                    ...
                    TESHIS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 199, 0, 244, 42, false);
                    TESHIS.Name = "TESHIS";
                    ...
                    KARAR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 244, 0, 360, 42, false);
                    KARAR.Name = "KARAR";
                    ...
                    FOTO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 360, 0, 395, 42, false);
                    FOTO.Name = "FOTO";
                    ...
                    OBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 429, 11, 454, 16, false);
                    ...
                    DTARIHI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 429, 27, 454, 32, false);
                    ...
                    MADDE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 429, 36, 454, 41, false);
                    MADDE.Name = "MADDE";
                    MADDE.Visible = EvetHayirEnum.ehHayir;
                    MADDE.FieldType = ReportFieldTypeEnum.ftVariable;
                    MADDE.Value = @"";

                    XXXXXXLIKSUBESI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 429, 3, 454, 8, false);
                    ...
                    PNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 462, 3, 487, 8, false);
                    PNAME.Name = "PNAME";
                    PNAME.Visible = EvetHayirEnum.ehHayir;
                    PNAME.FieldType = ReportFieldTypeEnum.ftVariable;
                    PNAME.Value = @"{#PARTB.PNAME#}";

                    PSURNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 462, 11, 487, 16, false);
                    ...
                    TCNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 462, 19, 487, 24, false);
                    TCNO.Name = "TCNO";
                    TCNO.Visible = EvetHayirEnum.ehHayir;
                    TCNO.FieldType = ReportFieldTypeEnum.ftVariable;
                    TCNO.Value = @"{#PARTB.TCNO#}";

                    FATHERNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 462, 28, 487, 33, false);
                    ...
                    BOY = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 462, 36, 487, 41, false);
                    BOY.Name = "BOY";
                    BOY.Visible = EvetHayirEnum.ehHayir;
                    BOY.FieldType = ReportFieldTypeEnum.ftVariable;
                    BOY.Value = @"{#PARTB.BOY#}";

                    KILO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 496, 3, 521, 8, false);
                    KILO.Name = "KILO";
                    KILO.Visible = EvetHayirEnum.ehHayir;
                    KILO.FieldType = ReportFieldTypeEnum.ftVariable;
                    KILO.Value = @"{#PARTB.KILO#}";

                    DYERIL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 496, 11, 521, 16, false);
                    DYERIL.Name = "DYERIL";
                    DYERIL.Visible = EvetHayirEnum.ehHayir;
                    DYERIL.FieldType = ReportFieldTypeEnum.ftVariable;
                    DYERIL.Value = @"{#PARTB.DOGUMYERI#}";

                    DYERILCE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 496, 19, 521, 24, false);
                    ...
                    DYERULKE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 496, 28, 521, 33, false);
                    ...
                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 0, 36, 42, false);
                    NewLine11.Name = "NewLine11";
                    NewLine11.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine11.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 52, 0, 52, 42, false);
                    NewLine111.Name = "NewLine111";
                    NewLine111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine112 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 102, 0, 102, 42, false);
                    NewLine112.Name = "NewLine112";
                    NewLine112.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine112.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine113 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 151, 0, 151, 42, false);
                    NewLine113.Name = "NewLine113";
                    NewLine113.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine113.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine114 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 199, 0, 199, 42, false);
                    NewLine114.Name = "NewLine114";
                    NewLine114.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine114.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine115 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 244, 0, 244, 42, false);
                    NewLine115.Name = "NewLine115";
                    NewLine115.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine115.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine116 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 360, 0, 360, 42, false);
                    NewLine116.Name = "NewLine116";
                    NewLine116.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine116.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine117 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 395, 0, 395, 42, false);
                    NewLine117.Name = "NewLine117";
                    NewLine117.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine117.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine111211 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 0, 395, 0, false);
                    NewLine111211.Name = "NewLine111211";
                    NewLine111211.DrawStyle = DrawStyleConstants.vbSolid;

                    SKSEBEBI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 496, 36, 521, 41, false);
                    ...
                    DECISIONTIME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 5, 8, 30, 13, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    DYERIL.CalcValue = (dataset_GetHealthCommitteesByType != null ? Globals.ToStringCore(dataset_GetHealthCommitteesByType.Dogumyeri) : "");
                    DYERILCE.CalcValue = (dataset_GetHealthCommitteesByType != null ? Globals.ToStringCore(dataset_GetHealthCommitteesByType.Dogumyeriilce) : "");
                    DYERULKE.CalcValue = (dataset_GetHealthCommitteesByType != null ? Globals.ToStringCore(dataset_GetHealthCommitteesByType.Dogumyeriulke) : "");
                    ...
                    return new TTReportObject[] { REPORTNODATE,SENDERDATENO,INFOS,GONDERILEN,TESHIS,KARAR,FOTO,OBJECTID,REPORTDATE,DTARIHI,MADDE,XXXXXXLIKSUBESI,PNAME,PSURNAME,TCNO,FATHERNAME,BOY,KILO,DYERIL,DYERILCE,DYERULKE,SKSEBEBI,DECISIONTIME};
                }
...
//                        ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfA++;
//                    else if(theAnectode.Dilim == SliceEnum.B)
//                        ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfB++;
//                    else if(theAnectode.Dilim == SliceEnum.C)
//                        ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfC++;
//                    else if(theAnectode.Dilim == SliceEnum.D)
//                        ((TTReportClasses.HealthCommitteeReportBook_A3)ParentReport).countOfD++;
//                }
        ...
        public partial class PARTDGroup : TTReportGroup
        {
            ...
            public partial class PARTDGroupBody : TTReportSection
            {
                ...
                public PARTDGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewLine111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 0, 36, 42, false);
                    NewLine111.Name = "NewLine111";
                    NewLine111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine1111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 52, 0, 52, 42, false);
                    NewLine1111.Name = "NewLine1111";
                    NewLine1111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine1111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine1211 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 102, 0, 102, 42, false);
                    NewLine1211.Name = "NewLine1211";
                    NewLine1211.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine1211.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine1311 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 151, 0, 151, 42, false);
                    ...
                    NewLine1411 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 199, 0, 199, 42, false);
                    ...
                    NewLine1511 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 244, 0, 244, 42, false);
                    ...
                    NewLine1611 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 360, 0, 360, 42, false);
                    ...
                    NewLine1711 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 395, 0, 395, 42, false);
                    ...
                    NewLine1112111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 0, 395, 0, false);
                    NewLine1112111.Name = "NewLine1112111";
                    NewLine1112111.DrawStyle = DrawStyleConstants.vbSolid;

                    OBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 5, 15, 30, 20, false);
                    OBJECTID.Name = "OBJECTID";
                    OBJECTID.Visible = EvetHayirEnum.ehHayir;
                    OBJECTID.FieldType = ReportFieldTypeEnum.ftVariable;
...
//            this.TESHIS.CalcValue = "";
        ...
        public HealthCommitteeReportBook_A3()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "HEALTHCOMMITTEEREPORTBOOK_A3";
            Caption = "Sağlık Kurulu Defteri (Sağlık Kurulu A3)";
