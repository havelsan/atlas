...
{
    /// <summary>
    /// Fizyoterapi Detay Raporu
    /// </summary>
    public partial class PhysiotheraphyDetailReport : TTReport
    {
        ...
        {
            public PhysiotheraphyDetailReport MyParentReport
            {
                get { return (PhysiotheraphyDetailReport)ParentReport; }
            }
            ...
            public partial class MASTERGroupHeader : TTReportSection
            {
                ...
                public MASTERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SubTypeExplanat = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 50, 39, 168, 43, false);
...
";
                    ...
                    PHYSIOTHERAPYREQUESTOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 46, 255, 51, false);
                    ...
                    REPORTHEADER1.Value = @"FİZYOTERAPİ UYGULAMA DETAYLARI RAPORU";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    UNIQUEREFNO.CalcValue = (dataset_PhysiotherapyAcceptionReportNQL != null ? Globals.ToStringCore(dataset_PhysiotherapyAcceptionReportNQL.UniqueRefNo) : "");
...
#region MASTER HEADER_Script
            ...
            string objectID = ((PhysiotheraphyDetailReport)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
        ...
        public partial class ORDERDETAILSGroup : TTReportGroup
        {
            ...
            public partial class ORDERDETAILSGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    WORKLISTDATE.CalcValue = (dataset_GetPhysiotherapyOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsByOrderObject.PricingDate) : "");
                    ...
                    return new TTReportObject[] { WORKLISTDATE,PROCEDUREBYUSER,ORDEROBJECTPROCEDUREDOCTOR,ORDERDETAILPROCEDUREBYUSER,PROCEDUREOBJECTCODENAME,APPLICATIONAREA,ORDEROBJECTOBJECTID,ACTIONDATE,CURRENTSTATEDEFID,ACTIONDATE2,ORDERDETAILOBJECTID,STATE};
                }

                public override void RunScript()
                {
#region ORDERDETAILS BODY_Script
                    if (TTObjectDefManager.Instance.ObjectDefs["PhysiotherapyOrderDetail"].StateDefs[new Guid(this.CURRENTSTATEDEFID.CalcValue != null ? TTUtils.Globals.ToStringCore(this.CURRENTSTATEDEFID.CalcValue) : "")] != null)
            {
                Guid currentStateDefID = TTObjectDefManager.Instance.ObjectDefs["PhysiotherapyOrderDetail"].StateDefs[new Guid(this.CURRENTSTATEDEFID.CalcValue != null ? TTUtils.Globals.ToStringCore(this.CURRENTSTATEDEFID.CalcValue) : "")].StateDefID;
                if (currentStateDefID != TTObjectClasses.PhysiotherapyOrderDetail.States.Completed)
        ...
        public partial class FTRNOTEGroup : TTReportGroup
        {
            ...
            public TTReportField ORDERDETAILOBJECTID { get {return Body().ORDERDETAILOBJECTID;} }
            public TTReportField FTRNOTE { get {return Body().FTRNOTE;} }
            ...
            public partial class FTRNOTEGroupBody : TTReportSection
            {
                ...
                public FTRNOTEGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField10.Value = @"Fizyoterapist Notu :
";
...
";
                    ...
                    FTRNOTE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 1, 206, 6, false);
                    FTRNOTE.Name = "FTRNOTE";
                    FTRNOTE.FieldType = ReportFieldTypeEnum.ftVariable;
                    FTRNOTE.TextFormat = @"g";
                    FTRNOTE.MultiLine = EvetHayirEnum.ehEvet;
                    FTRNOTE.NoClip = EvetHayirEnum.ehEvet;
                    FTRNOTE.WordBreak = EvetHayirEnum.ehEvet;
                    FTRNOTE.ExpandTabs = EvetHayirEnum.ehEvet;
                    FTRNOTE.TextFont.Name = "Arial Narrow";
                    FTRNOTE.TextFont.Size = 9;
                    FTRNOTE.Value = @"";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    ORDERDETAILOBJECTID.CalcValue = (dataset_GetPhysiotherapyOrderDetailsByOrderObject != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsByOrderObject.ObjectID) : "");
                    FTRNOTE.CalcValue = @"";
                    return new TTReportObject[] { NewField10,FTRNOTES,ORDERDETAILOBJECTID,FTRNOTE};
                }
...
#region FTRNOTE BODY_Script
                    TTObjectContext objectContext = new TTObjectContext(true);
            PhysiotherapyOrderDetail physiotherapyOrderDetail = (PhysiotherapyOrderDetail)objectContext.GetObject(new Guid(this.ORDERDETAILOBJECTID.CalcValue),"PhysiotherapyOrderDetail");
            if (physiotherapyOrderDetail != null)
            {
                if(physiotherapyOrderDetail.Note != null)
                    this.FTRNOTE.CalcValue = TTObjectClasses.Common.GetTextOfRTFString(physiotherapyOrderDetail.Note.ToString());
            }
        ...
        public PhysiotheraphyDetailReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "PHYSIOTHERAPHYDETAILREPORT";
            Caption = "Fizyoterapi Uygulama Detayı Raporu";
