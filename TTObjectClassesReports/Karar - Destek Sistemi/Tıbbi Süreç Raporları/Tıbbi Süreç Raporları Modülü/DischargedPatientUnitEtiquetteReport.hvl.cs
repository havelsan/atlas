...
{
    /// <summary>
    /// Taburcu Olan Hastalar Etiketi (XXXXXX Birlik ile)
    /// </summary>
    public partial class DischargedPatientUnitEtiquetteReport : TTReport
    {
        ...
        {
            public DischargedPatientUnitEtiquetteReport MyParentReport
            {
                get { return (DischargedPatientUnitEtiquetteReport)ParentReport; }
            }
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<InpatientAdmission.GetDischargeNumberForEtiquetteUnit_Class>("GetDischargeNumberForEtiquetteUnit2", InpatientAdmission.GetDischargeNumberForEtiquetteUnit((DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.STARTDATE),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.ENDDATE)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    MILITARYUNIT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 356, 15, 460, 38, false);
                ...
                {
                    InpatientAdmission.GetDischargeNumberForEtiquetteUnit_Class dataset_GetDischargeNumberForEtiquetteUnit2 = ParentGroup.rsGroup.GetCurrentRecord<InpatientAdmission.GetDischargeNumberForEtiquetteUnit_Class>(0);
                    MILITARYUNIT.CalcValue = @"";
                    TCNO.CalcValue = @"";
                    UNIQUEREFNO.CalcValue = (dataset_GetDischargeNumberForEtiquetteUnit2 != null ? Globals.ToStringCore(dataset_GetDischargeNumberForEtiquetteUnit2.Tcno) : "");
                    FOREIGNNO.CalcValue = (dataset_GetDischargeNumberForEtiquetteUnit2 != null ? Globals.ToStringCore(dataset_GetDischargeNumberForEtiquetteUnit2.Foreaignno) : "");
                    DISCHARGENUMBER.CalcValue = (dataset_GetDischargeNumberForEtiquetteUnit2 != null ? Globals.ToStringCore(dataset_GetDischargeNumberForEtiquetteUnit2.DischargeNumber) : "");
                    ETIQUETTE.CalcValue = @"";
                    PATIENTGROUPS.CalcValue = TTObjectClasses.SystemParameter.GetParameterValue("PATIENTGROUPSWITHUNITFORETIQUETTE", "");
                    return new TTReportObject[] { MILITARYUNIT,TCNO,UNIQUEREFNO,FOREIGNNO,DISCHARGENUMBER,ETIQUETTE,PATIENTGROUPS};
                }
...
#region MAIN BODY_Script
            ...
            etiquette += this.MILITARYUNIT.CalcValue;
        ...
        public DischargedPatientUnitEtiquetteReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DISCHARGEDPATIENTUNITETIQUETTEREPORT";
            Caption = "Taburcu Olan Hastalar Etiketi (XXXXXX Birlik ile)";
