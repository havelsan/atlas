...
{
    /// <summary>
    /// Yabancı Hasta Listesi (Yatan)
    /// </summary>
    public partial class ForeignInpatientListReport : TTReport
    {
        ...
        {
            public ForeignInpatientListReport MyParentReport
            {
                get { return (ForeignInpatientListReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1111.Value = @"XXXXXXYE BAŞVURU YAPAN YATAN YABANCI HASTA LİSTESİ";
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<InpatientAdmission.GetForeignInpatientsNQL_Class>("GetForeignInpatientsNQL", InpatientAdmission.GetForeignInpatientsNQL((DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.ENDDATE),(DateTime)TTObjectDefManager.Instance.DataTypes["DateTime"].ConvertValue(MyParentReport.RuntimeParameters.STARTDATE)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    InpatientAdmission.GetForeignInpatientsNQL_Class dataset_GetForeignInpatientsNQL = ParentGroup.rsGroup.GetCurrentRecord<InpatientAdmission.GetForeignInpatientsNQL_Class>(0);
                    HASTAADI.CalcValue = (dataset_GetForeignInpatientsNQL != null ? Globals.ToStringCore(dataset_GetForeignInpatientsNQL.Isim) : "") + @" " + (dataset_GetForeignInpatientsNQL != null ? Globals.ToStringCore(dataset_GetForeignInpatientsNQL.Soyisim) : "") + @" ";
                    YUPASSNO.CalcValue = (dataset_GetForeignInpatientsNQL != null ? Globals.ToStringCore(dataset_GetForeignInpatientsNQL.YUPASSNO) : "");
                    FOREIGNUNIQUEREFNO.CalcValue = (dataset_GetForeignInpatientsNQL != null ? Globals.ToStringCore(dataset_GetForeignInpatientsNQL.ForeignUniqueRefNo) : "");
                    SNO1.CalcValue = ParentGroup.Counter.ToString();
                    TARIH.CalcValue = (dataset_GetForeignInpatientsNQL != null ? Globals.ToStringCore(dataset_GetForeignInpatientsNQL.Tarih) : "");
                    HPROTNO.CalcValue = (dataset_GetForeignInpatientsNQL != null ? Globals.ToStringCore(dataset_GetForeignInpatientsNQL.Hprotno) : "");
        ...
        public ForeignInpatientListReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "FOREIGNINPATIENTLISTREPORT";
            Caption = "Yabancı Hasta Listesi (Yatan)";
