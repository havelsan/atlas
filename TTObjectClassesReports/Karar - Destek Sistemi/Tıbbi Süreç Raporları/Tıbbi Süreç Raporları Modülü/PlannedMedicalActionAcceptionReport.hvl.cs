...
{
    /// <summary>
    /// Planlı Tıbbi İşlem İstek Raporu
    /// </summary>
    public partial class PlannedMedicalActionAcceptionReport : TTReport
    {
        ...
        {
            public PlannedMedicalActionAcceptionReport MyParentReport
            {
                get { return (PlannedMedicalActionAcceptionReport)ParentReport; }
            }
            ...
            public partial class MASTERGroupHeader : TTReportSection
            {
                ...
                public MASTERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PLANNEDMEDICACTIONREQOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 63, 255, 68, false);
                    ...
                    REPORTHEADER1.Value = @"PLANLI TIBBİ İŞLEM İSTEK RAPORU";
...
#region MASTER HEADER_Script
            ...
            string objectID = ((PlannedMedicalActionAcceptionReport)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
        ...
        public partial class ORDERSGroup : TTReportGroup
        {
            ...
            public partial class ORDERSGroupHeader : TTReportSection
            {
                ...
                public ORDERSGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField11111411211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 140, 24, 206, 29, false);
                    ...
                    NewField1121141114.Value = @"İşlemi Yapacak Personel";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { ORDEROBJECTOBJECTID,NewField111141121,PROCEDUREOBJECTCODENAME,APPLICATIONAREA,DURATION,AMOUNT,TREATMENTUNITNAME,NewField11111411211,NewField11114111,NewField111141111,NewField112141111,NewField1111141211,NewField11121411111,NewField1121141113,NewField1121141114,NewField11,TREATMENTPROPERTIES,NewField118211};
                }
            }
        ...
        public partial class ORDERDETAILSGroup : TTReportGroup
        {
            ...
            public partial class ORDERDETAILSGroupBody : TTReportSection
            {
                ...
                public ORDERDETAILSGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    EMERGENCY = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 140, 1, 206, 6, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { WORKLISTDATE,EMERGENCY,CURENUMBER,PROCEDUREBYUSER,ORDEROBJECTPROCEDUREDOCTOR,ORDERDETAILPROCEDUREBYUSER};
                }
...
#region ORDERDETAILS BODY_Script
        ...
        public PlannedMedicalActionAcceptionReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "PLANNEDMEDICALACTIONACCEPTIONREPORT";
            Caption = "Planlı Tıbbi İşlem İstek Raporu";
