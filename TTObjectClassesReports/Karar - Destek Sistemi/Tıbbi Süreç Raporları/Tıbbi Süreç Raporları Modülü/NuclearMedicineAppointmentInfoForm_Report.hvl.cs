...
{
    /// <summary>
    /// Nükleer Tıp Randevu Bilgi Formu
    /// </summary>
    public partial class NuclearMedicineAppointmentInfoForm : TTReport
    {
        public class ReportRuntimeParameters 
        {
            public string TTOBJECTID = (string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue("d0b912f7-5c57-4996-9933-57d36f04c565");
        }

        public partial class HEADERGroup : TTReportGroup
        {
            public NuclearMedicineAppointmentInfoForm MyParentReport
            {
                get { return (NuclearMedicineAppointmentInfoForm)ParentReport; }
            }
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<NuclearMedicine.NuclearMedicineAppointmentInfoQuery_Class>("NuclearMedicineAppointmentInfoQuery", NuclearMedicine.NuclearMedicineAppointmentInfoQuery((string)TTObjectDefManager.Instance.DataTypes["String250"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class HEADERGroupHeader : TTReportSection
            {
                ...
                public HEADERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTHEADER11.Value = @"NÜKLEER TIP RANDEVU BİLGİLENDİRME FORMU";
                ...
                {
                    NuclearMedicine.NuclearMedicineAppointmentInfoQuery_Class dataset_NuclearMedicineAppointmentInfoQuery = ParentGroup.rsGroup.GetCurrentRecord<NuclearMedicine.NuclearMedicineAppointmentInfoQuery_Class>(0);
...
#region HEADER HEADER_Script
            ...
            public partial class HEADERGroupFooter : TTReportSection
            {
                ...
                public HEADERGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1131.Value = @"İstek Yapan Doktor";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    DOCTORNAME.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.Requestdoctor) : "");
...
#region HEADER FOOTER_Script
            ...
            string sObjectID = ((NuclearMedicineAppointmentInfoForm)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
            NuclearMedicine pObject = (NuclearMedicine)context.GetObject(new Guid(sObjectID),"NuclearMedicine");
            
            if(pObject.CurrentStateDefID == NuclearMedicine.States.AppointmentInfo)
            {
               if (pObject.GetMyNewAppointments() != null)
               {
                   if (pObject.GetMyNewAppointments().Count > 0)
                   {
                       if (pObject.GetMyNewAppointments()[0].GivenBy != null)
                       {
                            ResUser givenByUser = (ResUser)context.GetObject(pObject.GetMyNewAppointments()[0].GivenBy.ObjectID, "ResUser");
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ICDCode.MultiLine = EvetHayirEnum.ehEvet;
                    ICDCode.NoClip = EvetHayirEnum.ehEvet;
                    ICDCode.WordBreak = EvetHayirEnum.ehEvet;
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    REQUESTDATE.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.RequestDate) : "");
                    NewField14.CalcValue = MyParentReport.RuntimeParameters.TTOBJECTID.ToString();
                    NewField15.CalcValue = NewField15.Value;
                    NAME.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.Name) : "") + @" " + (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.Surname) : "");
                    PROTOKOLNO.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.Protocolno) : "");
                    NewField162.CalcValue = NewField162.Value;
                    NewField1761.CalcValue = NewField1761.Value;
                    NewField123.CalcValue = NewField123.Value;
                    HASTANO.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.Patientid) : "");
                    NewField142.CalcValue = NewField142.Value;
                    ACTIONID.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.Actionid) : "");
                    NewField163.CalcValue = NewField163.Value;
                    DTARIH.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.BirthDate) : "");
                    DYER.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.Townname) : "");
                    ...
                    UNIQUEREFNO.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.UniqueRefNo) : "");
                    ...
                    Barcode.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.Actionid) : "");
                    ACTIONID1.CalcValue = (dataset_NuclearMedicineAppointmentInfoQuery != null ? Globals.ToStringCore(dataset_NuclearMedicineAppointmentInfoQuery.Actionid) : "");
...
#region MAIN BODY_Script
            ...
            if (pObject.NuclearMedicineTests != null)
            {
                if (pObject.NuclearMedicineTests.Count > 0 )
                    this.ACCESSIONNO.CalcValue = pObject.NuclearMedicineTests[0].AccessionNo.ToString();
            }
...
#region RANDEVU BODY_PreScript
                    TTObjectContext context = new TTObjectContext(true);
            string sObjectID = ((NuclearMedicineAppointmentInfoForm)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
            NuclearMedicine nucMedicine = (NuclearMedicine)context.GetObject(new Guid(sObjectID),"NuclearMedicine");
            if (nucMedicine.NuclearMedicineTests != null)
            {
                if (nucMedicine.NuclearMedicineTests.Count > 0 )
                    this.Test.Value = nucMedicine.NuclearMedicineTests[0].ProcedureObject.Name;
            }
...
#region RANDEVU BODY_Script
            ...
            if(pObject.CurrentStateDefID == NuclearMedicine.States.AppointmentInfo)
            {
               this.AppointmentInfo.CalcValue = EpisodeAction.GetFullAppointmentDescription(pObject);
              
               if (pObject.GetMyNewAppointments() != null)
               {
                   if (pObject.GetMyNewAppointments().Count > 0)
                   {
                       if (pObject.GetMyNewAppointments()[0].StartTime != null)
                       {
                            DateTime appDate = pObject.GetMyNewAppointments()[0].StartTime.Value;
        ...
        public NuclearMedicineAppointmentInfoForm()
        {
            ...
            reportParameter = Parameters.Add("TTOBJECTID", "d0b912f7-5c57-4996-9933-57d36f04c565", "", @"", true, true, false, new Guid("8c070a29-bd8b-41e9-a888-1108a97d2419"));
        }
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "NUCLEARMEDICINEAPPOINTMENTINFOFORM";
            Caption = "Nükleer Tıp Randevu Bilgi Formu";
