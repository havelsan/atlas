...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class PlannedMedicalActionDetailReportByAcceptForFound : TTReport
    {
        ...
        {
            public PlannedMedicalActionDetailReportByAcceptForFound MyParentReport
            {
                get { return (PlannedMedicalActionDetailReportByAcceptForFound)ParentReport; }
            }
...
#region MASTER HEADER_Script
            ...
            string objectID = ((PlannedMedicalActionDetailReportByAcceptForFound)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
        ...
        public partial class ORDERSGroup : TTReportGroup
        {
            ...
            public partial class ORDERSGroupHeader : TTReportSection
            {
                ...
                public ORDERSGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 42, 24, 120, 29, false);
                    NewField13.Name = "NewField13";
                    NewField13.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField13.TextFont.Name = "Arial Narrow";
                    NewField13.TextFont.Size = 9;
                    ...
                    NewField121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 24, 41, 29, false);
                    NewField121.Name = "NewField121";
                    NewField121.TextFont.Name = "Arial Narrow";
                    NewField121.TextFont.Size = 9;
                    NewField121.TextFont.Bold = true;
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    NewField121.CalcValue = NewField121.Value;
                    return new TTReportObject[] { ORDEROBJECTOBJECTID,PROCEDUREOBJECTCODENAME,APPLICATIONAREA,DURATION,AMOUNT,TREATMENTUNITNAME,NewField15,NewField11114111,NewField111141111,NewField112141111,NewField1111141211,NewField11121411111,NewField13,NewField11,TREATMENTPROPERTIES,NewField118211,NewField151,NewField121};
                }
            }
        ...
        public partial class ORDERDETAILSGroup : TTReportGroup
        {
            ...
            public partial class ORDERDETAILSGroupBody : TTReportSection
            {
                ...
                public ORDERDETAILSGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PROCEDUREBYUSER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 42, 1, 120, 6, false);
                    ...
                    ACTIONDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 1, 41, 6, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { EMERGENCY,PROCEDUREBYUSER,ORDEROBJECTPROCEDUREDOCTOR,ORDERDETAILPROCEDUREBYUSER,ACTIONDATE,STATE};
                }
...
#region ORDERDETAILS BODY_Script
        ...
        public PlannedMedicalActionDetailReportByAcceptForFound()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "PLANNEDMEDICALACTIONDETAILREPORTBYACCEPTFORFOUND";
            Caption = "Planlı Tıbbi İşlem Detay Raporu (İstek Bazında-Kurum)";
