...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class DialysisDetailReportForFoundation : TTReport
    {
        ...
        {
            public DialysisDetailReportForFoundation MyParentReport
            {
                get { return (DialysisDetailReportForFoundation)ParentReport; }
            }
...
#region MASTER HEADER_Script
            ...
            string objectID = ((DialysisDetailReportForFoundation)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
...
";
                    ...
                    NewField111141111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 4, 134, 9, false);
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 134, 4, 187, 9, false);
                    NewField1.Name = "NewField1";
                    NewField1.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField1.TextFont.Name = "Arial Narrow";
                    NewField1.TextFont.Size = 9;
...
";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    NewField1.CalcValue = NewField1.Value;
                    NewField2.CalcValue = NewField2.Value;
                    return new TTReportObject[] { NewField0,NewField111141111,NewField1,NewField2};
                }
            }
        ...
        public partial class ORDERDETAILSGroup : TTReportGroup
        {
            ...
            public partial class ORDERDETAILSGroupBody : TTReportSection
            {
                ...
                public ORDERDETAILSGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PROCEDUREBYUSER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 134, 2, 187, 7, false);
                    ...
                    PROCEDUREOBJECTCODENAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 2, 134, 7, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { PROCEDUREBYUSER,ORDEROBJECTPROCEDUREDOCTOR,ORDERDETAILPROCEDUREBYUSER,PROCEDUREOBJECTCODENAME,ORDEROBJECTOBJECTID,ACTIONDATE,CURRENTSTATEDEFID,ACTIONDATE2,ORDERDETAILOBJECTID,STATE};
                }
...
";
        ...
        public DialysisDetailReportForFoundation()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "DIALYSISDETAILREPORTFORFOUNDATION";
            Caption = "Diyaliz Detay Raporu(Kurum)";
