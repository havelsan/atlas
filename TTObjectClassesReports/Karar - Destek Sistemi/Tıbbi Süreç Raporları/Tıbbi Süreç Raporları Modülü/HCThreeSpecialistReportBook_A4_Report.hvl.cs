...
{
    /// <summary>
    /// Üç Uzman Tabip İmzalı Rapor Defteri (A4)
    /// </summary>
    public partial class HCThreeSpecialistReportBook_A4 : TTReport
    {
        ...
        {
            public HCThreeSpecialistReportBook_A4 MyParentReport
            {
                get { return (HCThreeSpecialistReportBook_A4)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    BASLIK = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 17, 288, 25, false);
                    BASLIK.Name = "BASLIK";
                    ...
                    STARTDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 304, 9, 329, 14, false);
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 304, 19, 329, 24, false);
                    ...
                    DATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 238, 25, 288, 30, false);
                    DATE.Name = "DATE";
...
#region PARTA HEADER_Script
            ...
            ((HCThreeSpecialistReportBook_A4)ParentReport).RuntimeParameters.STARTDATE = Convert.ToDateTime(STARTDATE.FormattedValue + " 00:00:00");
            ((HCThreeSpecialistReportBook_A4)ParentReport).RuntimeParameters.ENDDATE = Convert.ToDateTime(ENDDATE.FormattedValue + " 23:59:59");
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 1, 289, 6, false);
        ...
        public partial class CAPTIONGroup : TTReportGroup
        {
            ...
            public partial class CAPTIONGroupHeader : TTReportSection
            {
                ...
                public CAPTIONGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 4, 28, 13, false);
                    ...
                    NewField12 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 4, 65, 13, false);
                    ...
                    NewField13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 65, 4, 104, 13, false);
                    ...
                    NewField131 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 104, 4, 141, 13, false);
                    ...
                    NewField132 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 141, 4, 181, 13, false);
                    ...
                    NewField133 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 181, 4, 254, 13, false);
                    ...
                    NewField134 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 254, 4, 289, 13, false);
                    ...
                    NewLine111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 4, 10, 13, false);
                    NewLine111.Name = "NewLine111";
                    NewLine111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine1111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 28, 4, 28, 13, false);
                    NewLine1111.Name = "NewLine1111";
                    NewLine1111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine1111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine1211 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 65, 4, 65, 13, false);
                    ...
                    NewLine1311 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 104, 4, 104, 13, false);
                    ...
                    NewLine1411 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 141, 4, 141, 13, false);
                    ...
                    NewLine1511 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 181, 4, 181, 13, false);
                    ...
                    NewLine1611 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 254, 4, 254, 13, false);
                    ...
                    NewLine12 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 93, 4, 289, 4, false);
                    NewLine12.Name = "NewLine12";
                    NewLine12.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine11161 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 289, 4, 289, 13, false);
                    ...
                    NewLine1121 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 93, 13, 289, 13, false);
                    NewLine1121.Name = "NewLine1121";
                    NewLine1121.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine121 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 4, 96, 4, false);
                    NewLine121.Name = "NewLine121";
                    NewLine121.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine122 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 13, 127, 13, false);
            ...
            public partial class CAPTIONGroupFooter : TTReportSection
            {
                ...
                public CAPTIONGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 2, 289, 2, false);
                    NewLine11.Name = "NewLine11";
                    NewLine11.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine112 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 0, 10, 2, false);
                    NewLine112.Name = "NewLine112";
                    NewLine112.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine112.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine1112 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 28, 0, 28, 2, false);
                    ...
                    NewLine1212 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 65, 0, 65, 2, false);
                    ...
                    NewLine1312 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 104, 0, 104, 2, false);
                    ...
                    NewLine1412 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 141, 0, 141, 2, false);
                    ...
                    NewLine1512 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 181, 0, 181, 2, false);
                    ...
                    NewLine1612 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 254, 0, 254, 2, false);
                    ...
                    NewLine1711 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 289, 0, 289, 2, false);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REPORTNODATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 0, 28, 42, false);
...
{%RTAR%}";
                    ...
                    SENDERDATENO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 29, 0, 65, 42, false);
                    ...
                    INFOS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 66, 0, 104, 42, false);
                    INFOS.Name = "INFOS";
                    ...
                    GONDERILEN = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 105, 0, 141, 42, false);
                    ...
                    TESHIS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 142, 0, 181, 42, false);
                    TESHIS.Name = "TESHIS";
                    ...
                    KARAR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 182, 0, 254, 42, false);
                    KARAR.Name = "KARAR";
                    ...
                    FOTO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 254, 0, 289, 42, false);
                    FOTO.Name = "FOTO";
                    ...
                    RTAR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 306, 16, 331, 21, false);
                    RTAR.Name = "RTAR";
                    ...
                    AD = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 306, 2, 331, 7, false);
                    AD.Name = "AD";
                    ...
                    TCNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 306, 9, 331, 14, false);
                    TCNO.Name = "TCNO";
                    ...
                    DTARIHI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 306, 24, 331, 29, false);
                    ...
                    BABAAD = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 336, 16, 361, 21, false);
                    BABAAD.Name = "BABAAD";
                    ...
                    OBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 336, 9, 361, 14, false);
                    OBJECTID.Name = "OBJECTID";
                    OBJECTID.Visible = EvetHayirEnum.ehHayir;
                    OBJECTID.FieldType = ReportFieldTypeEnum.ftVariable;
                    OBJECTID.Value = @"{#PARTB.OBJECTID#}";

                    NewLine1 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 0, 10, 42, false);
                    NewLine1.Name = "NewLine1";
                    NewLine1.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine1.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 28, 0, 28, 42, false);
                    NewLine11.Name = "NewLine11";
                    NewLine11.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine11.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 65, 0, 65, 42, false);
                    NewLine111.Name = "NewLine111";
                    NewLine111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine1111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 104, 0, 104, 42, false);
                    NewLine1111.Name = "NewLine1111";
                    NewLine1111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine1111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine11111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 141, 0, 141, 42, false);
                    NewLine11111.Name = "NewLine11111";
                    NewLine11111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine11111.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine111111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 181, 0, 181, 42, false);
                    ...
                    NewLine111112 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 254, 0, 254, 42, false);
                    ...
                    NewLine111113 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 289, 0, 289, 42, false);
                    ...
                    DYERI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 336, 2, 361, 7, false);
                    DYERI.Name = "DYERI";
                    ...
                    XXXXXXLIKSUBESI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 336, 24, 361, 29, false);
                    ...
                    MADDE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 307, 32, 332, 37, false);
                    MADDE.Name = "MADDE";
...
//            
        ...
        public HCThreeSpecialistReportBook_A4()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "HCTHREESPECIALISTREPORTBOOK_A4";
            Caption = "Üç Uzman Tabip İmzalı Rapor Defteri (A4)";
