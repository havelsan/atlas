...
{
    /// <summary>
    /// Sağlık Kurulu Ön Bildirim Belgesi(Dosya Sureti,Sahsa ve XXXXXXlik Şubesine)
    /// </summary>
    public partial class HCPreDeclarationDocumentReport_2 : TTReport
    {
        ...
        {
            public HCPreDeclarationDocumentReport_2 MyParentReport
            {
                get { return (HCPreDeclarationDocumentReport_2)ParentReport; }
            }
...
RAPOR ÖN BİLDİRİM BELGESİ";
                    ...
                    NewField3 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 9, 166, 38, 171, false);
...
Arz / Rica ederim. ";
                    ...
                    BASTABIP = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 149, 140, 193, 159, false);
                    ...
                    NewField7 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 149, 134, 193, 139, false);
...
Değildir Kararlılarda";
                    ...
                    DECISIONTIME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 216, 210, 241, 215, false);
...
#region MAIN BODY_Script
            ...
            string sObjectID = ((HCPreDeclarationDocumentReport_2)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
...
Değildir Kararlılarda";
                    ...
                    DECISIONTIME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 216, 220, 241, 225, false);
                    DECISIONTIME.Name = "DECISIONTIME";
                    DECISIONTIME.Visible = EvetHayirEnum.ehHayir;
                    DECISIONTIME.FieldType = ReportFieldTypeEnum.ftVariable;
                    DECISIONTIME.TextFormat = @"NUMBERTEXT";
...
Değildir Kararlılarda";
                    ...
                    DECISIONTIME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 216, 212, 241, 217, false);
                    DECISIONTIME.Name = "DECISIONTIME";
                    DECISIONTIME.Visible = EvetHayirEnum.ehHayir;
                    DECISIONTIME.FieldType = ReportFieldTypeEnum.ftVariable;
                    DECISIONTIME.TextFormat = @"NUMBERTEXT";
                    ...
                    NewField1131 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 9, 162, 38, 166, false);
                    NewField1131.Name = "NewField1131";
                    NewField1131.TextFont.Size = 9;
                    NewField1131.Value = @"Muayene Amacı :";
...
RAPOR ÖN BİLDİRİM BELGESİ";
                    ...
                    return new TTReportObject[] { KARAR,EVRAKTARIHI,NewField64,BASLIK,XXXXXXBASLIK,NewFieldA,NewField1141,DTARIHI,DYERTARIH,TCKN,ADATE,EVRAKNO,NewFieldA1521,RAPORSEBEP,FOTOGRAF,NewField131,NewField141,RAPORNO,RAPORTARIHI,NewField1671,TANI,NewField101,ADISOYADI,BABAADI,NewField1251,NewField1281,NewField1291,NewFieldQ1521,XXXXXXLIKSUBE,NewField1521,MAKAM,TCKIMLIKNO,NewField17701,NewField1771,HASTANO,NewField182,BASTABIP,AdditionalMembers,S151,S181,NewField161,RAPORTARIHI2,NewField7,NewField18,NewField19,NewField110,NewField1111,NewField1121,NewField1135,XXXXXXLIKSUBESIBASLIK,SKULBL1,SKULBL2,SKULBL3,DYERILCE,DYERIL,DYERULKE,NewField11521,SINIFRUTBE,NewField11531,BIRLIK,TCKIMLIKNOBARKOD,FOTOGRAF1,NewField197,DECISIONTIME,NewField1131,MUAYENEAMACI,XXXXXXADI1};
                }
...
//
        ...
        public HCPreDeclarationDocumentReport_2()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "HCPREDECLARATIONDOCUMENTREPORT_2";
            Caption = "Sağlık Kurulu Ön Bildirim Belgesi(Dosya Sureti,Sahsa ve XXXXXXlik Şubesine)";
