...
{
    /// <summary>
    /// Fizyoterapi İstek Raporu
    /// </summary>
    public partial class PhysiotheraphyAcceptionReportForPatient : TTReport
    {
        ...
        {
            public PhysiotheraphyAcceptionReportForPatient MyParentReport
            {
                get { return (PhysiotheraphyAcceptionReportForPatient)ParentReport; }
            }
            ...
            public partial class MASTERGroupHeader : TTReportSection
            {
                ...
                public MASTERGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NAME.ObjectDefName = "PhysiotherapyOrder";
                    NAME.DataMember = "EPISODE.PATIENT.FullName";
                    NAME.TextFont.Name = "Arial Narrow";
                    NAME.TextFont.Size = 9;
                    NAME.Value = @"{@TTOBJECTID@}";

                    DTARIH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 72, 255, 77, false);
                    DTARIH.Name = "DTARIH";
                    ...
                    DYER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 77, 255, 82, false);
                    DYER.Name = "DYER";
                    ...
                    SubTypeExplanat.Value = @"Fiziksel Tıp ve Rehabilitasyon Servisi
";
                    ...
                    HASTANO.ObjectDefName = "PhysiotherapyOrder";
                    ...
                    PHYSIOTHERAPYREQUESTOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 67, 255, 72, false);
                    ...
                    EPISODEID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 53, 266, 58, false);
                    ...
                    REPORTHEADER1.Value = @"FİZYOTERAPİ İSTEK RAPORU (HASTA)";
                    ...
                    EPISODEOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 58, 266, 63, false);
                    ...
                    AYAKYATANCODED = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 63, 255, 67, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    RUTBE.CalcValue = @"";
                    KABULSEBEBI.CalcValue = (dataset_PhysiotherapyAcceptionReportNQL != null ? Globals.ToStringCore(dataset_PhysiotherapyAcceptionReportNQL.Reasonforadm) : "");
                    ...
                    ACTIONID.CalcValue = (dataset_PhysiotherapyAcceptionReportNQL != null ? Globals.ToStringCore(dataset_PhysiotherapyAcceptionReportNQL.Actionid) : "");
                    NewField26.CalcValue = NewField26.Value;
                    TARIH.CalcValue = (dataset_PhysiotherapyAcceptionReportNQL != null ? Globals.ToStringCore(dataset_PhysiotherapyAcceptionReportNQL.ActionDate) : "");
...
#region MASTER HEADER_Script
            ...
            string objectID = ((PhysiotheraphyAcceptionReportForPatient)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
...
";
        ...
        public partial class ORDERSGroup : TTReportGroup
        {
            ...
            public partial class ORDERSGroupHeader : TTReportSection
            {
                ...
                public ORDERSGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewLine112111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 10, 13, 206, 13, false);
                    NewLine112111.Name = "NewLine112111";
                    NewLine112111.DrawStyle = DrawStyleConstants.vbSolid;

                    NewField1111141111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 37, 6, 94, 11, false);
                    ...
                    NewField0 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 94, 6, 115, 11, false);
                    NewField0.Name = "NewField0";
                    NewField0.TextFont.Name = "Arial Narrow";
                    NewField0.TextFont.Size = 9;
                    NewField0.TextFont.Bold = true;
                    NewField0.Value = @" Uygulama Alanı";

                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 115, 6, 127, 11, false);
                    NewField1.Name = "NewField1";
                    NewField1.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField1.TextFont.Name = "Arial Narrow";
                    NewField1.TextFont.Size = 9;
                    ...
                    NewField11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 127, 6, 169, 11, false);
                    NewField11.Name = "NewField11";
                    NewField11.TextFont.Name = "Arial Narrow";
                    NewField11.TextFont.Size = 9;
                    NewField11.TextFont.Bold = true;
                    NewField11.Value = @" Tanı Tedavi Birimi / Odası";

                    NewField2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 6, 37, 11, false);
                    NewField2.Name = "NewField2";
                    NewField2.TextFont.Name = "Arial Narrow";
                    NewField2.TextFont.Size = 9;
                    NewField2.TextFont.Bold = true;
                    ...
                    NewField15 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 169, 6, 206, 11, false);
                    ...
                    NewField15.Value = @"İşlemi Yapacak Fizyoterapist";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { NewField1111141111,NewField0,NewField1,NewField11,NewField2,NewField15};
                }
            }
        ...
        public partial class ORDERDETAILSGroup : TTReportGroup
        {
            ...
            {
                TTBaseReportNqlData[] list = new TTBaseReportNqlData[1];
                list[0] = new TTReportNqlData<PhysiotherapyOrderDetail.GetPhysiotherapyOrderDetailsForPatient_Class>("GetPhysiotherapyOrderDetailsForPatient", PhysiotherapyOrderDetail.GetPhysiotherapyOrderDetailsForPatient((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.MASTER.PHYSIOTHERAPYREQUESTOBJECTID.CalcValue)));
                return new TTReportNqlDataSet(ParentGroup, list);
            }
            ...
            public partial class ORDERDETAILSGroupBody : TTReportSection
            {
                ...
                public ORDERDETAILSGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PROCEDUREOBJECTCODENAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 37, 2, 94, 7, false);
                    ...
                    APPLICATIONAREA = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 94, 2, 115, 7, false);
                    ...
                    TREATMENTDIAGNOSISUNITNAME.Value = @" {#TREATMENTDIAGNOSISUNITNAME#} / {#TREATMENTROOMNAME#}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    PhysiotherapyOrderDetail.GetPhysiotherapyOrderDetailsForPatient_Class dataset_GetPhysiotherapyOrderDetailsForPatient = ParentGroup.rsGroup.GetCurrentRecord<PhysiotherapyOrderDetail.GetPhysiotherapyOrderDetailsForPatient_Class>(0);
                    WORKLISTDATE.CalcValue = (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.PricingDate) : "");
                    PROCEDUREBYUSER.CalcValue = (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.Procedurebyuser) : "");
                    ORDEROBJECTPROCEDUREDOCTOR.CalcValue = (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.Orderobjectproceduredoctor) : "");
                    ORDERDETAILPROCEDUREBYUSER.CalcValue = (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.Procedurebyuser) : "");
                    ORDEROBJECTOBJECTID.CalcValue = (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.Orderobjectobjectid) : "");
                    PROCEDUREOBJECTCODENAME.CalcValue = @" " + (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.Procedureobjectcode) : "") + @" " + (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.Procedureobjectname) : "");
                    APPLICATIONAREA.CalcValue = (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.Orderobjectapplicationarea) : "");
                    DURATION.CalcValue = (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.Orderobjectduration) : "");
                    TREATMENTDIAGNOSISUNITNAME.CalcValue = @" " + (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.Treatmentdiagnosisunitname) : "") + @" / " + (dataset_GetPhysiotherapyOrderDetailsForPatient != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetailsForPatient.Treatmentroomname) : "");
                    return new TTReportObject[] { WORKLISTDATE,PROCEDUREBYUSER,ORDEROBJECTPROCEDUREDOCTOR,ORDERDETAILPROCEDUREBYUSER,ORDEROBJECTOBJECTID,PROCEDUREOBJECTCODENAME,APPLICATIONAREA,DURATION,TREATMENTDIAGNOSISUNITNAME};
                }
...
#region ORDERDETAILS BODY_Script
        ...
        public PhysiotheraphyAcceptionReportForPatient()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "PHYSIOTHERAPHYACCEPTIONREPORTFORPATIENT";
            Caption = "Fizyoterapi İstek Raporu (Hasta)";
