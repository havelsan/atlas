...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class PhysiotheraphyAcceptionReport : TTReport
    {
        ...
        {
            public PhysiotheraphyAcceptionReport MyParentReport
            {
                get { return (PhysiotheraphyAcceptionReport)ParentReport; }
            }
...
";
                    ...
                    PHYSIOTHERAPYREQUESTOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 219, 63, 255, 68, false);
                    ...
                    REPORTHEADER1.Value = @"FİZYOTERAPİ İSTEK RAPORU";
...
#region MASTER HEADER_Script
            ...
            string objectID = ((PhysiotheraphyAcceptionReport)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
        ...
        public partial class ORDERSGroup : TTReportGroup
        {
            ...
            public partial class ORDERSGroupHeader : TTReportSection
            {
                ...
                public ORDERSGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1121141111.Value = @"Tedavi Odası";
                    ...
                    NewField1121141114.Value = @"İşlemi Yapacak Fizyoterapist";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { ORDEROBJECTOBJECTID,NewField111141121,PROCEDUREOBJECTCODENAME,APPLICATIONAREA,DURATION,AMOUNT,TREATMENTDIAGNOSISUNITNAME,NewField1121141111,NewField11111411211,NewField11114111,NewField111141111,NewField112141111,NewField1111141211,NewField11121411111,NewField1121141113,NewField1121141114,NewField11,TREATMENTPROPERTIES,NewField118211};
                }
            }
        ...
        public partial class ORDERDETAILSGroup : TTReportGroup
        {
            ...
            public partial class ORDERDETAILSGroupBody : TTReportSection
            {
                ...
                public ORDERDETAILSGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    TREATMENTROOMNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 142, 1, 186, 6, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    WORKLISTDATE.CalcValue = (dataset_GetPhysiotherapyOrderDetails != null ? Globals.ToStringCore(dataset_GetPhysiotherapyOrderDetails.PricingDate) : "");
                    ...
                    return new TTReportObject[] { WORKLISTDATE,TREATMENTROOMNAME,EMERGENCY,CURENUMBER,PROCEDUREBYUSER,ORDEROBJECTPROCEDUREDOCTOR,ORDERDETAILPROCEDUREBYUSER};
                }
...
#region ORDERDETAILS BODY_Script
        ...
        public PhysiotheraphyAcceptionReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "PHYSIOTHERAPHYACCEPTIONREPORT";
            Caption = "Fizyoterapi İstek Raporu";
