...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class MainCashOfficeClosingBankDeliveryReport : TTReport
    {
        ...
        {
            public MainCashOfficeClosingBankDeliveryReport MyParentReport
            {
                get { return (MainCashOfficeClosingBankDeliveryReport)ParentReport; }
            }
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<CashOfficeClosing.BankDeliveryReportQuery_Class>("BankDeliveryReportQuery", CashOfficeClosing.BankDeliveryReportQuery((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 31, 190, 36, false);
                    PRICE.Name = "PRICE";
                    PRICE.FieldType = ReportFieldTypeEnum.ftVariable;
                    PRICE.TextFormat = @"#,##0.#0";
                    PRICE.TextFont.Name = "Courier New";
                    PRICE.Value = @"{#SUBMITTEDTOTAL#}";

                    BANK = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 37, 190, 42, false);
                    BANK.Name = "BANK";
                    ...
                    CASHIER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 43, 190, 48, false);
                    ...
                    DESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 49, 190, 54, false);
                    ...
                    PRICEWITHLETTERS = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 45, 63, 145, 68, false);
                    ...
                    BANKACCOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 45, 70, 108, 75, false);
                    ...
                    SPECIALNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 164, 21, 190, 26, false);
                    ...
                    DSNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 6, 15, 143, 20, false);
                    DSNAME.Name = "DSNAME";
...
";
                ...
                {
                    CashOfficeClosing.BankDeliveryReportQuery_Class dataset_BankDeliveryReportQuery = ParentGroup.rsGroup.GetCurrentRecord<CashOfficeClosing.BankDeliveryReportQuery_Class>(0);
                    PRICE.CalcValue = (dataset_BankDeliveryReportQuery != null ? Globals.ToStringCore(dataset_BankDeliveryReportQuery.SubmittedTotal) : "");
...
;
        ...
        public MainCashOfficeClosingBankDeliveryReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "MAINCASHOFFICECLOSINGBANKDELIVERYREPORT";
