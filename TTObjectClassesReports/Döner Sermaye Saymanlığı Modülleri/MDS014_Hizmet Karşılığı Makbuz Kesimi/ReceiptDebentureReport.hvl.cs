...
namespace TTReportClasses
{
    ...
    /// Borç Senedi
    /// </summary>
    public partial class ReceiptDebentureReport : TTReport
    {
        ...
        {
            public ReceiptDebentureReport MyParentReport
            {
                get { return (ReceiptDebentureReport)ParentReport; }
            }
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<Receipt.GetReceiptDebentures_Class>("DebentureReportQuery", Receipt.GetReceiptDebentures((string)TTObjectDefManager.Instance.DataTypes["String255"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class HEADGroupHeader : TTReportSection
            {
                ...
                {
                    Receipt.GetReceiptDebentures_Class dataset_DebentureReportQuery = ParentGroup.rsGroup.GetCurrentRecord<Receipt.GetReceiptDebentures_Class>(0);
                    DEBENTUREOBJECTID.CalcValue = (dataset_DebentureReportQuery != null ? Globals.ToStringCore(dataset_DebentureReportQuery.ObjectID) : "");
            ...
            public partial class HEADGroupFooter : TTReportSection
            {
                ...
                public HEADGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    CURRENTUSER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 98, 1, 126, 6, false);
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 77, 4, 140, 24, false);
...
İl-İlçe ve Köy";
                    ...
                    HOSPITALDSNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 232, 59, 257, 64, false);
                    ...
                    HOSPITALCITY = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 230, 68, 265, 73, false);
                    ...
                    LOGO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 37, 4, 77, 24, false);
                    LOGO.Name = "LOGO";
