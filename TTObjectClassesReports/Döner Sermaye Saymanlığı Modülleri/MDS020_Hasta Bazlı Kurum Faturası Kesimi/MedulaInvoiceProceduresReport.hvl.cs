...
namespace TTReportClasses
{
    ...
    /// Medula Faturası
    /// </summary>
    public partial class MedulaInvoiceProceduresReport : TTReport
    {
#region Methods
   Currency PageTotal = 0;
        ...
        {
            public MedulaInvoiceProceduresReport MyParentReport
            {
                get { return (MedulaInvoiceProceduresReport)ParentReport; }
            }
            ...
            public partial class HEADGroupHeader : TTReportSection
            {
                ...
                public HEADGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SEVKTARIHI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 327, 27, 352, 32, false);
                    ...
                    PAYER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 31, 47, 207, 52, false);
                    PAYER.Name = "PAYER";
                    ...
                    PATIENTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 31, 37, 110, 42, false);
                    ...
                    HPROTNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 31, 42, 110, 47, false);
                    ...
                    DOCUMENTNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 102, 55, 152, 60, false);
                    ...
                    ICD10 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 110, 63, 207, 73, false);
                    ICD10.Name = "ICD10";
                    ...
                    TAXINFO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 327, 59, 367, 71, false);
                    ...
                    TAXNUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 327, 33, 360, 38, false);
                    ...
                    TURNOVERTOTALLABEL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 323, 77, 347, 81, false);
                    ...
                    TURNOVERTOTAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 347, 77, 377, 81, false);
                    ...
                    PAGENO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 193, 55, 206, 60, false);
                    PAGENO.Name = "PAGENO";
                    ...
                    ICD10CODE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 327, 50, 349, 54, false);
                    ...
                    CASHIERNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 354, 44, 393, 48, false);
                    ...
                    CASHIERTITLE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 354, 48, 393, 52, false);
                    ...
                    CASHIERRECID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 354, 52, 393, 56, false);
                    ...
                    MAPULKE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 327, 46, 349, 50, false);
                    ...
                    SEVKNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 327, 19, 352, 24, false);
                    SEVKNO.Name = "SEVKNO";
                    ...
                    HOSPITALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 5, 6, 208, 24, false);
                    ...
                    NewRect1 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtRectangle, 5, 31, 208, 53, false);
                    NewRect1.Name = "NewRect1";
                    NewRect1.DrawStyle = DrawStyleConstants.vbSolid;
                    NewRect1.FillStyle = FillStyleConstants.vbFSTransparent;

                    NewField1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 6, 32, 28, 37, false);
                    ...
                    NewField11 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 6, 37, 28, 42, false);
                    ...
                    NewField12 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 32, 30, 37, false);
                    ...
                    UNIQUEREFNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 31, 32, 110, 37, false);
                    ...
                    NewField2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 249, 8, 276, 15, false);
                    ...
                    NewField3 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 16, 301, 33, false);
                    ...
                    NewField4 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 227, 54, 242, 68, false);
                    ...
                    NewField5 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 35, 243, 40, false);
                    NewField5.Name = "NewField5";
                    NewField5.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 243, 35, 245, 40, false);
                    ...
                    BANKACCOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 245, 35, 301, 42, false);
                    ...
                    IBANNo = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 42, 243, 47, false);
                    IBANNo.Name = "IBANNo";
                    ...
                    NewField1121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 243, 42, 245, 47, false);
                    NewField1121.Name = "NewField1121";
                    NewField1121.Visible = EvetHayirEnum.ehHayir;
                    ...
                    HOSPITALIBANNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 245, 42, 301, 47, false);
                    ...
                    NewField16 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 47, 243, 52, false);
                    NewField16.Name = "NewField16";
                    NewField16.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField1122 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 243, 47, 245, 52, false);
                    NewField1122.Name = "NewField1122";
                    NewField1122.Visible = EvetHayirEnum.ehHayir;
                    ...
                    TAXOFFICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 327, 39, 350, 44, false);
                    ...
                    NewField122 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 37, 30, 42, false);
                    ...
                    NewField1221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 42, 30, 47, false);
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 6, 42, 28, 47, false);
                    ...
                    DOCUMENTDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 55, 78, 60, false);
                    ...
                    NewField112211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 26, 55, 28, 60, false);
                    ...
                    NewField11111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 6, 55, 26, 60, false);
                    ...
                    NewField11221 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 47, 30, 52, false);
                    ...
                    NewField1111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 6, 47, 28, 52, false);
                    ...
                    NewField6 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 278, 20, 280, 25, false);
                    ...
                    OPENINGDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 137, 32, 207, 37, false);
                    ...
                    NewField11222 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 134, 32, 136, 37, false);
                    ...
                    NewField1112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 112, 32, 134, 37, false);
                    ...
                    INPATIENTDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 137, 37, 207, 42, false);
                    ...
                    NewField11223 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 134, 37, 136, 42, false);
                    ...
                    NewField7 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 112, 37, 134, 42, false);
                    ...
                    DISCHARGEDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 137, 42, 207, 47, false);
                    ...
                    NewField132211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 134, 42, 136, 47, false);
                    ...
                    NewField8 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 112, 42, 134, 47, false);
                    ...
                    NewRect2 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtRectangle, 5, 54, 208, 61, false);
                    NewRect2.Name = "NewRect2";
                    NewRect2.DrawStyle = DrawStyleConstants.vbSolid;
                    NewRect2.FillStyle = FillStyleConstants.vbFSTransparent;

                    NewField1112211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 99, 55, 101, 60, false);
                    NewField1112211.Name = "NewField1112211";
                    NewField1112211.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 82, 55, 99, 60, false);
                    ...
                    NewField11122111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 191, 55, 193, 60, false);
                    ...
                    NewField1111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 176, 55, 191, 60, false);
                    ...
                    NewRect3 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtRectangle, 5, 62, 208, 74, false);
                    NewRect3.Name = "NewRect3";
                    NewRect3.DrawStyle = DrawStyleConstants.vbSolid;
                    NewRect3.FillStyle = FillStyleConstants.vbFSTransparent;

                    NewField11112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 6, 63, 23, 68, false);
                    ...
                    NewField112212 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 23, 63, 25, 68, false);
                    ...
                    NewField121111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 6, 68, 23, 73, false);
                    ...
                    NewField1212211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 23, 68, 25, 73, false);
                    ...
                    SERVICENAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 25, 63, 99, 68, false);
                    ...
                    DOCTORNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 25, 68, 99, 73, false);
                    ...
                    NewField121112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 6, 75, 19, 79, false);
                    ...
                    NewField1211121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 21, 75, 43, 79, false);
                    ...
                    NewField11211121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 45, 75, 163, 79, false);
                    ...
                    NewField1211122 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 75, 179, 79, false);
                    ...
                    NewField13211121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 181, 75, 207, 79, false);
                    ...
                    NewField13211121.Value = @"Toplam Fiyat";

                    TAXOFFICEINFO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 245, 47, 301, 52, false);
                    TAXOFFICEINFO.Name = "TAXOFFICEINFO";
                    TAXOFFICEINFO.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewLine111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 5, 74, 5, 81, false);
                    NewLine111.Name = "NewLine111";
                    NewLine111.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 20, 74, 20, 81, false);
                    NewLine1111.Name = "NewLine1111";
                    NewLine1111.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1112 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 44, 74, 44, 81, false);
                    NewLine1112.Name = "NewLine1112";
                    NewLine1112.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1113 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 164, 74, 164, 81, false);
                    NewLine1113.Name = "NewLine1113";
                    NewLine1113.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1116 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 180, 74, 180, 81, false);
                    NewLine1116.Name = "NewLine1116";
                    NewLine1116.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1117 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 208, 74, 208, 81, false);
                    NewLine1117.Name = "NewLine1117";
                    NewLine1117.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 5, 80, 208, 80, false);
                    NewLine1.Name = "NewLine1";
                    NewLine1.DrawStyle = DrawStyleConstants.vbSolid;

                    PAGENUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 327, 12, 358, 17, false);
                    ...
                    HEADER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 5, 25, 208, 30, false);
                    HEADER.Name = "HEADER";
                    ...
                    HEADER.Value = @"MEDULA FATURA HİZMET DÖKÜMÜ";

                    NewField121113 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 100, 63, 109, 68, false);
                    NewField121113.Name = "NewField121113";
                    NewField121113.TextFont.Name = "Arial";
                    NewField121113.TextFont.Size = 9;
                    NewField121113.TextFont.Bold = true;
                    NewField121113.TextFont.CharSet = 162;
                    NewField121113.Value = @"Tanı :";
...
#region HEAD HEADER_Script
            ...
            if (pid != null)
            {
                ...
                if (episode != null)
                {
                    ...
                    MyParentReport.HPROTNO = episode.HospitalProtocolNo.Value.ToString();
            ...
            public partial class HEADGroupFooter : TTReportSection
            {
                ...
                public HEADGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SEVKTARIHIFOOTER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 326, 7, 398, 11, false);
                    ...
                    TOTALPRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 390, 50, 427, 55, false);
                    ...
                    TOTALDISCOUNTPRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 258, 2, 287, 6, false);
                    ...
                    GENERALTOTALPRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 258, 7, 293, 12, false);
                    ...
                    PAGETOTALLABEL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 2, 254, 6, false);
                    ...
                    PAGETOTAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 7, 255, 11, false);
                    ...
                    SEVKNOFOOTER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 326, 3, 398, 7, false);
                    ...
                    NewField10 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 227, 21, 430, 24, false);
                    ...
                    NewField13 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 227, 24, 430, 28, false);
                    ...
                    NewRect4 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtRectangle, 227, 29, 430, 62, false);
                    NewRect4.Name = "NewRect4";
                    NewRect4.DrawStyle = DrawStyleConstants.vbSolid;
                    NewRect4.FillStyle = FillStyleConstants.vbFSTransparent;

                    NewField14 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 227, 63, 430, 73, false);
                    ...
                    HOSPITALNAMEFOOTER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 229, 30, 334, 48, false);
                    HOSPITALNAMEFOOTER.Name = "HOSPITALNAMEFOOTER";
                    HOSPITALNAMEFOOTER.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField15 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 229, 49, 245, 53, false);
                    ...
                    NewField151 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 229, 53, 245, 57, false);
                    ...
                    NewField17 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 245, 49, 247, 53, false);
                    ...
                    NewField171 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 245, 53, 247, 57, false);
                    ...
                    PAYERFOOTER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 247, 53, 334, 61, false);
                    ...
                    HPROTNOFOOTER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 390, 30, 427, 35, false);
                    ...
                    NewField11224 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 388, 30, 390, 35, false);
                    NewField11224.Name = "NewField11224";
                    NewField11224.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField1113 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 363, 30, 388, 35, false);
                    NewField1113.Name = "NewField1113";
                    NewField1113.Visible = EvetHayirEnum.ehHayir;
                    ...
                    DOCUMENTNOFOOTER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 390, 35, 427, 40, false);
                    ...
                    NewField11122112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 388, 35, 390, 40, false);
                    NewField11122112.Name = "NewField11122112";
                    NewField11122112.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField1111112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 363, 35, 388, 40, false);
                    NewField1111112.Name = "NewField1111112";
                    NewField1111112.Visible = EvetHayirEnum.ehHayir;
                    ...
                    DOCUMENTDATEFOOTER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 390, 40, 427, 45, false);
                    DOCUMENTDATEFOOTER.Name = "DOCUMENTDATEFOOTER";
                    DOCUMENTDATEFOOTER.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField1112212 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 388, 40, 390, 45, false);
                    NewField1112212.Name = "NewField1112212";
                    NewField1112212.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField111112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 363, 40, 388, 45, false);
                    NewField111112.Name = "NewField111112";
                    NewField111112.Visible = EvetHayirEnum.ehHayir;
                    ...
                    PAGENOFOOTER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 390, 45, 427, 50, false);
                    PAGENOFOOTER.Name = "PAGENOFOOTER";
                    PAGENOFOOTER.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField111122111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 388, 45, 390, 50, false);
                    NewField111122111.Name = "NewField111122111";
                    NewField111122111.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField11111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 363, 45, 388, 50, false);
                    NewField11111111.Name = "NewField11111111";
                    NewField11111111.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField1111221111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 388, 50, 390, 55, false);
                    NewField1111221111.Name = "NewField1111221111";
                    NewField1111221111.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField111111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 363, 50, 388, 55, false);
                    NewField111111111.Name = "NewField111111111";
                    NewField111111111.Visible = EvetHayirEnum.ehHayir;
                    ...
                    NewField18 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 341, 47, 356, 61, false);
                    ...
                    HPROTNOANDPATIENTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 247, 49, 334, 53, false);
                    ...
                    PRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 297, 2, 322, 7, false);
                    PRICE.Name = "PRICE";
...
#region HEAD FOOTER_Script
        ...
        public partial class TRXDESCGroup : TTReportGroup
        {
            ...
            {
                TTBaseReportNqlData[] list = new TTBaseReportNqlData[1];
                list[0] = new TTReportNqlData<PayerInvoiceDocument.MedulaInvoiceProceduresReportQuery_Class>("MedulaInvoiceReportQuery", PayerInvoiceDocument.MedulaInvoiceProceduresReportQuery((Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
                return new TTReportNqlDataSet(ParentGroup, list);
            }
            ...
            public partial class TRXDESCGroupHeader : TTReportSection
            {
                ...
                public TRXDESCGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    BUTCODE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 45, 0, 163, 4, false);
                    ...
                    NewLine111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 20, 0, 20, 4, false);
                    NewLine111.Name = "NewLine111";
                    NewLine111.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine111.ExtendTo = ExtendToEnum.extSectionHeight;

                    NewLine112 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 164, 0, 164, 4, false);
                    ...
                    NewLine1111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 44, 0, 44, 4, false);
                    NewLine1111.Name = "NewLine1111";
                    NewLine1111.DrawStyle = DrawStyleConstants.vbSolid;
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    PayerInvoiceDocument.MedulaInvoiceProceduresReportQuery_Class dataset_MedulaInvoiceReportQuery = ParentGroup.rsGroup.GetCurrentRecord<PayerInvoiceDocument.MedulaInvoiceProceduresReportQuery_Class>(0);
                    BUTCODE.CalcValue = (dataset_MedulaInvoiceReportQuery != null ? Globals.ToStringCore(dataset_MedulaInvoiceReportQuery.Pricinggroupdescription) : "");
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                PayerInvoiceDocument.MedulaInvoiceProceduresReportQuery_Class dataSet_MedulaInvoiceReportQuery = ParentGroup.rsGroup.GetCurrentRecord<PayerInvoiceDocument.MedulaInvoiceProceduresReportQuery_Class>(0);    
                return new object[] {(dataSet_MedulaInvoiceReportQuery==null ? null : dataSet_MedulaInvoiceReportQuery.Pricinggroupdescription)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    ORDERNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 6, 0, 19, 4, false);
                    ...
                    DESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 45, 0, 163, 4, false);
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 165, 0, 179, 4, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    PRICE.TextFont.Size = 8;
                    PRICE.TextFont.CharSet = 162;
                    PRICE.Value = @"{#TRXDESC.MEDULAPRICE#}";

                    DATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 21, 0, 43, 4, false);
                    DATE.Name = "DATE";
                    ...
                    DAY = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 300, 0, 317, 4, false);
                    DAY.Name = "DAY";
                    ...
                    MONTH = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 319, 0, 336, 4, false);
                    MONTH.Name = "MONTH";
                    ...
                    YEAR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 340, 0, 357, 4, false);
                    YEAR.Name = "YEAR";
                    ...
                    NewLine2 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 20, 0, 20, 4, false);
                    NewLine2.Name = "NewLine2";
                    NewLine2.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine2.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine3 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 44, 0, 44, 4, false);
                    NewLine3.Name = "NewLine3";
                    NewLine3.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine3.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine4 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 164, 0, 164, 4, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    PayerInvoiceDocument.MedulaInvoiceProceduresReportQuery_Class dataset_MedulaInvoiceReportQuery = MyParentReport.TRXDESC.rsGroup.GetCurrentRecord<PayerInvoiceDocument.MedulaInvoiceProceduresReportQuery_Class>(0);
                    ORDERNO.CalcValue = ParentGroup.Counter.ToString();
                    DESCRIPTION.CalcValue = @"";
                    AMOUNT.CalcValue = (dataset_MedulaInvoiceReportQuery != null ? Globals.ToStringCore(dataset_MedulaInvoiceReportQuery.Amount) : "");
                    PRICE.CalcValue = (dataset_MedulaInvoiceReportQuery != null ? Globals.ToStringCore(dataset_MedulaInvoiceReportQuery.MedulaPrice) : "");
                    DATE.CalcValue = @"";
                    TRXNAME.CalcValue = (dataset_MedulaInvoiceReportQuery != null ? Globals.ToStringCore(dataset_MedulaInvoiceReportQuery.Trxname) : "");
                    TRXEXTERNALCODE.CalcValue = (dataset_MedulaInvoiceReportQuery != null ? Globals.ToStringCore(dataset_MedulaInvoiceReportQuery.Trxexternalcode) : "");
                    DAY.CalcValue = (dataset_MedulaInvoiceReportQuery != null ? Globals.ToStringCore(dataset_MedulaInvoiceReportQuery.Day) : "");
                    MONTH.CalcValue = (dataset_MedulaInvoiceReportQuery != null ? Globals.ToStringCore(dataset_MedulaInvoiceReportQuery.Month) : "");
                    YEAR.CalcValue = (dataset_MedulaInvoiceReportQuery != null ? Globals.ToStringCore(dataset_MedulaInvoiceReportQuery.Year) : "");
                    return new TTReportObject[] { ORDERNO,DESCRIPTION,AMOUNT,PRICE,DATE,TRXNAME,TRXEXTERNALCODE,DAY,MONTH,YEAR};
                }
...
#region MAIN BODY_Script
            ...
            this.DATE.CalcValue = this.DAY.CalcValue + "." + this.MONTH.CalcValue + "." + this.YEAR.CalcValue;
...
#region MAIN_Script
        ...
        public MedulaInvoiceProceduresReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "MEDULAINVOICEPROCEDURESREPORT";
            Caption = "Medula Faturası";
