...
{
    /// <summary>
    /// Toplu Fatura Önyazı Raporu
    /// </summary>
    public partial class CollectedInvoicePreReport : TTReport
    {
        ...
        {
            public CollectedInvoicePreReport MyParentReport
            {
                get { return (CollectedInvoicePreReport)ParentReport; }
            }
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    XXXXXXADI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 11, 197, 34, false);
                    ...
                    BODYTEXT1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 79, 197, 89, false);
...
";
                    ...
                    BODYTEXT2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 90, 197, 100, false);
                    ...
                    STARTDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 214, 43, 241, 47, false);
                    ...
                    ENDDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 214, 49, 241, 53, false);
                    ...
                    BANKACCOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 214, 55, 241, 60, false);
...
";
                    ...
                    IBANNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 214, 62, 241, 66, false);
                    IBANNO.Name = "IBANNO";
...
#region PARTD FOOTER_Script
        ...
        public partial class PARTAGroup : TTReportGroup
        {
            ...
            {
                TTBaseReportNqlData[] list = new TTBaseReportNqlData[1];
                list[0] = new TTReportNqlData<CollectedInvoice.CollectedInvoicePreReportQuery_Class>("CollectedInvoicePreReportQuery", CollectedInvoice.CollectedInvoicePreReportQuery((string)TTObjectDefManager.Instance.DataTypes["String255"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
                return new TTReportNqlDataSet(ParentGroup, list);
            }
        ...
        public partial class PARTFGroup : TTReportGroup
        {
            ...
            public TTReportField BASLIK1131 { get {return Header().BASLIK1131;} }
            ...
            public TTReportField BASLIK1112111 { get {return Header().BASLIK1112111;} }
            public TTReportField BASLIK1212111 { get {return Header().BASLIK1212111;} }
            ...
            public partial class PARTFGroupHeader : TTReportSection
            {
                ...
                public TTReportField BASLIK1112111;
                public TTReportField BASLIK1212111; 
                public PARTFGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    BASLIK1111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 7, 26, 17, false);
                    BASLIK1111.Name = "BASLIK1111";
                    BASLIK1111.DrawStyle = DrawStyleConstants.vbSolid;
                    ...
                    BASLIK1111.Value = @"Klasör No";

                    BASLIK1121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 26, 7, 44, 17, false);
                    ...
                    BASLIK1121.Value = @"Branş Kodu";

                    BASLIK1131 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 44, 7, 128, 17, false);
                    BASLIK1131.Name = "BASLIK1131";
                    BASLIK1131.DrawStyle = DrawStyleConstants.vbSolid;
                    BASLIK1131.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    BASLIK1131.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    BASLIK1131.Value = @"Branş Adı";

                    BASLIK11211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 145, 7, 156, 17, false);
                    ...
                    BASLIK11211.Value = @"Koli 
Adedi";

                    BASLIK111211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 156, 7, 173, 17, false);
                    ...
                    BASLIK111211.MultiLine = EvetHayirEnum.ehEvet;
                    BASLIK111211.Value = @"Toplam
Hasta Sayısı";

                    BASLIK1112111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 173, 7, 197, 17, false);
                    BASLIK1112111.Name = "BASLIK1112111";
                    BASLIK1112111.DrawStyle = DrawStyleConstants.vbSolid;
                    BASLIK1112111.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    BASLIK1112111.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    BASLIK1112111.Value = @"Toplam Tutar(TL)";

                    BASLIK1212111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 128, 7, 145, 17, false);
                    BASLIK1212111.Name = "BASLIK1212111";
                    BASLIK1212111.DrawStyle = DrawStyleConstants.vbSolid;
                    BASLIK1212111.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    BASLIK1212111.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    BASLIK1212111.MultiLine = EvetHayirEnum.ehEvet;
                    BASLIK1212111.Value = @"Örneklenen
Hasta Sayısı";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    BASLIK1112111.CalcValue = BASLIK1112111.Value;
                    BASLIK1212111.CalcValue = BASLIK1212111.Value;
                    return new TTReportObject[] { BASLIK1111,BASLIK1121,BASLIK1131,BASLIK11211,BASLIK111211,BASLIK1112111,BASLIK1212111};
                }
            }
        ...
        public partial class PARTCGroup : TTReportGroup
        {
            ...
            public TTReportField EPIZOTSAYISI { get {return Body().EPIZOTSAYISI;} }
            public TTReportField TOPLAMTUTAR { get {return Body().TOPLAMTUTAR;} }
            public TTReportField ORNEKLENENHASTASAYISI1 { get {return Body().ORNEKLENENHASTASAYISI1;} }
            ...
            public partial class PARTCGroupBody : TTReportSection
            {
                ...
                public TTReportField EPIZOTSAYISI;
                public TTReportField TOPLAMTUTAR;
                public TTReportField ORNEKLENENHASTASAYISI1; 
                public PARTCGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    EPIZOTSAYISI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 156, 0, 173, 5, false);
                    EPIZOTSAYISI.Name = "EPIZOTSAYISI";
                    EPIZOTSAYISI.DrawStyle = DrawStyleConstants.vbSolid;
                    EPIZOTSAYISI.FieldType = ReportFieldTypeEnum.ftVariable;
                    EPIZOTSAYISI.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    EPIZOTSAYISI.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    EPIZOTSAYISI.Value = @"{#EPISODECOUNT#}";
                    ...
                    ORNEKLENENHASTASAYISI1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 128, 0, 145, 5, false);
                    ORNEKLENENHASTASAYISI1.Name = "ORNEKLENENHASTASAYISI1";
                    ORNEKLENENHASTASAYISI1.DrawStyle = DrawStyleConstants.vbSolid;
                    ORNEKLENENHASTASAYISI1.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    ORNEKLENENHASTASAYISI1.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    ORNEKLENENHASTASAYISI1.Value = @"";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    CollectedInvoice.CollectedInvoicePreReportQuery_Class dataset_CollectedInvoicePreReportQuery = ParentGroup.rsGroup.GetCurrentRecord<CollectedInvoice.CollectedInvoicePreReportQuery_Class>(0);
                    SIRANO.CalcValue = ParentGroup.GroupCounter.ToString();
                    BRANSKODU.CalcValue = (dataset_CollectedInvoicePreReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoicePreReportQuery.Specialitycode) : "");
                    BRANSADI.CalcValue = (dataset_CollectedInvoicePreReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoicePreReportQuery.Specialityname) : "");
                    KOLIADEDI.CalcValue = KOLIADEDI.Value;
                    EPIZOTSAYISI.CalcValue = (dataset_CollectedInvoicePreReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoicePreReportQuery.Episodecount) : "");
                    TOPLAMTUTAR.CalcValue = (dataset_CollectedInvoicePreReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoicePreReportQuery.Totalprice) : "");
                    ORNEKLENENHASTASAYISI1.CalcValue = ORNEKLENENHASTASAYISI1.Value;
                    return new TTReportObject[] { SIRANO,BRANSKODU,BRANSADI,KOLIADEDI,EPIZOTSAYISI,TOPLAMTUTAR,ORNEKLENENHASTASAYISI1};
                }
            }
        ...
        public CollectedInvoicePreReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "COLLECTEDINVOICEPREREPORT";
            Caption = "Toplu Fatura Önyazı Raporu";
