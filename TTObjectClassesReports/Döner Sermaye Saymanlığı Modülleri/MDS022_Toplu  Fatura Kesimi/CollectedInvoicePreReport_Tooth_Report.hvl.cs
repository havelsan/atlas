...
{
    public partial class CollectedInvoicePreReport_Tooth : TTReport
    {
        ...
        {
            public CollectedInvoicePreReport_Tooth MyParentReport
            {
                get { return (CollectedInvoicePreReport_Tooth)ParentReport; }
            }
...
#region PARTD FOOTER_Script
        ...
        public partial class PARTFGroup : TTReportGroup
        {
            ...
            public partial class PARTFGroupHeader : TTReportSection
            {
                ...
                public PARTFGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    BASLIK111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 11, 26, 17, false);
                    BASLIK111.Name = "BASLIK111";
                    ...
                    BASLIK121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 26, 11, 44, 17, false);
                    ...
                    BASLIK131 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 44, 11, 132, 17, false);
                    BASLIK131.Name = "BASLIK131";
                    BASLIK131.DrawStyle = DrawStyleConstants.vbSolid;
                    BASLIK131.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    ...
                    BASLIK1121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 132, 11, 146, 17, false);
                    ...
                    BASLIK1121.Value = @"Koli Adedi";

                    BASLIK11211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 146, 11, 173, 17, false);
                    ...
                    BASLIK11211.Value = @"Toplam Hasta Sayısı";

                    BASLIK111211 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 173, 11, 197, 17, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { BASLIK111,BASLIK121,BASLIK131,BASLIK1121,BASLIK11211,BASLIK111211};
                }
            }
        ...
        public partial class PARTCGroup : TTReportGroup
        {
            ...
            public partial class PARTCGroupBody : TTReportSection
            {
                ...
                public PARTCGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    BRANSKODU.Value = @"5102";

                    BRANSADI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 44, 0, 132, 5, false);
                    ...
                    BRANSADI.Value = @"ORAL DİAGNOZ";

                    KOLIADEDI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 132, 0, 146, 5, false);
                    ...
                    EPIZOTSAYISI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 146, 0, 173, 5, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    BRANSKODU.CalcValue = BRANSKODU.Value;
                    BRANSADI.CalcValue = BRANSADI.Value;
                    KOLIADEDI.CalcValue = KOLIADEDI.Value;
                    EPIZOTSAYISI.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_Tooth != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_Tooth.Episodecount) : "");
                    TOPLAMTUTAR.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_Tooth != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_Tooth.Totalprice) : "");
                    return new TTReportObject[] { SIRANO,BRANSKODU,BRANSADI,KOLIADEDI,EPIZOTSAYISI,TOPLAMTUTAR};
                }
            }
        ...
        public CollectedInvoicePreReport_Tooth()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "COLLECTEDINVOICEPREREPORT_TOOTH";
            Caption = "Toplu Fatura Önyazı Raporu (Diş)";
