...
{
    /// <summary>
    /// Hizmet Detay Bilgisi
    /// </summary>
    public partial class CollectedInvoiceProcedureDetailReport : TTReport
    {
        ...
        {
            public CollectedInvoiceProcedureDetailReport MyParentReport
            {
                get { return (CollectedInvoiceProcedureDetailReport)ParentReport; }
            }
...
#region PARTA HEADER_Script
            ...
            resFilterList.Add("00000000-0000-0000-0000-000000000000");
            ((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RESOURCESFILTER = resFilterList;
            
            if (((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RES == null)
            {
                ((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RESOURCEFLAG = 0;
            }
            else
            {
                ((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RESOURCEFLAG = 1;
                
                foreach (string objectID in ((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RES)
                {
                    ...
                    if (section is ResDepartment)
                    {
                        ...
                        {
                            //((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(Pol.ObjectID.ToString());
                            foreach(ResourceSpecialityGrid polSpeciality in Pol.ResourceSpecialities)
                            {
                                if(polSpeciality.Speciality != null)
                                    ((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(polSpeciality.Speciality.ObjectID.ToString());
                            }
                        }
                        foreach (ResClinic Cln in department.Clinics)
                        {
                            //((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(Cln.ObjectID.ToString());
                            foreach(ResourceSpecialityGrid clnSpeciality in Cln.ResourceSpecialities)
                            {
                                if(clnSpeciality.Speciality != null)
                                    ((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(clnSpeciality.Speciality.ObjectID.ToString());
                            }
                        }
                    ...
                    {
                        //((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(objectID.ToString());
                        foreach(ResourceSpecialityGrid resSpeciality in section.ResourceSpecialities)
                        {
                            if(resSpeciality.Speciality != null)
                                ((CollectedInvoiceProcedureDetailReport)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(resSpeciality.Speciality.ObjectID.ToString());
                        }
                    }
                }
            }
        ...
        public partial class HEADGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<CollectedPatientList.CollectedInvoiceProcedureDetailReportQuery_Class>("CollectedInvoiceProcedureDetailReportQuery", CollectedPatientList.CollectedInvoiceProcedureDetailReportQuery((string)TTObjectDefManager.Instance.DataTypes["String255"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID),(List<string>) MyParentReport.RuntimeParameters.RESOURCESFILTER,(int)TTObjectDefManager.Instance.DataTypes["Integer"].ConvertValue(MyParentReport.RuntimeParameters.RESOURCEFLAG)));
            ...
            public partial class HEADGroupHeader : TTReportSection
            {
                ...
                {
                    CollectedPatientList.CollectedInvoiceProcedureDetailReportQuery_Class dataset_CollectedInvoiceProcedureDetailReportQuery = ParentGroup.rsGroup.GetCurrentRecord<CollectedPatientList.CollectedInvoiceProcedureDetailReportQuery_Class>(0);
                    NewField1101.CalcValue = NewField1101.Value;
                    NewField1111.CalcValue = NewField1111.Value;
                    NewField1121.CalcValue = NewField1121.Value;
                    HASTAADI.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Patientname) : "");
                    TCKIMLIKNO.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.UniqueRefNo) : "");
                    ...
                    KURUMADI.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Payername) : "");
                    HOSPITALPROTOCOLNO.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.HospitalProtocolNo) : "");
                    KURUMKODU.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Payercode) : "");
                    ICD10KOD.CalcValue = @"";
                    ICD10.CalcValue = @"";
                    TARIH1.CalcValue = @"";
                    BRANS.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Specialityname) : "");
                    HASTATIP.CalcValue = @"";
                    FATURANO.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.DocumentNo) : "");
                    CINSIYET.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Sex) : "");
                    PROVIZYONNO.CalcValue = @"";
                    HASTATURU.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.PATIENTSTATUS) : "");
                    EPISODE.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Eobjid) : "");
                    PATIENT.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Pobjid) : "");
                    TARIH2LBL.CalcValue = TARIH2LBL.Value;
                    TARIH2.CalcValue = @"";
                    OPENINGDATE.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.OpeningDate) : "");
                    QUARANTINEINPATIENTDATE.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.HospitalInPatientDate) : "");
                    ...
                    QUARANTINEDISCHARGEDATE.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.HospitalDischargeDate) : "");
...
//            }
            ...
            public partial class HEADGroupFooter : TTReportSection
            {
                ...
                public HEADGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    TOPLAMFIYAT.Value = @"{#TOTALPRICEBYPATIENT#}";
                ...
                {
                    CollectedPatientList.CollectedInvoiceProcedureDetailReportQuery_Class dataset_CollectedInvoiceProcedureDetailReportQuery = ParentGroup.rsGroup.GetCurrentRecord<CollectedPatientList.CollectedInvoiceProcedureDetailReportQuery_Class>(0);
                    TOPLAMFIYAT.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Totalpricebypatient) : "");
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                CollectedPatientList.CollectedInvoiceProcedureDetailReportQuery_Class dataSet_CollectedInvoiceProcedureDetailReportQuery = ParentGroup.rsGroup.GetCurrentRecord<CollectedPatientList.CollectedInvoiceProcedureDetailReportQuery_Class>(0);    
                return new object[] {(dataSet_CollectedInvoiceProcedureDetailReportQuery==null ? null : dataSet_CollectedInvoiceProcedureDetailReportQuery.HospitalProtocolNo)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    CollectedPatientList.CollectedInvoiceProcedureDetailReportQuery_Class dataset_CollectedInvoiceProcedureDetailReportQuery = MyParentReport.HEAD.rsGroup.GetCurrentRecord<CollectedPatientList.CollectedInvoiceProcedureDetailReportQuery_Class>(0);
                    HIZMET.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.ExternalCode) : "") + @" " + (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Description) : "");
                    TOPLAMFIYAT.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Totalprice) : "");
                    BIRIMFIYAT.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.UnitPrice) : "");
                    ADET.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Amount) : "");
                    TOPLAMFIYAT1.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Totalprice) : "");
                    TARIH.CalcValue = (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Day) : "") + @"." + (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Month) : "") + @"." + (dataset_CollectedInvoiceProcedureDetailReportQuery != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcedureDetailReportQuery.Year) : "");
...
#region MAIN BODY_Script
        ...
        public CollectedInvoiceProcedureDetailReport()
        {
            ...
            reportParameter = Parameters.Add("RESOURCESFILTER", "", "Poliklinik ve Klinik", @"", false, false, true, new Guid("ea658106-fa2f-4da3-a702-db9139c4e63f"));
            reportParameter = Parameters.Add("RES", "", "Ana Bilim Dalı/Poliklinik/Klinik Listesi", @"", false, true, true, new Guid("ea658106-fa2f-4da3-a702-db9139c4e63f"));
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "COLLECTEDINVOICEPROCEDUREDETAILREPORT";
