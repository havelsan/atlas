...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class CollectedInvoiceProcDetPrvReport_NoCheck_1 : TTReport
    {
        ...
        {
            public CollectedInvoiceProcDetPrvReport_NoCheck_1 MyParentReport
            {
                get { return (CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport; }
            }
...
#region PARTA HEADER_Script
                    if (((CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport).RuntimeParameters.RES == null)
            {
                ((CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport).RuntimeParameters.RESOURCEFLAG = 0;
            }
            else
            {
                ((CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport).RuntimeParameters.RESOURCEFLAG = 1;
                
                foreach (string objectID in ((CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport).RuntimeParameters.RES)
                {
                    ...
                    if (section is ResDepartment)
                    {
                        ...
                        {
                            //((CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(Pol.ObjectID.ToString());
                            foreach(ResourceSpecialityGrid polSpeciality in Pol.ResourceSpecialities)
                            {
                                if(polSpeciality.Speciality != null)
                                    ((CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(polSpeciality.Speciality.ObjectID.ToString());
                            }
                        }
                        foreach (ResClinic Cln in department.Clinics)
                        {
                            //((CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(Cln.ObjectID.ToString());
                            foreach(ResourceSpecialityGrid clnSpeciality in Cln.ResourceSpecialities)
                            {
                                if(clnSpeciality.Speciality != null)
                                    ((CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(clnSpeciality.Speciality.ObjectID.ToString());
                            }
                        }
                    ...
                    {
                        //((CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(objectID.ToString());
                        foreach(ResourceSpecialityGrid resSpeciality in section.ResourceSpecialities)
                        {
                            if(resSpeciality.Speciality != null)
                                ((CollectedInvoiceProcDetPrvReport_NoCheck_1)ParentReport).RuntimeParameters.RESOURCESFILTER.Add(resSpeciality.Speciality.ObjectID.ToString());
                        }
                    }
                }
            }
        ...
        public partial class HEADGroup : TTReportGroup
        {
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<AccountTransaction.CollectedInvoiceProcDetPreviewReportQuery1_Class>("CollectedInvoiceProcDetPreviewReportQuery1", AccountTransaction.CollectedInvoiceProcDetPreviewReportQuery1((List<string>) MyParentReport.RuntimeParameters.RESOURCESFILTER,(int)TTObjectDefManager.Instance.DataTypes["Integer"].ConvertValue(MyParentReport.RuntimeParameters.RESOURCEFLAG),(List<string>) MyParentReport.RuntimeParameters.EPISODES,(List<string>) MyParentReport.RuntimeParameters.PAYERS,(int)TTObjectDefManager.Instance.DataTypes["Integer"].ConvertValue(MyParentReport.RuntimeParameters.PATIENTSTATUS)));
            ...
            public partial class HEADGroupHeader : TTReportSection
            {
                ...
                public HEADGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    HASTATURU = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 14, 266, 18, false);
                    ...
                    EPISODE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 21, 266, 25, false);
                    ...
                    PATIENT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 27, 266, 31, false);
                    ...
                    OPENINGDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 48, 266, 52, false);
                    ...
                    QUARANTINEINPATIENTDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 54, 266, 58, false);
                    ...
                    QUARANTINEDISCHARGEDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 37, 266, 41, false);
                    ...
                    DOKTORLBL1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 126, 59, 149, 63, false);
                    ...
                    HASTADURUMU = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 226, 8, 266, 12, false);
                ...
                {
                    AccountTransaction.CollectedInvoiceProcDetPreviewReportQuery1_Class dataset_CollectedInvoiceProcDetPreviewReportQuery1 = ParentGroup.rsGroup.GetCurrentRecord<AccountTransaction.CollectedInvoiceProcDetPreviewReportQuery1_Class>(0);
                    NewField1101.CalcValue = NewField1101.Value;
                    NewField1111.CalcValue = NewField1111.Value;
                    NewField1121.CalcValue = NewField1121.Value;
                    HASTAADI.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Patientname) : "");
                    TCKIMLIKNO.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.UniqueRefNo) : "");
                    ...
                    KURUMADI.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Payername) : "");
                    HOSPITALPROTOCOLNO.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.HospitalProtocolNo) : "");
                    KURUMKODU.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Payercode) : "");
                    ICD10KOD.CalcValue = @"";
                    ICD10.CalcValue = @"";
                    TARIH1.CalcValue = @"";
                    BRANS.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Specialityname) : "");
                    HASTATIP.CalcValue = @"";
                    FATURANO.CalcValue = MyParentReport.RuntimeParameters.DOCUMENTNO.ToString();
                    CINSIYET.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Sex) : "");
                    PROVIZYONNO.CalcValue = @"";
                    HASTATURU.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.PatientStatus) : "");
                    EPISODE.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Eobjid) : "");
                    PATIENT.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Pobjid) : "");
                    TARIH2LBL.CalcValue = TARIH2LBL.Value;
                    TARIH2.CalcValue = @"";
                    OPENINGDATE.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.OpeningDate) : "");
                    QUARANTINEINPATIENTDATE.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.HospitalInPatientDate) : "");
                    NewField1411121.CalcValue = NewField1411121.Value;
                    NewField11111121.CalcValue = NewField11111121.Value;
                    EVTELEFONU.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Homephone) : "");
                    NewField1711121.CalcValue = NewField1711121.Value;
                    NewField12111121.CalcValue = NewField12111121.Value;
                    EVADRESI.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Homeaddress) : "") + @" " + (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Homecity) : "");
                    ...
                    QUARANTINEDISCHARGEDATE.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.HospitalDischargeDate) : "");
...
//
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            protected override object[] GetGroupByValues()
            {
                ...
                AccountTransaction.CollectedInvoiceProcDetPreviewReportQuery1_Class dataSet_CollectedInvoiceProcDetPreviewReportQuery1 = ParentGroup.rsGroup.GetCurrentRecord<AccountTransaction.CollectedInvoiceProcDetPreviewReportQuery1_Class>(0);    
                return new object[] {(dataSet_CollectedInvoiceProcDetPreviewReportQuery1==null ? null : dataSet_CollectedInvoiceProcDetPreviewReportQuery1.HospitalProtocolNo)};
            }
            private void onConstruct()
            {
                _header = null;
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    AccountTransaction.CollectedInvoiceProcDetPreviewReportQuery1_Class dataset_CollectedInvoiceProcDetPreviewReportQuery1 = MyParentReport.HEAD.rsGroup.GetCurrentRecord<AccountTransaction.CollectedInvoiceProcDetPreviewReportQuery1_Class>(0);
                    HIZMET.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.ExternalCode) : "") + @" " + (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Description) : "");
                    TOPLAMFIYAT.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Totalprice) : "");
                    BIRIMFIYAT.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.UnitPrice) : "");
                    ADET.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Amount) : "");
                    TOPLAMFIYAT1.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Totalprice) : "");
                    TARIH.CalcValue = (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Day) : "") + @"." + (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Month) : "") + @"." + (dataset_CollectedInvoiceProcDetPreviewReportQuery1 != null ? Globals.ToStringCore(dataset_CollectedInvoiceProcDetPreviewReportQuery1.Year) : "");
...
#region MAIN BODY_Script
        ...
        public CollectedInvoiceProcDetPrvReport_NoCheck_1()
        {
            ...
            reportParameter = Parameters.Add("PAYERS", "", "Kurum", @"", true, false, true, new Guid("8c070a29-bd8b-41e9-a888-1108a97d2419"));
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "COLLECTEDINVOICEPROCDETPRVREPORT_NOCHECK_1";
            Caption = "Hizmet Detay Bilgisi Öndökümü (Checksiz 1)";
