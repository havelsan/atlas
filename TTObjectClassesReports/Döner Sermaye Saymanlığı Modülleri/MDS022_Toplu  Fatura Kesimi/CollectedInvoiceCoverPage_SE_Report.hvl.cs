...
{
    /// <summary>
    /// Toplu Fatura Kapak Sayfası (Alt Vaka)
    /// </summary>
    public partial class CollectedInvoiceCoverPage_SE : TTReport
    {
        ...
        {
            public CollectedInvoiceCoverPage_SE MyParentReport
            {
                get { return (CollectedInvoiceCoverPage_SE)ParentReport; }
            }
        ...
        public partial class HEADGroup : TTReportGroup
        {
            ...
            public TTReportField RESOURCEOBJECTID { get {return Header().RESOURCEOBJECTID;} }
            public TTReportField TOPLAMTUTAR { get {return Header().TOPLAMTUTAR;} }
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<CollectedPatientList.CollectedInvoiceCoverPageQuery_SE_Class>("CollectedInvoiceCoverPageQuery_SE", CollectedPatientList.CollectedInvoiceCoverPageQuery_SE((string)TTObjectDefManager.Instance.DataTypes["StringGuid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class HEADGroupHeader : TTReportSection
            {
                ...
                public TTReportField RESOURCEOBJECTID;
                ...
                public HEADGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    BOLUM = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 134, 179, 146, false);
                    BOLUM.Name = "BOLUM";
                    BOLUM.FieldType = ReportFieldTypeEnum.ftVariable;
                    BOLUM.CaseFormat = CaseFormatEnum.fcUpperCase;
                    BOLUM.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    ...
                    BOLUM.TextFont.Size = 12;
                    BOLUM.TextFont.Bold = true;
                    BOLUM.TextFont.CharSet = 162;
                    BOLUM.Value = @"{#SPECIALITYCODE#}  {#SPECIALITYNAME#}";
                    ...
                    HASTASAYISI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 154, 179, 160, false);
                    ...
                    KLASORSAYISI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 186, 179, 192, false);
                    ...
                    RESOURCEOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 19, 86, 24, false);
                    RESOURCEOBJECTID.Name = "RESOURCEOBJECTID";
                    RESOURCEOBJECTID.Visible = EvetHayirEnum.ehHayir;
                    RESOURCEOBJECTID.FieldType = ReportFieldTypeEnum.ftVariable;
                    RESOURCEOBJECTID.Value = @"";

                    TOPLAMTUTAR = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 28, 170, 179, 176, false);
                    ...
                    TOPLAMTUTAR.TextFont.Size = 12;
                    TOPLAMTUTAR.TextFont.Bold = true;
                ...
                {
                    CollectedPatientList.CollectedInvoiceCoverPageQuery_SE_Class dataset_CollectedInvoiceCoverPageQuery_SE = ParentGroup.rsGroup.GetCurrentRecord<CollectedPatientList.CollectedInvoiceCoverPageQuery_SE_Class>(0);
                    BOLUM.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_SE != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_SE.Specialitycode) : "") + @"  " + (dataset_CollectedInvoiceCoverPageQuery_SE != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_SE.Specialityname) : "");
                    FATURANO.CalcValue = @"";
                    ...
                    STARTDATE.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_SE != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_SE.STARTDATE) : "");
                    ENDDATE.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_SE != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_SE.ENDDATE) : "");
                    PATIENTSTATUS.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_SE != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_SE.PATIENTSTATUS) : "");
                    EPISODECOUNT.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_SE != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_SE.Episodecount) : "");
                    TOTALPRICE.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_SE != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_SE.Totalprice) : "");
                    DOCUMENTNO.CalcValue = (dataset_CollectedInvoiceCoverPageQuery_SE != null ? Globals.ToStringCore(dataset_CollectedInvoiceCoverPageQuery_SE.DocumentNo) : "");
                    RESOURCEOBJECTID.CalcValue = @"";
                    ...
                    return new TTReportObject[] { BOLUM,FATURANO,HASTASAYISI,KLASORSAYISI,YIL,TARIHARALIGI,AYAKTANYATAN,STARTDATE,ENDDATE,PATIENTSTATUS,EPISODECOUNT,TOTALPRICE,DOCUMENTNO,RESOURCEOBJECTID,TOPLAMTUTAR,XXXXXXADI,XXXXXXKODU};
                }
...
#region HEAD HEADER_Script
            ...
            else if(PATIENTSTATUS.FormattedValue == "DAILY" || PATIENTSTATUS.FormattedValue == "DAİLY" || PATIENTSTATUS.FormattedValue == "2")
            {
                AYAKTANYATAN.CalcValue = "(GÜNÜBİRLİK)";
                HASTASAYISI.CalcValue = "(GÜNÜBİRLİK " + EPISODECOUNT.CalcValue + " HASTA)";
            }
            else
            {
            ...
            TOPLAMTUTAR.CalcValue = "Toplam Tutar : " + TOTALPRICE.FormattedValue + " TL";
            
            // Bölüm Alanına Ana Bilim Dalı Bşk. nın adı yazılır
            /*
            TTObjectContext context = new TTObjectContext(true);
            string rObjectId = RESOURCEOBJECTID.CalcValue;
            Resource res = (Resource)context.GetObject(new Guid(rObjectId),"Resource");
            
            if(res != null)
            {
                if(res is ResPoliclinic)
                {
                    if(((ResPoliclinic)res).Department != null)
                        BOLUM.CalcValue = ((ResPoliclinic)res).Department.Name;
                }
                else if(res is ResClinic)
                {
                    if(((ResClinic)res).Department != null)
                        BOLUM.CalcValue = ((ResClinic)res).Department.Name;
                }
            }
            */
        ...
        public CollectedInvoiceCoverPage_SE()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "COLLECTEDINVOICECOVERPAGE_SE";
            Caption = "Toplu Fatura Kapak Sayfası (Alt Vaka)";
