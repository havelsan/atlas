...
{
    public partial class InvoiceCollectionProceduresReport : TTReport
    {
#region Methods
   int PageNumber = 1;
        bool IsLastPage;
        ...
        {
            public InvoiceCollectionProceduresReport MyParentReport
            {
                get { return (InvoiceCollectionProceduresReport)ParentReport; }
            }
            ...
            protected override TTReportNqlDataSet GetReportNqlDataSet()
            {
                ...
                list[0] = new TTReportNqlData<InvoiceCollectionDetail.ICProceduresReportQuery_Class>("ICProceduresReportQuery", InvoiceCollectionDetail.ICProceduresReportQuery((Guid)TTObjectDefManager.Instance.DataTypes["Guid"].ConvertValue(MyParentReport.RuntimeParameters.TTOBJECTID)));
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                {
                    InvoiceCollectionDetail.ICProceduresReportQuery_Class dataset_ICProceduresReportQuery = ParentGroup.rsGroup.GetCurrentRecord<InvoiceCollectionDetail.ICProceduresReportQuery_Class>(0);
                    PIDOBJECTID.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.Pidobjectid) : "");
...
#region PARTA HEADER_Script
        ...
        public partial class HEADGroup : TTReportGroup
        {
            ...
            public partial class HEADGroupHeader : TTReportSection
            {
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    InvoiceCollectionDetail.ICProceduresReportQuery_Class dataset_ICProceduresReportQuery = MyParentReport.PARTA.rsGroup.GetCurrentRecord<InvoiceCollectionDetail.ICProceduresReportQuery_Class>(0);
                    KURUM.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.Payercode) : "") + @" " + (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.Payername) : "");
                    ADSOYAD.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.Patientname) : "");
                    PROTOKOLNO.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.Episodeid) : "");
                    FATURATARIHI.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.Invoicedate) : "");
                    FATURANO.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.Invoiceno) : "");
                    TANI.CalcValue = @"";
                    PAGENO.CalcValue = @"";
                    ...
                    SICILNO.CalcValue = @"";
                    KARNENO.CalcValue = @"";
                    TCKIMLIKNO.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.UniqueRefNo) : "");
                    MURACAATTARIHI.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.OpeningDate) : "");
                    DOGUMTARIHIYASI.CalcValue = @"";
                    PROVIZYONNO.CalcValue = @"";
                    GSSTAKIPNO.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.Medulatakipno) : "");
                    ...
                    EPISODEOBJECTID.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.Episodeobjectid) : "");
                    PIDOBJECTID.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.Pidobjectid) : "");
                    HOMEADDRESS.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.HomeAddress) : "");
                    HOMETOWN.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.HomeTown) : "");
                    HOMECITY.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.HomeCity) : "");
                    HOMEPHONE.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.HomePhone) : "");
                    MOBILEPHONE.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.MobilePhone) : "");
                    BUSINESSPHONE.CalcValue = (dataset_ICProceduresReportQuery != null ? Globals.ToStringCore(dataset_ICProceduresReportQuery.BusinessPhone) : "");
...
#region MAIN_Script
        ...
        public InvoiceCollectionProceduresReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "INVOICECOLLECTIONPROCEDURESREPORT";
            Caption = "Açıklamalı Hizmet Detay Belgesi (Atılış Sırası)";
