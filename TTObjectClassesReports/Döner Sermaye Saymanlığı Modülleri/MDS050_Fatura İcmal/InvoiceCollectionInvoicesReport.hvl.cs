...
namespace TTReportClasses
{
    ...
    /// İcmal Faturaları
    /// </summary>
    public partial class InvoiceCollectionInvoicesReport : TTReport
    {
#region Methods
   int PageNumber = 1;
        ...
        {
            public InvoiceCollectionInvoicesReport MyParentReport
            {
                get { return (InvoiceCollectionInvoicesReport)ParentReport; }
            }
...
";
                    ...
                    PIDOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 229, 33, 254, 38, false);
                    PIDOBJECTID.Name = "PIDOBJECTID";
                    PIDOBJECTID.Visible = EvetHayirEnum.ehHayir;
                    PIDOBJECTID.FieldType = ReportFieldTypeEnum.ftVariable;
                    PIDOBJECTID.TextFont.Name = "Arial Narrow";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    InvoiceCollectionDetail.InvoiceCollectionListReportNQL_Class dataset_InvoiceCollectionListReportNQL = MyParentReport.PARTA.rsGroup.GetCurrentRecord<InvoiceCollectionDetail.InvoiceCollectionListReportNQL_Class>(0);
...
;
                    ...
                    return new TTReportObject[] { SEVKTARIHI,PAYER,PATIENTNAME,HPROTNO,DOCUMENTDATE,DOCUMENTNO,ICD10,TAXOFFICE,TAXNUMBER,TURNOVERTOTALLABEL,TURNOVERTOTAL,PAGENO,ICD10CODE,CASHIERNAME,CASHIERTITLE,CASHIERRECID,INVOICELABEL,MAPULKE,SEVKNO,PIDOBJECTID,TAXINFO,BANKACCOUNT,HOSPITALIBANNO,SIGNATUREBLOCK};
                }
...
//
            ...
            this.PAGENO2.CalcValue = MyParentReport.PageNumber + ". SAYFA";
        ...
        public partial class TRXDESCGroup : TTReportGroup
        {
            ...
            public partial class TRXDESCGroupHeader : TTReportSection
            {
                ...
                public TRXDESCGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PIDOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 225, 0, 250, 4, false);
                    PIDOBJECTID.Name = "PIDOBJECTID";
                    PIDOBJECTID.Visible = EvetHayirEnum.ehHayir;
                    PIDOBJECTID.FieldType = ReportFieldTypeEnum.ftVariable;
                    PIDOBJECTID.TextFont.Name = "Arial Narrow";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    PIDOBJECTID.CalcValue = (dataset_InvoiceCollectionListReportNQL != null ? Globals.ToStringCore(dataset_InvoiceCollectionListReportNQL.Pidobjectid) : "");
                    return new TTReportObject[] { BUTCODE,PIDOBJECTID};
                }
            }
...
#region MAIN_Script
        ...
        public InvoiceCollectionInvoicesReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "INVOICECOLLECTIONINVOICESREPORT";
            Caption = "İcmal Faturaları";
