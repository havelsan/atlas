...
{
    /// <summary>
    /// Piyasa İlaç İhtiyaç Bildirim Formu Hazırlama Tablosu
    /// </summary>
    public partial class MarketDrugIBFReport : TTReport
    {
        ...
        {
            public MarketDrugIBFReport MyParentReport
            {
                get { return (MarketDrugIBFReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    MILITARYUNIT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 52, 15, 120, 23, false);
                    ...
                    TOTALMATERIAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 51, 23, 121, 31, false);
                    ...
                    REPORTNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 31, 121, 41, false);
                    ...
                    REPORTNAME.Value = @".... YILI MÜSTAHZAR İLAÇ İHTİYAÇ BİLDİRİM FORMU
HAZIRLAMA TABLOSU";
...
NUMARASI";
                    ...
                    NewField1212 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 46, 41, 82, 49, false);
                    ...
                    NewField1213 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 81, 41, 98, 49, false);
...
ŞEKLİ";
                    ...
                    NewField13121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 98, 41, 121, 49, false);
                    ...
                    NewField13121.Value = @"FARMAKOLOJİK
ETKİSİ";

                    YEAR0 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 121, 15, 135, 49, false);
                    YEAR0.Name = "YEAR0";
...
(ADET)";
                    ...
                    NewField122131 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 135, 15, 150, 49, false);
...
(ADET)";
                    ...
                    YEAR1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 150, 15, 164, 49, false);
                    YEAR1.Name = "YEAR1";
...
MİKTARI";
                    ...
                    NewField122133 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 164, 15, 181, 49, false);
...
MAL SORUMLULARI";
                    ...
                    NewLine2 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 51, 15, 121, 15, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { MILITARYUNIT,NewField1,TOTALMATERIAL,NewField11,REPORTNAME,NewField112,NewField1211,NewField1212,NewField1213,NewField13121,YEAR0,NewField122131,YEAR1,NewField122133,NewField1231221,NewField11221321,NewField1331221,NewField11221331,NewField1214,NewField14121,NewField14122};
                }
...
#region PARTA HEADER_Script
            ...
            if(purchaseAction is IBFDemand)
            {
                ...
                REPORTNAME.CalcValue = ibfDemand.IBFYear.ToString() + " YILI MÜSTAHZAR İLAÇ İHTİYAÇ BİLDİRİM FORMU\nHAZIRLAMA TABLOSU";
            ...
            else if(purchaseAction is AnnualRequirement)
            {
                ...
                REPORTNAME.CalcValue = ibf.IBFYear.ToString() + " YILI MÜSTAHZAR İLAÇ İHTİYAÇ BİLDİRİM FORMU\nHAZIRLAMA TABLOSU";
            ...
            else if(purchaseAction is LBPurchaseProject)
            {
                ...
                REPORTNAME.CalcValue = lbPurchase.IBFYear.ToString() + " YILI MÜSTAHZAR İLAÇ İHTİYAÇ BİLDİRİM FORMU\nHAZIRLAMA TABLOSU";
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public TTReportField PHARMACOLOGICALEFFECT { get {return Body().PHARMACOLOGICALEFFECT;} }
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public TTReportField PHARMACOLOGICALEFFECT;
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REQUESTAMOUNTBOX = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 195, 0, 209, 8, false);
                    ...
                    REQUESTAMOUNTBOX.TextFont.Size = 8;
                    REQUESTAMOUNTBOX.TextFont.CharSet = 162;
                    REQUESTAMOUNTBOX.Value = @"";

                    DESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 164, 0, 181, 8, false);
                    ...
                    LASTIBFREQUESTAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 150, 0, 164, 8, false);
                    ...
                    LASTIBFREQUESTAMOUNT.TextFont.Size = 8;
                    ...
                    CONSUMPTIONAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 121, 0, 135, 8, false);
                    ...
                    STOCK = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 135, 0, 150, 8, false);
                    STOCK.Name = "STOCK";
                    ...
                    STOCK.TextFont.Size = 8;
                    STOCK.TextFont.CharSet = 162;
                    STOCK.Value = @"{#STORESTOCKS!GetIBFDetailInQuery#}";
                    ...
                    MATERIAL = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 47, 0, 80, 8, false);
                    ...
                    DISTRIBUTIONTYPE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 81, 0, 98, 8, false);
                    ...
                    PHARMACOLOGICALEFFECT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 98, 0, 121, 8, false);
                    PHARMACOLOGICALEFFECT.Name = "PHARMACOLOGICALEFFECT";
                    PHARMACOLOGICALEFFECT.FieldType = ReportFieldTypeEnum.ftVariable;
                    PHARMACOLOGICALEFFECT.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    PHARMACOLOGICALEFFECT.VertAlign = VerticalAlignmentEnum.vaMiddle;
                    PHARMACOLOGICALEFFECT.MultiLine = EvetHayirEnum.ehEvet;
                    PHARMACOLOGICALEFFECT.WordBreak = EvetHayirEnum.ehEvet;
                    PHARMACOLOGICALEFFECT.TextFont.Name = "Arial";
                    PHARMACOLOGICALEFFECT.TextFont.Size = 8;
                    PHARMACOLOGICALEFFECT.TextFont.CharSet = 162;
                    PHARMACOLOGICALEFFECT.Value = @"";

                    REQUESTAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 181, 0, 195, 8, false);
                    ...
                    NewLine13 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 81, 0, 81, 8, false);
                    NewLine13.Name = "NewLine13";
                    NewLine13.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine13.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine14 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 98, 0, 98, 8, false);
                    NewLine14.Name = "NewLine14";
                    NewLine14.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine14.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine15 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 121, 0, 121, 8, false);
                    NewLine15.Name = "NewLine15";
                    NewLine15.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine15.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine16 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 135, 0, 135, 8, false);
                    NewLine16.Name = "NewLine16";
                    NewLine16.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine16.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine17 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 150, 0, 150, 8, false);
                    NewLine17.Name = "NewLine17";
                    NewLine17.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine17.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine18 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 164, 0, 164, 8, false);
                    NewLine18.Name = "NewLine18";
                    NewLine18.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine18.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine19 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 181, 0, 181, 8, false);
                    NewLine19.Name = "NewLine19";
                    NewLine19.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine19.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine20 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 195, 0, 195, 8, false);
                    NewLine20.Name = "NewLine20";
                    NewLine20.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine20.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine21 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 209, 0, 209, 8, false);
                    NewLine21.Name = "NewLine21";
                    NewLine21.DrawStyle = DrawStyleConstants.vbSolid;
                    NewLine21.ExtendTo = ExtendToEnum.extPageHeight;

                    NewLine22 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 226, 0, 226, 8, false);
                    ...
                    DETAILOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 306, 0, 331, 5, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    STOCK.CalcValue = (dataset_GetIBFDetailInQuery != null ? Globals.ToStringCore(dataset_GetIBFDetailInQuery.StoreStocks) : "");
                    ...
                    PHARMACOLOGICALEFFECT.CalcValue = @"";
                    ...
                    return new TTReportObject[] { REQUESTAMOUNTBOX,DESCRIPTION,LASTIBFREQUESTAMOUNT,CONSUMPTIONAMOUNT,STOCK,COUNT,NSN,MATERIAL,DISTRIBUTIONTYPE,PHARMACOLOGICALEFFECT,REQUESTAMOUNT,DETAILOBJECTID};
                }
...
#region MAIN BODY_Script
                    if(DETAILOBJECTID.CalcValue != "")
            {
                ...
                {
                    IBFDemand ibfDemand = (IBFDemand)purchaseAction;
                    IBFDet_MarketDrugIn marketDrug = (IBFDet_MarketDrugIn)MyParentReport.ReportObjectContext.GetObject(new Guid(DETAILOBJECTID.CalcValue), typeof(IBFDet_MarketDrugIn));
                    if(ibfDemand.CurrentStateDefID == IBFDemand.States.New || ibfDemand.CurrentStateDefID == IBFDemand.States.ClinicApproval)
                    {
                        if(marketDrug.ClinicApprovedAmount == null)
                            REQUESTAMOUNT.CalcValue = marketDrug.RequestAmount.ToString();
                        else
                            REQUESTAMOUNT.CalcValue = marketDrug.ClinicApprovedAmount.ToString();
                    }
                        ...
                        REQUESTAMOUNT.CalcValue = marketDrug.Amount.ToString();
                    
                    PHARMACOLOGICALEFFECT.CalcValue = marketDrug.PharmacologicalEffect;
                    REQUESTAMOUNTBOX.CalcValue = marketDrug.RequestAmountBox.ToString();
                    
                }
                else if(purchaseAction is AnnualRequirement)
                {
                    AnnualRequirement ibf = (AnnualRequirement)purchaseAction;
                    ARD_MarketDrugIn marketDrug = (ARD_MarketDrugIn)MyParentReport.ReportObjectContext.GetObject(new Guid(DETAILOBJECTID.CalcValue), typeof(ARD_MarketDrugIn));
                    ...
                    {                        
                        if(marketDrug.ACC_ApproveAmount == null)
                            REQUESTAMOUNT.CalcValue = marketDrug.RequestAmount.ToString();
                        else
                            REQUESTAMOUNT.CalcValue = marketDrug.ACC_ApproveAmount.ToString();
                    }
                        ...
                        REQUESTAMOUNT.CalcValue = marketDrug.LD_ApproveAmount.ToString();
                    
                    else
                        REQUESTAMOUNT.CalcValue = marketDrug.LB_ApproveAmount.ToString();
                ...
                {
                    LBD_MarketDrugIn marketDrug = (LBD_MarketDrugIn)MyParentReport.ReportObjectContext.GetObject(new Guid(DETAILOBJECTID.CalcValue), typeof(LBD_MarketDrugIn));
                    PHARMACOLOGICALEFFECT.CalcValue = marketDrug.PharmacologicalEffect;
                    REQUESTAMOUNTBOX.CalcValue = marketDrug.RequestAmountBox.ToString();
                }
            }
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "MARKETDRUGIBFREPORT";
            Caption = "Piyasa İlaç İhtiyaç Bildirim Formu Hazırlama Tablosu";
