...
{
    /// <summary>
    /// İptal Edilen İhale Kararı_KİK033.0/M
    /// </summary>
    public partial class IptalEdilenIhaleKarari : TTReport
    {
        ...
        {
            public IptalEdilenIhaleKarari MyParentReport
            {
                get { return (IptalEdilenIhaleKarari)ParentReport; }
            }
...
#region PARTA FOOTER_Script
                    string objectID = ((IptalEdilenIhaleKarari)ParentReport).RuntimeParameters.TTOBJECTID.ToString();
        ...
        public partial class PARTBGroup : TTReportGroup
        {
            ...
            public TTReportField PROJECTCANCELDESCRIPTION { get {return Header().PROJECTCANCELDESCRIPTION;} }
            public TTReportField XXXXXXBASLIK { get {return Header().XXXXXXBASLIK;} }
            public TTReportField LOGO10 { get {return Header().LOGO10;} }
            ...
            public TTReportField NewField1113311 { get {return Footer().NewField1113311;} }
            ...
            public partial class PARTBGroupHeader : TTReportSection
            {
                ...
                public TTReportField PROJECTCANCELDESCRIPTION;
                public TTReportField XXXXXXBASLIK;
                public TTReportField LOGO10;
                ...
                public PARTBGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    PROJECTNO3.Value = @"İptal edilen ihale kararı";
                    ...
                    PROJECTNO9.Value = @"___/___/______ tarihinde ......... sıra numarası ile kayda alınan teklifiniz.";
                    ...
                    ACTDEFINE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 212, 74, 237, 79, false);
                    ...
                    PROJECTCANCELDESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 212, 66, 237, 71, false);
                    PROJECTCANCELDESCRIPTION.Name = "PROJECTCANCELDESCRIPTION";
                    PROJECTCANCELDESCRIPTION.Visible = EvetHayirEnum.ehHayir;
                    PROJECTCANCELDESCRIPTION.FieldType = ReportFieldTypeEnum.ftVariable;
                    PROJECTCANCELDESCRIPTION.Value = @"{#PROJECTCANCELDESCRIPTION#}";
                    ...
                    LOGO10 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 15, 40, 35, false);
                    LOGO10.Name = "LOGO10";
                    LOGO10.Visible = EvetHayirEnum.ehHayir;
                    LOGO10.TextFont.CharSet = 1;
                    LOGO10.Value = @"LOGO";
                    ...
                    PROPOSALOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 212, 90, 237, 95, false);
                    ...
                    TTOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 212, 82, 237, 87, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    PROJECTNO9.CalcValue = PROJECTNO9.Value;
                    ...
                    PROJECTCANCELDESCRIPTION.CalcValue = (dataset_GetProposalledFirms != null ? Globals.ToStringCore(dataset_GetProposalledFirms.ProjectCancelDescription) : "");
                    LOGO10.CalcValue = LOGO10.Value;
                    ...
                    return new TTReportObject[] { NewField2,NewField,NewField3,NewField4,KIKTENDERREGISTERNO,NewField5,NewField6,PROJECTNO3,NewField7,NewField8,TENDERDATE,PROJECTNO4,PROJECTNO5,ORDERNO,PROJECTNO9,NewField17,NewField18,PROJECTCANCELDATE,ACTDEFINE,PROJECTCANCELDESCRIPTION,LOGO10,SUPPLIERADDRESS,PROPOSALOBJECTID,TTOBJECTID,XXXXXXBASLIK,SUPPLIER};
                }
...
#region PARTB HEADER_Script
            ...
            public partial class PARTBGroupFooter : TTReportSection
            {
                ...
                public TTReportField NewField1113311;
                ...
                public PARTBGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1113311 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 103, 5, 170, 10, false);
                    NewField1113311.Name = "NewField1113311";
                    NewField1113311.CaseFormat = CaseFormatEnum.fcUpperCase;
                    NewField1113311.HorzAlign = HorizontalAlignmentEnum.haCenter;
                    NewField1113311.TextFont.Name = "Arial";
                    NewField1113311.Value = @"İdare Yetkilisi";
                ...
                {
                    Proposal.GetProposalledFirms_Class dataset_GetProposalledFirms = ParentGroup.rsGroup.GetCurrentRecord<Proposal.GetProposalledFirms_Class>(0);
                    NewField1113311.CalcValue = NewField1113311.Value;
                    ...
                    return new TTReportObject[] { NewField1113311,TITLE,DELIVEREDBYDUTY,NAME,RANK,DELIVEREDBYNAME};
                }
            }
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DESC.Value = @"""   "" + {%PARTB.ACTDEFINE%} + "" işine ait ihale, ihale yetkilisi tarafından "" + {%PARTB.PROJECTCANCELDESCRIPTION%} + "" nedeniyle iptal edilmiştir.\n\n       Bu mektubun elden tebliğ edilmesi halinde aynı gün, postayla gönderilmesi halinde postaya verildiği tarihi izleyen yedinci (7) gün kararın tarafınıza tebliğ edildiği tarih sayılacaktır. Tebliğ tarihinden itibaren beş (5) gün içinde yazılı talepte bulunmanız halinde, ihale kararının iptal edilme gerekçeleri daha ayrıntılı olarak tarafınıza bildirilecektirç 4734 sayılı Kamu İhale Kanununun 41 inci maddesi hükmüne göre bilgi edinilmesi hususunu rica ederim.""";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    DESC.CalcValue = "   " + MyParentReport.PARTB.ACTDEFINE.CalcValue + " işine ait ihale, ihale yetkilisi tarafından " + MyParentReport.PARTB.PROJECTCANCELDESCRIPTION.CalcValue + " nedeniyle iptal edilmiştir.\n\n       Bu mektubun elden tebliğ edilmesi halinde aynı gün, postayla gönderilmesi halinde postaya verildiği tarihi izleyen yedinci (7) gün kararın tarafınıza tebliğ edildiği tarih sayılacaktır. Tebliğ tarihinden itibaren beş (5) gün içinde yazılı talepte bulunmanız halinde, ihale kararının iptal edilme gerekçeleri daha ayrıntılı olarak tarafınıza bildirilecektirç 4734 sayılı Kamu İhale Kanununun 41 inci maddesi hükmüne göre bilgi edinilmesi hususunu rica ederim.";
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "IPTALEDILENIHALEKARARI";
            Caption = "İptal Edilen İhale Kararı";
