...
{
    public partial class ChattelDocumentInDetailReport : TTReport
    {
        ...
        {
            public ChattelDocumentInDetailReport MyParentReport
            {
                get { return (ChattelDocumentInDetailReport)ParentReport; }
            }
            ...
            public partial class PARTCGroupHeader : TTReportSection
            {
                ...
                public PARTCGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    STOCKACTIONOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 167, 3, 192, 8, false);
            ...
            public partial class PARTCGroupFooter : TTReportSection
            {
                ...
                public PARTCGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DESCRIPTIONBOTTOMLEFT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 11, 0, 104, 33, false);
                    ...
                    DESCRIPTIONBOTTOMRIGHT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 106, 0, 199, 33, false);
...
#region PARTA HEADER_Script
                    if (MyParentReport.RuntimeParameters.TTOBJECTID.HasValue)
            {
                ...
                if (string.IsNullOrEmpty(MyParentReport.PARTC.STOCKACTIONOBJECTID.CalcValue) == false && Globals.IsGuid(MyParentReport.PARTC.STOCKACTIONOBJECTID.CalcValue))
                {
                    ...
                    if (stockAction is IChattelDocumentWithPurchase)
                    {
                        ...
                        TESLIMEDENFIRMA.CalcValue = chattelDocumentWithPurchase.GetSupplier().GetName();
                        ...
                        //IDARESI.CalcValue = chattelDocumentWithPurchase.AccountingTerm.Accountancy.AccountancyMilitaryUnit.Name;
                        //IDARESIKODU.CalcValue = chattelDocumentWithPurchase.AccountingTerm.Accountancy.AccountancyMilitaryUnit.Code;
                        //HARCAMABIRIMI.CalcValue = chattelDocumentWithPurchase.SpendingUnit.ToString();
                        //HARCAMABIRIMIKODU.CalcValue = chattelDocumentWithPurchase.SpendingUnitCode.ToString();
                        //CONCLUSIONDATETIMENUMBER.CalcValue = chattelDocumentWithPurchase.ExaminationReportDate.Value.ToShortDateString() + "-" + chattelDocumentWithPurchase.ExaminationReportNo.ToString();
                    }
                    if (stockAction is IChattelDocumentInputWithAccountancy)
                    {
                        IChattelDocumentInputWithAccountancy chattelDocumentInputWithAccountancy = (IChattelDocumentInputWithAccountancy)stockAction;
                        DEPOSUAMBARI.CalcValue = chattelDocumentInputWithAccountancy.GetStore().GetName();
                        DEPOSUAMBARIKODU.CalcValue = chattelDocumentInputWithAccountancy.GetStore().GetQREF();
                        TESLIMEDENFIRMA.CalcValue = chattelDocumentInputWithAccountancy.GetAccountancy().GetName();
                        TESLIMEDENFIRMAKODU.CalcValue = chattelDocumentInputWithAccountancy.GetAccountancy().GetAccountancyNO();
                        //IDARESI.CalcValue = chattelDocumentInputWithAccountancy.AccountingTerm.Accountancy.AccountancyMilitaryUnit.Name;
                        //IDARESIKODU.CalcValue = chattelDocumentInputWithAccountancy.AccountingTerm.Accountancy.AccountancyMilitaryUnit.Code;
                        //HARCAMABIRIMI.CalcValue = chattelDocumentInputWithAccountancy.SpendingUnit.ToString();
                        //HARCAMABIRIMIKODU.CalcValue = chattelDocumentInputWithAccountancy.SpendingUnitCode.ToString();
                    }
                    if (stockAction is IReturningDocument)
                    {
                        IReturningDocument returningDocument = (IReturningDocument)stockAction;
                        DEPOSUAMBARI.CalcValue = returningDocument.GetDestinationStore().GetName();
                        DEPOSUAMBARIKODU.CalcValue = returningDocument.GetDestinationStore().GetQREF();
                        //IDARESI.CalcValue = returningDocument.AccountingTerm.Accountancy.AccountancyMilitaryUnit.Name;
                        //IDARESIKODU.CalcValue = returningDocument.AccountingTerm.Accountancy.AccountancyMilitaryUnit.Code;
                        //HARCAMABIRIMI.CalcValue = returningDocument.AccountingTerm.Accountancy.Name;
                        //HARCAMABIRIMIKODU.CalcValue = returningDocument.AccountingTerm.Accountancy.AccountancyNO;
                    }
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField1111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 5, 200, 16, false);
                    ...
                    DESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 22, 5, 199, 15, false);
...
#region PARTA FOOTER_Script
                    if (MyParentReport.RuntimeParameters.TTOBJECTID.HasValue)
            {
                ...
                if (string.IsNullOrEmpty(MyParentReport.PARTC.STOCKACTIONOBJECTID.CalcValue) == false && Globals.IsGuid(MyParentReport.PARTC.STOCKACTIONOBJECTID.CalcValue))
                {
                    ...
                    foreach (StockActionSignDetail stockActionSignDetail in stockAction.StockActionSignDetails)
                    {
                        ...
                        switch (stockActionSignDetail.SignUserType)
                        {
                            case SignUserTypeEnum.HesapSorumlusu:
                                this.SIGNTOPLEFTS.CalcValue = unvan + vekil + "\r\n" + signDesc;
                                this.SIGNTOPRIGHTS.CalcValue = unvan;
                                break;
                            case SignUserTypeEnum.MalSorumlusu:
                                this.SIGNTOPLEFTM.CalcValue = unvan + vekil + "\r\n" + signDesc;
                                this.SIGNTOPRIGHTM.CalcValue = unvan;
                                break;
                            case SignUserTypeEnum.MalSaymani:
                                this.SIGNTOPLEFTE.CalcValue = unvan + vekil + "\r\n" + signDesc;
                                this.SIGNTOPRIGHTE.CalcValue = unvan;
                                break;
                            default:
                                break;
                        }
                    ...
                    message = "Yukarıda gösterilen " + documentRecordLog.NumberOfRows + " kalem, toplam " + amount + " taşınırın GİRİŞ KAYDI YAPILMIŞTIR.\r\n";
                    message += "                                            " + documentRecordLog.DocumentDateTime.Value.ToString("dd.MM.yyyy");
                    DESCRIPTIONTOPLEFT.CalcValue = message;

                    message = "Yukarıda gösterilen ..... kalem, toplam ..... taşınırın ÇIKIŞ KAYDI YAPILMIŞTIR.\r\n";
                    message += "                                      ..../..../20....\r\n";
...
Sıra Nu.";
                    ...
                    NewField111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 9, 124, 27, false);
                    ...
                    NewField111112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 124, 9, 139, 27, false);
...
Birimi";
                    ...
                    NewField111113 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 139, 9, 159, 27, false);
                    ...
                    NewField1311111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 159, 9, 177, 27, false);
                    ...
                    NewField1311112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 177, 9, 200, 27, false);
...
#region PARTB FOOTER_Script
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    MATERIALDESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 0, 124, 5, false);
                    ...
                    DISTRIBUTIONTYPE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 124, 0, 139, 5, false);
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 139, 0, 159, 5, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    UNITPRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 159, 0, 177, 5, false);
                    ...
                    PRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 177, 0, 200, 5, false);
                    PRICE.Name = "PRICE";
        ...
        public ChattelDocumentInDetailReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CHATTELDOCUMENTINDETAILREPORT";
