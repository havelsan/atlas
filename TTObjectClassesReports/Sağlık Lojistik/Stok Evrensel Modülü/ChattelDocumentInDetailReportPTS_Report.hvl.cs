...
{
    public partial class ChattelDocumentInDetailReportPTS : TTReport
    {
#region Methods
   public double prices=0.0;
        ...
        {
            public ChattelDocumentInDetailReportPTS MyParentReport
            {
                get { return (ChattelDocumentInDetailReportPTS)ParentReport; }
            }
            ...
            public partial class PARTCGroupHeader : TTReportSection
            {
                ...
                public PARTCGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    STOCKACTIONOBJECTID = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 175, 4, 200, 9, false);
        ...
        public partial class PARTAGroup : TTReportGroup
        {
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DOCUMENTTRANSACTIONTYPEVALUE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 220, 7, 312, 12, false);
...
#region PARTA HEADER_Script
                    if (MyParentReport.RuntimeParameters.TTOBJECTID.HasValue)
            {
                ...
                Guid stockActionObjectID =documentRecordLog.StockAction.ObjectID;
                    //new Guid(MyParentReport.PARTC.STOCKACTIONOBJECTID.CalcValue);
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    SUMOFPRICE.FieldType = ReportFieldTypeEnum.ftExpression;
...
#region PARTA FOOTER_Script
                    if (MyParentReport.RuntimeParameters.TTOBJECTID.HasValue)
            {
                SUMOFPRICE.CalcValue = this.MyParentReport.prices.ToString();
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    VATRATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 218, 1, 243, 6, false);
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    return new TTReportObject[] { ORDERNO,NATOSTOCKNO,MATERIALDESCRIPTION,DISTRIBUTIONTYPE,AMOUNT,UNITPRICE,PRICE,VATRATE};
                }
...
//
            ...
            PRICE.CalcValue = pricexx.ToString();
            this.MyParentReport.prices += Convert.ToDouble(pricexx.ToString());
            
            /*  DocumentRecordLog documentRecordLog = (DocumentRecordLog)MyParentReport.ReportObjectContext.GetObject(MyParentReport.RuntimeParameters.TTOBJECTID.Value, typeof(DocumentRecordLog));
            Guid stockActionObjectID =documentRecordLog.StockAction.ObjectID;
            StockActionDetailIn stockAction = (StockActionDetailIn)MyParentReport.ReportObjectContext.GetObject(stockActionObjectID, typeof(StockActionDetailIn));
            UNITPRICE.CalcValue = stockAction.UnitPrice.ToString();
            PRICE.CalcValue = stockAction.Price.ToString();*/
        ...
        public ChattelDocumentInDetailReportPTS()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "CHATTELDOCUMENTINDETAILREPORTPTS";
            Caption = "PTS Taşınır Mal Giriş Fişi";
