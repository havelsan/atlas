...
namespace TTReportClasses
{
    ...
    /// </summary>
    public partial class ProductionConsumptionDocumentReport : TTReport
    {
        ...
        {
            public ProductionConsumptionDocumentReport MyParentReport
            {
                get { return (ProductionConsumptionDocumentReport)ParentReport; }
            }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    REGISTRATIONNUMBER = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 260, 30, 292, 36, false);
                    ...
                    NewField16111231 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 229, 24, 260, 30, false);
                    ...
                    TRANSACTIONDATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 260, 24, 292, 30, false);
                    ...
                    NewField113211161 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 229, 30, 260, 36, false);
                    ...
                    NewField113211162 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 24, 70, 36, false);
                    ...
                    SIPARISADIVENUMARASI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 70, 24, 229, 36, false);
...
#region PARTA HEADER_Script
            ...
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    DESC1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 15, 0, 292, 32, false);
                    DESC1.Name = "DESC1";
                    ...
                    IMZA1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 17, 8, 52, 29, false);
                    IMZA1.Name = "IMZA1";
                    ...
                    IMZA2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 96, 8, 131, 29, false);
                    IMZA2.Name = "IMZA2";
                    ...
                    IMZA3 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 136, 8, 171, 29, false);
                    IMZA3.Name = "IMZA3";
                    ...
                    IMZA4 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 176, 8, 211, 29, false);
                    IMZA4.Name = "IMZA4";
                    ...
                    IMZA5 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 215, 8, 250, 29, false);
                    IMZA5.Name = "IMZA5";
                    ...
                    IMZA6 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 255, 8, 290, 29, false);
                    IMZA6.Name = "IMZA6";
                    ...
                    MALSAYMANI = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 56, 8, 91, 29, false);
                    ...
                    DESCLEFT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 18, 1, 289, 6, false);
...
S. Nu.";
                    ...
                    NewField111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 22, 6, 40, 23, false);
                    ...
                    NewField1111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 40, 6, 97, 23, false);
...
Taşınır Malın Cins ve Özellikleri";
                    ...
                    NewField1111112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 97, 6, 112, 23, false);
                    ...
                    NewField12111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 142, 6, 157, 23, false);
                    ...
                    NewField11111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 112, 6, 127, 23, false);
...
Ölçü Birimi";
                    ...
                    NewField111111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 127, 6, 142, 23, false);
...
Birim Fiyatı";
                    ...
                    NewField1111113 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 157, 6, 175, 23, false);
                    ...
                    NewField11111112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 175, 6, 232, 23, false);
...
Taşınır Malın Cins ve Özellikleri";
                    ...
                    NewField12111112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 232, 6, 247, 23, false);
                    ...
                    NewField111111121 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 277, 6, 292, 23, false);
                    ...
                    NewField111111112 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 247, 6, 262, 23, false);
...
Ölçü Birimi";
                    ...
                    NewField1111111111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 262, 6, 277, 23, false);
...
#region PARTB FOOTER_Script
                    if (MyParentReport.RuntimeParameters.TTOBJECTID.HasValue)
                    {
                        ...
                        string closer = "/////////////////////////////////////////////////////////////////////////////////////////////////////////";
                        if (productionConsumptionDocument.ProductionConsumptionDocumentOutMaterials.Count > 0)
                        {
                            int outItemCount = productionConsumptionDocument.ProductionConsumptionDocumentOutMaterials.Count;
                        ...
                        if (productionConsumptionDocument.ProductionConsumptionDocumentInMaterials.Count > 0)
                        {
                            int inItemCount = productionConsumptionDocument.ProductionConsumptionDocumentInMaterials.Count;
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    CONSUMPTIONDISTRIBUTIONTYPE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 112, 0, 127, 5, false);
                    ...
                    UNITPRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 262, 0, 277, 5, false);
                    ...
                    AMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 232, 0, 247, 5, false);
                    AMOUNT.Name = "AMOUNT";
                    ...
                    DISTRIBUTIONTYPE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 247, 0, 262, 5, false);
                    ...
                    MATERIALDESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 175, 0, 232, 5, false);
                    ...
                    CONSUMPTIONMATERIALDESCRIPTION = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 40, 0, 97, 5, false);
                    ...
                    CONSUMPTIONAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 97, 0, 112, 5, false);
                    ...
                    CONSUMPTIONMATERIALNATOSTOCKNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 22, 0, 40, 5, false);
                    ...
                    OUTUNITPRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 127, 0, 142, 5, false);
                    ...
                    OUTPRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 142, 0, 157, 5, false);
                    ...
                    MATERIALNATOSTOCKNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 157, 0, 175, 5, false);
                    ...
                    PRICE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 277, 0, 292, 5, false);
                    PRICE.Name = "PRICE";
...
#region MAIN BODY_Script
        ...
        public ProductionConsumptionDocumentReport()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "PRODUCTIONCONSUMPTIONDOCUMENTREPORT";
            Caption = "Tüketim, Üretim ve Elde Edilenler Belgesi";
