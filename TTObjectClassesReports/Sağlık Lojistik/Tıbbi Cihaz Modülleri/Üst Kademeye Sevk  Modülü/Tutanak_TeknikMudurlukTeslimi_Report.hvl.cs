...
{
    /// <summary>
    /// Tutanaktır(Teknik Müdürlük Birimine Teslim)
    /// </summary>
    public partial class Tutanak_TeknikMudurlukTeslimi : TTReport
    {
        ...
        {
            public Tutanak_TeknikMudurlukTeslimi MyParentReport
            {
                get { return (Tutanak_TeknikMudurlukTeslimi)ParentReport; }
            }
            ...
            public TTReportShape NewLine1131 { get {return Footer().NewLine1131;} }
            ...
            public TTReportShape NewLine1171 { get {return Footer().NewLine1171;} }
            public TTReportShape NewLine1181 { get {return Footer().NewLine1181;} }
            ...
            public partial class PARTAGroupHeader : TTReportSection
            {
                ...
                public PARTAGroupHeader(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NewField12 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 25, 40, 30, false);
                    ...
                    NewField132 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 40, 25, 41, 30, false);
                    ...
                    MILITARYUNIT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 41, 15, 149, 25, false);
                    MILITARYUNIT.Name = "MILITARYUNIT";
                    MILITARYUNIT.FieldType = ReportFieldTypeEnum.ftVariable;
                    MILITARYUNIT.HorzAlign = HorizontalAlignmentEnum.haleft;
                    ...
                    MATERIALNAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 41, 25, 190, 30, false);
                    ...
                    NewField2 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 36, 8, 46, false);
                    ...
                    NewField14 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 8, 36, 36, 46, false);
                    NewField14.Name = "NewField14";
                    NewField14.DrawStyle = DrawStyleConstants.vbSolid;
                    NewField14.TextFont.Bold = true;
                    NewField14.Value = @"NATO STOK NU.";

                    NewField141 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 36, 36, 98, 46, false);
                    NewField141.Name = "NewField141";
                    NewField141.DrawStyle = DrawStyleConstants.vbSolid;
                    NewField141.TextFont.Bold = true;
                    NewField141.Value = @"MALZEMENİN ADI";

                    NewField142 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 98, 36, 113, 46, false);
                    ...
                    NewField1241 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 113, 36, 134, 46, false);
                    ...
                    NewField1242 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 134, 36, 190, 41, false);
                    ...
                    NewField12421 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 134, 41, 149, 46, false);
                    ...
                    NewField112421 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 149, 41, 164, 46, false);
                    ...
                    NewField112422 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 164, 41, 178, 46, false);
                    ...
                    NewField112423 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 178, 41, 190, 46, false);
                    ...
                    NewField111 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 150, 20, 162, 25, false);
                    NewField111.Name = "NewField111";
                    NewField111.HorzAlign = HorizontalAlignmentEnum.haleft;
                    NewField111.TextFont.Bold = true;
                    NewField111.Value = @"TARİH:";

                    DATE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 162, 20, 190, 25, false);
                    DATE.Name = "DATE";
                    ...
                    REQUESTNO = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 170, 10, 190, 15, false);
                    REQUESTNO.Name = "REQUESTNO";
                    REQUESTNO.FieldType = ReportFieldTypeEnum.ftVariable;
                    REQUESTNO.TextFormat = @"dd/MM/yyyy";
                    REQUESTNO.HorzAlign = HorizontalAlignmentEnum.haleft;
                    REQUESTNO.TextFont.Name = "Arial Narrow";
                    REQUESTNO.TextFont.Size = 8;
                    REQUESTNO.Value = @"{#REQUESTNO#}";

                    REFERTYPENAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 130, 0, 158, 5, false);
                    ...
                    NewField16 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 163, 0, 165, 5, false);
                    ...
                    NewField161 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 118, 0, 120, 5, false);
                    NewField161.Name = "NewField161";
                    NewField161.HorzAlign = HorizontalAlignmentEnum.haleft;
                    NewField161.VertAlign = VerticalAlignmentEnum.vaTop;
                    NewField161.TextFont.Name = "Arial Narrow";
                    NewField161.TextFont.Bold = true;
                    NewField161.Value = @"(";

                    MATERIALNAME1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 41, 30, 190, 35, false);
                    MATERIALNAME1.Name = "MATERIALNAME1";
                    MATERIALNAME1.FieldType = ReportFieldTypeEnum.ftVariable;
                    MATERIALNAME1.HorzAlign = HorizontalAlignmentEnum.haleft;
                    MATERIALNAME1.WordBreak = EvetHayirEnum.ehEvet;
                    MATERIALNAME1.Value = @"{#MARK#} - {#MODEL#} - {#SERIALNUMBER#}";
                ...
                override public TTReportObject[] GetCalculatedFields()
                {
                    ...
                    REQUESTNO.CalcValue = (dataset_GetReferToUpperLevelByObjectIDQuery != null ? Globals.ToStringCore(dataset_GetReferToUpperLevelByObjectIDQuery.RequestNo) : "");
                    ...
                    MATERIALNAME1.CalcValue = (dataset_GetReferToUpperLevelByObjectIDQuery != null ? Globals.ToStringCore(dataset_GetReferToUpperLevelByObjectIDQuery.Mark) : "") + @" - " + (dataset_GetReferToUpperLevelByObjectIDQuery != null ? Globals.ToStringCore(dataset_GetReferToUpperLevelByObjectIDQuery.Model) : "") + @" - " + (dataset_GetReferToUpperLevelByObjectIDQuery != null ? Globals.ToStringCore(dataset_GetReferToUpperLevelByObjectIDQuery.SerialNumber) : "");
                    return new TTReportObject[] { REPORTNAME,NewField1,NewField11,NewField12,NewField13,NewField131,NewField132,ORDERNO,MILITARYUNIT,MATERIALNAME,NewField2,NewField14,NewField141,NewField142,NewField1241,NewField1242,NewField12421,NewField112421,NewField112422,NewField112423,NewField111,DATE,NewField1111,REQUESTNO,REFERTYPENAME,NewField16,NewField161,MATERIALNAME1};
                }
            }
            public partial class PARTAGroupFooter : TTReportSection
            {
                ...
                public PARTAGroupFooter(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    TOTALITEMAMOUNT = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 0, 10, 190, 20, false);
                    ...
                    TOTALITEMAMOUNT.Value = @"Yukarıda adı, miktarı ve birimi yazılı olan ({@subgroupcount@}) kalem malzeme ve ana malzeme onarım için tam olarak teslim alınmıştır.";

                    NewField3 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 23, 40, 28, false);
                    NewField3.Name = "NewField3";
                    NewField3.TextFont.Bold = true;
                    NewField3.Value = @"TESLİM EDEN";

                    NewField15 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 150, 23, 180, 28, false);
                    NewField15.Name = "NewField15";
                    NewField15.TextFont.Bold = true;
                    NewField15.Value = @"TESLİM ALAN";

                    NAME = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 28, 40, 33, false);
                    NAME.Name = "NAME";
                    ...
                    RANK = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 33, 40, 38, false);
                    RANK.Name = "RANK";
                    ...
                    TITLE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 10, 38, 40, 43, false);
                    TITLE.Name = "TITLE";
                    ...
                    NAME1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 150, 28, 180, 33, false);
                    NAME1.Name = "NAME1";
                    ...
                    RANK1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 150, 33, 180, 38, false);
                    RANK1.Name = "RANK1";
                    ...
                    TITLE1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 150, 38, 180, 43, false);
                    TITLE1.Name = "TITLE1";
                    ...
                    DELIVERTITLE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 53, 26, 78, 31, false);
                    ...
                    RECEIVERTITLE = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 104, 31, 129, 36, false);
                    ...
                    NewLine11 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 0, 3, 0, 8, false);
                    ...
                    NewLine12 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 0, 5, 190, 5, false);
                    NewLine12.Name = "NewLine12";
                    NewLine12.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine111 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 0, 0, 0, 5, false);
                    ...
                    NewLine1121 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 36, 0, 36, 5, false);
                    NewLine1121.Name = "NewLine1121";
                    NewLine1121.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1131 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 98, 0, 98, 5, false);
                    NewLine1131.Name = "NewLine1131";
                    NewLine1131.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1141 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 113, 0, 113, 5, false);
                    NewLine1141.Name = "NewLine1141";
                    NewLine1141.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1151 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 134, 0, 134, 5, false);
                    NewLine1151.Name = "NewLine1151";
                    NewLine1151.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1161 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 149, 0, 149, 5, false);
                    NewLine1161.Name = "NewLine1161";
                    NewLine1161.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1171 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 164, 0, 164, 5, false);
                    NewLine1171.Name = "NewLine1171";
                    NewLine1171.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1181 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 178, 0, 178, 5, false);
                    NewLine1181.Name = "NewLine1181";
                    NewLine1181.DrawStyle = DrawStyleConstants.vbSolid;

                    NewLine1191 = ReportObjects.AddNewShape(MyParentReport.SetShapeDefaultProperties(), ShapeTypeEnum.shtLine, 190, 0, 190, 5, false);
                ...
                {
                    ReferToUpperLevel.GetReferToUpperLevelByObjectIDQuery_Class dataset_GetReferToUpperLevelByObjectIDQuery = ParentGroup.rsGroup.GetCurrentRecord<ReferToUpperLevel.GetReferToUpperLevelByObjectIDQuery_Class>(0);
                    TOTALITEMAMOUNT.CalcValue = @"Yukarıda adı, miktarı ve birimi yazılı olan (" + (ParentGroup.SubGroupCount - 1).ToString() + @") kalem malzeme ve ana malzeme onarım için tam olarak teslim alınmıştır.";
                    ...
                    return new TTReportObject[] { TOTALITEMAMOUNT,NewField3,NewField15,NAME,RANK,DELIVERTITLE,TITLE,NAME1,RANK1,RECEIVERTITLE,TITLE1,TOTAL};
                }
            }
        ...
        public partial class MAINGroup : TTReportGroup
        {
            ...
            public partial class MAINGroupBody : TTReportSection
            {
                ...
                public MAINGroupBody(TTReportGroup parentGroup) : base(parentGroup)
                {
                    ...
                    NORMAL1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 217, 2, 232, 7, false);
                    ...
                    DAMAGED1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 233, 2, 248, 7, false);
                    ...
                    CHANGED1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 249, 2, 263, 7, false);
                    ...
                    MISSING1 = ReportObjects.AddNewField(MyParentReport.SetFieldDefaultProperties(), 265, 2, 277, 7, false);
...
#region MAIN BODY_Script
        ...
        public Tutanak_TeknikMudurlukTeslimi()
        {
        ...
        public override void PrepareTTReport(Dictionary<string, object> parameters)
        {
            ...
            Name = "TUTANAK_TEKNIKMUDURLUKTESLIMI";
            Caption = "Tutanaktır(Teknik Müdürlük Birimine Teslim)";
