...
namespace TTFormClasses
{
    ...
    public partial class PA_RetiredGeneralFamilyForm : PA_MilitaryRetiredFamiliyForm
    {
        ...
        {
#region PA_RetiredGeneralFamilyForm_PreScript
    base.PreScript();
            
            // Faturalama Yöntemindeki Hasta Grubuna göre Kurumların filtreli gelmesi
            /*
            string payerTypeList = null;
            PatientGroupDefinition pGroup = Common.PatientGroupDefinitionByEnum(this._PA_RetiredGeneralFamily.ObjectContext,this._PA_RetiredGeneralFamily.Episode.PatientGroup.Value);
            ...
            if (payerTypeList != null)
            {
                ...
                */
#endregion PA_RetiredGeneralFamilyForm_PreScript
