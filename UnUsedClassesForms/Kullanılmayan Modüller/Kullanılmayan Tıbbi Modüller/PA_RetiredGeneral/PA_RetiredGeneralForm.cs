...
namespace TTFormClasses
{
    ...
    public partial class PA_RetiredGeneralForm : PA_MilitaryRetiredForm
    {
        ...
        {
#region PA_RetiredGeneralForm_PreScript
    base.PreScript();
            // Faturalama Yöntemindeki Hasta Grubuna göre Kurumların filtreli gelmesi
            /*
            string payerTypeList = null;
            PatientGroupDefinition pGroup = Common.PatientGroupDefinitionByEnum(this._PA_RetiredGeneral.ObjectContext,this._PA_RetiredGeneral.Episode.PatientGroup.Value);
            ...
            if (payerTypeList != null)
            {
                ...
                */
#endregion PA_RetiredGeneralForm_PreScript
