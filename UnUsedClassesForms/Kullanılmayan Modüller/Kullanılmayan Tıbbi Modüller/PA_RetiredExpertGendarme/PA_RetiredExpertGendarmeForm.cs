...
namespace TTFormClasses
{
    ...
    public partial class PA_RetiredExpertGendarmeForm : PA_MilitaryRetiredForm
    {
        ...
        {
#region PA_RetiredExpertGendarmeForm_PreScript
    base.PreScript();
            // Faturalama Yöntemindeki Hasta Grubuna göre Kurumların filtreli gelmesi
            /*
            string payerTypeList = null;
            PatientGroupDefinition pGroup = Common.PatientGroupDefinitionByEnum(this._PA_RetiredExpertGendarme.ObjectContext,this._PA_RetiredExpertGendarme.Episode.PatientGroup.Value);
            ...
            if (payerTypeList != null)
            {
                ...
                */
#endregion PA_RetiredExpertGendarmeForm_PreScript
