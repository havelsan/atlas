...
namespace TTFormClasses
{
    ...
    public partial class PA_RetiredMilitaryCivilOfficialFamilyForm : PA_MilitaryRetiredFamiliyForm
    {
        ...
        {
#region PA_RetiredMilitaryCivilOfficialFamilyForm_PreScript
    base.PreScript();
            // Faturalama Yöntemindeki Hasta Grubuna göre Kurumların filtreli gelmesi
            /*
            string payerTypeList = null;
            PatientGroupDefinition pGroup = Common.PatientGroupDefinitionByEnum(this._PA_RetiredMilitaryCivilOfficialFamily.ObjectContext,this._PA_RetiredMilitaryCivilOfficialFamily.Episode.PatientGroup.Value);
            ...
            if (payerTypeList != null)
            {
                ...
                */
#endregion PA_RetiredMilitaryCivilOfficialFamilyForm_PreScript
