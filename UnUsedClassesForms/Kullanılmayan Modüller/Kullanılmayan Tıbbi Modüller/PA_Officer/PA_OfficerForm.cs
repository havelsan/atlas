...
namespace TTFormClasses
{
    ...
    public partial class PA_OfficerForm : PatientAdmissionForm
    {
        ...
        {
#region PA_OfficerForm_MilitaryUnit_SelectedObjectChanged
   if(this.SenderChair.SelectedObject == null)
                this.SenderChair.SelectedObject = this.MilitaryUnit.SelectedObject;
#endregion PA_OfficerForm_MilitaryUnit_SelectedObjectChanged
        }

        protected override void PreScript()
        {
#region PA_OfficerForm_PreScript
    base.PreScript();
#endregion PA_OfficerForm_PreScript
