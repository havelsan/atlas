...
namespace TTFormClasses
{
    ...
    public partial class PA_ConsignmentPrivateForm : PatientAdmissionForm
    {
        ...
        {
#region PA_ConsignmentPrivateForm_MilitaryUnit_SelectedObjectChanged
   if(this.SenderChair.SelectedObject == null)
                this.SenderChair.SelectedObject = this.MilitaryUnit.SelectedObject;
#endregion PA_ConsignmentPrivateForm_MilitaryUnit_SelectedObjectChanged
        }

        protected override void PreScript()
        {
#region PA_ConsignmentPrivateForm_PreScript
    base.PreScript();
#endregion PA_ConsignmentPrivateForm_PreScript
