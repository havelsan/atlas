...
{
    [Serializable, TTStorageManager.Attributes.ObjectDefAttribute(Name="PA_ExpertGendarmeFamily")] 

    /// <summary>
    /// Uzman Jandarma Ailesi Kabul 
    /// </summary>
    public  partial class PA_ExpertGendarmeFamily : PatientAdmission
    {
        public class PA_ExpertGendarmeFamilyList : TTObjectCollection<PA_ExpertGendarmeFamily> { }
                    
        public class ChildPA_ExpertGendarmeFamilyCollection : TTObject.TTChildObjectCollection<PA_ExpertGendarmeFamily>
        {
            public ChildPA_ExpertGendarmeFamilyCollection(TTObject parent, Guid relDefID) : base(parent, relDefID) { }
            public ChildPA_ExpertGendarmeFamilyCollection(TTObject.ITTChildObjectCollection parentCollection, string relSubtypeDefName) : base(parentCollection, relSubtypeDefName) { }
        }
    ...
    /// </summary>
        ...
        protected PA_ExpertGendarmeFamily(TTObjectContext objectContext, string objectDefName, DataRow dataRow) : base(objectContext, objectDefName, dataRow) { }
        protected PA_ExpertGendarmeFamily(TTObjectContext objectContext, string objectDefName, DataRow dataRow, bool isImported) : base(objectContext, objectDefName, dataRow, isImported) { }
        protected PA_ExpertGendarmeFamily(TTObjectContext objectContext, string objectDefName, Guid objectID) : base(objectContext, objectDefName, objectID) { }
        protected PA_ExpertGendarmeFamily(TTObjectContext objectContext, string objectDefName, Guid objectID, bool isImported) : base(objectContext, objectDefName, objectID, isImported) { }
        protected PA_ExpertGendarmeFamily(TTObjectContext objectContext, DataRow dataRow) : base(objectContext, "PA_EXPERTGENDARMEFAMILY", dataRow) { }
        protected PA_ExpertGendarmeFamily(TTObjectContext objectContext, DataRow dataRow, bool isImported) : base(objectContext, "PA_EXPERTGENDARMEFAMILY", dataRow, isImported) { }
        public PA_ExpertGendarmeFamily(TTObjectContext objectContext) : this(objectContext, (DataRow)null) { }

        public PA_ExpertGendarmeFamily(SerializationInfo info, StreamingContext context) : base(info, context) { }

        public PA_ExpertGendarmeFamily() : base() { }
