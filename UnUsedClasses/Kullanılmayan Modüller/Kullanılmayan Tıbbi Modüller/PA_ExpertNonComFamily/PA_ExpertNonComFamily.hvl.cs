...
{
    [Serializable, TTStorageManager.Attributes.ObjectDefAttribute(Name="PA_ExpertNonComFamily")] 

    /// <summary>
    /// Uzman Erbaş Ailesi Kabul 
    /// </summary>
    public  partial class PA_ExpertNonComFamily : PatientAdmission
    {
        public class PA_ExpertNonComFamilyList : TTObjectCollection<PA_ExpertNonComFamily> { }
                    
        public class ChildPA_ExpertNonComFamilyCollection : TTObject.TTChildObjectCollection<PA_ExpertNonComFamily>
        {
            public ChildPA_ExpertNonComFamilyCollection(TTObject parent, Guid relDefID) : base(parent, relDefID) { }
            public ChildPA_ExpertNonComFamilyCollection(TTObject.ITTChildObjectCollection parentCollection, string relSubtypeDefName) : base(parentCollection, relSubtypeDefName) { }
        }
    ...
    /// </summary>
        ...
        protected PA_ExpertNonComFamily(TTObjectContext objectContext, string objectDefName, DataRow dataRow) : base(objectContext, objectDefName, dataRow) { }
        protected PA_ExpertNonComFamily(TTObjectContext objectContext, string objectDefName, DataRow dataRow, bool isImported) : base(objectContext, objectDefName, dataRow, isImported) { }
        protected PA_ExpertNonComFamily(TTObjectContext objectContext, string objectDefName, Guid objectID) : base(objectContext, objectDefName, objectID) { }
        protected PA_ExpertNonComFamily(TTObjectContext objectContext, string objectDefName, Guid objectID, bool isImported) : base(objectContext, objectDefName, objectID, isImported) { }
        protected PA_ExpertNonComFamily(TTObjectContext objectContext, DataRow dataRow) : base(objectContext, "PA_EXPERTNONCOMFAMILY", dataRow) { }
        protected PA_ExpertNonComFamily(TTObjectContext objectContext, DataRow dataRow, bool isImported) : base(objectContext, "PA_EXPERTNONCOMFAMILY", dataRow, isImported) { }
        public PA_ExpertNonComFamily(TTObjectContext objectContext) : this(objectContext, (DataRow)null) { }

        public PA_ExpertNonComFamily(SerializationInfo info, StreamingContext context) : base(info, context) { }

        public PA_ExpertNonComFamily() : base() { }
