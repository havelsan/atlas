...
{
    [Serializable, TTStorageManager.Attributes.ObjectDefAttribute(Name="PA_GeneralAdmiral")] 

    /// <summary>
    /// General/Amiral Kabul
    /// </summary>
    public  partial class PA_GeneralAdmiral : PatientAdmission
    {
        public class PA_GeneralAdmiralList : TTObjectCollection<PA_GeneralAdmiral> { }
                    
        public class ChildPA_GeneralAdmiralCollection : TTObject.TTChildObjectCollection<PA_GeneralAdmiral>
        {
            public ChildPA_GeneralAdmiralCollection(TTObject parent, Guid relDefID) : base(parent, relDefID) { }
            public ChildPA_GeneralAdmiralCollection(TTObject.ITTChildObjectCollection parentCollection, string relSubtypeDefName) : base(parentCollection, relSubtypeDefName) { }
        }
    ...
    /// </summary>
        ...
        protected PA_GeneralAdmiral(TTObjectContext objectContext, string objectDefName, DataRow dataRow) : base(objectContext, objectDefName, dataRow) { }
        protected PA_GeneralAdmiral(TTObjectContext objectContext, string objectDefName, DataRow dataRow, bool isImported) : base(objectContext, objectDefName, dataRow, isImported) { }
        protected PA_GeneralAdmiral(TTObjectContext objectContext, string objectDefName, Guid objectID) : base(objectContext, objectDefName, objectID) { }
        protected PA_GeneralAdmiral(TTObjectContext objectContext, string objectDefName, Guid objectID, bool isImported) : base(objectContext, objectDefName, objectID, isImported) { }
        protected PA_GeneralAdmiral(TTObjectContext objectContext, DataRow dataRow) : base(objectContext, "PA_GENERALADMIRAL", dataRow) { }
        protected PA_GeneralAdmiral(TTObjectContext objectContext, DataRow dataRow, bool isImported) : base(objectContext, "PA_GENERALADMIRAL", dataRow, isImported) { }
        public PA_GeneralAdmiral(TTObjectContext objectContext) : this(objectContext, (DataRow)null) { }

        public PA_GeneralAdmiral(SerializationInfo info, StreamingContext context) : base(info, context) { }

        public PA_GeneralAdmiral() : base() { }
